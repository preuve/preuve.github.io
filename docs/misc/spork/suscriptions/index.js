...
(function($PS) {
  ...
  var interpreter = Spork_Interpreter.Interpreter(Spork_EventQueue.withAccumArray(Effect.applicativeEffect)(function (queue) {
      return function __do() {
          ...
          var v2 = Web_Event_EventTarget.eventListener(function (event) {
              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Web_UIEvent_MouseEvent.fromEvent(event))(function (mouseEvent) {
                  ...
                  return function __do() {
                      Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(v))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (v2) {
                          return queue.push(v2.value0(coord));
                      }))();
                      return queue.run();
                  };
              });
          ...
          var commit = function ($$new) {
              return function __do() {
                  ...
                  if ($$new.length === 0) {
                      return Web_Event_EventTarget.removeEventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(v2)(false)(v1)();
                  };
                  if (v3.length === 0) {
                      return Web_Event_EventTarget.addEventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(v2)(false)(v1)();
                  };
                  return Data_Unit.unit;
              };
          };
...
(function($PS) {
  ...
  var subs = function (v) {
      if (v.subscribing) {
          return Spork_Batch.lift(Sub.mouseMove(UpdateCoord.create));
      };
      if (Data_Boolean.otherwise) {
  ...
  var app = {
      ...
      update: update,
      subs: subs,
      init: Spork_Transition.purely(initialState)
  };
  var main = function __do() {
      var v = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.never(Effect.monadEffect))(Sub.interpreter))(app)("#app")();
      return v.run();
  };
