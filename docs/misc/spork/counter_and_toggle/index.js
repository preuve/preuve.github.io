      ...
      return function (v) {
          if (v instanceof Inc) {
              return {
                  ...
                  toggleButtons: st.toggleButtons
              };
          };
          if (v instanceof Dec) {
              return {
          ...
          if (v instanceof Toggle) {
              return {
                  counter: st.counter,
                  toggleButtons: Data_Array.modifyAtIndices(Data_Foldable.foldableArray)([ v.value0 ])(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(st.toggleButtons)
              };
          };
          throw new Error("Failed pattern match at Main (line 23, column 13 - line 29, column 59): " + [ v.constructor.name ]);
      };
  };
  var render = function (st) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Inc.value)) ])([ Spork_Html_Core.text("+") ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Dec.value)) ])([ Spork_Html_Core.text("-") ]), Spork_Html_Elements.span([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showInt)(st.counter)) ]), Spork_Html_Elements.div([  ])(Data_FoldableWithIndex.foldMapWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(Data_Monoid.monoidArray)(function (i) {
          return function (b) {
              return [ Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(new Toggle(i))) ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showBoolean)(b)) ]) ];
          };
      })(st.toggleButtons)) ]);
  };
  var init = {
