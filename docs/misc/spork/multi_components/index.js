...
(function($PS) {
  ...
  var UpdateMessage = (function () {
      function UpdateMessage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateMessage.create = function (value0) {
          return function (value1) {
              return new UpdateMessage(value0, value1);
          };
      };
      return UpdateMessage;
  })();
  var SubmitMessage = (function () {
      function SubmitMessage(value0) {
          this.value0 = value0;
      };
      SubmitMessage.create = function (value0) {
          return new SubmitMessage(value0);
      };
      return SubmitMessage;
  })();
  var render = function (v) {
      var renderReceived = function (v1) {
          return Spork_Html_Elements.li([  ])([ Spork_Html_Core.text("From" + (Data_Show.show(Data_Show.showInt)(v1.value1) + (" : " + v1.value0))) ]);
      };
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.input([ Spork_Html_Properties.value(v.message), Spork_Html_Events.onValueChange((function () {
          var $12 = Data_Function.flip(UpdateMessage.create)(v.id);
          return function ($13) {
              return Data_Maybe.Just.create($12($13));
          };
      })()) ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Data_Function["const"](new Data_Maybe.Just(new SubmitMessage(v.id)))) ])([ Spork_Html_Core.text("Send") ]), Spork_Html_Elements.ul([  ])(Data_Functor.map(Data_Functor.functorArray)(renderReceived)(v.received)), Spork_Html_Elements.hr([  ]) ]);
  };
...
(function($PS) {
  ...
  var render = function (st) {
      return Spork_Html_Elements.div([  ])(Data_Functor.map(Data_Functor.functorArray)(Child.render)(st));
  };
  var init = Data_Functor.map(Data_Functor.functorArray)(function (i) {
      return Child.initialState({
          id: i
      });
  ...
  var getChild = function (id) {
      return function (children) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
              return v.head;
          })(Data_Array.uncons(Data_Array.filter((function () {
              var $14 = Data_Eq.eq(Data_Eq.eqInt)(id);
              return function ($15) {
                  return $14((function (v) {
                      return v.id;
                  })($15));
              };
          })())(children)));
  ...
  var update = function (children) {
      return function (v) {
          if (v instanceof Child.UpdateMessage) {
              return Data_Functor.map(Data_Functor.functorArray)(Control_Bind.ifM(Control_Bind.bindFn)((function () {
                  var $16 = Data_Eq.eq(Data_Eq.eqInt)(v.value1);
                  return function ($17) {
                      return $16((function (v1) {
                          return v1.id;
                      })($17));
                  };
              })())(function (v1) {
              ...
              })(Control_Category.identity(Control_Category.categoryFn)))(children);
          };
          if (v instanceof Child.SubmitMessage) {
              var message = Data_Maybe.maybe("")(function (v1) {
                  return v1.message;
              })(getChild(v.value0)(children));
              return Data_Functor.map(Data_Functor.functorArray)(Control_Bind.ifM(Control_Bind.bindFn)((function () {
                  var $18 = Data_Eq.eq(Data_Eq.eqInt)(v.value0);
                  return function ($19) {
                      return $18((function (v1) {
                          return v1.id;
                      })($19));
                  };
              })())(function (v1) {
                  ...
                  return {
                      ...
                      id: child.id,
                      received: Data_Array.snoc(child.received)(new Child.Post(message, v.value0))
                  };
              }))(children);
          };
          throw new Error("Failed pattern match at Parent (line 26, column 1 - line 26, column 41): " + [ children.constructor.name, v.constructor.name ]);
      };
  };
  var app = {
      init: init,
...
(function($PS) {
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(Spork_PureApp.makeWithSelector(Parent.app)("#app"));
  exports["main"] = main;
})(PS);
PS["Main"].main();