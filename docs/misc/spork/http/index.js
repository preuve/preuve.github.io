...
(function($PS) {
  ...
  var img = function (ps) {
      return Spork_Html_Core.elem("img")(ps)([  ]);
  };                                  
...
(function($PS) {
  ...
  var Spork_Html_Core = $PS["Spork.Html.Core"];
  var src = Spork_Html_Core.prop(Spork_Html_Core.stringToPropValue)("src");
  exports["src"] = src;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
...
(function($PS) {
  ...
  var GetRandomGif = (function () {
      function GetRandomGif(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      GetRandomGif.create = function (value0) {
          return function (value1) {
              return new GetRandomGif(value0, value1);
          };
      };
      return GetRandomGif;
  })();
  var MorePlease = (function () {
      function MorePlease() {

      };
      MorePlease.value = new MorePlease();
      return MorePlease;
  })();
  var NewGif = (function () {
      function NewGif(value0) {
          this.value0 = value0;
      };
      NewGif.create = function (value0) {
          return new NewGif(value0);
      };
      return NewGif;
  })();
  var update = function (model) {
      return function (msg) {
          if (msg instanceof MorePlease) {
              return {
                  model: model,
                  effects: Spork_Batch.lift(new GetRandomGif(model.topic, NewGif.create))
              };
          };
          if (msg instanceof NewGif && msg.value0 instanceof Data_Either.Left) {
              return Spork_Transition.purely(model);
          };
          if (msg instanceof NewGif && msg.value0 instanceof Data_Either.Right) {
              return Spork_Transition.purely({
                  gifUrl: msg.value0.value0,
                  topic: model.topic
              });
          };
          throw new Error("Failed pattern match at Main (line 57, column 5 - line 65, column 51): " + [ msg.constructor.name ]);
      };
  };
  var trim = function (str) {
      var len = Data_String_CodePoints.length(str);
      return Data_String_CodePoints.drop(1)(Data_String_CodePoints.take(len - 1 | 0)(str));
  };
  var render = function (model) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.h2([  ])([ Spork_Html_Core.text(model.topic) ]), Spork_Html_Elements.img([ Spork_Html_Properties.src(model.gifUrl) ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(model.gifUrl) ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Data_Function["const"](new Data_Maybe.Just(MorePlease.value))) ])([ Spork_Html_Core.text("More Please!") ]) ]);
  };
  ...
  var getValue = function (str) {
      return function (key) {
          var v = Data_Argonaut_Parser.jsonParser(str);
          if (v instanceof Data_Either.Right) {
              return Data_Maybe.maybe(Data_Either.Left.create("not an json object or " + (key + " not present")))(function (o) {
                  return Data_Functor.map(Data_Either.functorEither)(Data_Argonaut_Core.stringify)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonJson)(o)(key));
              })(Data_Argonaut_Core.toObject(v.value0));
          };
          return new Data_Either.Left("not a valid json");
      };
  };
  var runUnpure = function (unpure) {
      var url = "https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=" + unpure.value0;
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(url))(function (v) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(unpure.value1((function () {
              if (v instanceof Data_Either.Right) {
                  var v1 = getValue(v.value0.body)("data");
                  if (v1 instanceof Data_Either.Right) {
                      return Data_Functor.map(Data_Either.functorEither)(trim)(getValue(v1.value0)("image_url"));
                  };
                  return new Data_Either.Left("unvalid data");
              };
              return new Data_Either.Left("unvalid response");
          })()));
      });
  };
  var app = {
  ...
  var main = (function () {
      ...
      return function __do() {
          var v = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(interpreter)(Spork_Interpreter.never(Effect.monadEffect)))(app)("#app")();
          return v.run();
      };
  })();
  exports["MorePlease"] = MorePlease;
