...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Common.Svg"] = $PS["Common.Svg"] || {};
  var exports = $PS["Common.Svg"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Spork_Html_Core = $PS["Spork.Html.Core"];                
  var y2 = Spork_Html_Core.attr("y2");
  var y1 = Spork_Html_Core.attr("y1");
  var x2 = Spork_Html_Core.attr("x2");
  var x1 = Spork_Html_Core.attr("x1");
  var viewBox = Spork_Html_Core.attr("viewBox");
  var stroke = Spork_Html_Core.attr("stroke");
  var r = Spork_Html_Core.attr("r");
  var fill = Spork_Html_Core.attr("fill");
  var elemSvg = Spork_Html_Core.elemWithNS(Data_Maybe.Just.create("http://www.w3.org/2000/svg"));
  var line = elemSvg("line");
  var svg = elemSvg("svg");
  var cy = Spork_Html_Core.attr("cy");
  var cx = Spork_Html_Core.attr("cx");
  var circle = elemSvg("circle");
  exports["svg"] = svg;
...
(function($PS) {
  ...
  var update = function (model) {
      return function (msg) {
          return Spork_Transition.purely(new Data_Maybe.Just(msg.value0));
      };
  };
  var turns = function (ts) {
      return 2.0 * $$Math.pi * ts;
  };
  var subs = function (model) {
      return Spork_Batch.lift(new TickTime(Tick.create));
  };
  var runSubscriptions = Spork_Interpreter.Interpreter(Spork_EventQueue.withAccumArray(Effect.applicativeEffect)(function (queue) {
      return function __do() {
          ...
          var tick = function __do() {
              var v1 = Effect_Now.now();
              Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(v))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (v2) {
                  return queue.push(v2.value0(v1));
              }))();
              return queue.run();
          };
          var commit = function ($$new) {
              return function __do() {
                  var v1 = Effect_Ref.read(v)();
                  Effect_Ref.write($$new)(v)();
                  (function () {
                      if (v1.length === 0) {
                          return Data_Functor["void"](Effect.functorEffect)(Effect_Timer.setInterval(1000)(tick))();
                      };
                      return Data_Unit.unit;
                  })();
                  return Data_Unit.unit;
  ...
  var init = Spork_Transition.purely(Data_Maybe.Nothing.value);
  var inMinutes = (function () {
      var $22 = Data_Time_Duration.convertDuration(Data_Time_Duration.durationMilliseconds)(Data_Time_Duration.durationMinutes);
      return function ($23) {
          return $22(Data_DateTime_Instant.unInstant($23));
      };
  })();
  var render = function (model) {
      var v = Data_Maybe.maybe(0.0)(inMinutes)(model);
      var angle = turns(v);
      var handX = Data_Show.show(Data_Show.showNumber)(50.0 + 40.0 * $$Math.cos(angle));
      var handY = Data_Show.show(Data_Show.showNumber)(50.0 + 40.0 * $$Math.sin(angle));
      return Spork_Html_Elements.div([ Spork_Html_Properties.styles([ new Spork_Html_Properties.Style("width", "300px") ]) ])([ Common_Svg.svg([ Common_Svg.viewBox("0 0 100 100") ])([ Common_Svg.circle([ Common_Svg.cx("50"), Common_Svg.cy("50"), Common_Svg.r("45"), Common_Svg.fill("#0B79CE") ])([  ]), Common_Svg.line([ Common_Svg.x1("50"), Common_Svg.y1("50"), Common_Svg.x2(handX), Common_Svg.y2(handY), Common_Svg.stroke("#023963") ])([  ]) ]) ]);
  };
  var functorSub = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new TickTime(Data_Functor.map(Data_Functor.functorFn)(f)(m.value0));
      };
  });
  var app = {
      render: render,
  ...
  var main = function __do() {
      var v = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.never(Effect.monadEffect))(runSubscriptions))(app)("#app")();
      return v.run();
  };
  exports["Tick"] = Tick;
  exports["TickTime"] = TickTime;
  exports["init"] = init;
  exports["turns"] = turns;
