...
(function($PS) {
  ...
  var UpdateText = (function () {
      function UpdateText(value0) {
          this.value0 = value0;
      };
      UpdateText.create = function (value0) {
          return new UpdateText(value0);
      };
      return UpdateText;
  })();
  ...
  var update = function (s) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 40, column 1 - line 40, column 63): " + [ s.constructor.name, v.constructor.name ]);
      };
  };
  var runEffect = function (effect) {
      return function __do() {
          Web_DOM_Element.setAttribute("href")("data:text/plain;charset=utf-8," + Global_Unsafe.unsafeEncodeURIComponent(effect.value0.text))(effect.value0.element)();
          Web_DOM_Element.setAttribute("download")(effect.value0.name)(effect.value0.element)();
          Web_HTML_HTMLElement.click(Data_Maybe.fromJust()(Web_HTML_HTMLElement.fromElement(effect.value0.element)))();
          return effect.value1;
      };
  };
  var render = function (s) {
      return Spork_Html_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Spork_Html_Elements.textarea([ Spork_Html_Events.onValueChange(Spork_Html_Events.always(UpdateText.create)) ]), Spork_Html_Elements.input([ Spork_Html_Properties.type_(Spork_Html_Core.inputTypeToPropValue)(DOM_HTML_Indexed_InputType.InputText.value), Spork_Html_Events.onValueChange(Spork_Html_Events.always(RegisterFilename.create)) ]), Spork_Html_Elements.a([ Spork_Html_Properties.style("display=\"none\""), Spork_Html_Core.ref(Spork_Html_Events.always(RegisterAnchor.create)) ])([  ]) ])(Data_Maybe.maybe([  ])(Data_Function["const"]([ Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(DoWrite.value)) ])([ Spork_Html_Core.text("Save") ]) ]))(s.filename)));
  };
  var app = {
      update: update,
  ...
  var main = function __do() {
      var inst = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.liftNat(Effect.monadEffect)(runEffect))(Spork_Interpreter.never(Effect.monadEffect)))(app)("#app")();
      return inst.run();
  };
