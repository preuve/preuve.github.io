...
(function($PS) {
  ...
  exports["shiftMapCofree"] = shiftMapCofree;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var node_ = function (s) {
      return function (dictShiftMap) {
          return el(dictShiftMap)(nodeBuilder(s));
      };
  };
  var div_ = function (dictShiftMap) {
      return node_("div")(dictShiftMap);
  };
...
(function($PS) {
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];                
  var textSignal = Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!"));
  var incrementTicker = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (n) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(1000.0)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(n + 1 | 0);
          });
      });
  };
  var hello = function (s) {
      return Concur_Core_FRP.step(s)(Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]))(function (greeting) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!"))(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("restart") ]))))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(hello(greeting));
          });
      }));
  };
  var helloListWithDisplay1 = function (prev) {
      return Concur_VDom_DOM.div_(Control_Cofree.shiftMapCofree(Data_Monoid.monoidArray))([  ])(Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Previously selected greetings - " + Data_Show.show(Data_Show.showArray(Data_Show.showString))(prev))))(function () {
          return Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(hello)(prev);
      }));
  };
  var helloListWidget1 = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(helloListWithDisplay1([ "ab", "cd" ]));
  var helloListWithDisplay2 = function (prev) {
      return Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(prev)(function (prev$prime) {
          return Concur_VDom_DOM.div_(Control_Cofree.shiftMapCofree(Data_Monoid.monoidArray))([  ])(Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Previously selected greetings - " + Data_Show.show(Data_Show.showArray(Data_Show.showString))(prev$prime))))(function () {
              return Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(hello)(prev$prime);
          }));
      });
  };
  var helloListWidget2 = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(helloListWithDisplay2([ "ab", "cd" ]));
  var helloWidget = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(hello(""));
  var counterSignal = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (n) {
          return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(n + 1 | 0)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("+") ])), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(n)) ]), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(n - 1 | 0)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("-") ])) ]);
      });
  };
  var counterWidget = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(0)(function (n) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(n))))(function () {
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(incrementTicker(n))(function (n$prime) {
              return counterSignal(n$prime);
          });
      });
  }));
  var main = Concur_VDom_Run.runWidgetInDom("main")(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(helloListWidget2)(Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(textSignal)))(counterWidget));
  exports["hello"] = hello;
  exports["helloWidget"] = helloWidget;
  exports["textSignal"] = textSignal;
  exports["helloListWithDisplay1"] = helloListWithDisplay1;
  exports["helloListWidget1"] = helloListWidget1;
  exports["helloListWithDisplay2"] = helloListWithDisplay2;
  exports["helloListWidget2"] = helloListWidget2;
  exports["counterWidget"] = counterWidget;
  exports["counterSignal"] = counterSignal;
