...
(function($PS) {
  ...
  exports["widgetMonadRec"] = widgetMonadRec;
...
(function($PS) {
  ...
  var button = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return node("button")(dictMultiAlternative)(dictShiftMap);
      };
  };
  exports["text"] = text;
...
(function($PS) {
  ...
  var onClick = handle("click");
  var onFocus = handle("focus");
...
(function($PS) {
  ...
  var timerWidget = function (ms) {
      return Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(ms)))(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)(Data_Unit.unit)(Concur_VDom_Props.onClick) ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Cancel") ]));
  };
  var pingPong = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Control_Monad_Rec_Class.forever(Concur_Core_Types.widgetMonadRec)(Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ping") ])))(function () {
      return Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pong") ]);
  }))))(function () {
      return Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("This text will never be shown");
  });
  var inputWidget3 = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_VDom_DOM.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          focusCount: st.focusCount + 1 | 0,
          currentText: st.currentText
      })(Concur_VDom_Props.onFocus), Data_Functor.map(Concur_Core_Props.functorProps)(function ($7) {
          return (function (s) {
              return {
                  currentText: s,
                  focusCount: st.focusCount
              };
          })(Concur_VDom_Props.unsafeTargetValue($7));
      })(Concur_VDom_Props.onChange) ]))(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(st.currentText + Data_Show.show(Data_Show.showInt)(st.focusCount))))(function (st$prime) {
          return inputWidget3(st$prime);
      });
  };
  var inputWidget2 = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(st.currentText), Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(st.focusCount)), Concur_VDom_DOM.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          focusCount: st.focusCount + 1 | 0,
          currentText: st.currentText
      })(Concur_VDom_Props.onFocus), Data_Functor.map(Concur_Core_Props.functorProps)(function ($8) {
          return (function (s) {
              return {
                  currentText: s,
                  focusCount: st.focusCount
              };
          })(Concur_VDom_Props.unsafeTargetValue($8));
      })(Concur_VDom_Props.onChange) ]) ]))(function (st$prime) {
          return inputWidget2(st$prime);
      });
  };
  var inputWidget1 = Concur_VDom_DOM.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.map(Concur_Core_Props.functorProps)(function ($9) {
      return Changed.create(Concur_VDom_Props.unsafeTargetValue($9));
  })(Concur_VDom_Props.onChange), Data_Functor.voidRight(Concur_Core_Props.functorProps)(Focused.value)(Concur_VDom_Props.onFocus) ]);
  var helloWidget = Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]))(function (greeting) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(Effect_Console.log("You chose to say " + greeting)))(function () {
          return Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!");
      });
  });
  var decodeJsonPost = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (obj) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(obj)("data"))(function (d) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(d)("id"))(function (id) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(d)("title"))(function (title) {
  ...
  var work = function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (o) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(o)("data"))(function (d1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonJson)(d1)("children"))(function (cs) {
                  return Control_Bind.bind(Data_Either.bindEither)(Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(cs))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Argonaut_Decode_Class.decodeJson(decodeJsonPost))))(function (os) {
                      return Data_Either.Right.create(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                          return v.title;
                      })(os));
                  });
              });
  ...
  var fetchWidget = Control_Bind.bind(Concur_Core_Types.widgetBind)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("https://www.reddit.com/search.json?q=purescript&sort=new"))(Data_Either.either(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)([ "invalid response" ])))((function () {
      var $10 = Data_Either.either(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)([ "invalid structure" ])))(Control_Applicative.pure(Effect_Aff.applicativeAff));
      return function ($11) {
          return $10(work((function (v) {
              return v.body;
          })($11)));
      };
  })()))))(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Fetching posts from subreddit...")))(function (resp) {
      return Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap))(Data_Array.singleton))(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)))(resp));
  });
  var main = Concur_VDom_Run.runWidgetInDom("main")(fetchWidget);
  var counter = function (count) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(count)) ])))(function () {
          return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(count + 1 | 0);
      });
  };
  var listCounters1 = (function () {
      var $12 = Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray));
      var $13 = Data_Functor.map(Data_Functor.functorArray)(counter);
      return function ($14) {
          return $12($13($14));
      };
  })();
  var listCounters2 = function (initialCounts) {
      return Concur_Core_Types.andd(Data_Monoid.monoidArray)(Data_Functor.map(Data_Functor.functorArray)(counter)(initialCounts));
  };
  exports["Changed"] = Changed;
  exports["Focused"] = Focused;
  exports["inputWidget1"] = inputWidget1;
  exports["inputWidget2"] = inputWidget2;
  exports["inputWidget3"] = inputWidget3;
  exports["pingPong"] = pingPong;
  exports["counter"] = counter;
  exports["listCounters1"] = listCounters1;
  exports["listCounters2"] = listCounters2;
  exports["helloWidget"] = helloWidget;
