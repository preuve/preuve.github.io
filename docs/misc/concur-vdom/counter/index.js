...
(function($PS) {
  ...
  var p$prime = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return node$prime("p")(dictMultiAlternative)(dictShiftMap);
      };
  };
  var el = function (dictShiftMap) {
      return function (f) {
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Console = $PS["Effect.Console"];                
  var counterWidget = function (count) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["hr'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap), Concur_VDom_DOM["p'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("State: " + Data_Show.show(Data_Show.showInt)(count)) ]), Data_Functor.voidLeft(Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Increment") ]))(count + 1 | 0), Data_Functor.voidLeft(Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Decrement") ]))(count - 1 | 0) ]))(function (n) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(Effect_Console.log("COUNT IS NOW: " + Data_Show.show(Data_Show.showInt)(n))))(function () {
              return counterWidget(n);
          });
      });
  };
  var main = (function () {
      var widget = function (w) {
          return function (s) {
              return Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))([ Concur_VDom_DOM.h2_(Concur_Core_Types.widgetShiftMap)([  ])(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(s)), Concur_VDom_DOM.div_(Concur_Core_Types.widgetShiftMap)([  ])(w) ]);
          };
      };
      return Concur_VDom_Run.runWidgetInDom("main")(Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))([ widget(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(counterWidget(0))(counterWidget(100)))("Counter") ]));
  })();
