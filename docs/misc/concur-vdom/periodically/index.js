...
(function($PS) {
  ...
  // | Library
  var ToMap = function (toMapImpl) {
      this.toMapImpl = toMapImpl;
  };
  var RecordApplyWithLabels = function (recordApplyImpl) {
      this.recordApplyImpl = recordApplyImpl;
  };
  var toMapNil = new ToMap(function (v) {
      return function (v1) {
          return Data_Map_Internal.empty;
      };
  });
  var toMapImpl = function (dict) {
      return dict.toMapImpl;
  };
  var toMapCons = function (dictRowToList) {
      return function (dictIsSymbol) {
          return function (dictLacks) {
              return function (dictCons) {
                  return function (dictRowToList1) {
                      return function (dictToMap) {
                          return new ToMap(function (v) {
                              return function (record) {
                                  var record$prime = Record["delete"](dictIsSymbol)()()(Data_Symbol.SProxy.value)(record);
                                  var value = Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(record);
                                  var key = Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value);
                                  return Data_Map_Internal.insert(Data_Ord.ordString)(key)(value)(toMapImpl(dictToMap)(Type_Data_RowList.RLProxy.value)(record$prime));
                              };
                          });
                      };
                  };
  ...
  var toMap = function (dictRowToList) {
      return function (dictToMap) {
          return toMapImpl(dictToMap)(Type_Data_RowList.RLProxy.value);
      };
  };
  var tickerAff1 = function (r) {
      return function (del) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(del))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(r - 0.1);
          });
      };
  };
  var tickerAff0 = function (t) {
      return function (del) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(del))(function () {
  ...
  var rot = function (v) {
      return function (a) {
          return function (v1) {
              var v2 = new Data_Tuple.Tuple(Data_Int.toNumber(v.value0), Data_Int.toNumber(v.value1));
              var v3 = new Data_Tuple.Tuple(Data_Int.toNumber(v1.value0), Data_Int.toNumber(v1.value1));
              return new Data_Tuple.Tuple(Data_Int.round((v2.value0 + (v3.value0 - v2.value0) * $$Math.cos(a)) - (v3.value1 - v2.value1) * $$Math.sin(a)), Data_Int.round(v2.value1 + (v3.value0 - v2.value0) * $$Math.sin(a) + (v3.value1 - v2.value1) * $$Math.cos(a)));
          };
      };
  };
  var red = "#FF0000";
  var recordApplyImpl = function (dict) {
      return dict.recordApplyImpl;
  };
  var recordApplyWithLabels = function (dictRecordApplyWithLabels) {
      return function (dictRowToList) {
          return function (dictRowToList1) {
              return function (n) {
                  return function (keys) {
                      return function (recf) {
                          return function (recx) {
                              return recordApplyImpl(dictRecordApplyWithLabels)(n)(keys)(Type_Data_RowList.RLProxy.value)(recf)(Type_Data_RowList.RLProxy.value)(recx);
                          };
                      };
                  };
              };
  ...
  var modulo = function ($copy_x) {
      return function ($copy_m) {
          var $tco_var_x = $copy_x;
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(x, m) {
              if (x < 0.0) {
                  $tco_var_x = x + m;
                  $copy_m = m;
                  return;
              ...
              throw new Error("Failed pattern match at Main (line 136, column 1 - line 136, column 37): " + [ x.constructor.name, m.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_x, $copy_m);
          };
          return $tco_result;
      };
  };
  var minPos = function (dictRowToList) {
      return function (dictToMap) {
          return function (onset) {
              return Data_Maybe.fromMaybe(0.0)(Data_Foldable.minimum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Data_Array.filter((function () {
                  var $119 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                  return function ($120) {
                      return $119((function (v) {
                          return v === 0.0;
                      })($120));
                  };
              })())(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Map_Internal.values(toMap()(dictToMap)(onset))))));
          };
      };
  };
  var line = function (v) {
      return Concur_VDom_SVG.line(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x1")(v.ptA.value0), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y1")(v.ptA.value1), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x2")(v.ptB.value0), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y2")(v.ptB.value1), Concur_VDom_SVG.stroke(v.color) ])([  ]);
  };
  var lines = function (color) {
      return function (t0) {
          return function (pt1) {
              return function (a1) {
                  var t = function (v) {
                      return new Data_Tuple.Tuple(v.value0 + t0 | 0, v.value1);
                  };
                  var r = rot(pt1)(a1);
                  var pt4 = new Data_Tuple.Tuple(50, 200);
                  var ptC = t(r(pt4));
                  var pt3 = new Data_Tuple.Tuple(100, 150);
                  var ptB = t(r(pt3));
                  var pt2 = new Data_Tuple.Tuple(50, 150);
                  var ptA = t(r(pt2));
                  return [ line({
                      ptA: ptA,
                      ptB: ptB,
  ...
  var green = "#00FF00";
  var filterNaught = function (dictRowToList) {
      return function (dictKeys) {
          return function (dictToMap) {
              return function (rec) {
                  var m = toMap()(dictToMap)(rec);
                  var ks = Data_Array.fromFoldable(Data_List_Types.foldableList)(Record_Extra.keys()(dictKeys)(rec));
                  var fs = Data_Array.filter(function (k) {
                      return Data_Maybe.maybe(false)(function (v) {
                          return v === 0.0;
                      })(Data_Map_Internal.lookup(Data_Ord.ordString)(k)(m));
                  })(ks);
                  return new Data_Tuple.Tuple(fs, Data_Array.length(fs));
              };
          };
      };
  };
  ...
  var tickerAff2 = function (c) {
      return function (del) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(del))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(nextColor(c));
          });
      };
  };
  var applyNil = new RecordApplyWithLabels(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return function (v4) {
  ...
  var applyCons = function (dictIsSymbol) {
      return function (dictRecordApplyWithLabels) {
          return function (dictCons) {
              return function (dictLacks) {
                  return function (dictCons1) {
                      return function (dictLacks1) {
                          return function (dictCons2) {
                              return function (dictLacks2) {
                                  return new RecordApplyWithLabels(function (n) {
                                      return function (keys) {
                                          return function (fs) {
                                              return function (recf) {
                                                  return function (xs) {
                                                      return function (recx) {
                                                          var nextf = Record["delete"](dictIsSymbol)()()(Data_Symbol.SProxy.value)(recf);
                                                          var nextx = Record["delete"](dictIsSymbol)()()(Data_Symbol.SProxy.value)(recx);
                                                          var itr = recordApplyImpl(dictRecordApplyWithLabels)(n)(keys)(Type_Data_RowList.RLProxy.value)(nextf)(Type_Data_RowList.RLProxy.value)(nextx);
                                                          return Record.insert(dictIsSymbol)()()(Data_Symbol.SProxy.value)((function () {
                                                              var $100 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value))(keys);
                                                              if ($100) {
                                                                  return Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(recf)(Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(recx))(n);
                                                              };
                                                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(recx));
                                                          })())(itr);
                                                      };
                                                  };
                                              };
  ...
  var allNaught = function (dictRowToList) {
      return function (dictSequenceRecord) {
          return function (dictRowToList1) {
              return function (dictMapRecord) {
                  return function (rec) {
                      var m = Record_Extra.sequenceRecord()(dictSequenceRecord)(Record_Extra.mapRecord()(dictMapRecord)(function (v) {
                          var $101 = v === 0.0;
                          if ($101) {
                      ...
                      return Data_Maybe.maybe(false)(Data_Function["const"](true))(m);
                  };
              };
          };
      };
  };
  var trim = function ($copy_dictRowToList) {
      return function ($copy_dictSequenceRecord) {
          return function ($copy_dictMapRecord) {
              return function ($copy_dictToMap) {
                  return function ($copy_dictRowToList1) {
                      return function ($copy_dictRowToList2) {
                          return function ($copy_dictMapRecord1) {
                              return function ($copy_dictZipRecord) {
                                  return function ($copy_period) {
                                      return function ($copy_onset) {
                                          var $tco_var_dictRowToList = $copy_dictRowToList;
                                          var $tco_var_dictSequenceRecord = $copy_dictSequenceRecord;
                                          var $tco_var_dictMapRecord = $copy_dictMapRecord;
                                          var $tco_var_dictToMap = $copy_dictToMap;
                                          var $tco_var_dictRowToList1 = $copy_dictRowToList1;
                                          var $tco_var_dictRowToList2 = $copy_dictRowToList2;
                                          var $tco_var_dictMapRecord1 = $copy_dictMapRecord1;
                                          var $tco_var_dictZipRecord = $copy_dictZipRecord;
                                          var $tco_var_period = $copy_period;
                                          var $tco_done = false;
                                          var $tco_result;
                                          function $tco_loop(dictRowToList, dictSequenceRecord, dictMapRecord, dictToMap, dictRowToList1, dictRowToList2, dictMapRecord1, dictZipRecord, period, onset) {
                                              var $102 = allNaught()(dictSequenceRecord)()(dictMapRecord)(onset);
                                              if ($102) {
                                                  $tco_var_dictRowToList = undefined;
                                                  $tco_var_dictSequenceRecord = dictSequenceRecord;
                                                  $tco_var_dictMapRecord = dictMapRecord;
                                                  $tco_var_dictToMap = dictToMap;
                                                  $tco_var_dictRowToList1 = undefined;
                                                  $tco_var_dictRowToList2 = undefined;
                                                  $tco_var_dictMapRecord1 = dictMapRecord1;
                                                  $tco_var_dictZipRecord = dictZipRecord;
                                                  $tco_var_period = period;
                                                  $copy_onset = period;
                                                  return;
                                              };
                                              var mp = minPos()(dictToMap)(period);
                                              var mo = minPos()(dictToMap)(onset);
                                              var m = Data_Ord.min(Data_Ord.ordNumber)(mp)(mo);
                                              $tco_done = true;
                                              return new Data_Tuple.Tuple(Record_Extra.mapRecord()(dictMapRecord1)(function (v) {
                                                  return modulo(v.value0 - m)(v.value1);
                                              })(Record_Extra.zipRecord()()(dictZipRecord)(onset)(period)), m);
                                          };
                                          while (!$tco_done) {
                                              $tco_result = $tco_loop($tco_var_dictRowToList, $tco_var_dictSequenceRecord, $tco_var_dictMapRecord, $tco_var_dictToMap, $tco_var_dictRowToList1, $tco_var_dictRowToList2, $tco_var_dictMapRecord1, $tco_var_dictZipRecord, $tco_var_period, $copy_onset);
                                          };
                                          return $tco_result;
                                      };
                                  };
  ...
  var periodically = function (dictRowToList) {
      return function (dictSequenceRecord) {
          return function (dictMapRecord) {
              return function (dictRowToList1) {
                  return function (dictMapRecord1) {
                      return function (dictZipRecord) {
                          return function (dictRowToList2) {
                              return function (dictKeys) {
                                  return function (dictToMap) {
                                      return function (dictRowToList3) {
                                          return function (dictSequenceRecord1) {
                                              return function (dictRecordApplyWithLabels) {
                                                  return function (dictRowToList4) {
                                                      return function (dictRowToList5) {
                                                          return function (fs) {
                                                              return function (period) {
                                                                  return function (model) {
                                                                      var v = trim()(dictSequenceRecord)(dictMapRecord)(dictToMap)()()(dictMapRecord1)(dictZipRecord)(period)(model.period);
                                                                      var v1 = filterNaught()(dictKeys)(dictToMap)(v.value0);
                                                                      var $108 = v1.value1 > 0;
                                                                      if ($108) {
                                                                          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.hold(Concur_Core_Types.widgetMonad)(model.sample)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Record_Extra.sequenceRecord()(dictSequenceRecord1)(recordApplyWithLabels(dictRecordApplyWithLabels)()()(v.value1 / Data_Int.toNumber(v1.value1))(v1.value0)(fs)(model.sample)))))(function (updated) {
                                                                              return Control_Applicative.pure(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))((function () {
                                                                                  var $109 = {};
                                                                                  for (var $110 in model) {
                                                                                      if ({}.hasOwnProperty.call(model, $110)) {
                                                                                          $109[$110] = model[$110];
                                                                                      };
                                                                                  };
                                                                                  $109.sample = updated;
                                                                      ...
                                                                      return Control_Applicative.pure(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))((function () {
                                                                          var $112 = {};
                                                                          for (var $113 in model) {
                                                                              if ({}.hasOwnProperty.call(model, $113)) {
                                                                                  $112[$113] = model[$113];
                                                                              };
                                                                          };
                                                                          $112.period = v.value0;
  ...
  var widget3 = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)((function () {
      var init = {
          sample: {
              t: 0,
              r: 0.0,
      ...
      return Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(init)(function (model) {
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(periodically()(Record_Extra.sequenceRecordCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()(Data_Maybe.applyMaybe)(Record_Extra.sequenceRecordCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()(Data_Maybe.applyMaybe)(Record_Extra.sequenceRecordSingle(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()(Data_Maybe.functorMaybe)()())()())()())(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()(Record_Extra.mapRecordNil)()())()())()())()(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()(Record_Extra.mapRecordCons(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()(Record_Extra.mapRecordNil)()())()())()())(Record_Extra.zipRecordCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()()()()(Record_Extra.zipRecordCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()()()()(Record_Extra.zipRecordCons(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()()()()(Record_Extra.zipRecordNil))))()(Record_Extra.consKeys(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))(Record_Extra.consKeys(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))(Record_Extra.consKeys(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))(Record_Extra.nilKeys))))(toMapCons()(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()()()(toMapCons()(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()()()(toMapCons()(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()()()(toMapNil))))()(Record_Extra.sequenceRecordCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))()(Effect_Aff.applyAff)(Record_Extra.sequenceRecordCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))()(Effect_Aff.applyAff)(Record_Extra.sequenceRecordSingle(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))()(Effect_Aff.functorAff)()())()())()())(applyCons(new Data_Symbol.IsSymbol(function () {
              return "c";
          }))(applyCons(new Data_Symbol.IsSymbol(function () {
              return "r";
          }))(applyCons(new Data_Symbol.IsSymbol(function () {
              return "t";
          }))(applyNil)()()()()()())()()()()()())()()()()()())()()({
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("500") ])(lines(m.sample.c)(m.sample.t)(new Data_Tuple.Tuple(100, 200))(m.sample.r)) ])))(function () {
                  return Control_Applicative.pure(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(m);
              });
          });
      });
  })());
  var main = Concur_VDom_Run.runWidgetInDom("main")(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ widget3 ]));
  exports["recordApplyImpl"] = recordApplyImpl;
  exports["toMapImpl"] = toMapImpl;
  exports["black"] = black;
  exports["blue"] = blue;
  exports["red"] = red;
  exports["green"] = green;
  ...
  exports["allNaught"] = allNaught;
  exports["filterNaught"] = filterNaught;
  exports["trim"] = trim;
  exports["RecordApplyWithLabels"] = RecordApplyWithLabels;
  exports["recordApplyWithLabels"] = recordApplyWithLabels;
  exports["periodically"] = periodically;
  exports["tickerAff0"] = tickerAff0;
  exports["tickerAff1"] = tickerAff1;
  exports["tickerAff2"] = tickerAff2;
  exports["widget3"] = widget3;
  exports["main"] = main;
  exports["toMapNil"] = toMapNil;
  exports["toMapCons"] = toMapCons;
  exports["applyNil"] = applyNil;
  exports["applyCons"] = applyCons;
})(PS);
PS["Main"].main();