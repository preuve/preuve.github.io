...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var v1 = DOM_Editor.createElement("label")(v.document)();
      var v2 = DOM_Editor.setTextContent("From direct string: " + Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "age";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "team";
      }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Show.showString))(Data_Maybe.showMaybe(Data_Show.showInt)))))(translate1(userJsonString)))(v1)();
      var v3 = DOM_Editor.appendChild(v1)(v.body)();
      var v4 = DOM_Editor.createElement("br")(v.document)();
      var v5 = DOM_Editor.appendChild(v4)(v.body)();
      var v6 = DOM_Editor.createElement("div")(v.document)();
      var v7 = DOM_Editor.createElement("textarea")(v.document)();
      var v8 = DOM_Editor.setAttribute("cols")("80")(v7)();
      var v9 = DOM_Editor.setAttribute("rows")("25")(v7)();
      var v10 = DOM_Editor.appendChild(v7)(v6)();
      var v11 = DOM_Editor.createElement("div")(v.document)();
      var v12 = DOM_Editor.appendChild(v11)(v6)();
      var v13 = DOM_Editor.createElement("button")(v.document)();
      var v14 = DOM_Editor.setTextContent("Save")(v13)();
      var v15 = DOM_Editor.appendChild(v13)(v6)();
      var v16 = DOM_Editor.createElement("input")(v.document)();
      var v17 = DOM_Editor.setAttribute("type")("file")(v16)();
      var v18 = DOM_Editor.addEventListener(function (ev) {
          return function __do() {
              DOM_Editor.withTextReader(function (json) {
                  return function __do() {
                      var v18 = DOM_Editor.setTextContent(json)(v7)();
                      var v19 = DOM_Editor.setTextContent(Data_Show.show(Data_Either.showEither(Data_Show.showString)(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "record";
                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "status";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showBoolean))(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "key1";
                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "key2";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt)))))))(translate2(json)))(v11)();
                      return Data_Unit.unit;
                  };
              })(ev)();
              var v18 = DOM_Editor.fileName(v16)();
              var v19 = DOM_Editor.addEventListener(function (_ev) {
                  return function __do() {
                      var v19 = DOM_Editor.dateTimeTag();
                      return v.saveText(v7)(v19 + v18)(_ev)();
                  };
              })(DOM_Editor.click)(v13)();
              var v20 = DOM_Editor.removeChild(v16)();
              return Data_Unit.unit;
          };
      })(DOM_Editor.change)(v16)();
      var v19 = DOM_Editor.appendChild(v16)(v.body)();
      var v20 = DOM_Editor.appendChild(v6)(v.body)();
      return Data_Unit.unit;
  };
  exports["userJsonString"] = userJsonString;
