...
(function($PS) {
  ...
  var newSVG = function (node) {
      return function __do() {
          ...
          var v3 = setAttribute("style")("position: absolute; width:100%; height:100%;")(svg)();
...
(function($PS) {
  ...
  var inc = function (n) {
      return function (arr) {
          return Data_Maybe.fromJust()(Data_Array.updateAt(n)(1 + Data_Maybe.fromJust()(Data_Array.index(arr)(n)) | 0)(arr));
      };
  };
  var classes = 200;
  var indices = Data_Array.range(0)(classes - 1 | 0);
  var initial = Data_Array.replicate(classes)(0);
  var slice = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(10000)(classes);
  var classify = function (n) {
      return function (hist) {
          var rest = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n)(slice);
          var cl = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(n - rest | 0)(slice);
          return inc(cl)(hist);
      };
  };
  var main = function __do() {
      var v = DOM_Editor.setup();
      var v1 = DOM_Editor.newSVG(v.body)();
      var context = SVG_Render.defaultContext(v1);
      ...
      var rnds = Rand.rands(900)(r0);
      var hist = Data_Foldable.foldr(Data_Foldable.foldableArray)(classify)(initial)(rnds);
      var rects = Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
          var pD = SVG_Geometry.point("")(5.0 * Data_Int.toNumber(v2.value0))(500.0 - 30.0 * Data_Int.toNumber(v2.value1));
          var pC = SVG_Geometry.point("")(5.0 * Data_Int.toNumber(v2.value0 + 1 | 0))(500.0 - 30.0 * Data_Int.toNumber(v2.value1));
          var pB = SVG_Geometry.point("")(5.0 * Data_Int.toNumber(v2.value0 + 1 | 0))(500.0);
          var pA = SVG_Geometry.point("")(5.0 * Data_Int.toNumber(v2.value0))(500.0);
          return [ SVG_Geometry.segment(pA)(pB)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pB)(pC)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pC)(pD)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pD)(pA)(Data_Maybe.Nothing.value) ];
      })(Data_Array.zip(indices)(hist)));
      return Data_Array.foldM(Effect.monadEffect)(function (a) {
          return function (b) {
              return Data_Semigroup.append(Effect.semigroupEffect(Data_Semigroup.semigroupUnit))(Control_Applicative.pure(Effect.applicativeEffect)(a))(render(SVG_Render.renderSegment)(b));
          };
      })(Data_Unit.unit)(rects)();
  };
  exports["inc"] = inc;
