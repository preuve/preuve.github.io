...
(function($PS) {
  ...
  var UpdateMagnitude = (function () {
      ...
      UpdateMagnitude.create = function (value0) {
          return new UpdateMagnitude(value0);
      };
      return UpdateMagnitude;
  })();
  var UpdateH = (function () {
      function UpdateH(value0) {
          this.value0 = value0;
      };
      UpdateH.create = function (value0) {
          return new UpdateH(value0);
      };
      return UpdateH;
  })();
  var IncreaseLength = (function () {
      ...
      IncreaseLength.value = new IncreaseLength();
      return IncreaseLength;
  })();
  var DecreaseLength = (function () {
      function DecreaseLength() {

      };
      DecreaseLength.value = new DecreaseLength();
  ...
  var IncreaseCount = (function () {
      ...
      IncreaseCount.value = new IncreaseCount();
  ...
  var update = function (model) {
      return function (v) {
          if (v instanceof Fx) {
              return {
                  fx: Data_Either.hush(Control_Bind.bind(Data_Either.bindEither)(new Data_Either.Right(v.value0))(Parser_Parser.parse(Parser_Syntax.realNumber))),
                  fy: model.fy,
          ...
          if (v instanceof Fy) {
              return {
                  fx: model.fx,
                  fy: Data_Either.hush(Control_Bind.bind(Data_Either.bindEither)(new Data_Either.Right(v.value0))(Parser_Parser.parse(Parser_Syntax.realNumber))),
                  magnitude: model.magnitude,
                  h: model.h,
                  pathLength: model.pathLength,
                  pathCount: model.pathCount
          ...
          if (v instanceof DecreaseLength) {
              return {
                  ...
                  magnitude: model.magnitude,
                  h: model.h,
                  pathLength: Control_Bind.ifM(Control_Bind.bindFn)(function (v2) {
                      return v2 > 0;
                  })(function (v2) {
                      return v2 - 1 | 0;
                  })(Control_Category.identity(Control_Category.categoryFn))(model.pathLength),
                  pathCount: model.pathCount
              };
          };
          ...
          if (v instanceof DecreaseCount) {
              return {
                  ...
                  h: model.h,
                  pathLength: model.pathLength,
                  pathCount: Control_Bind.ifM(Control_Bind.bindFn)(function (v2) {
                      return v2 > 0;
                  })(function (v2) {
                      return v2 - 1 | 0;
                  })(Control_Category.identity(Control_Category.categoryFn))(model.pathCount)
              };
          };
          throw new Error("Failed pattern match at Main (line 77, column 16 - line 89, column 67): " + [ v.constructor.name ]);
      };
  };
  ...
  var randomNumberLessThan = function (mag) {
      return function (r) {
          var rs = Rand.rand(r);
          var rx = Rand.rand(rs);
          var s = (function () {
              var $32 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rs.val)(2) === 0;
              if ($32) {
                  return 1.0;
              };
              return -1.0;
          })();
          return ((s * Data_Int.toNumber(rx.val)) / 10000.0) * mag;
      };
  };
  var liftExprNumber = function (x) {
      return new Parser_Syntax.Lit(x);
  };
  var withSolution = function (v) {
      return function (time) {
          return Data_Map_Internal.insert(Data_Ord.ordString)("x")(liftExprNumber(v.x))(Data_Map_Internal.insert(Data_Ord.ordString)("y")(liftExprNumber(v.y))(Data_Map_Internal.insert(Data_Ord.ordString)("t")(liftExprNumber(time))(Data_Map_Internal.empty)));
      };
  };
  var initialModel = {
  ...
  var rk4 = function (model) {
      return function (v) {
          return function (t) {
              var mk1 = execute(model)({
                  x: v.x,
                  y: v.y
              })(t);
              var mk2 = Control_Bind.bind(Data_Maybe.bindMaybe)(mk1)(function (v1) {
                  return execute(model)({
                      x: v.x + (model.h * v1.x) / 2.0,
                      y: v.y + (model.h * v1.y) / 2.0
                  })(t + model.h / 2.0);
              });
              var mk3 = Control_Bind.bind(Data_Maybe.bindMaybe)(mk2)(function (v1) {
                  return execute(model)({
                      x: v.x + (model.h * v1.x) / 2.0,
                      y: v.y + (model.h * v1.y) / 2.0
                  })(t + model.h / 2.0);
              });
              var mk4 = Control_Bind.bind(Data_Maybe.bindMaybe)(mk3)(function (v1) {
                  return execute(model)({
                      x: v.x + model.h * v1.x,
                      y: v.y + model.h * v1.y
                  })(t + model.h);
              });
              return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                  return function (v2) {
                      return function (v3) {
                          return function (v4) {
                              return function (v5) {
                                  return {
                                      x: v1.x + (model.h * (v2.x + 2.0 * v3.x + 2.0 * v4.x + v5.x)) / 6.0,
                                      y: v1.y + (model.h * (v2.y + 2.0 * v3.y + 2.0 * v4.y + v5.y)) / 6.0
                                  };
                              };
                          };
                      };
  ...
  var segmentSolution = function (iter) {
  ...
  var renderSolutions = function (iter) {
      return function (ctx) {
          return function (r) {
              return function (model) {
                  var $85 = iter === 0;
                  ...
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(segmentSolution(model.pathLength)(model)({
                      x: x,
                      y: y
                  })(t)) ])(renderSolutions(iter - 1 | 0)(ctx)(Rand.rand(rt))(model));
              };
          };
      };
  };
  ...
  exports["DecreaseLength"] = DecreaseLength;
  ...
  exports["segmentSolution"] = segmentSolution;
  exports["app"] = app;
  exports["main"] = main;
})(PS);
PS["Main"].main();