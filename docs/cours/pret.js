...
(function($PS) {
  ...
  var ThreeMonthly = (function () {
      function ThreeMonthly() {

      };
      ThreeMonthly.value = new ThreeMonthly();
      return ThreeMonthly;
  })();
  var FourMonthly = (function () {
      function FourMonthly() {

      };
      FourMonthly.value = new FourMonthly();
      return FourMonthly;
  })();
  var SixMonthly = (function () {
      function SixMonthly() {

      };
      SixMonthly.value = new SixMonthly();
      return SixMonthly;
  })();
  var Yearly = (function () {
      function Yearly() {
  ...
  var Capital = (function () {
      function Capital(value0) {
          this.value0 = value0;
      };
      Capital.create = function (value0) {
          return new Capital(value0);
      };
      return Capital;
  })();
  var Taux = (function () {
      function Taux(value0) {
          this.value0 = value0;
      };
      Taux.create = function (value0) {
          return new Taux(value0);
      };
      return Taux;
  })();
  var Period = (function () {
      function Period(value0) {
          this.value0 = value0;
      };
      Period.create = function (value0) {
          return new Period(value0);
      };
      return Period;
  })();
  ...
  var update = function (s) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 56, column 12 - line 60, column 34): " + [ v.constructor.name ]);
      };
  };
  var nbOfAnnuities = function (v) {
      return v.duration * (function () {
          ...
          throw new Error("Failed pattern match at Main (line 34, column 14 - line 41, column 25): " + [ v.frequency.constructor.name ]);
      })();
  };
  var floatEntry = function (str) {
      return function (cnstr) {
          return [ Spork_Html_Elements.p([  ])([ Spork_Html_Core.text(str + ": ") ]), Spork_Html_Elements.input([ Spork_Html_Properties.type_(Spork_Html_Core.inputTypeToPropValue)(DOM_HTML_Indexed_InputType.InputText.value), Spork_Html_Events.onValueInput(function ($17) {
              return Data_Maybe.Just.create(cnstr(Global.readFloat($17)));
          }) ]) ];
      };
  };
  var annuity = function (s) {
      var t = s.taux / 100.0;
      var n = nbOfAnnuities(s);
      return (s.capital * t) / (1.0 - $$Math.pow(1.0 + t)(-n));
  };
  var render = function (s) {
      return Spork_Html_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(floatEntry("Montant du pr\xeat (en euros)")(Capital.create))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(floatEntry("Taux (en %)")(Taux.create))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(floatEntry("Dur\xe9e (en ann\xe9es)")(Duration.create))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Spork_Html_Elements.p([  ])([ Spork_Html_Core.text("Fr\xe9quence des remboursements: ") ]), Spork_Html_Elements.select([ Spork_Html_Events.onSelectedIndexChange(function ($18) {
          return Data_Maybe.Just.create(Period.create((function (v) {
              if (v === 0) {
                  return Daily.value;
              };
              if (v === 1) {
              ...
              if (v === 3) {
                  return ThreeMonthly.value;
              };
              if (v === 4) {
                  return FourMonthly.value;
              };
              if (v === 5) {
                  return SixMonthly.value;
              };
              return Yearly.value;
          })($18)));
      }) ])([ Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les jours") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("toutes les semaines") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les mois") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les 3 mois") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les 4 mois") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les 6 mois") ]), Spork_Html_Elements.option([  ])([ Spork_Html_Core.text("tous les ans") ]) ]) ])([ Spork_Html_Elements.h3([  ])([ Spork_Html_Core.text(Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(annuity(s)) + "\u20ac") ]) ])))));
  };
  var app = {
      update: update,
      render: render,
  ...
  exports["ThreeMonthly"] = ThreeMonthly;
  exports["FourMonthly"] = FourMonthly;
  exports["SixMonthly"] = SixMonthly;
  exports["Yearly"] = Yearly;
  exports["nbOfAnnuities"] = nbOfAnnuities;
