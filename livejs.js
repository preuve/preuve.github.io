(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply1(map16($$const(identity2))(a2))(b2);
      };
    };
  };
            ...
            return function(array) {
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  case 2:
                    return apply5(map16(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply5(apply5(map16(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply5(map16(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
      ...
      return function(map16) {
        return function(f) {
          var buildFrom = function(x, ys) {
            return apply5(map16(consList)(f(x)))(ys);
          };
          ...
          return function(k) {
            return function __do3() {
              ...
              return s2(e)(function(i2) {
                return $$void5(write(i2)(r));
              })();
            };
          };
        });
        var eee = map7(function(v) {
          return v;
        })(ee);
        var eeee = envy(map7(function(v) {
          return v;
        })(eee));
        return eeee;
      };
  ...
  var useState = function(a2) {
    return function(f) {
      return bind3(useState$prime)(function(v) {
        return bind3(useMemoized(alt3(v.value1)(pure6(a2))))(function(m) {
  ...
  var useEffect = function(e) {
    return function(f1) {
      return function(f2) {
        ...
        var eeee = map7(function(v) {
          return v;
        })(eee);
        var eeeee = map7(function(v) {
          return v;
        })(eeee);
        var ee = envy(eeeee);
        return ee;
  ...
  var flattenToSingleEvent = function(ffi) {
    ...
    var go2 = function(n) {
      return function($54) {
        return function(v) {
          if (v instanceof Left) {
            return keepLatest4(map10(f(n))(v.value0));
          }
          ;
          if (v instanceof Right) {
            return mempty4;
  ...
  var runInElement$prime = function(elt) {
    return function(eee) {
      return function __do3() {
        ...
        var evt = mapFlipped2(liftST4(newSTRef(0)))(function() {
          var $55 = deku(elt)(eee);
          return function($56) {
  ...
  var pureAttr2 = /* @__PURE__ */ pureAttr(attrCanvas_HeightString);
  var pureAttr1 = /* @__PURE__ */ pureAttr(attrCanvas_WidthString);
  var pureAttr22 = /* @__PURE__ */ pureAttr(attrSelfElementFunctionEf);
  var traverse_3 = /* @__PURE__ */ traverse_(applicativeEffect)(foldableMaybe);
  var pureAttr3 = /* @__PURE__ */ pureAttr(attrButton_StyleString);
  var pureAttr4 = /* @__PURE__ */ pureAttr(attrOnClickCb);
  ...
  var Special = /* @__PURE__ */ function() {
    function Special2(value0) {
      this.value0 = value0;
    }
    ;
    Special2.create = function(value0) {
      return new Special2(value0);
    };
    return Special2;
  }();
  var Regular = /* @__PURE__ */ function() {
    function Regular2(value0) {
      this.value0 = value0;
    }
    ;
    Regular2.create = function(value0) {
      return new Regular2(value0);
    };
    return Regular2;
  }();
  ...
  var for1 = /* @__PURE__ */ $$for(applicativeEffect);
  var main2 = function __do2() {
    var emctx = $$new(Nothing.value)();
    return runInBody(bind3(useState(None2.value))(function(v) {
      return bind3(useRef(None2.value)(v.value1))(function(rorigin) {
        return bind3(useState$prime)(function(v1) {
          return discard3(useEffect(v.value1)(function(v2) {
            if (v2 instanceof Special) {
              return function __do3() {
                var mctx = read2(emctx)();
                return for_4(mctx)(function(ctx) {
                  return function __do4() {
                    beginPath(ctx)();
                    arc(ctx)({
                      end: 2 * pi,
            ...
            return discard3(useEffect(v1.value1)(function(v2) {
              return function __do3() {
                var morig = rorigin();
                return for1(morig)(function(v3) {
                  return function __do4() {
                    var mctx = read2(emctx)();
                    for_4(mctx)(function(ctx) {
                      return strokePath(ctx)(function __do5() {
                        moveTo2(ctx)(v3.x)(v3.y)();
                        lineTo(ctx)(v2.x)(v2.y)();
                        return closePath(ctx)();
                      });
                    })();
                    return v.value0(new Regular({
                      x: v2.x,
                      y: v2.y
                    }))();
                  };
              ...
              return div_([canvas([pureAttr2(Height.value)("3000px"), pureAttr1(Width.value)("2000px"), pureAttr22(Self.value)(function() {
                var $60 = traverse_3(function(elt) {
                  return function __do3() {
                    var initialCtx = getContext2D(elt)();
                    setFillStyle(initialCtx)("#00000277")();
                    setStrokeStyle(initialCtx)("#00000277")();
                    setLineWidth(initialCtx)(12)();
                    write2(new Just(initialCtx))(emctx)();
                    var startTouch = touchListener(function($62) {
                      return v.value0(Special.create($62));
                    })();
                    addEventListener("touchstart")(startTouch)(true)(toEventTarget(elt))();
                    var moveTouch = touchListener(v1.value0)();
                    addEventListener("touchmove")(moveTouch)(true)(toEventTarget(elt))();
                    var startMouse = mouseListener(function($63) {
                      return v.value0(Special.create($63));
                    })();
                    addEventListener("mousedown")(startMouse)(true)(toEventTarget(elt))();
                    var moveMouse = mouseListener(v1.value0)();
                    addEventListener("mousemove")(moveMouse)(true)(toEventTarget(elt))();
                    var stopMouse = eventListener(function(v2) {
                      return v.value0(None2.value);
                    })();
                    return addEventListener("mouseup")(stopMouse)(true)(toEventTarget(elt))();
                  };
                });
                return function($61) {
                  return $60(fromElement($61));
                };
              }())])([]), button([pureAttr3(Style.value)("font-size: 100px;"), pureAttr4(OnClick.value)(cb(function(v2) {
                return function __do3() {
                  var mctx = read2(emctx)();
                  return for_4(mctx)(function(ctx) {
                    return setFillStyle(ctx)("#0000FFFF");
                  })();
                };
              }))])([text(map11(show3)(v1.value1))])]);
            });
          });
        });
      });
