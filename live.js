...
(function($PS) {
  ...
  var EndWord = (function () {
      ...
      EndWord.value = new EndWord();
      return EndWord;
  })();
  var StartWord = (function () {
      function StartWord(value0) {
          this.value0 = value0;
      };
      StartWord.create = function (value0) {
          return new StartWord(value0);
      };
      return StartWord;
  })();
  var Write = (function () {
  ...
  var safePos = function (v) {
      ...
      if (v.pos instanceof Data_Maybe.Just) {
          return number2(v.pos.value0);
      };
      throw new Error("Failed pattern match at Main (line 74, column 1 - line 74, column 94): " + [ v.constructor.name ]);
  };
  var initialState = {
      marks: Control_Applicative.pure(Effect.applicativeEffect)(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit)),
      wasPressed: Data_Maybe.Nothing.value
  };
  var scene = function (v) {
      return function (mouse) {
          return function (ctx) {
              var state = FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (action) {
                  return function (st) {
                      if (action instanceof EndWord) {
                          return {
                              wasPressed: Data_Maybe.Nothing.value,
                              marks: st.marks
                          };
                      };
                      if (action instanceof StartWord) {
                          return {
                              wasPressed: new Data_Maybe.Just(action.value0),
                              marks: st.marks
                          };
                      };
                      if (action instanceof Write) {
                          return {
                              marks: Data_Maybe.maybe(st.marks)(function (was) {
                                  return Control_Applicative.pure(Effect.applicativeEffect)(Graphics_Canvas.strokePath(ctx)(function __do() {
                                      Graphics_Canvas.moveTo(ctx)(was.x)(was.y)();
                                      Graphics_Canvas.lineTo(ctx)(action.value0.x)(action.value0.y)();
                                      return Graphics_Canvas.closePath(ctx)();
                                  }));
                              })(st.wasPressed),
                              wasPressed: Data_Maybe.maybe(Data_Maybe.Nothing.value)(Data_Function["const"](new Data_Maybe.Just(action.value0)))(st.wasPressed)
                          };
                      };
                      if (action instanceof Wait) {
                          return st;
                      };
                      throw new Error("Failed pattern match at Main (line 41, column 9 - line 60, column 21): " + [ action.constructor.name ]);
                  };
              })(Control_Alt.alt(FRP_Event.altEvent)(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.map(FRP_Event.functorEvent)(function ($26) {
                  return StartWord.create(safePos($26));
              })(FRP_Event_Mouse.withPosition(mouse)(FRP_Event_Mouse.down)))(Data_Functor.voidRight(FRP_Event.functorEvent)(EndWord.value)(FRP_Event_Mouse.up)))(Data_Functor.map(FRP_Event.functorEvent)(function ($27) {
                  return Write.create(number2($27));
              })(FRP_Event_Mouse.move(mouse))))(initialState);
  ...
  var main = function __do() {
      ...
      (function () {
          if (mcanvas instanceof Data_Maybe.Just) {
              ...
              FRP_Behavior.animate(scene({
                  w: w,
                  h: h
              })(mouse)(ctx))(Control_Category.identity(Control_Category.categoryFn))();
              return Data_Unit.unit;
          };
          return Data_Unit.unit;
      })();
