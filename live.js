...
(function($PS) {
  ...
  var initialState = {
      marks: [  ],
      wasPressed: Data_Maybe.Nothing.value
  };
  var context = {
      stroke: "#000",
      strokeWidth: 1.5,
  ...
  var toText = function (v) {
      return Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))(context)(v.marks);
  };
  var liveWidget = function (state) {
      var wordEnd = {
          wasPressed: Data_Maybe.Nothing.value,
          marks: state.marks
      };
      var fromMouse = function (mouse) {
          return Data_Geometry_Plane.point("")(Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(mouse)))(Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(mouse)));
      };
      var isWriting = function (ev) {
          return Data_Maybe.maybe(state)(function (mouse) {
              var isPressed = fromMouse(mouse);
              return {
                  marks: Data_Maybe.maybe(state.marks)(function (was) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.marks)([ Data_Geometry_Plane.segment(was)(isPressed)(Data_Maybe.Nothing.value) ]);
                  })(state.wasPressed),
                  wasPressed: Data_Maybe.maybe(Data_Maybe.Nothing.value)(Data_Function["const"](new Data_Maybe.Just(isPressed)))(state.wasPressed)
              };
          })(Web_UIEvent_MouseEvent.fromEvent(ev));
      };
      var wordStart = function (ev) {
          return Data_Maybe.maybe(state)(function (mouse) {
              return {
                  marks: state.marks,
                  wasPressed: Data_Maybe.Just.create(fromMouse(mouse))
              };
          })(Web_UIEvent_MouseEvent.fromEvent(ev));
      };
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.attr("position")("fixed"), Concur_VDom_SVG.attr("top")("0"), Concur_VDom_SVG.attr("left")("0"), Concur_VDom_SVG.width("100%"), Concur_VDom_SVG.height("100%"), Concur_VDom_SVG.attr("viewBox")("0 0 3000 3000"), Data_Functor.map(Concur_Core_Props.functorProps)(isWriting)(Concur_VDom_Props.onMouseMove), Data_Functor.map(Concur_Core_Props.functorProps)(wordStart)(Concur_VDom_Props.onMouseDown), Data_Functor.voidRight(Concur_Core_Props.functorProps)(wordEnd)(Concur_VDom_Props.onMouseUp) ])(toText(state)))(function (newState) {
          return liveWidget(newState);
      });
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(liveWidget(initialState));
  exports["context"] = context;
  exports["toText"] = toText;
  exports["liveWidget"] = liveWidget;
