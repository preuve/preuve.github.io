  ...
  var text = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM["el'"](dictShiftMap)(dictMultiAlternative)(function (p) {
              return function (c) {
                  return Concur_VDom_Types.mkHTMLNode(new Halogen_VDom_Types.Elem(Data_Maybe.Just.create(svgNS), "text", p, Concur_VDom_Types.unHTML(c)));
              };
          });
      };
  };
...
(function($PS) {
  ...
  var interLineLine = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Geometry.Plane (line 189, column 8 - line 192, column 65): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var measure = function (p) {
      return function (q) {
          return function (howFar) {
              ...
              var mid = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(Data_Geometry_Plane.middle("")(Data_Geometry_Plane.segment(p)(q)(Data_Maybe.Nothing.value)))(Data_Geometry_Plane.scale(howFar)(Data_Geometry_Plane.normalized(n)));
              var x = Data_Int.round(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(mid));
              var y = Data_Int.round(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(mid));
              var pos = Data_Show.show(Data_Show.showInt)(x) + ("," + Data_Show.show(Data_Show.showInt)(y));
              var grow = (Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(q) - Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(p)) * (Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(q) - Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(p)) > 0.0;
              var a = Data_Int.round((function (v1) {
                  return v1 / $$Math.pi;
              })((function (v1) {
                  return v1 * 180.0;
              })($$Math.acos(Data_Geometry_Plane.cosAngle(v)(Data_Geometry_Plane.vector(Data_Geometry_Plane.point("")(0.0)(0.0))(Data_Geometry_Plane.point("")(1.0)(0.0)))))));
              return [ Concur_VDom_SVG.attr("x")(Data_Show.show(Data_Show.showInt)(x)), Concur_VDom_SVG.attr("y")(Data_Show.show(Data_Show.showInt)(y)), Concur_VDom_SVG.transform("rotate(" + (Data_Show.show(Data_Show.showInt)((function () {
                  if (grow) {
                      return a;
                  };
                  return -a | 0;
  ...
  var invPerm = function (ps) {
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (i) {
          return function (acc) {
              return Data_Array.cons(Data_Maybe.fromJust()(Data_Array.elemIndex(Data_Eq.eqInt)(i)(ps)))(acc);
          };
...
(function($PS) {
      ...
      return function (y) {
          return function (color) {
              return function (fontStyle) {
                  return function (str) {
                      return Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x")(Data_Int.round(x)), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y")(Data_Int.round(y)), Concur_VDom_SVG.style("fill:" + (color + ("; font:" + (fontStyle + "; ")))) ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(str) ]);
                  };
              };
          };
      };
  ...
  var renderSequence = function (dictRender) {
      return new Render(function (ctx) {
          return function (arr) {
              return Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(render$prime(dictRender)(ctx))(arr));
          };
      });
  };
  var pathCoord = function (p) {
      return " " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(p)) + (" " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(p)) + " ")));
  };
  var path = function (stroke) {
      return function (strokeWidth) {
          return function (fill) {
              return function (content) {
                  return Concur_VDom_SVG.path(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.d(content), Concur_VDom_SVG.style("stroke:" + (stroke + ("; stroke-width:" + (Data_Show.show(Data_Show.showInt)(Data_Int.round(strokeWidth)) + ("; fill:" + (fill + ";")))))) ])([  ]);
              };
          };
      };
  }; 
  var renderRightAngle = new Render(function (v) {
      return function (v1) {
          var w = Data_Geometry_Plane.scale(v1.radius / Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(v1.origin))(v1.origin);
          ...
          var u = Data_Geometry_Plane.plus(Data_Geometry_Plane.summableVectorVector)(v2)(w);
          var o = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(w);
          var n = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(v2);
          var m = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(u);
          return [ path(v.stroke)(v.strokeWidth)(v.fill)("M" + (pathCoord(o) + ("L" + (pathCoord(m) + ("L" + pathCoord(n)))))) ];
      };
  });
              ...
              return function (y2) {
                  return function (color) {
                      return function (size) {
                          return Concur_VDom_SVG.line(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x1")(Data_Int.round(x1)), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x2")(Data_Int.round(x2)), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y1")(Data_Int.round(y1)), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y2")(Data_Int.round(y2)), Concur_VDom_SVG.stroke(color), Concur_VDom_SVG.strokeWidth(Data_Int.round(size)) ])([  ]);
                      };
                  };
              };
          };
  ...
  var renderHalfLine = new Render(function (v) {
      return function (v1) {
          var far = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.origin)(Data_Geometry_Plane.scale(10.0)(v1.direction));
          return [ line(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(far))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(far))(v.stroke)(v.strokeWidth) ];
      };
  });
  var renderLine = new Render(function (ctx) {
      return function (l) {
          var v = Data_Geometry_Plane.aVectorOfLine(l);
          var m = Data_Geometry_Plane.aPointOnLine(l);
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render$prime(renderHalfLine)(ctx)(Data_Geometry_Plane.halfline(m)(v)))(render$prime(renderHalfLine)(ctx)(Data_Geometry_Plane.halfline(m)(Data_Geometry_Plane.scale(-1.0)(v))));
      };
  });
  var renderPoint = new Render(function (v) {
      return function (v1) {
          return [ line(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1) - 5.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1) - 5.0)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1) + 5.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1) + 5.0)(v.stroke)(v.strokeWidth), line(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1) - 5.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1) + 5.0)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1) + 5.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1) - 5.0)(v.stroke)(v.strokeWidth), text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1) + 10.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1) - 10.0)(v.textFill)(v.fontStyle)(v1.name) ];
      };
  });
  var defaultContext = {
      stroke: "#000",
  ...
  var renderArc = new Render(function (v) {
      return function (v1) {
          ...
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ path(v.stroke)(v.strokeWidth)(v.fill)("M" + (pathCoord(pO) + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 " + (a1 + (a2 + (" " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pE) - Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pO)) + (" " + Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pE) - Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pO))))))))))))))) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              return [ path(v.stroke)(v.strokeWidth)(v.stroke)("M" + (pathCoord(v3.at2) + ("L" + (pathCoord(pE) + ("L" + (pathCoord(v3.at1) + "Z")))))) ];
  ...
  var renderSegment = new Render(function (v) {
      return function (v1) {
          var m = Data_Geometry_Plane.middle("")(v1);
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ line(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.extremity))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.extremity))(v.stroke)(v.strokeWidth) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              var v2 = arrowTip(v1);
              return [ path(v.stroke)(v.strokeWidth)(v.stroke)("M" + (pathCoord(v2.at1) + ("L" + (pathCoord(v1.extremity) + ("L" + (pathCoord(v2.at2) + "Z")))))) ];
          })(v1.asOriented))(Data_Maybe.maybe([  ])(function (str) {
              return [ text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(m) + 10.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(m) - 10.0)(v.textFill)(v.fontStyle)(str), text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(m) + 10.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(m) - 23.0)(v.textFill)(v.fontStyle)((function () {
                  var $80 = str === "";
                  if ($80) {
                      return "";
                  };
...
(function($PS) {
  ...
  var Data_String_CodePoints = $PS["Data.String.CodePoints"];
  var Rand = $PS["Rand"];                
  var HasDefault = function (dflt) {
      this.dflt = dflt;
  };
  var showFraction = function (p) {
      return "\\dfrac{" + (Data_Show.show(Data_Show.showInt)(Data_Ratio.numerator(p)) + ("}{" + (Data_Show.show(Data_Show.showInt)(Data_Ratio.denominator(p)) + "}")));
  };
  var rep5 = function (dataSet) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" III "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(Data_Show.show(Data_Show.showBoolean)(dataSet.ok)))(function () {
              return Article.m(showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(dataSet.a))(Data_Rational.fromInt(dataSet.b))));
          });
      });
  };
  var rep4 = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" IV "))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" a. "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("angles oppos\xe9s par le sommet"))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" b. "))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("triangles avec deux angles \xe9gaux"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" c. "))(function () {
                          return Article.m("\\frac{AI}{DI}=\\frac{IB}{IC}");
                      });
                  });
              });
          });
  ...
  var rep2 = function (dataSet) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" II "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(Data_Show.show(Data_Show.showBoolean)(dataSet.ok)))(function () {
              return Article.t(" Oui, comme le plus petit commun multiple de " + (Data_Show.show(Data_Show.showInt)(dataSet.a) + (" et de " + (Data_Show.show(Data_Show.showInt)(dataSet.b) + (" est " + (Data_Show.show(Data_Show.showInt)(dataSet.p) + (", les voitures se croisent sur la ligne d'arriv\xe9e toutes les " + (Data_Show.show(Data_Show.showInt)(dataSet.p) + " secondes."))))))));
          });
      });
  };
  var rep1 = function (dataSet) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" I "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(Data_Show.show(Data_Show.showBoolean)(dataSet.ok)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" I.1) "))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Non, " + (Data_Show.show(Data_Show.showInt)(dataSet.unfit) + (" n'est pas un diviseur de " + (Data_Show.show(Data_Show.showInt)(dataSet.b) + ".")))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" I.2) "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le plus grand diviseur commun de " + (Data_Show.show(Data_Show.showInt)(dataSet.a) + (" et " + (Data_Show.show(Data_Show.showInt)(dataSet.b) + (" est " + (Data_Show.show(Data_Show.showInt)(dataSet.g) + (" donc il pourra concevoir " + (Data_Show.show(Data_Show.showInt)(dataSet.g) + " paniers au maximum.")))))))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" I.3) "))(function () {
                                  return Article.t(Data_Show.show(Data_Show.showInt)(dataSet.u) + (" poissons et " + (Data_Show.show(Data_Show.showInt)(dataSet.v) + " coquillages par panier.")));
                              });
                          });
                      });
                  });
  ...
  var primes = [ [ 2, 4, 8, 16, 32 ], [ 3, 9, 27, 81 ], [ 5, 25 ], [ 7, 49 ] ];
  var opener = function (title) {
      return function (points) {
          return Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("margin: 0; display: flex; justify-content: space-between") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("font-size: 24px; font-weight: 700;") ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(title) ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("font-size: 16px; font-weight: 700;") ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(points) ]) ]), Concur_VDom_DOM["hr'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap) ]));
      };
  };
  var mediatrice = function (p) {
      return function (q) {
          var v = Data_Geometry_Plane.normalTo(Data_Geometry_Plane.vector(p)(q));
          var i = Data_Geometry_Plane.middle("")(Data_Geometry_Plane.segment(p)(q)(Data_Maybe.Nothing.value));
          return Data_Geometry_Plane.line(i)(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(i)(v));
      };
  };
  var initialState = {
  ...
  var header = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.setTitle("Devoir 3 : Nombres premiers / Thal\xe8s - Triangles semblables"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pr\xe9nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Classe:") ]) ])))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.ul(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Les 5 exercices sont ind\xe9pendants.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("L'usage de la calculatrice est autoris\xe9.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("On veillera \xe0 respecter le format indiqu\xe9 pour les r\xe9sultats num\xe9riques.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("La ma\xeetrise de la langue et la pr\xe9sentation rapporteront 1 point.") ]) ])))(function () {
  ...
  var ex3 = function (v) {
      return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Dans un coll\xe8ge de " + (Data_Show.show(Data_Show.showInt)(v.b) + (" \xe9l\xe8ves, " + (Data_Show.show(Data_Show.showInt)(v.a) + " \xe9l\xe8ves affirment manger au moins cinq fruits et l\xe9gumes par jour. ")))) ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Donner la fraction irr\xe9ductible repr\xe9sentant la proportion de ces \xe9l\xe8ves.") ]) ]);
  };
  var ex2 = function (v) {
      return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Deux voitures partent en m\xeame temps de la ligne de d\xe9part et font plusieurs tours d\u2019un m\xeame circuit.") ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("La voiture A fait le tour du circuit en " + (Data_Show.show(Data_Show.showInt)(v.a) + (" secondes et a voiture B en " + (Data_Show.show(Data_Show.showInt)(v.b) + " secondes. ")))) ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Y-a-t-il des moments (autres que le d\xe9part!) o\xf9 les voitures se croisent sur la ligne de d\xe9part ? Expliquer.") ]) ]);
  };
  var ex1 = function (v) {
      return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Deux amis discutent") ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM.em(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("\u2022AUREL : ") ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Belle p\xeache ! Combien de poissons et de coquillages vas-tu pouvoir vendre au march\xe9 ?") ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM.em(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("\u2022ANTOINE : ") ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("En tout, je vais pouvoir vendre au march\xe9 ") ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.a)) ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(" poissons et ") ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.b)) ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(" coquillages. ") ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Antoine est un p\xeacheur professionnel. Il veut vendre des paniers contenant des coquillages et des poissons. Il souhaite concevoir le plus grand nombre possible de paniers identiques. Enfin, il voudrait qu\u2019il ne lui reste aucun coquillage et aucun poisson dans son cong\xe9lateur.") ]), Concur_VDom_DOM.br(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([  ]), Concur_VDom_DOM.node("ol")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Peut-il concevoir "), Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.unfit)), Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(" paniers ? Pourquoi ?") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Combien de paniers au maximum Antoine pourra t-il concevoir ? Justifier.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Quelle sera la composition de chaque panier ? Justifier.") ]) ]) ]);
  };
  var dfltString = new HasDefault("");
  var dfltPoint = new HasDefault(Data_Geometry_Plane.point("")(0.0)(0.0));
  var dfltInt = new HasDefault(0);
  var dfltArray = function (dictHasDefault) {
      return new HasDefault([  ]);
  };
  ...
  var ex5 = function (v) {
      return Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 3fr 2fr;") ])([ Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Pendant les vacances, Robin est all\xe9 visiter le phare Am\xe9d\xe9e."))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Lors d'une sieste sur la plage il a remarqu\xe9 que le sommet d'un parasol \xe9tait en parfait alignement avec le sommet du phare. Robin a donc pris quelques mesures et a d\xe9cid\xe9 de faire un sch\xe9ma de la situation dans le sable pour trouver une estimation de la hauteur du phare."))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Les points "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("B"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", "))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("J"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("R"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont align\xe9s."))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(SB)"))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(BR)"))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont perpendiculaires."))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(PJ)"))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(BR)"))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont perpendiculaires."))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quelle hauteur, arrondie au m\xe8tre, va-t-il trouver \xe0 l'aide de son plan ? Justifier la r\xe9ponse."))(function () {
                                                                                                              return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                                                          });
                                                                                                      });
                                                                                                  });
      ...
      }))), Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("400"), Concur_VDom_SVG.height("450") ])((function () {
          var style = [ Concur_VDom_SVG.attr("font-size")("17"), Concur_VDom_SVG.attr("font-weight")("500") ];
          var pL = Data_Geometry_Plane.point("")(280.0)(300.0);
          var pI = Data_Geometry_Plane.point("")(350.0)(400.0);
          var pS = Data_Geometry_Plane.point("S")(40.0)(23.0);
          var pS$prime = Data_Geometry_Plane.point("")(40.0 - 5.0)(23.0);
          var mer = 23.0 + 360.0;
          var pB = Data_Geometry_Plane.point("B")(40.0)(mer);
          var pB$prime = Data_Geometry_Plane.point("")(40.0 - 15.0)(mer);
          var pO = Data_Geometry_Plane.point("")(40.0)(mer + 60.0);
          var plage = 40.0 + 200.0;
          var pJ = Data_Geometry_Plane.point("J")(plage)(mer);
          var pM = Data_Geometry_Plane.point("")(plage)(mer + 30.0);
          var pN$prime = Data_Geometry_Plane.point("")(plage - 30.0)(mer);
          var pP = Data_Geometry_Plane.point("P")(plage)(mer - 100.0);
          var pN = Data_Geometry_Plane.point("")(plage - 30.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pP));
          var pR = Data_Geometry_Plane.rename("R")((function (v2) {
              return nth(dfltPoint)(v2)(0);
          })(Data_Geometry_Plane.meets(Data_Geometry_Plane.interLineLine)(Data_Geometry_Plane.line(pS)(pP))(Data_Geometry_Plane.line(pB)(pJ))));
          var pM$prime = Data_Geometry_Plane.point("")(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pR))(mer + 30.0);
          var pO$prime = Data_Geometry_Plane.point("")(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pR))(mer + 60.0);
          var pQ = Data_Geometry_Plane.point("")(plage)(mer - 30.0);
          var pQ$prime = Data_Geometry_Plane.point("")(plage - 8.0 / 2.0)(mer - 30.0);
          var pQ$prime$prime = Data_Geometry_Plane.point("")(plage + 8.0 / 2.0)(mer - 30.0);
          var pK = Data_Geometry_Plane.middle("")(Data_Geometry_Plane.segment(pP)(pQ$prime$prime)(Data_Maybe.Nothing.value));
          var center = function (p) {
              return function (q) {
                  return function (k) {
                      return function (o) {
                          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(p)(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(p)(Data_Geometry_Plane.scale(k)(Data_Geometry_Plane.vector(p)(q))))(o))(style);
                      };
                  };
              };
          };
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))(Concur_VDom_GeometryRender.defaultContext)([ Data_Geometry_Plane.segment(pB)(pS)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pS)(pS$prime)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pS$prime)(pB$prime)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pB$prime)(pR)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pJ)(pQ)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pQ$prime)(pQ$prime$prime)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pQ$prime$prime)(pP)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pP)(pQ$prime)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pO)(pO$prime)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pO$prime)(pO)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pM)(pM$prime)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pM$prime)(pM)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pN)(pN$prime)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pN$prime)(pN)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pI)(pR)(new Data_Maybe.Just("")), Data_Geometry_Plane.segment(pL)(pK)(new Data_Maybe.Just("")) ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Concur_VDom_SVG.line(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.attr("x1")(Data_Show.show(Data_Show.showInt)(Data_Int.round(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pS)))), Concur_VDom_SVG.attr("y1")(Data_Show.show(Data_Show.showInt)(Data_Int.round(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pS)))), Concur_VDom_SVG.attr("x2")(Data_Show.show(Data_Show.showInt)(Data_Int.round(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pR)))), Concur_VDom_SVG.attr("y2")(Data_Show.show(Data_Show.showInt)(Data_Int.round(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pR)))), Concur_VDom_SVG.stroke("#000"), Concur_VDom_SVG.strokeWidth(2), Concur_VDom_SVG.attr("stroke-dasharray")("5,5") ])([  ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))(Concur_VDom_GeometryRender.defaultContext)([ pS, pB, pP, pJ, pR ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderLine)(Concur_VDom_GeometryRender.defaultContext)(Data_Geometry_Plane.line(pB$prime)(pR)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pB$prime)(pS$prime)(0.75)(-9.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Phare") ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pO)(pO$prime)(0.85)(-9.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("34,7 m") ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pM)(pM$prime)(0.4)(-9.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("1,3 m") ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pN)(pN$prime)(1.4)(12.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("2,1 m") ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pR)(pI)(2.1)(3.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("moi") ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(center(pK)(pL)(2.1)(3.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("parasol") ]) ])(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderRightAngle))(Concur_VDom_GeometryRender.defaultContext)([ Data_Geometry_Plane.rightangle(Data_Geometry_Plane.vector(pB)(pS))(pB)(Data_Geometry_Plane.vector(pB)(pJ))(10.0), Data_Geometry_Plane.rightangle(Data_Geometry_Plane.vector(pJ)(pP))(pJ)(Data_Geometry_Plane.vector(pJ)(pB))(10.0) ]))))));
      })()) ]);
  };
  var randomDataSet = function (r0) {
      var r1 = Rand.rand(r0);
      var r2 = Rand.rand(r1);
      var r3 = Rand.rand(r2);
      var r4 = Rand.rand(r3);
      var primeLines = Rand.unsort(4)(r4);
      var p4 = nth(dfltArray(dfltInt))(primes)(nth(dfltInt)(primeLines)(3));
      var v$prime = nth(dfltInt)(p4)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r4.val)(Data_Array.length(p4) - 1 | 0));
      var p3 = nth(dfltArray(dfltInt))(primes)(nth(dfltInt)(primeLines)(2));
      var u$prime = nth(dfltInt)(p3)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r3.val)(Data_Array.length(p3) - 1 | 0));
      var p2 = nth(dfltArray(dfltInt))(primes)(nth(dfltInt)(primeLines)(1));
      var p1 = nth(dfltArray(dfltInt))(primes)(nth(dfltInt)(primeLines)(0));
      var g2 = nth(dfltInt)(p2)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r2.val)(Data_Array.length(p2) - 1 | 0));
      var g1 = nth(dfltInt)(p1)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(Data_Array.length(p1) - 1 | 0));
      var g = g1 * g2 | 0;
      var v = (function () {
          var $50 = u$prime < v$prime;
          if ($50) {
              return {
                  a: g * u$prime | 0,
                  b: g * v$prime | 0,
      ...
      var unfit = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v.a)(Data_Ord.max(Data_Ord.ordInt)(g1)(g2));
      var p = v.a * v.v | 0;
      var ok = p === (v.b * v.u | 0);
      return {
          a: v.a,
  ...
  var circumCenter = function (p) {
      return function (q) {
          return function (r) {
              var m2 = mediatrice(p)(r);
              var m1 = mediatrice(p)(q);
              return nth(dfltPoint)(Data_Geometry_Plane.meets(Data_Geometry_Plane.interLineLine)(m1)(m2))(0);
          };
      };
  };
  var ex4 = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 3fr;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("230"), Concur_VDom_SVG.height("170") ])((function () {
      var pC = Data_Geometry_Plane.point("C")(200.0)(120.0);
      var pB = Data_Geometry_Plane.point("B")(190.0)(64.0);
      var pA = Data_Geometry_Plane.point("A")(40.0)(23.0);
      var pO = circumCenter(pA)(pB)(pC);
      var c = Data_Geometry_Plane.circle(pO)(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(Data_Geometry_Plane.vector(pO)(pB)));
      var bo = Data_Geometry_Plane.line(pB)(pO);
      var pD = Data_Geometry_Plane.rename("D")(nth(dfltPoint)(Data_Geometry_Plane.meets(Data_Geometry_Plane.interLineCircle)(bo)(c))(1));
      var pI = Data_Geometry_Plane.rename("I")((function (v) {
          return nth(dfltPoint)(v)(0);
      })(Data_Geometry_Plane.meets(Data_Geometry_Plane.interLineLine)(Data_Geometry_Plane.line(pB)(pD))(Data_Geometry_Plane.line(pA)(pC))));
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))(Concur_VDom_GeometryRender.defaultContext)([ pA, pB, pI, pD, pC ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))(Concur_VDom_GeometryRender.defaultContext)([ Data_Geometry_Plane.segment(pA)(pB)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pC)(pB)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pC)(pD)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pA)(pD)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pA)(pC)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pD)(pB)(Data_Maybe.Nothing.value) ]))(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderArc))(Concur_VDom_GeometryRender.defaultContext)([ Data_Geometry_Plane.arc(Data_Geometry_Plane.vector(pA)(pB))(pA)(Data_Geometry_Plane.vector(pA)(pC))(30.0)(false)(false)(false)(Data_Maybe.Nothing.value), Data_Geometry_Plane.arc(Data_Geometry_Plane.vector(pD)(pB))(pD)(Data_Geometry_Plane.vector(pD)(pC))(30.0)(false)(false)(false)(Data_Maybe.Nothing.value) ])));
  })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("ABCD"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est un quadrilat\xe8re tel que "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(" \\widehat{BAC}=\\widehat{BDC}"))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" On note "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("I"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le point d'intersection des diagonales "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("[AC]"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("[BD]"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                                                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                              });
                                          });
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("a. "))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Expliquer pourquoi les angles "))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{AIB}"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{DIC}"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont de m\xeame mesure."))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("b. "))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("En d\xe9duire alors que les triangles "))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("AIB"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("DIC"))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont semblables."))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("c. "))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Montrer alors que "))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("AI\\times IC = DI \\times IB"))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                                                                                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                              });
                                                                          });
          ...
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental((function () {
                      ...
                      var r1 = Rand.consume(8)(r0);
                      var f = function ($copy_r) {
                          return function ($copy_r$prime) {
                              var $tco_var_r = $copy_r;
                              var $tco_done = false;
                              var $tco_result;
                              function $tco_loop(r, r$prime) {
                                  var $57 = r$prime.val === r.val;
                                  if ($57) {
                                      $tco_var_r = r;
                                      $copy_r$prime = Rand.rand(r$prime);
                                      return;
                                  };
                                  $tco_done = true;
                                  return r$prime;
                              ...
                              while (!$tco_done) {
                                  $tco_result = $tco_loop($tco_var_r, $copy_r$prime);
                              };
                              return $tco_result;
                          };
                      };
                      var r2 = f(r1)(Rand.consume(8)(r1));
                      var r3 = f(r2)(Rand.consume(8)(r2));
                      var r5 = f(r2)(Rand.consume(8)(r3));
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(opener("Exercice I")("4,5 points"))(function () {
                              var dataSet1 = randomDataSet(r1);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(ex1(dataSet1)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(opener("Exercice II")("4,5 points"))(function () {
                                              var dataSet2 = randomDataSet(r2);
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(ex2(dataSet2)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(opener("Exercice III")("3 points"))(function () {
                                                              var dataSet3 = randomDataSet(r3);
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(ex3(dataSet3)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(opener("Exercice IV")("4 points"))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(ex4))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(opener("Exercice V")("3 points"))(function () {
                                                                                              var dataSet5 = randomDataSet(r5);
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(ex5(dataSet5)))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                                                                                                      var $58 = Data_Maybe.fromMaybe(0)(Article.validateInput(newState.seed)) < 0;
                                                                                                      if ($58) {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("r\xe9ponses: "))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(rep1(dataSet1))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(rep2(dataSet2))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(rep3(dataSet3))(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(rep4)(function () {
                                                                                                                                  return rep5(dataSet5);
                                                                                                                              });
                                                                                                                          });
                                                                                                                      });
                                                                                                                  });
  ...
  var after = function (letter) {
      return function (n) {
          return Data_String_CodePoints.fromCodePointArray([ Data_Foldable.foldr(Data_Foldable.foldableArray)(Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn))(Control_Category.identity(Control_Category.categoryFn))(Data_Array.replicate(n)((function () {
              var $59 = Data_Enum.succ(Data_String_CodePoints.enumCodePoint);
              return function ($60) {
                  return (function (x) {
                      return Data_Maybe.fromMaybe(letter)(x);
                  })($59($60));
              };
          })()))(letter) ]);
      };
  ...
  var showProp = function (props) {
      return function (ord) {
          var templateCols = Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(Data_Functor.map(Data_Functor.functorArray)(Data_Function["const"](" 1fr"))(props));
          var a = Data_String_CodePoints.codePointFromChar("a");
          return Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns:" + (templateCols + ";")) ])(Data_Array.mapWithIndex(function (i) {
              return function (v) {
                  return Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(after(a)(i) + ") "))(function () {
                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(nth(dfltString)(props)(nth(dfltInt)(ord)(i))))(function () {
                          return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                      });
                  })));
              };
  ...
  var showSol = function (reps) {
      return function (ord) {
          var revOrd = Article.invPerm(ord);
          var a = Data_String_CodePoints.codePointFromChar("a");
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupString))("")(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $61 = after(a);
              return function ($62) {
                  return (function (v) {
                      return v + ")";
                  })($61((function (v) {
                      return nth(dfltInt)(revOrd)(v);
                  })($62)));
              };
          })())(reps));
      };
  ...
  exports["main"] = main;
  exports["dfltInt"] = dfltInt;
  exports["dfltString"] = dfltString;
  exports["dfltPoint"] = dfltPoint;
  exports["dfltArray"] = dfltArray;
})(PS);
PS["Main"].main();