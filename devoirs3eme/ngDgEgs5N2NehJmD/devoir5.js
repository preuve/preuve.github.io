...
(function($PS) {
  ...
  var $$Math = $PS["Math"];
  var Rand = $PS["Rand"];                
  var TwoDecimals = function (x) {
      return x;
  };
  var HasDefault = function (dflt) {
      this.dflt = dflt;
  };
  var showTwoDecimals = new Data_Show.Show(function (v) {
      var r = Data_Int.round(v * 100.0);
      var dec = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r)(100);
      var $$int = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(r - dec | 0)(100);
      return Data_Show.show(Data_Show.showInt)($$int) + (",\\!" + Data_Show.show(Data_Show.showInt)(dec));
  });
  var randDifferentRadii = function (ra) {
      return function (rb) {
          return function (v) {
              var x = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(ra)(v.value1 - v.value0 | 0);
              var dx = 1 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rb)((v.value1 - v.value0 | 0) - 2 | 0) | 0;
              return new Data_Tuple.Tuple(v.value0 + x | 0, v.value0 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x + dx | 0)(v.value1 - v.value0 | 0) | 0);
          };
      };
  };
  var initialState = {
  ...
  var header = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.setTitle("Devoir 5 : Sph\xe8res et boules"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; " + "grid-template-columns: 1fr 1fr 1fr;") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pr\xe9nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Classe:") ]) ])))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.ul(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ce devoir est un QCM.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Entourer la ou les bonnes r\xe9ponses.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Aucun document.") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Aucune justification demand\xe9e.") ]) ])))(function () {
  ...
  var after = function (letter) {
      return function (n) {
          return Data_String_CodePoints.fromCodePointArray([ Data_Foldable.foldr(Data_Foldable.foldableArray)(Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn))(Control_Category.identity(Control_Category.categoryFn))(Data_Array.replicate(n)((function () {
              var $48 = Data_Enum.succ(Data_String_CodePoints.enumCodePoint);
              return function ($49) {
                  return (function (x) {
          ...
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental((function () {
                      ...
                      var r1 = Rand.consume(4)(r0);
                      var r2 = Rand.consume(4)(r1);
                      var r3 = Rand.consume(4)(r2);
                      var r4 = Rand.consume(4)(r3);
                      var r5 = Rand.consume(4)(r4);
                      var r6 = Rand.consume(4)(r5);
                      var r7 = Rand.consume(4)(r6);
                      var r8 = Rand.consume(4)(r7);
                      var r9 = Rand.consume(4)(r8);
                      var rs = Rand.rands(12)(r9);
                      var v = randDifferentRadii(nth(dfltInt)(rs)(0))(nth(dfltInt)(rs)(1))(new Data_Tuple.Tuple(5, 10));
                      var v1 = randDifferentRadii(nth(dfltInt)(rs)(2))(nth(dfltInt)(rs)(3))(new Data_Tuple.Tuple(5, 10));
                      var v2 = randDifferentRadii(nth(dfltInt)(rs)(4))(nth(dfltInt)(rs)(5))(new Data_Tuple.Tuple(10, 81));
                      var v3 = randDifferentRadii(nth(dfltInt)(rs)(6))(nth(dfltInt)(rs)(7))(new Data_Tuple.Tuple(5, 10));
                      var v4 = randDifferentRadii(nth(dfltInt)(rs)(8))(nth(dfltInt)(rs)(9))(new Data_Tuple.Tuple(5, 10));
                      var v5 = randDifferentRadii(nth(dfltInt)(rs)(10))(nth(dfltInt)(rs)(11))(new Data_Tuple.Tuple(5, 10));
                      var sol9 = [ 1, 2 ];
                      var sol8 = [ 0 ];
                      var sol7 = [ 0 ];
                      var sol6 = [ 3 ];
                      ...
                      var sol10 = [ 0, 3 ];
                      var sol1 = [ 0 ];
                      var ord9 = Rand.unsort(4)(r8);
                      var ord8 = Rand.unsort(4)(r7);
                      var ord7 = Rand.unsort(4)(r6);
                      var ord6 = Rand.unsort(4)(r5);
                      var ord5 = Rand.unsort(4)(r4);
                      var ord4 = Rand.unsort(4)(r3);
                      var ord3 = Rand.unsort(4)(r2);
                      var ord2 = Rand.unsort(4)(r1);
                      var ord10 = Rand.unsort(4)(r9);
                      var ord1 = Rand.unsort(4)(r0);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("1. "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Soit "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" un point sur une sph\xe8re de centre "))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("O"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et de rayon "))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(v.value0)))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On peut \xeatre s\xfbr que"))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                              var props = function (rad) {
                                                                                  return [ "OM =" + (Data_Show.show(Data_Show.showInt)(rad) + "\\;\\mathrm{cm}"), "OM \\leq" + (Data_Show.show(Data_Show.showInt)(rad) + "\\;\\mathrm{cm}"), "OM \\geq " + (Data_Show.show(Data_Show.showInt)(rad) + "\\;\\mathrm{cm}"), "OM > " + (Data_Show.show(Data_Show.showInt)(rad) + "\\;\\mathrm{cm}") ];
                                                                              };
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(props(v.value0))(ord1)))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("2. "))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Soit "))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" un point dans une boule de centre "))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("O"))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et de rayon "))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(v.value1)))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On peut \xeatre s\xfbr que"))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(props(v.value1))(ord2)))(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("3. "))(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On consid\xe8re deux points antipodaux sur une sph\xe8re de rayon "))(function () {
                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(2 * v1.value0 | 0)))(function () {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quelle distance les s\xe9pare ?"))(function () {
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                      var choice = function (halfrad) {
                                                                                                                                                                                          return function (other) {
                                                                                                                                                                                              return [ Data_Show.show(Data_Show.showInt)(halfrad) + "\\;\\mathrm{cm}", Data_Show.show(Data_Show.showInt)(2 * halfrad | 0) + "\\;\\mathrm{cm}", Data_Show.show(Data_Show.showInt)(4 * halfrad | 0) + "\\;\\mathrm{cm}", Data_Show.show(Data_Show.showInt)((2 * other | 0) + 1 | 0) + "\\;\\mathrm{cm}" ];
                                                                                                                                                                                          };
                                                                                                                                                                                      };
                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(choice(v1.value0)(v1.value1))(ord3)))(function () {
                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("4. "))(function () {
                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On consid\xe8re un grand cercle sur une sph\xe8re de rayon "))(function () {
                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(2 * v1.value1 | 0)))(function () {
                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quel est son diam\xe8tre ?"))(function () {
                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(choice(v1.value1)(v1.value0))(ord4)))(function () {
                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5. "))(function () {
                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Selectionner les notions associ\xe9es :"))(function () {
                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                              var tuples = [ "\\mathrm{parall\\grave{e}les}\\;\\mathrm{et}\\;\\mathrm{latitudes}", "\\mathrm{parall\\grave{e}les}\\;\\mathrm{et}\\;\\mathrm{longitudes}", "\\mathrm{m\\acute{e}ridiens}\\;\\mathrm{et}\\;\\mathrm{latitudes}", "\\mathrm{m\\acute{e}ridiens}\\;\\mathrm{et}\\;\\mathrm{longitudes}" ];
                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(tuples)(ord5)))(function () {
                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("6. "))(function () {
                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Soit "))(function () {
                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("P"))(function () {
                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le point de la surface globe terrestre de coordonn\xe9es "))(function () {
                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(" + (Data_Show.show(Data_Show.showInt)(v2.value0) + ("^\\circ\\; \\mathrm{nord}," + (Data_Show.show(Data_Show.showInt)(v2.value1) + "^\\circ\\;  \\mathrm{est}).")))))(function () {
                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quelles sont les coordonn\xe9es du point A antipodal de P ?"))(function () {
                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                              var coord = function (lat) {
                                                                                                                                                                                                                                                                                                                  return function ($$long) {
                                                                                                                                                                                                                                                                                                                      return [ "(" + (Data_Show.show(Data_Show.showInt)(90 - lat | 0) + ("^\\circ\\;\\mathrm{nord}," + (Data_Show.show(Data_Show.showInt)(180 - $$long | 0) + "^\\circ\\;\\mathrm{ouest})"))), "(" + (Data_Show.show(Data_Show.showInt)(lat) + ("^\\circ\\;\\mathrm{sud}," + (Data_Show.show(Data_Show.showInt)($$long) + "^\\circ\\;\\mathrm{ouest})"))), "(" + (Data_Show.show(Data_Show.showInt)(lat) + ("^\\circ\\;\\mathrm{nord}," + (Data_Show.show(Data_Show.showInt)(180 - $$long | 0) + "^\\circ\\;\\mathrm{est})"))), "(" + (Data_Show.show(Data_Show.showInt)(90 - lat | 0) + ("^\\circ\\;  \\mathrm{sud}," + (Data_Show.show(Data_Show.showInt)(180 - $$long | 0) + "^\\circ\\;\\mathrm{ouest})"))) ];
                                                                                                                                                                                                                                                                                                                  };
                                                                                                                                                                                                                                                                                                              };
                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(coord(v2.value0)(v2.value1))(ord6)))(function () {
                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("7. "))(function () {
                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quelle est l'aire "))(function () {
                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.em("exacte"))(function () {
                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" d'une sph\xe8re de rayon  "))(function () {
                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(3 * v3.value0 | 0)))(function () {
                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                          var aera = function (third) {
                                                                                                                                                                                                                                                                                                                                                              return [ Data_Show.show(Data_Show.showInt)((4 * (3 * third | 0) | 0) * (3 * third | 0) | 0) + "\\pi\\;\\mathrm{cm}^2", Data_Show.show(Data_Show.showInt)(((4 * (3 * third | 0) | 0) * (3 * third | 0) | 0) * third | 0) + "\\pi\\;\\mathrm{cm}^3", Data_Show.show(showTwoDecimals)(TwoDecimals(4.0 * (3.0 * Data_Int.toNumber(third)) * (3.0 * Data_Int.toNumber(third)) * $$Math.pi)) + "\\;\\mathrm{cm}^2", Data_Show.show(Data_Show.showInt)((9 * third | 0) * third | 0) + "\\pi\\;\\mathrm{cm}^2" ];
                                                                                                                                                                                                                                                                                                                                                          };
                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(aera(v3.value0))(ord7)))(function () {
                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("8. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Quel est le volume "))(function () {
                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.em("exact"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" d'une boule de rayon  "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(3 * v3.value1 | 0)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                      var volume = function (third) {
                                                                                                                                                                                                                                                                                                                                                                                                          return [ Data_Show.show(Data_Show.showInt)(((4 * (3 * third | 0) | 0) * (3 * third | 0) | 0) * third | 0) + "\\pi\\;\\mathrm{cm}^3", Data_Show.show(Data_Show.showInt)((4 * (3 * third | 0) | 0) * (3 * third | 0) | 0) + "\\pi\\;\\mathrm{cm}^2", Data_Show.show(showTwoDecimals)(TwoDecimals(4.0 * (3.0 * Data_Int.toNumber(third)) * (3.0 * Data_Int.toNumber(third)) * $$Math.pi * Data_Int.toNumber(third))) + "\\;\\mathrm{cm}^3", Data_Show.show(Data_Show.showInt)(((4 * 9 | 0) * third | 0) * third | 0) + "\\pi\\;\\mathrm{cm}^3" ];
                                                                                                                                                                                                                                                                                                                                                                                                      };
                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(volume(v3.value1))(ord8)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("9. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Un plan est tangent en un point "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("T"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" \xe0 une sph\xe8re de centre "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("O"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et de rayon "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(v4.value0)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On consid\xe8re un point "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("P"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" du plan, distinct de "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("T"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(". On peut \xeatre s\xfbr que"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  var cas1 = [ "(TO)\\;\\mathrm{et}\\;(TP)\\;\\mathrm{sont}\\;\\mathrm{parall\\grave{e}les}", "(TO)\\;\\mathrm{et}\\;(TP)\\;\\mathrm{sont}\\;\\mathrm{perpendiculaires}", "OP>" + (Data_Show.show(Data_Show.showInt)(v4.value0) + "\\;\\mathrm{cm}"), "OP=" + (Data_Show.show(Data_Show.showInt)(v4.value0) + "\\;\\mathrm{cm}") ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(cas1)(ord9)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var v6 = new Data_Tuple.Tuple(Data_Ord.max(Data_Ord.ordInt)(v5.value0)(v5.value1), Data_Ord.min(Data_Ord.ordInt)(v5.value0)(v5.value1));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var cc = v4.value1 * ((v6.value0 * v6.value0 | 0) + (v6.value1 * v6.value1 | 0) | 0) | 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var bb = ((v4.value1 * 2 | 0) * v6.value0 | 0) * v6.value1 | 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var aa = v4.value1 * ((v6.value0 * v6.value0 | 0) - (v6.value1 * v6.value1 | 0) | 0) | 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("10. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("La section par un plan d'une sph\xe8re de centre "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("O"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et de rayon "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(cc)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm est un cercle de centre "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("H"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et de rayon "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(bb)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" cm."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On peut \xeatre s\xfbr que"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      var cas2 = [ "OH=" + (Data_Show.show(Data_Show.showInt)(aa) + "\\;\\mathrm{cm}"), "OH=" + (Data_Show.show(Data_Show.showInt)(bb) + "\\;\\mathrm{cm}"), "OH=" + (Data_Show.show(Data_Show.showInt)(cc) + "\\;\\mathrm{cm}"), "(OH)\\;\\mathrm{perpendiculaire}\\;\\mathrm{au}\\;\\mathrm{plan}" ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(cas2)(ord10)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  var $33 = Data_Maybe.fromMaybe(0)(Article.validateInput(newState.seed)) < 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  if ($33) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("r\xe9ponses: "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 1. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol1)(ord1)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 2. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol2)(ord2)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 3. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol3)(ord3)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 4. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol4)(ord4)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 5. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol5)(ord5)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 6. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol6)(ord6)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 7. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol7)(ord7)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 8. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol8)(ord8)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 9. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol9)(ord9)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 10. "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Article.t(showSol(sol10)(ord10));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          });
  ...
  exports["nth"] = nth;
  exports["randDifferentRadii"] = randDifferentRadii;
  exports["after"] = after;
  ...
  exports["showTwoDecimals"] = showTwoDecimals;
})(PS);
PS["Main"].main();