...
(function($PS) {
  ...
  var showFraction = new Data_Show.Show(function (v) {
      if (v.length === 2) {
          return "\\dfrac{" + (Data_Show.show(Data_Show.showInt)(v[0]) + ("}{" + (Data_Show.show(Data_Show.showInt)(v[1]) + "}")));
      };
      return "";
  });
  var initialState = {
  ...
  var after = function (letter) {
      return function (n) {
          return Data_String_CodePoints.fromCodePointArray([ Data_Foldable.foldr(Data_Foldable.foldableArray)(Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn))(Control_Category.identity(Control_Category.categoryFn))(Data_Array.replicate(n)((function () {
              var $46 = Data_Enum.succ(Data_String_CodePoints.enumCodePoint);
              return function ($47) {
                  return (function (x) {
          ...
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental((function () {
                      ...
                      var r1 = Rand.consume(3)(r0);
                      var r2 = Rand.consume(4)(r1);
                      var rs = Rand.rands(15)(r2);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("1."))(function () {
                              var ab = (function (v) {
                                  return v + 3 | 0;
                              })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(0))(10));
                              var ac = (function (v) {
                                  return v + 1 | 0;
                              })((function (v) {
                                  return v + ab | 0;
                              })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(2))(5)));
                              var bm = (function (v) {
                                  return v + 1 | 0;
                              })((function (v) {
                                  return v + ab | 0;
                              })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(1))(5)));
                              var sol1 = Data_Ring.sub(Data_Ratio.ringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt((ab + bm | 0) * ac | 0))(Data_Rational.fromInt(ab)))(Data_Rational.fromInt(ac));
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("180"), Concur_VDom_SVG.height("240"), Concur_VDom_SVG.viewBox("-10 -10 200 200") ])((function () {
                                  var mkPoint = function (name) {
                                      return function (x) {
                                          return function (y) {
                                              return Data_Geometry_Plane.point(name)(80.0 + 140.0 * x)(5.0 - 140.0 * y);
                                          };
                                      };
                                  };
                                  var pA = mkPoint("A")(0.0)(0.0);
                                  var pB = mkPoint("B")(-0.2)(-0.5);
                                  var pC = mkPoint("C")(0.1)(-0.4);
                                  var pM = Data_Geometry_Plane.rename("M")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(2.4)(Data_Geometry_Plane.vector(pA)(pB))));
                                  var pN = Data_Geometry_Plane.rename("N")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(2.4)(Data_Geometry_Plane.vector(pA)(pC))));
                                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))([ pA, pB, pC, pM, pN ]))(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))([ Data_Geometry_Plane.segment(pA)(pM)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pA)(pN)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pB)(pC)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pM)(pN)(Data_Maybe.Nothing.value) ]));
                              })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Sur la figure ci-contre (qui n'est pas \xe0 l'\xe9chelle), les droites "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(BC)"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(MN)"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont parall\xe8les."))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On donne "))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("AB =" + Data_Show.show(Data_Show.showInt)(ab)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", "))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("BM =" + Data_Show.show(Data_Show.showInt)(bm)))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("AC =" + Data_Show.show(Data_Show.showInt)(ac)))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Calculer la longueur "))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(" CN:"))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                          return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                                                      });
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("2."))(function () {
                                          var ed = (function (v) {
                                              return v + 3 | 0;
                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(3))(10));
                                          var ep = (function (v) {
                                              return v + 1 | 0;
                                          })((function (v) {
                                              return v + ed | 0;
                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(4))(5)));
                                          var eq = (function (v) {
                                              return v + 1 | 0;
                                          })((function (v) {
                                              return v + ep | 0;
                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(5))(5)));
                                          var sol2 = Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(ed * eq | 0))(Data_Rational.fromInt(ep));
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("180"), Concur_VDom_SVG.height("240"), Concur_VDom_SVG.viewBox("-10 -10 200 200") ])((function () {
                                              var mkPoint = function (name) {
                                                  return function (x) {
                                                      return function (y) {
                                              ...
                                              var pD = mkPoint("D")(0.0)(0.0);
                                              var pE = mkPoint("E")(-0.2)(-0.5);
                                              var pF = mkPoint("F")(-0.4)(-0.1);
                                              var k = -1.3;
                                              var pP = Data_Geometry_Plane.rename("P")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pE)(Data_Geometry_Plane.scale(k)(Data_Geometry_Plane.vector(pE)(pD))));
                                              var pQ = Data_Geometry_Plane.rename("Q")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pE)(Data_Geometry_Plane.scale(k)(Data_Geometry_Plane.vector(pE)(pF))));
                                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))([ pD, pE, pF, pP, pQ ]))(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))([ Data_Geometry_Plane.segment(pD)(pP)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pF)(pQ)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pD)(pF)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pP)(pQ)(Data_Maybe.Nothing.value) ]));
                                          })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Sur la figure ci-contre (qui n'est pas \xe0 l'\xe9chelle), les droites "))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(DF)"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(PQ)"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont parall\xe8les."))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On donne "))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("ED =" + Data_Show.show(Data_Show.showInt)(ed)))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", "))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("EP =" + Data_Show.show(Data_Show.showInt)(ep)))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("EQ =" + Data_Show.show(Data_Show.showInt)(eq)))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Calculer la longueur "))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(" EF:"))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                      return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                                                                  });
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("3."))(function () {
                                                      var sol3 = [ nth(dfltInt)(Data_Array.range(0)(2))(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(6))(3)) ];
                                                      var props = [ "(BC)\\; \\mathrm{et}\\; (DE) \\;\\mathrm{sont}\\; \\mathrm{parall\\grave{e}les}", "(BC)\\; \\mathrm{et} \\;(FG)\\; \\mathrm{sont}\\; \\mathrm{parall\\grave{e}les}", "(DE)\\; \\mathrm{et} \\;(FG)\\; \\mathrm{sont}\\; \\mathrm{parall\\grave{e}les}" ];
                                                      var v = (function () {
                                                          var v1 = nth(dfltInt)(sol3)(0);
                                                          if (v1 === 0) {
                                                              return {
                                                                  ab: 2,
                                                                  ac: 3,
                                                      ...
                                                      var ord3 = Rand.unsort(3)(r0);
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("400"), Concur_VDom_SVG.height("180"), Concur_VDom_SVG.viewBox("-10 -35 400 220") ])((function () {
                                                          var style = [ Concur_VDom_SVG.attr("font-size")("20"), Concur_VDom_SVG.attr("font-weight")("700") ];
                                                          var mkPoint = function (name) {
                                                              return function (x) {
                                                                  return function (y) {
                                                                      return Data_Geometry_Plane.point(name)(30.0 + 150.0 * x)(65.0 - 150.0 * y);
                                                                  };
                                                              };
                                                          };
                                                          var pA = mkPoint("A")(0.0)(0.0);
                                                          var pB = mkPoint("B")(-0.3)(-0.15);
                                                          var pD = Data_Geometry_Plane.rename("D")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(-1.95)(Data_Geometry_Plane.vector(pA)(pB))));
                                                          var pF = Data_Geometry_Plane.rename("F")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(-3.3)(Data_Geometry_Plane.vector(pA)(pB))));
                                                          var pC = mkPoint("C")(-0.4)(0.1);
                                                          var pE = Data_Geometry_Plane.rename("E")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(-1.9)(Data_Geometry_Plane.vector(pA)(pC))));
                                                          var pG = Data_Geometry_Plane.rename("G")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pA)(Data_Geometry_Plane.scale(-3.4)(Data_Geometry_Plane.vector(pA)(pC))));
                                                          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))([ pA, pB, pC, pD, pE, pF, pG ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))([ Data_Geometry_Plane.segment(pB)(pF)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pG)(pC)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pC)(pB)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pE)(pD)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pF)(pG)(Data_Maybe.Nothing.value) ]))([ Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pB)(pA)(20.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.ab)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pA)(pE)(20.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.ae)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pE)(pG)(20.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.ag - v.ae | 0)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pC)(pA)(-8.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.ac)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pA)(pD)(-8.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.ad)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Article.measure(pD)(pF)(-8.0))(style))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(v.af - v.ad | 0)) ]) ]));
                                                      })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Sur la figure ci-contre (qui n'est pas \xe0 l'\xe9chelle), on a report\xe9 la longueur de six segments."))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Une seule des affirmations ci-dessous est exacte."))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" D\xe9terminer laquelle :"))(function () {
                                                                              return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                          });
                                                                      });
                                                                  });
                                                          ...
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(props)(ord3)))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("4."))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Les quatre triangles en gras des figures ci-dessous ont pour sommets des points d'un quadrillage (grille compos\xe9e de carr\xe9s)."))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Trois de ces triangles sont semblables."))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Trouver l'intrus :"))(function () {
                                                                                                      var typeIII = [ [ 0, 2, 6 ], [ 2, 6, 8 ], [ 0, 2, 8 ], [ 0, 6, 8 ] ];
                                                                                                      var typeII = [ [ 0, 4, 6 ], [ 1, 3, 7 ], [ 1, 7, 5 ], [ 2, 4, 8 ], [ 1, 3, 5 ], [ 0, 2, 4 ], [ 3, 5, 7 ], [ 4, 6, 8 ] ];
                                                                                                      var typeI = [ [ 0, 1, 3 ], [ 1, 3, 4 ], [ 0, 4, 1 ], [ 0, 3, 4 ], [ 1, 4, 5 ], [ 1, 2, 5 ], [ 1, 4, 2 ], [ 2, 4, 5 ], [ 3, 6, 7 ], [ 3, 7, 4 ], [ 3, 4, 6 ], [ 4, 6, 7 ], [ 4, 7, 8 ], [ 4, 8, 5 ], [ 4, 5, 7 ], [ 5, 7, 8 ] ];
                                                                                                      var type0 = [ [ 0, 5, 6 ], [ 2, 3, 8 ], [ 0, 2, 7 ], [ 1, 6, 8 ] ];
                                                                                                      var triIII = nth(dfltArray(dfltInt))(typeIII)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(10))(4));
                                                                                                      var triII = nth(dfltArray(dfltInt))(typeII)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(9))(8));
                                                                                                      var triI = nth(dfltArray(dfltInt))(typeI)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(8))(16));
                                                                                                      var tri0 = nth(dfltArray(dfltInt))(type0)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(7))(4));
                                                                                                      var sol4 = [ 0 ];
                                                                                                      var ord4 = Rand.unsort(4)(r1);
                                                                                                      var shuffle = function (n) {
                                                                                                          var v1 = nth(dfltInt)(ord4)(n);
                                                                                                          if (v1 === 0) {
                                                                                                              return tri0;
                                                                                                          };
                                                                                                          if (v1 === 1) {
                                                                                                      ...
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("800"), Concur_VDom_SVG.height("180"), Concur_VDom_SVG.viewBox("-10 -35 800 220") ])((function () {
                                                                                                              var mkPoint = function (name) {
                                                                                                                  return function (x) {
                                                                                                                      return function (y) {
                                                                                                                          return function (origx) {
                                                                                                                              return Data_Geometry_Plane.point(name)(origx + 60.0 * x)(5.0 + 60.0 * y);
                                                                                                                          };
                                                                                                                      };
                                                                                                                  };
                                                                                                              };
                                                                                                              var mkSquare = function (origx) {
                                                                                                                  return function (tri) {
                                                                                                                      return function (txt) {
                                                                                                                          var pI = mkPoint("")(2.0)(2.0)(origx);
                                                                                                                          var pH = mkPoint("")(1.0)(2.0)(origx);
                                                                                                                          var pG = mkPoint("")(0.0)(2.0)(origx);
                                                                                                                          var pF = mkPoint("")(2.0)(1.0)(origx);
                                                                                                                          var pE = mkPoint("")(1.0)(1.0)(origx);
                                                                                                                          var pD = mkPoint("")(0.0)(1.0)(origx);
                                                                                                                          var pC = mkPoint("")(2.0)(0.0)(origx);
                                                                                                                          var pB = mkPoint("")(1.0)(0.0)(origx);
                                                                                                                          var pA = mkPoint("")(0.0)(0.0)(origx);
                                                                                                                          var vertices = [ pA, pB, pC, pD, pE, pF, pG, pH, pI ];
                                                                                                                          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.attr("x")(Data_Show.show(Data_Show.showNumber)(origx - 60.0 / 2.0)), Concur_VDom_SVG.attr("y")(Data_Show.show(Data_Show.showNumber)(5.0 + 60.0)), Concur_VDom_SVG.attr("font-size")("20") ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(txt) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))([ Data_Geometry_Plane.segment(pA)(pC)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pA)(pG)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pC)(pI)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pI)(pG)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pB)(pH)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pD)(pF)(Data_Maybe.Nothing.value) ]))(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))({
                                                                                                                              stroke: Concur_VDom_GeometryRender.defaultContext.stroke,
                                                                                                                              fill: Concur_VDom_GeometryRender.defaultContext.fill,
                                                                                                                              strokeWidth: 4.0,
                                                                                                                              fontStyle: Concur_VDom_GeometryRender.defaultContext.fontStyle,
                                                                                                                              textFill: Concur_VDom_GeometryRender.defaultContext.textFill
                                                                                                                          })([ Data_Geometry_Plane.segment(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(0)))(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(1)))(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(1)))(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(2)))(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(2)))(nth(dfltPoint)(vertices)(nth(dfltInt)(tri)(0)))(Data_Maybe.Nothing.value) ])));
                                                                                                                      };
                                                                                                                  };
                                                                                                              };
                                                                                                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(mkSquare(10.0)(shuffle(0))("a)"))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mkSquare(10.0 + 4.0 * 60.0)(shuffle(1))("b)"))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mkSquare(10.0 + 8.0 * 60.0)(shuffle(2))("c)"))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mkSquare(10.0 + 12.0 * 60.0)(shuffle(3))("d)"))([  ]))));
                                                                                                          })())))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5."))(function () {
                                                                                                                          var inf = (function (v1) {
                                                                                                                              return v1 + 2 | 0;
                                                                                                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(11))(10));
                                                                                                                          var sup = (function (v1) {
                                                                                                                              return v1 + 2 | 0;
                                                                                                                          })((function (v1) {
                                                                                                                              return v1 + inf | 0;
                                                                                                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(12))(20)));
                                                                                                                          var thirdMax = sup - 1 | 0;
                                                                                                                          var thirdMin = 1 + Data_Ord.max(Data_Ord.ordInt)(inf)(sup - inf | 0) | 0;
                                                                                                                          var third = thirdMin + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(13))((thirdMax - thirdMin | 0) + 1 | 0) | 0;
                                                                                                                          var coef = (function (v1) {
                                                                                                                              return v1 + 2 | 0;
                                                                                                                          })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(nth(dfltInt)(rs)(14))(10));
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("400"), Concur_VDom_SVG.height("180"), Concur_VDom_SVG.viewBox("-10 -35 400 220") ])((function () {
                                                                                                                              var pA = Data_Geometry_Plane.point("A")(0.0)(0.0);
                                                                                                                              var mkPoint = function (z) {
                                                                                                                                  return Data_Geometry_Plane.point("")(Data_Complex.real(z))(Data_Complex.imag(z));
                                                                                                                              };
                                                                                                                              var pB = Data_Geometry_Plane.point("B")(8.0)(0.0);
                                                                                                                              var s1 = function (z) {
                                                                                                                                  var transB = new Data_Complex.Cartesian(150.0, 120.0);
                                                                                                                                  var transA = new Data_Complex.Cartesian(5.0, 20.0);
                                                                                                                                  var m = Data_Functor.map(Data_Complex.functorCartesian)(function (v1) {
                                                                                                                                      return v1 / 8.0;
                                                                                                                                  })(Data_Ring.sub(Data_Complex.ringCartesian(Data_Ring.ringNumber))(transB)(transA));
                                                                                                                                  return Data_Semiring.add(Data_Complex.semiringCartesian(Data_Ring.ringNumber))(Data_Semiring.mul(Data_Complex.semiringCartesian(Data_Ring.ringNumber))(m)(z))(transA);
                                                                                                                              };
                                                                                                                              var s2 = function (z) {
                                                                                                                                  var transB = new Data_Complex.Cartesian(150.0, 150.0);
                                                                                                                                  var transA = new Data_Complex.Cartesian(400.0, 80.0);
                                                                                                                                  var m = Data_Functor.map(Data_Complex.functorCartesian)(function (v1) {
                                                                                                                                      return v1 / 8.0;
                                                                                                                                  })(Data_Ring.sub(Data_Complex.ringCartesian(Data_Ring.ringNumber))(transB)(transA));
                                                                                                                                  return Data_Semiring.add(Data_Complex.semiringCartesian(Data_Ring.ringNumber))(Data_Semiring.mul(Data_Complex.semiringCartesian(Data_Ring.ringNumber))(m)(z))(transA);
                                                                                                                              };
                                                                                                                              var complex = function (p) {
                                                                                                                                  return new Data_Complex.Cartesian(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(p), Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(p));
                                                                                                                              };
                                                                                                                              var zA = complex(pA);
                                                                                                                              var pD = mkPoint(s1(zA));
                                                                                                                              var pG = mkPoint(s2(zA));
                                                                                                                              var zB = complex(pB);
                                                                                                                              var pE = mkPoint(s1(zB));
                                                                                                                              var pH = mkPoint(s2(zB));
                                                                                                                              var c2 = Data_Geometry_Plane.circle(pB)(6.0);
                                                                                                                              var c1 = Data_Geometry_Plane.circle(pA)(3.0);
                                                                                                                              var pC = nth(dfltPoint)(Data_Geometry_Plane.meets(Data_Geometry_Plane.interCircleCircle)(c1)(c2))(0);
                                                                                                                              var zC = complex(pC);
                                                                                                                              var pF = mkPoint(s1(zC));
                                                                                                                              var pI = mkPoint(s2(zC));
                                                                                                                                      ...
                                                                                                                                      return function (q) {
                                                                                                                                          return function (r) {
                                                                                                                                              return function (b1) {
                                                                                                                                                  return function (b2) {
                                                                                                                                                      return function (b3) {
                                                                                                                                                          return Data_Geometry_Plane.arc(Data_Geometry_Plane.vector(o)(p))(o)(Data_Geometry_Plane.vector(o)(q))(r)(b1)(b2)(b3)(Data_Maybe.Nothing.value);
                                                                                                                                                      };
                                                                                                                                                  };
                                                                                                                                              };
                                                                                                                                          };
                                                                                                                              ...
                                                                                                                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderSegment))([ Data_Geometry_Plane.segment(pD)(pE)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pD)(pF)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pE)(pF)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pG)(pH)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pG)(pI)(Data_Maybe.Nothing.value), Data_Geometry_Plane.segment(pH)(pI)(Data_Maybe.Nothing.value) ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderArc))([ angle(pF)(pD)(pE)(25.0)(false)(false)(false), angle(pI)(pG)(pH)(25.0)(false)(false)(false), angle(pE)(pF)(pD)(15.0)(false)(false)(false), angle(pH)(pI)(pG)(15.0)(false)(false)(false), angle(pE)(pF)(pD)(20.0)(false)(false)(false), angle(pH)(pI)(pG)(20.0)(false)(false)(false) ]))([ Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.measure(pD)(pE)(20.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(sup)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.measure(pD)(pF)(-8.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(inf)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.measure(pH)(pG)(-8.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(coef * sup | 0)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.measure(pH)(pI)(20.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(coef * third | 0)) ]), Concur_VDom_SVG.text(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.measure(pI)(pG)(20.0))([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(coef * inf | 0)) ]) ]));
                                                                                                                          })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" On se donne deux triangles semblables."))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Sur la figure ci-contre (qui n'est pas \xe0 l'\xe9chelle) sont report\xe9es les longueurs de tous leurs c\xf4t\xe9s sauf une."))(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Calculer la longueur manquante :"))(function () {
                                                                                                                                                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                                                                                              });
                                                                                                                                          });
                                                                                                                                      });
                                                                                                                              ...
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                                                                                                                                  var $39 = Data_Maybe.fromMaybe(0)(Article.validateInput(newState.seed)) < 0;
                                                                                                                                  if ($39) {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("r\xe9ponses: "))(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 1. "))(function () {
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(showFraction)([ Data_Ratio.numerator(sol1), Data_Ratio.denominator(sol1) ])))(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 2. "))(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(showFraction)([ Data_Ratio.numerator(sol2), Data_Ratio.denominator(sol2) ])))(function () {
                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 3. "))(function () {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol3)(ord3)))(function () {
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 4. "))(function () {
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(sol4)(ord4)))(function () {
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 5. "))(function () {
                                                                                                                                                                                  return Article.m(Data_Show.show(Data_Show.showInt)(third));
                                                                                                                                                                              });
                                                                                                                                                                          });
                                                                                                                                                                      });
                                                                                                                                                                  });
