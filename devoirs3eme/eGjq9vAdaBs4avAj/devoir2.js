...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];                
  var shuffle = function (ps) {
      return function (xs) {
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (i) {
              return function (acc) {
                  return Data_Array.cons(Data_Maybe.fromJust()(Data_Array.index(xs)(Data_Maybe.fromJust()(Data_Array.index(ps)(i)))))(acc);
              };
          })([  ])(Data_Array.range(0)(Data_Array.length(xs) - 1 | 0));
      };
  };
  ...
  var choose = function (n) {
      return function (xs) {
          return function (r) {
              var ps = unsort(Data_Array.length(xs))(r);
              return Data_Array.take(n)(shuffle(ps)(xs));
          };
      };
  };
  exports["rand"] = rand;
...
(function($PS) {
  ...
  var showFactors = new Data_Show.Show(function (v) {
      return Data_String_Common.joinWith("\\times")(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
          if (v1.e === 0) {
              return Data_Maybe.Nothing.value;
          };
          if (v1.e === 1) {
              return Data_Maybe.Just.create(Data_Show.show(Data_Show.showInt)(v1.p));
          };
          return Data_Maybe.Just.create(Data_Show.show(Data_Show.showInt)(v1.p) + ("^" + Data_Show.show(Data_Show.showInt)(v1.e)));
      })(v)));
  });
  var shorts = [ 2, 3, 5, 7 ];
  var initialState = {
  ...
  var dfltProd = new HasDefault([  ]);
  var dfltInt = new HasDefault(0);
  var dfltFrac = new HasDefault([  ]);
  var dfltFact = new HasDefault({
      p: 1,
      e: 1
  });
  var dfltDiv = new HasDefault({
      n: 1,
      ds: [ 1 ],
      ps: "1"
  });
  ...
  var divides = function (v) {
      return function (v1) {
          return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (i) {
              return expo(nth(dfltFact)(v)(i)) <= expo(nth(dfltFact)(v1)(i));
          })(Data_Array.range(0)(3));
      };
  };
  var pick = function (dictHasDefault) {
      return function (xs) {
          return function (r) {
              return nth(dictHasDefault)(xs)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(Data_Array.length(xs) - 1 | 0));
          };
      };
  };
  var showProp = function (props) {
      return function (ord) {
          return Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("a) "))(function () {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(nth(dfltString)(props)(nth(dfltInt)(ord)(0))))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
              ...
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(nth(dfltString)(props)(nth(dfltInt)(ord)(1))))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
              ...
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(nth(dfltString)(props)(nth(dfltInt)(ord)(2))))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
          }))), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("d) "))(function () {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(nth(dfltString)(props)(nth(dfltInt)(ord)(3))))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
          }))) ]);
      };
  ...
  var composites = [ {
      ...
      n: 36,
      ds: [ 1, 2, 3, 4, 6, 9, 12, 18, 36 ],
      ps: "2^2\\times 3^2"
  }, {
      n: 42,
      ds: [ 1, 2, 3, 6, 7, 14, 21, 42 ],
      ps: "2\\times 3\\times 7"
  }, {
      n: 50,
      ds: [ 1, 2, 5, 10, 25, 50 ],
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("1."))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("180"), Concur_VDom_SVG.height("280"), Concur_VDom_SVG.viewBox("-10 -10 200 200") ])((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Sur la figure (qui n'est pas \xe0 l'\xe9chelle), les droites "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(BC)"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(MN)"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sont parall\xe8les. On donne "))(function () {
                                                      var rab = Rand.rand(r0);
                                                      var rbm = Rand.rand(rab);
                                                      var rac = Rand.rand(rbm);
                                                      var bm = (function (v) {
                                                          return v + 3 | 0;
                                                      })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rbm.val)(10));
                                                      var ac = (function (v) {
                                                          return v + 3 | 0;
                                                      })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rac.val)(10));
                                                      var ab = (function (v) {
                                                          return v + 3 | 0;
                                                      })(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rab.val)(10));
                                  ...
                                  var composites1 = [ 9, 15, 21, 25, 27 ];
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Quelle est la seule liste uniquement compos\xe9e de nombres premiers ?"))(function () {
                                      var ps = Data_Semigroup.append(Data_Semigroup.semigroupArray)(shorts)([ 11, 13, 17, 19, 23, 29 ]);
                                      var rep1 = Data_Array.sort(Data_Ord.ordInt)(Rand.choose(4)(ps)(r0));
                                      var np = Data_Array.length(ps);
                                      var r1 = Rand.consume(np)(r0);
                                      var rc2 = Rand.rand(r1);
                                      var r2 = Rand.consume(np)(rc2);
                                      var rc3 = Rand.rand(r2);
                                      var r3 = Rand.consume(np)(rc3);
                                      var rc4 = Rand.rand(r3);
                                      var r4 = Rand.consume(np)(rc4);
                                      var c4 = pick(dfltInt)(composites1)(rc4);
                                      var rep4 = Data_Array.sort(Data_Ord.ordInt)(Data_Array.cons(c4)(Rand.choose(3)(ps)(r3)));
                                      var c3 = pick(dfltInt)(composites1)(rc3);
                                      var rep3 = Data_Array.sort(Data_Ord.ordInt)(Data_Array.cons(c3)(Rand.choose(3)(ps)(r2)));
                                      var c2 = pick(dfltInt)(composites1)(rc2);
                                      var rep2 = Data_Array.sort(Data_Ord.ordInt)(Data_Array.cons(c2)(Rand.choose(3)(ps)(r1)));
                                      var rs1 = Rand.consume(4)(r4);
                                      var prop1 = Data_Functor.map(Data_Functor.functorArray)((function () {
                                          var $56 = Data_String_Common.joinWith(",");
                                          return function ($57) {
                                              return $56((function (xs) {
                                                  return Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showInt))(xs);
                                              })($57));
                                          };
                                      })())([ rep1, rep2, rep3, rep4 ]);
                                      var ord1 = Rand.unsort(4)(r4);
                                      var good1 = [ 0 ];
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(prop1)(ord1)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("2."))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" \xc9crire la liste des diviseurs de "))(function () {
                                                              var rs2 = Rand.consume(2)(rs1);
                                                              var cs = Rand.choose(2)(composites)(rs1);
                                                              var composite2 = nth(dfltDiv)(cs)(0);
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(composite2.n)))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" :"))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("3."))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Donner la d\xe9composition en produit de facteurs premiers de "))(function () {
                                                                                      var rs3 = Rand.rand(rs2);
                                                                                      var composite3 = nth(dfltDiv)(cs)(1);
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(Data_Show.showInt)(composite3.n)))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" : "))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("4."))(function () {
                                                                                                          var rs$prime4 = Rand.consume(20)(rs3);
                                                                                                          var es = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                                                                                                              return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v)(5);
                                                                                                          })(Rand.rands(20)(rs3));
                                                                                                          var n = Prod(Data_Array.zipWith(function (p) {
                                                                                                              return function (e) {
                                                                                                                  return {
                                                                                                                      p: p,
                                                                                                                      e: e + 1 | 0
                                                                                                          ...
                                                                                                          })(shorts)(Data_Array.slice(0)(3)(es)));
                                                                                                          var n0 = Prod(Data_Array.zipWith(function (p) {
                                                                                                              return function (e) {
                                                                                                                  return {
                                                                                                                      p: p,
                                                                                                                      e: e
                                                                                                          ...
                                                                                                          })(shorts)(Data_Array.slice(4)(7)(es)));
                                                                                                          var n1 = Prod(Data_Array.zipWith(function (p) {
                                                                                                              return function (e) {
                                                                                                                  return {
                                                                                                                      p: p,
                                                                                                                      e: e
                                                                                                          ...
                                                                                                          })(shorts)(Data_Array.slice(8)(11)(es)));
                                                                                                          var n2 = Prod(Data_Array.zipWith(function (p) {
                                                                                                              return function (e) {
                                                                                                                  return {
                                                                                                                      p: p,
                                                                                                                      e: e
                                                                                                          ...
                                                                                                          })(shorts)(Data_Array.slice(12)(15)(es)));
                                                                                                          var n3 = Prod(Data_Array.zipWith(function (p) {
                                                                                                              return function (e) {
                                                                                                                  return {
                                                                                                                      p: p,
                                                                                                                      e: e
                                                                                                          ...
                                                                                                          })(shorts)(Data_Array.slice(16)(19)(es)));
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" D\xe9terminer lesquelles de ces d\xe9compositions sont des diviseurs de "))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(showFactors)(n)))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" (il peut ne pas y en avoir) :"))(function () {
                                                                                                                      var rs4 = Rand.consume(4)(rs$prime4);
                                                                                                                      var prop4 = Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showFactors))([ n0, n1, n2, n3 ]);
                                                                                                                      var ord4 = Rand.unsort(4)(rs$prime4);
                                                                                                                      var good4 = Data_Array.catMaybes([ (function () {
                                                                                                                          var $42 = divides(n0)(n);
                                                                                                                          if ($42) {
                                                                                                                      ...
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(prop4)(ord4)))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5."))(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Donner la forme irr\xe9ductible de "))(function () {
                                                                                                                                                  var fractions = Data_Functor.map(Data_Functor.functorArray)(Frac)([ [ 27, 108 ], [ 420, 504 ], [ 42, 504 ], [ 420, 252 ], [ 168, 180 ], [ 70, 196 ], [ 270, 720 ], [ 177, 264 ], [ 210, 75 ] ]);
                                                                                                                                                  var fraction = pick(dfltFrac)(fractions)(rs4);
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(Data_Show.show(showFraction)(fraction)))(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" :"))(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                                                                                                                                                              var $46 = Data_Maybe.fromMaybe(0)(Article.validateInput(newState.seed)) < 0;
                                                                                                                                                              if ($46) {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("r\xe9ponses: "))(function () {
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 1. "))(function () {
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(good1)(ord1)))(function () {
                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 2. "))(function () {
                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(Data_Show.show(Data_Show.showArray(Data_Show.showInt))(composite2.ds)))(function () {
                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 3. "))(function () {
                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(composite3.ps))(function () {
                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b(" 4. "))(function () {
                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(showSol(good4)(ord4)))(function () {
                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5. "))(function () {
                                                                                                                                                                                                              return Article.m((function () {
                                                                                                                                                                                                                  var q = Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(nth(dfltInt)(fraction)(0)))(Data_Rational.fromInt(nth(dfltInt)(fraction)(1)));
                                                                                                                                                                                                                  var num = Data_Ratio.numerator(q);
                                                                                                                                                                                                                  var den = Data_Ratio.denominator(q);
                                                                                                                                                                                                                  return Data_Show.show(showFraction)([ num, den ]);
                                                                                                                                                                                                              })());
                                                                                                                                                                                                          });
                                                                                                                                                                                                      });
                                                                                                                                                                                                  });
  ...
  exports["dfltDiv"] = dfltDiv;
  exports["dfltFact"] = dfltFact;
  exports["dfltProd"] = dfltProd;
  exports["showFactors"] = showFactors;
