...
(function($PS) {
  ...
  var p$prime = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM["node'"]("p")(dictMultiAlternative)(dictShiftMap);
      };
  };
  var hr = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return function (ps) {
              return Concur_VDom_DOM.node("hr")(dictMultiAlternative)(dictShiftMap)(ps)([  ]);
          };
      };
  };
  ...
  var h2_ = function (dictShiftMap) {
      return Concur_VDom_DOM.node_("h2")(dictShiftMap);
  };
...
(function($PS) {
  ...
  var counterWidget = function (count) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes["hr'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap), Nodes["p'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("State: " + Data_Show.show(Data_Show.showInt)(count)) ]), Data_Functor.voidLeft(Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Increment") ]))(count + 1 | 0), Data_Functor.voidLeft(Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Decrement") ]))(count - 1 | 0) ]))(function (n) {
  ...
  var main = (function () {
      var widget = function (w) {
          return function (s) {
              return Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))([ Nodes.h2_(Concur_Core_Types.widgetShiftMap)([  ])(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(s)), Nodes.div_(Concur_Core_Types.widgetShiftMap)([  ])(w) ]);
          };
      };
