...
(function($PS) {
  ...
  var checked = Concur_VDom_Props.prop("checked");
...
(function($PS) {
  ...
  var formWidget = function (form) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.map(Concur_Core_Types.widgetFunctor)(Name.create)(Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles["_type"]("text"), Handles.value(form.name), Data_Functor.map(Concur_Core_Props.functorProps)(Handles.unsafeTargetValue)(Handles.onChange) ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(new RememberMe(!form.rememberMe))(Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles["_type"]("checkbox"), Handles.checked(form.rememberMe), Handles.onChange ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(Submit.value)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Submit") ])) ]))(function (res) {
