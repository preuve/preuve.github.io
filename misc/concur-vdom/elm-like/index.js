...
(function($PS) {
  ...
  var RememberMe = (function () {
      function RememberMe(value0) {
          this.value0 = value0;
      };
      RememberMe.create = function (value0) {
          return new RememberMe(value0);
      };
      return RememberMe;
  })();
  var Submit = (function () {
  ...
  var formWidget = function (form) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.map(Concur_Core_Types.widgetFunctor)(Name.create)(Concur_VDom_DOM.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props["_type"]("text"), Concur_VDom_Props.value(form.name), Data_Functor.map(Concur_Core_Props.functorProps)(Concur_VDom_Props.unsafeTargetValue)(Concur_VDom_Props.onChange) ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(new RememberMe(!form.rememberMe))(Concur_VDom_DOM.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props["_type"]("checkbox"), Concur_VDom_Props.checked(form.rememberMe), Concur_VDom_Props.onChange ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(Submit.value)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Submit") ])) ]))(function (res) {
          ...
          if (res instanceof RememberMe) {
              return formWidget({
                  name: form.name,
                  rememberMe: res.value0
              });
          };
          if (res instanceof Submit) {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(form);
          };
          throw new Error("Failed pattern match at Main (line 39, column 3 - line 42, column 24): " + [ res.constructor.name ]);
      });
  };
  var multiFormWidget1 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Concur_Core_Types.widgetApplicative)(formWidget);
  var multiFormWidget2 = (function () {
      var $5 = Concur_Core_Types.andd(Data_Monoid.monoidArray);
      var $6 = Data_Functor.map(Data_Functor.functorArray)(formWidget);
      return function ($7) {
          return $5($6($7));
      };
  })();
  var main = Concur_VDom_Run.runWidgetInDom("main")(multiFormWidget2(forms));
  exports["Name"] = Name;
  exports["RememberMe"] = RememberMe;
  exports["Submit"] = Submit;
  exports["formWidget"] = formWidget;
  exports["forms"] = forms;
  exports["multiFormWidget1"] = multiFormWidget1;
  exports["multiFormWidget2"] = multiFormWidget2;
  exports["main"] = main;
})(PS);
PS["Main"].main();