...
(function($PS) {
  ...
  var tickTime = 500.0;
  var stepSize = 2;
  var startCoord = new Data_Tuple.Tuple(300, 300);
  var rotate = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 54, column 10 - line 58, column 16): " + [ v.constructor.name ]);
  };
  var unfold = function (v) {
      if (v.length === 0) {
          return [ Down.value ];
      };
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Functor.map(Data_Functor.functorArray)(rotate)(Data_Array.reverse(v)));
  };
  var newModel = {
      dirs: [  ],
      iteration: 0
  ...
  var move = function (v) {
      return function (v1) {
          if (v1 instanceof Up) {
              return new Data_Tuple.Tuple(v.value0, v.value1 - stepSize | 0);
          };
          if (v1 instanceof Down) {
              return new Data_Tuple.Tuple(v.value0, v.value1 + stepSize | 0);
          };
          if (v1 instanceof Left) {
              return new Data_Tuple.Tuple(v.value0 - stepSize | 0, v.value1);
          };
          if (v1 instanceof Right) {
              return new Data_Tuple.Tuple(v.value0 + stepSize | 0, v.value1);
          };
          throw new Error("Failed pattern match at Main (line 85, column 17 - line 89, column 31): " + [ v1.constructor.name ]);
      };
  };
  ...
  var renderLine = function (v) {
      return function (dir) {
          var newCoord = move(v.value0)(dir);
          var newLine = makeLine(v.value0)(newCoord);
          return new Data_Tuple.Tuple(newCoord, Data_Array.cons(newLine)(v.value1));
      };
  };
  var renderLines = (function () {
      var $41 = Data_Foldable.foldl(Data_Foldable.foldableArray)(renderLine)(new Data_Tuple.Tuple(startCoord, [  ]));
      return function ($42) {
          return Data_Tuple.snd($41((function (v) {
              return v.dirs;
          })($42)));
      };
  })();
  ...
  var update = function (model) {
      var $27 = model.iteration > iterations;
      if ($27) {
          return newModel;
      };
      return {
          dirs: unfold(model.dirs),
          iteration: model.iteration + 1 | 0
      };
  };
  var svgLines = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (model) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)(Data_Unit.unit)(Handles.onClick), Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("500"), Concur_VDom_SVG.viewBox("0 0 500 500") ])(renderLines(model)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(update(model));
          });
      });
  };
  var timer = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (model) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(tickTime)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(update(model));
          });
      });
  };
  var signal = Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(newModel)(function (model) {
      return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(timer(model))(function (model$prime) {
          return svgLines(model$prime);
      });
  });
  var main = Concur_VDom_Run.runWidgetInDom("main")(Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(signal));
  var genericDir = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Up) {
      ...
      throw new Error("Failed pattern match at Main (line 35, column 1 - line 35, column 44): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showDir = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericDir)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Up";
