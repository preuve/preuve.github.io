...
(function($PS) {
  ...
  var renderLines = (function () {
      var $42 = Data_Foldable.foldl(Data_Foldable.foldableArray)(renderLine)(new Data_Tuple.Tuple(startCoord, [  ]));
      return function ($43) {
          return Data_Tuple.snd($42((function (v) {
              return v.dirs;
          })($43)));
      };
  })();
  ...
  var update = function (model) {
      var $28 = model.iteration > iterations;
      if ($28) {
          return newModel;
      };
      return {
  ...
  var signal = Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(newModel)(function ($44) {
      return (function (v) {
          return Control_Bind.bindFlipped(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(svgLines)(v);
      })(timer($44));
  });
