...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["SimpleCalculator"] = $PS["SimpleCalculator"] || {};
  var exports = $PS["SimpleCalculator"];
  ...
  var K_Add = (function () {
      ...
      K_Add.value = new K_Add();
      return K_Add;
  })();
  var K_Subtract = (function () {
      function K_Subtract() {

      };
      K_Subtract.value = new K_Subtract();
      return K_Subtract;
  })();
  var K_Divide = (function () {
      function K_Divide() {

      };
      K_Divide.value = new K_Divide();
      return K_Divide;
  })();
  var K_Multiple = (function () {
      function K_Multiple() {

      };
      K_Multiple.value = new K_Multiple();
      return K_Multiple;
  })();
  var K_Equal = (function () {
      function K_Equal() {

      };
      K_Equal.value = new K_Equal();
      return K_Equal;
  })();
  var K_C = (function () {
      function K_C() {
  ...
  var showKey = new Data_Show.Show(function (v) {
      ...
      if (v instanceof K_Dot) {
          return ".";
      };
      if (v instanceof K_Add) {
          return "+";
      };
      if (v instanceof K_Subtract) {
          return "-";
      };
      if (v instanceof K_Divide) {
          return "/";
      };
      if (v instanceof K_Multiple) {
          return "*";
      };
      if (v instanceof K_Equal) {
          return "=";
      };
      if (v instanceof K_C) {
          return "C";
      };
      if (v instanceof K_AC) {
          return "#";
      };
      if (v instanceof NOOP) {
          return "";
      };
      throw new Error("Failed pattern match at SimpleCalculator (line 119, column 1 - line 138, column 27): " + [ v.constructor.name ]);
  });
  var toString = function (xs) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(Data_Semigroup.append(Data_Semigroup.semigroupString))("")(Data_Functor.map(Data_List_Types.functorList)(Data_Show.show(showKey))(xs));
  };
  var toNumber = function (xs) {
      var text = toString(xs);
      var value = (function () {
          var $18 = text === "";
          if ($18) {
              return "0";
      ...
      return Global.readFloat(value);
  };
  var operation = function (v) {
      ...
      if (v instanceof Division) {
          return Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingNumber);
      };
      if (v instanceof Multiplication) {
          return Data_Semiring.mul(Data_Semiring.semiringNumber);
      };
      throw new Error("Failed pattern match at SimpleCalculator (line 23, column 1 - line 23, column 54): " + [ v.constructor.name ]);
  };
  var emptyDisplayContent = "0";
  var initialState = {
      input: Data_List_Types.Nil.value,
      memory: Data_Maybe.Nothing.value,
      operator: Data_Maybe.Nothing.value,
      cleanDisplayOnNextKey: true,
      isInsertingDecimalValues: false,
      display: emptyDisplayContent
  };
  var computeStatusInput = function (s) {
      return function (v) {
          if (v instanceof K_Dot) {
              if (s.isInsertingDecimalValues) {
                  return s.input;
              };
              return Data_List.snoc(s.input)(K_Dot.value);
          };
          return Data_List.snoc(s.input)(v);
      };
  };
  var computeMemory = function (v) {
      return function (v1) {
          return function (v2) {
              if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Just) {
                  return operation(v.value0)(v1.value0)(v2);
              };
              if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Nothing) {
                  return operation(v.value0)(0.0)(v2);
              };
              if (v instanceof Data_Maybe.Nothing && (v1 instanceof Data_Maybe.Just && v2 === 0.0)) {
                  return v1.value0;
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return v2;
              };
              throw new Error("Failed pattern match at SimpleCalculator (line 60, column 1 - line 60, column 72): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var computeStatusMemory = function (s) {
      return computeMemory(s.operator)(s.memory)(toNumber(s.input));
  };
  var computeStatusDisplay = function (s) {
      return function (v) {
          if (v instanceof K_Dot) {
              if (s.isInsertingDecimalValues) {
                  return s.display;
              ...
              return (function () {
                  if (s.cleanDisplayOnNextKey) {
                      return emptyDisplayContent;
                  };
                  return s.display;
              })() + Data_Show.show(showKey)(K_Dot.value);
          };
          if (v instanceof K_Equal) {
              var x = computeStatusMemory(s);
              var $34 = x === $$Math.round(x);
              if ($34) {
                  return Data_Show.show(Data_Show.showInt)(Data_Int.round(x));
              };
              return Data_Show.show(Data_Show.showNumber)(x);
          };
          var $35 = s.cleanDisplayOnNextKey || s.display === emptyDisplayContent;
          if ($35) {
              return Data_Show.show(showKey)(v);
          };
          return s.display + Data_Show.show(showKey)(v);
      };
  };
  var handleKey = function (s) {
      return function (v) {
          if (v instanceof NOOP) {
              return s;
          };
          ...
          if (v instanceof K_C) {
              return {
                  ...
                  memory: s.memory,
                  operator: s.operator,
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
          ...
          if (v instanceof K_Equal) {
              return {
                  input: initialState.input,
                  memory: new Data_Maybe.Just(computeStatusMemory(s)),
                  operator: initialState.operator,
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
                  display: computeStatusDisplay(s)(K_Equal.value)
              };
          };
          if (v instanceof K_Add) {
              return {
                  input: initialState.input,
                  memory: new Data_Maybe.Just(computeStatusMemory(s)),
                  operator: new Data_Maybe.Just(Addition.value),
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
                  display: s.display
              };
          ...
          if (v instanceof K_Subtract) {
              return {
                  input: initialState.input,
                  memory: new Data_Maybe.Just(computeStatusMemory(s)),
                  operator: new Data_Maybe.Just(Subtraction.value),
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
                  display: s.display
              };
          ...
          if (v instanceof K_Multiple) {
              return {
                  input: initialState.input,
                  memory: new Data_Maybe.Just(computeStatusMemory(s)),
                  operator: new Data_Maybe.Just(Multiplication.value),
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
                  display: s.display
              };
          ...
          if (v instanceof K_Divide) {
              return {
                  input: initialState.input,
                  memory: new Data_Maybe.Just(computeStatusMemory(s)),
                  operator: new Data_Maybe.Just(Division.value),
                  cleanDisplayOnNextKey: initialState.cleanDisplayOnNextKey,
                  isInsertingDecimalValues: initialState.isInsertingDecimalValues,
                  display: s.display
              };
          ...
          if (v instanceof K_Dot) {
              return {
                  input: computeStatusInput(s)(K_Dot.value),
                  memory: s.memory,
                  operator: s.operator,
                  cleanDisplayOnNextKey: false,
                  isInsertingDecimalValues: true,
                  display: computeStatusDisplay(s)(K_Dot.value)
              };
          };
          return {
              input: computeStatusInput(s)(v),
              memory: s.memory,
              operator: s.operator,
              cleanDisplayOnNextKey: false,
              isInsertingDecimalValues: s.isInsertingDecimalValues,
              display: computeStatusDisplay(s)(v)
          };
      };
  };
  exports["K_0"] = K_0;
  ...
  exports["K_Dot"] = K_Dot;
  exports["K_Add"] = K_Add;
  exports["K_Subtract"] = K_Subtract;
  exports["K_Divide"] = K_Divide;
  exports["K_Multiple"] = K_Multiple;
  exports["K_Equal"] = K_Equal;
  exports["K_C"] = K_C;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Widgets.SimpleCalculatorWidget"] = $PS["Widgets.SimpleCalculatorWidget"] || {};
  var exports = $PS["Widgets.SimpleCalculatorWidget"];
  var Concur_Core_LiftWidget = $PS["Concur.Core.LiftWidget"];
  var Concur_Core_Types = $PS["Concur.Core.Types"];
  var Concur_VDom_DOM = $PS["Concur.VDom.DOM"];
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Data_Monoid = $PS["Data.Monoid"];
  var SimpleCalculator = $PS["SimpleCalculator"];                
  var std = "background-color: yellow; text-align: center; width: 25px; border: 1px solid green;";
  var result = "background-color: chocolate; text-align: center; width: 20px; border: 1px solid maroon; color: white;";
  var operator = "width: 114px; margin-left: 2px; padding: 3px; background-color: lightgray; text-align: left;    fontsize: 6pt; color: gray; margin-bottom: 4px;";
  var display = "width: 200px; margin-left: 2px; padding: 2px; border: 1px solid gray; text-align: right;";
  var decimal = "background-color: green; text-align: center; width: 20px; border: 1px solid lightgreen; color: lightgreen;";
  var cancel = "background-color: violet; text-align: center; width: 20px; border: 1px solid purple; color: purple;";
  var calculatorWidget = function (status) {
      var key = function (colSpan) {
          return function (styleContent) {
              return function (action) {
                  return function (label) {
                      return Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(action)(Concur_VDom_DOM.node("td")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.prop("colSpan")(colSpan), Concur_VDom_Props.prop("style")(styleContent), Concur_VDom_Props.handle("click") ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(label) ]));
                  };
              };
          };
      };
      return Concur_VDom_DOM.node("div")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.node("div")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.prop("style")(display) ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(status.display) ]), Concur_VDom_DOM.node("table")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.node("tbody")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.node("tr")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ key(1)(std)(SimpleCalculator.K_7.value)("7"), key(1)(std)(SimpleCalculator.K_8.value)("8"), key(1)(std)(SimpleCalculator.K_9.value)("9"), key(1)(operator)(SimpleCalculator.K_Divide.value)("/") ]), Concur_VDom_DOM.node("tr")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ key(1)(std)(SimpleCalculator.K_4.value)("4"), key(1)(std)(SimpleCalculator.K_5.value)("5"), key(1)(std)(SimpleCalculator.K_6.value)("6"), key(1)(operator)(SimpleCalculator.K_Multiple.value)("*") ]), Concur_VDom_DOM.node("tr")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ key(1)(std)(SimpleCalculator.K_1.value)("1"), key(1)(std)(SimpleCalculator.K_2.value)("2"), key(1)(std)(SimpleCalculator.K_3.value)("3"), key(1)(operator)(SimpleCalculator.K_Subtract.value)("-") ]), Concur_VDom_DOM.node("tr")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ key(2)(std)(SimpleCalculator.K_0.value)("0"), key(1)(decimal)(SimpleCalculator.K_Dot.value)("."), key(1)(operator)(SimpleCalculator.K_Add.value)("+") ]), Concur_VDom_DOM.node("tr")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ key(3)(result)(SimpleCalculator.K_Equal.value)("="), key(1)(cancel)(SimpleCalculator.K_C.value)("C") ]) ]) ]) ]);
  };
  var widget = (function () {
      var go = function (status) {
          return Control_Bind.bind(Concur_Core_Types.widgetBind)(calculatorWidget(status))(function (key) {
              return go(SimpleCalculator.handleKey(status)(key));
          });
      };
      return go(SimpleCalculator.initialState);
  })();
  exports["widget"] = widget;
})(PS);
(function($PS) {
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Widgets_SimpleCalculatorWidget = $PS["Widgets.SimpleCalculatorWidget"];                
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(0.0))(function () {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Concur_VDom_Run.runWidgetInDom("main")(Widgets_SimpleCalculatorWidget.widget));
  }));
  var hello = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.node("button")(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.handle("click") ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!");
  });
  exports["hello"] = hello;
  exports["main"] = main;
})(PS);
