...
(function($PS) {
  ...
  var button$prime = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return node$prime("button")(dictMultiAlternative)(dictShiftMap);
      };
  };
...
(function($PS) {
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Data_Monoid = $PS["Data.Monoid"];                
  var hello8 = Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))([ Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]), Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]), Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("One more button!") ]) ]);
  var main = Concur_VDom_Run.runWidgetInDom("main")(hello8);
  var hello7 = Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]))(Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]));
  var hello6 = Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]))(function (greeting) {
      return Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!");
  });
  var hello5 = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!") ]);
  });
  var hello4 = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!");
  });
  var hello3 = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]) ]), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]) ]) ]);
  var hello2 = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]), Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]) ]);
  var hello1 = Concur_VDom_DOM["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!") ]);
