...
(function($PS) {
  ...
  var Nodes = $PS["Nodes"];                
  var hello8 = Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))([ Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]), Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]), Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("One more button!") ]) ]);
  ...
  var hello5 = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!") ]);
  });
  var hello4 = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])))(function () {
      return Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!");
  });
  var hello3 = Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]) ]), Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]) ]) ]);
  var hello2 = Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Port!") ]), Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ahoy Starboard!") ]) ]);
  var hello1 = Nodes["button'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!") ]);
