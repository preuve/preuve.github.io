...
(function($PS) {
  ...
  var randPositive = function ($copy_r) {
      ...
      var $tco_result;
      function $tco_loop(r) {
          var $29 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(intMax) === 0;
          if ($29) {
              $copy_r = Rand.rand(r);
              return;
          };
  ...
  var body = function (st) {
      return Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
          ...
          var a = Data_Geometry_Plane.point("A")(310.0)(320.0);
          var b = Data_Geometry_Plane.point("B")(100.0)(210.0);
          var c = Data_Geometry_Plane.circle(a)(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(Data_Geometry_Plane.vector(a)(b)));
          var n = Data_Geometry_Plane.normalTo(Data_Geometry_Plane.vector(a)(b));
          var d = Data_Geometry_Plane.halfline(a)(n);
          var v = Data_Functor.map(Data_Functor.functorArray)(Data_Geometry_Plane.rename("E"))(Data_Geometry_Plane.meets(Data_Geometry_Plane.interHalfLineCircle)(d)(c));
          if (v.length === 1) {
              var eb = Data_Geometry_Plane.segment(v[0])(b)(Data_Maybe.Nothing.value);
              var i = Data_Geometry_Plane.middle("I")(eb);
              var v1 = Data_Functor.map(Data_Functor.functorArray)(Data_Geometry_Plane.rename("F"))(Data_Geometry_Plane.meets(Data_Geometry_Plane.interCircleHalfLine)(c)(Data_Geometry_Plane.halfline(a)(Data_Geometry_Plane.vector(b)(a))));
              if (v1.length === 1) {
                  var g = Data_Geometry_Plane.circle(v1[0])(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(Data_Geometry_Plane.vector(i)(v[0])));
                  var v2 = Data_Geometry_Plane.meets(Data_Geometry_Plane.interCircleCircle)(g)(c);
                  if (v2.length === 2) {
                      var v3 = Data_Functor.map(Data_Functor.functorArray)(Data_Geometry_Plane.rename("H"))(Data_Geometry_Plane.meets(Data_Geometry_Plane.interLineLine)(Data_Geometry_Plane.line(a)(v[0]))(Data_Geometry_Plane.line(i)(v1[0])));
                      if (v3.length === 1) {
                          var v4 = Data_Geometry_Plane.meets(Data_Geometry_Plane.interSegmentSegment)(Data_Geometry_Plane.segment(b)(v3[0])(Data_Maybe.Nothing.value))(Data_Geometry_Plane.segment(v[0])(v1[0])(Data_Maybe.Nothing.value));
                          if (v4.length === 0) {
                              var v5 = Data_Functor.map(Data_Functor.functorArray)(Data_Geometry_Plane.rename("J"))(Data_Geometry_Plane.meets(Data_Geometry_Plane.interHalfLineSegment)(Data_Geometry_Plane.halfline(b)(Data_Geometry_Plane.vector(b)(v3[0])))(Data_Geometry_Plane.segment(v[0])(v1[0])(Data_Maybe.Nothing.value)));
                              if (v5.length === 1) {
                                  return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                                      var $36 = !newState.enabled;
                                      if ($36) {
                                          return [  ];
                                      };
                                      return Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation("\\frac{18}{7}" + Data_Maybe.fromMaybe("")(newState.seed)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x^2"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" signifie "))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x\\times x"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Et "))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\frac{2}{3}"))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est irr\xe9ductible."))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("300"), Concur_VDom_SVG.viewBox("0 0 1000 800") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))([ a, b, v[0], i, v1[0], v2[0], v2[1], v3[0], v5[0] ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderCircle))([ c, g ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderHalfLine)(d))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(eb))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderLine)(Data_Geometry_Plane.line(a)(b)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderArc)(Data_Geometry_Plane.arc(Data_Geometry_Plane.vector(i)(v1[0]))(i)(Data_Geometry_Plane.vector(i)(b))(50.0)(false)(false)(true)(new Data_Maybe.Just("\u03b1"))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(i)(v5[0])(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_GeometryRender["render'"](Concur_VDom_GeometryRender.renderSegment)({
                                                                          stroke: ctx.stroke,
                                                                          fill: ctx.fill,
                                                                          strokeWidth: 2.0,
                                                                          fontStyle: ctx.fontStyle,
                                                                          textFill: ctx.textFill
                                                                      })(Data_Geometry_Plane.segment(i)(v1[0])(new Data_Maybe.Just("u"))))(draw(Concur_VDom_GeometryRender.renderRightAngle)(Data_Geometry_Plane.rightangle(Data_Geometry_Plane.vector(a)(b))(a)(Data_Geometry_Plane.vector(a)(v[0]))(15.0)))))))))))))(function () {
                                                                          return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                      });
                                                                  });
                                                              });
                              ...
                              throw new Error("Failed pattern match at Main (line 90, column 7 - line 91, column 52): " + [ v5.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 89, column 7 - line 89, column 63): " + [ v4.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 87, column 7 - line 87, column 59): " + [ v3.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main (line 86, column 7 - line 86, column 28): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 84, column 7 - line 84, column 65): " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 81, column 7 - line 81, column 43): " + [ v.constructor.name ]);
      }));
  };
