...
(function($PS) {
  ...
  var interLineLine = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Concur.VDom.SVG.Geometry (line 176, column 8 - line 179, column 65): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
  ...
  var interLineCircle = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Concur.VDom.SVG.Geometry (line 196, column 10 - line 202, column 55): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var renderHalfLine = new Render(function (v) {
      return function (v1) {
          var far = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.origin)(Concur_VDom_SVG_Geometry.scale(10.0)(v1.direction));
          return [ line(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1.origin))(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1.origin))(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(far))(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(far))(v.stroke)(v.strokeWidth) ];
      };
  });
  var renderLine = new Render(function (ctx) {
      return function (l) {
          var v = Concur_VDom_SVG_Geometry.aVectorOfLine(l);
          var m = Concur_VDom_SVG_Geometry.aPointOnLine(l);
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render$prime(renderHalfLine)(ctx)(Concur_VDom_SVG_Geometry.halfline(m)(v)))(render$prime(renderHalfLine)(ctx)(Concur_VDom_SVG_Geometry.halfline(m)(Concur_VDom_SVG_Geometry.scale(-1.0)(v))));
      };
  });
  ...
  var renderArc = new Render(function (v) {
      return function (v1) {
          var v2 = Concur_VDom_SVG_Geometry.scale(v1.radius / Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(v1.extremity))(v1.extremity);
          var u = Concur_VDom_SVG_Geometry.scale(v1.radius / Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(v1.origin))(v1.origin);
          var pO = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(u);
          var pE = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(v2);
          ...
          var p = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summableVectorVector)(Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summableVectorVector)(Concur_VDom_SVG_Geometry.scale(a3 * d)(v2))(v1.origin))(Concur_VDom_SVG_Geometry.scale(-1.0)(Concur_VDom_SVG_Geometry.projection(v1.extremity)(v1.origin)));
          var n = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(pE)(Concur_VDom_SVG_Geometry.scale(-a3)(p));
          var a2 = (function () {
              if (v1.flipped) {
                  return "0 ";
              };
          ...
          var v3 = arrowTip(Concur_VDom_SVG_Geometry.segment(n)(pE)(Data_Maybe.Nothing.value));
          var uv = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summableVectorVector)(u)(v2);
          var i = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(Concur_VDom_SVG_Geometry.scale((v1.radius * 0.8) / Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(uv))(uv));
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ path(v.stroke)(v.strokeWidth)(v.fill)("M" + (pathCoord(pO) + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 " + (a1 + (a2 + (" " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(pE) - Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(pO)) + (" " + Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(pE) - Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(pO))))))))))))))) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              ...
              return [ text(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(i))(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(i))(v.textFill)(v.fontStyle)(str) ];
          })(v1.asOriented)));
      };
  });
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var KaTeX = $PS["KaTeX"];                
  var mathWidget = Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(KaTeX.equation("\\frac{18}{7}")))(function (ktx) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(KaTeX.inline("x^2")))(function (exp1) {
          return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(KaTeX.inline("x \\times x")))(function (exp2) {
              var ctx = {
                  strokeWidth: 1.0,
              ...
              var a = Concur_VDom_SVG_Geometry.point("A")(310.0)(320.0);
              var b = Concur_VDom_SVG_Geometry.point("B")(100.0)(210.0);
              var c = Concur_VDom_SVG_Geometry.circle(a)(Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(Concur_VDom_SVG_Geometry.vector(a)(b)));
              var n = Concur_VDom_SVG_Geometry.normalTo(Concur_VDom_SVG_Geometry.vector(a)(b));
              var d = Concur_VDom_SVG_Geometry.halfline(a)(n);
              var v = Data_Functor.map(Data_Functor.functorArray)(Concur_VDom_SVG_Geometry.rename("E"))(Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interHalfLineCircle)(d)(c));
              if (v.length === 1) {
                  var eb = Concur_VDom_SVG_Geometry.segment(v[0])(b)(Data_Maybe.Nothing.value);
                  var i = Concur_VDom_SVG_Geometry.middle("I")(eb);
                  var v1 = Data_Functor.map(Data_Functor.functorArray)(Concur_VDom_SVG_Geometry.rename("F"))(Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interCircleHalfLine)(c)(Concur_VDom_SVG_Geometry.halfline(a)(Concur_VDom_SVG_Geometry.vector(b)(a))));
                  if (v1.length === 1) {
                      var g = Concur_VDom_SVG_Geometry.circle(v1[0])(Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(Concur_VDom_SVG_Geometry.vector(i)(v[0])));
                      var v2 = Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interCircleCircle)(g)(c);
                      if (v2.length === 2) {
                          var v3 = Data_Functor.map(Data_Functor.functorArray)(Concur_VDom_SVG_Geometry.rename("H"))(Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interLineLine)(Concur_VDom_SVG_Geometry.line(a)(v[0]))(Concur_VDom_SVG_Geometry.line(i)(v1[0])));
                          if (v3.length === 1) {
                              var v4 = Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interSegmentSegment)(Concur_VDom_SVG_Geometry.segment(b)(v3[0])(Data_Maybe.Nothing.value))(Concur_VDom_SVG_Geometry.segment(v[0])(v1[0])(Data_Maybe.Nothing.value));
                              if (v4.length === 0) {
                                  var v5 = Data_Functor.map(Data_Functor.functorArray)(Concur_VDom_SVG_Geometry.rename("J"))(Concur_VDom_SVG_Geometry.meets(Concur_VDom_SVG_Geometry.interHalfLineSegment)(Concur_VDom_SVG_Geometry.halfline(b)(Concur_VDom_SVG_Geometry.vector(b)(v3[0])))(Concur_VDom_SVG_Geometry.segment(v[0])(v1[0])(Data_Maybe.Nothing.value)));
                                  if (v5.length === 1) {
                                      return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.dangerouslySetInnerHTML(ktx) ])([  ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.dangerouslySetInnerHTML(exp1) ])([  ]), Concur_VDom_DOM["label'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(" signifie ") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.dangerouslySetInnerHTML(exp2) ])([  ]), Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("300"), Concur_VDom_SVG.viewBox("0 0 1000 800") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderSequence(Concur_VDom_SVG_Render.renderPoint))([ a, b, v[0], i, v1[0], v2[0], v2[1], v3[0], v5[0] ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderSequence(Concur_VDom_SVG_Render.renderCircle))([ c, g ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderHalfLine)(d))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderSegment)(eb))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderLine)(Concur_VDom_SVG_Geometry.line(a)(b)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderArc)(Concur_VDom_SVG_Geometry.arc(Concur_VDom_SVG_Geometry.vector(i)(v1[0]))(i)(Concur_VDom_SVG_Geometry.vector(i)(b))(50.0)(false)(false)(true)(new Data_Maybe.Just("\u03b1"))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_SVG_Render.renderSegment)(Concur_VDom_SVG_Geometry.segment(i)(v5[0])(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Concur_VDom_SVG_Render["render'"](Concur_VDom_SVG_Render.renderSegment)({
                                          stroke: ctx.stroke,
                                          fill: ctx.fill,
                                          strokeWidth: 2.0,
                                          fontStyle: ctx.fontStyle,
                                          textFill: ctx.textFill
                                      })(Concur_VDom_SVG_Geometry.segment(i)(v1[0])(new Data_Maybe.Just("u"))))(draw(Concur_VDom_SVG_Render.renderRightAngle)(Concur_VDom_SVG_Geometry.rightangle(Concur_VDom_SVG_Geometry.vector(a)(b))(a)(Concur_VDom_SVG_Geometry.vector(a)(v[0]))(15.0))))))))))) ]);
                                  };
                                  throw new Error("Failed pattern match at Main (line 45, column 7 - line 46, column 52): " + [ v5.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Main (line 44, column 7 - line 44, column 63): " + [ v4.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 42, column 7 - line 42, column 59): " + [ v3.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 41, column 7 - line 41, column 28): " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main (line 39, column 7 - line 39, column 65): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 36, column 7 - line 36, column 43): " + [ v.constructor.name ]);
          });
      });
  });
  var main = Concur_VDom_Run.runWidgetInDom("main")(mathWidget);
