...
(function($PS) {
  ...
  var value = Concur_VDom_Props.prop("value");
  ...
  var onFocus = Concur_VDom_Props.handle("focus");
...
(function($PS) {
  ...
  var timerWidget = function (ms) {
      return Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(ms)))(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)(Data_Unit.unit)(Handles.onClick) ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Cancel") ]));
  };
  var pingPong = Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Control_Monad_Rec_Class.forever(Concur_Core_Types.widgetMonadRec)(Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Ping") ])))(function () {
      return Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pong") ]);
  }))))(function () {
      return Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("This text will never be shown");
  });
  var inputWidget3 = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          focusCount: st.focusCount + 1 | 0,
          currentText: st.currentText
      })(Handles.onFocus), Data_Functor.map(Concur_Core_Props.functorProps)(function ($7) {
          return (function (s) {
              return {
                  currentText: s,
                  focusCount: st.focusCount
              };
          })(Handles.unsafeTargetValue($7));
      })(Handles.onChange) ]))(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(st.currentText + Data_Show.show(Data_Show.showInt)(st.focusCount))))(function (st$prime) {
          return inputWidget3(st$prime);
      });
  };
  var inputWidget2 = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(st.currentText), Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(st.focusCount)), Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          focusCount: st.focusCount + 1 | 0,
          currentText: st.currentText
      })(Handles.onFocus), Data_Functor.map(Concur_Core_Props.functorProps)(function ($8) {
          return (function (s) {
              return {
                  currentText: s,
                  focusCount: st.focusCount
              };
          })(Handles.unsafeTargetValue($8));
      })(Handles.onChange) ]) ]))(function (st$prime) {
          return inputWidget2(st$prime);
      });
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(inputWidget2({
      currentText: "df",
      focusCount: 0
  }));
  var inputWidget1 = Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.map(Concur_Core_Props.functorProps)(function ($9) {
      return Changed.create(Handles.unsafeTargetValue($9));
  })(Handles.onChange), Data_Functor.voidRight(Concur_Core_Props.functorProps)(Focused.value)(Handles.onFocus) ]);
  var helloWidget = Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]))(function (greeting) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(Effect_Console.log("You chose to say " + greeting)))(function () {
          return Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!");
      });
  });
  ...
  })()))))(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Fetching posts from subreddit...")))(function (resp) {
      return Control_MultiAlternative.orr(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap))(Data_Array.singleton))(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)))(resp));
  });
  var counter = function (count) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(count)) ])))(function () {
