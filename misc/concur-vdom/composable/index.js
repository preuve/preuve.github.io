...
(function($PS) {
  ...
  var showGreeting = function (greeting) {
      return Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!"), Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("restart") ])) ]);
  };
  var getGreeting = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Concur_VDom_DOM.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.onClick ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]);
  var hello1 = Control_Bind.bind(Concur_Core_Types.widgetBind)(getGreeting)(function (greeting) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(showGreeting(greeting))(function () {
          return hello1;
      });
  });
  var hello2 = function (prev) {
      return Control_Bind.bindFlipped(Concur_Core_Types.widgetBind)(hello2)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Previous greeting - " + prev), Control_Bind.bind(Concur_Core_Types.widgetBind)(getGreeting)(function (greeting) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(showGreeting(greeting))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(greeting);
          });
      }) ]));
  };
  var helloWithPrev = hello2("");
  var main = Concur_VDom_Run.runWidgetInDom("main")(hello2(""));
  exports["getGreeting"] = getGreeting;
  exports["showGreeting"] = showGreeting;
  exports["hello1"] = hello1;
  exports["hello2"] = hello2;
  exports["helloWithPrev"] = helloWithPrev;
  exports["main"] = main;
})(PS);
PS["Main"].main();