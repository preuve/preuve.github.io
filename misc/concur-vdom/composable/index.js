...
(function($PS) {
  ...
  var hello2 = function (prev) {
      return Control_Bind.bindFlipped(Concur_Core_Types.widgetBind)(hello2)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Previous greeting - " + prev), Control_Bind.bind(Concur_Core_Types.widgetBind)(getGreeting)(function (greeting) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(showGreeting(greeting))(function () {
