...
(function($PS) {
  ...
  var unsafeTextContent = function (ev) {
      return Effect_Unsafe.unsafePerformEffect(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(""))(Web_DOM_Node.textContent)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($0) {
          return Data_Maybe.Just.create(Web_DOM_Element.toNode($0));
      })(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_DOM_Element.fromEventTarget)(Web_Event_Event.target(ev)))));
  };
  var prop = function (s) {
      return function (v) {
  ...
  exports["unsafeTextContent"] = unsafeTextContent;
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var KaTeX = $PS["KaTeX"];                
  var katexWidget = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(KaTeX.equation(st.text)))(function (ktx) {
          return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("contenteditable")("true"), Concur_VDom_Props.attr("spellcheck")("false"), Data_Functor.map(Concur_Core_Props.functorProps)(function ($1) {
              return (function (txt) {
                  return {
                      text: txt
                  };
              })(Concur_VDom_Props.unsafeTextContent($1));
          })(Concur_VDom_Props.onChange) ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Click me, then edit \\LaTeX") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.dangerouslySetInnerHTML(ktx) ])([  ]) ]))(function (st$prime) {
              return katexWidget(st$prime);
          });
      });
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(katexWidget({
      text: "Click it, then edit \\LaTeX"
  }));
  exports["katexWidget"] = katexWidget;
  exports["main"] = main;
})(PS);
PS["Main"].main();