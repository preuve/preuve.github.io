...
(function($PS) {
  ...
  var dangerouslySetInnerHTML = Concur_VDom_Props.prop("innerHTML");
  var attr = function (s) {
      return function (v) {
...
(function($PS) {
  ...
  var katexWidget = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(KaTeX.equation(st.text)))(function (ktx) {
          return Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.attr("contenteditable")("true"), Handles.attr("spellcheck")("false"), Data_Functor.map(Concur_Core_Props.functorProps)(function ($1) {
              return (function (txt) {
                  return {
                      text: txt
                  };
              })(Handles.unsafeTextContent($1));
          })(Handles.onChange) ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Click me, then edit \\LaTeX") ]), Nodes.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.dangerouslySetInnerHTML(ktx) ])([  ]) ]))(function (st$prime) {
