...
(function($PS) {
  ...
  var makeLine = function (v) {
      return function (v1) {
          return Concur_VDom_SVG.line(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x1")(v.value0), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("x2")(v1.value0), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y1")(v.value1), Concur_VDom_SVG.unsafeMkProp(Data_Show.showInt)("y2")(v1.value1), Concur_VDom_SVG.stroke("#000000"), Concur_VDom_SVG.strokeWidth(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value0)(10)) ])([  ]);
      };
  };
  var makeShape = function (model) {
      var y_ = model.lastPosition.value1 + squareSide | 0;
      var x_ = model.lastPosition.value0 + squareSide | 0;
      var _y = model.lastPosition.value1 - squareSide | 0;
      var _x = model.lastPosition.value0 - squareSide | 0;
      if (model.pressed) {
          return [ makeLine(new Data_Tuple.Tuple(_x, _y))(new Data_Tuple.Tuple(_x, y_)), makeLine(new Data_Tuple.Tuple(_x, y_))(new Data_Tuple.Tuple(x_, y_)), makeLine(new Data_Tuple.Tuple(x_, y_))(new Data_Tuple.Tuple(x_, _y)), makeLine(new Data_Tuple.Tuple(x_, _y))(new Data_Tuple.Tuple(_x, _y)) ];
      };
      return [ makeLine(new Data_Tuple.Tuple(_x, _y))(new Data_Tuple.Tuple(_x, y_)), makeLine(new Data_Tuple.Tuple(_x, y_))(new Data_Tuple.Tuple(model.lastPosition.value0, model.lastPosition.value1)), makeLine(new Data_Tuple.Tuple(model.lastPosition.value0, model.lastPosition.value1))(new Data_Tuple.Tuple(_x, _y)) ];
  };
  var modelWidget = function (model) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("500"), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
          return {
      ...
      })(Handles.onMouseMove), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
          return {
              pressed: Data_Maybe.maybe(model.pressed)(Data_Function["const"](true))(Web_UIEvent_MouseEvent.fromEvent(ev)),
              lastPosition: model.lastPosition
          };
      })(Handles.onMouseDown), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
          return {
              pressed: Data_Maybe.maybe(model.pressed)(Data_Function["const"](false))(Web_UIEvent_MouseEvent.fromEvent(ev)),
              lastPosition: model.lastPosition
          };
