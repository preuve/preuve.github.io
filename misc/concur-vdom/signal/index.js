...
(function($PS) {
  ...
  var div_ = function (dictShiftMap) {
      return Concur_VDom_DOM.node_("div")(dictShiftMap);
  };
...
(function($PS) {
  ...
  var Nodes = $PS["Nodes"];                
  var textSignal = Concur_Core_FRP.display(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Hello Sailor!"));
  ...
  var hello = function (s) {
      return Concur_Core_FRP.step(s)(Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Hello")(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Hello") ])), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)("Namaste")(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Say Namaste") ])) ]))(function (greeting) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Data_Functor["void"](Concur_Core_Types.widgetFunctor)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(greeting + " Sailor!"))(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("restart") ]))))(function () {
  ...
  var counterSignal = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (n) {
          return Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(n + 1 | 0)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("+") ])), Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(n)) ]), Data_Functor.voidRight(Concur_Core_Types.widgetFunctor)(n - 1 | 0)(Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles.onClick ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("-") ])) ]);
      });
  };
  var counterWidget = Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(0)(function (n) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(n))))(function () {
