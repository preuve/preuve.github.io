...
(function($PS) {
  ...
  var pre = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return node$prime("pre")(dictMultiAlternative)(dictShiftMap);
      };
  };
  exports["text"] = text;
...
(function($PS) {
  ...
  var warnings = function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (o) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonJson)(o)("warnings"))(function (trans) {
              return Data_Either.Right.create(Data_Argonaut_Core.stringify(trans));
          });
      });
  };
  var js = function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (o) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(o)("js"))(function (trans) {
              return new Data_Either.Right(trans);
          });
      });
  };
  var code = "\x0amodule Main where\x0a\x0aimport Prelude\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = pure unit\x0a\x0a";
  var fetchWidget = function (f) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.post(Affjax_ResponseFormat.json)("https://compile.purescript.org/compile")(new Data_Maybe.Just(Affjax_RequestBody.string(code))))(Data_Either.either(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)("invalid response")))((function () {
          var $1 = Data_Either.either(Data_Function["const"](Control_Applicative.pure(Effect_Aff.applicativeAff)("invalid structure")))(Control_Applicative.pure(Effect_Aff.applicativeAff));
          return function ($2) {
              return $1(f((function (v) {
                  return v.body;
              })($2)));
          };
      })()))))(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Submitting code to api...")))(function (resp) {
          return Concur_VDom_DOM.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Array.singleton(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(resp)));
      });
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(fetchWidget(js));
  exports["js"] = js;
