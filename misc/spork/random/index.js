...
(function($PS) {
  ...
  var GenerateRandom = (function () {
      function GenerateRandom(value0) {
          this.value0 = value0;
      };
      GenerateRandom.create = function (value0) {
          return new GenerateRandom(value0);
      };
  ...
  var NewFace = (function () {
      function NewFace(value0) {
          this.value0 = value0;
      };
      NewFace.create = function (value0) {
          return new NewFace(value0);
      };
      return NewFace;
  })();
  var update = function (model) {
      return function (msg) {
          if (msg instanceof Roll) {
              return {
                  model: model,
                  effects: Spork_Batch.lift(new GenerateRandom(NewFace.create))
              };
          };
          if (msg instanceof NewFace) {
              return Spork_Transition.purely({
                  dieFace: msg.value0
              });
          };
          throw new Error("Failed pattern match at Main (line 37, column 5 - line 42, column 53): " + [ msg.constructor.name ]);
      };
  };
  var runEffect = function (effect) {
      return function __do() {
          var v = Effect_Random.randomInt(1)(6)();
          return effect.value0(v);
      };
  };
  var render = function (model) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.h1([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showInt)(model.dieFace)) ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Roll.value))) ])([ Spork_Html_Core.text("Roll") ]) ]);
  };
  ...
  var main = function __do() {
      var v = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.liftNat(Effect.monadEffect)(runEffect))(Spork_Interpreter.never(Effect.monadEffect)))(app)("#app")();
      return v.run();
  };
  exports["Roll"] = Roll;
  exports["NewFace"] = NewFace;
