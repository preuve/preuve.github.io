...
(function($PS) {
  ...
  var render = function (s) {
      ...
      return Spork_Html_Core.elemWithNS(ns)("svg")([ Spork_Html_Core.attr("width")("100%"), Spork_Html_Core.attr("height")("100%"), Spork_Html_Events.onMouseDown(function (mouseev) {
          return Data_Maybe.Just.create(new Update(Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(mouseev)), Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(mouseev))));
      }) ])([ Spork_Html_Core.elemWithNS(ns)("circle")([ Spork_Html_Core.attr("cx")(Data_Show.show(Data_Show.showNumber)(s.x)), Spork_Html_Core.attr("cy")(Data_Show.show(Data_Show.showNumber)(s.y)), Spork_Html_Core.attr("r")("2"), Spork_Html_Core.attr("fill")("red") ])([  ]) ]);
  };
  var app = {
      update: update,
      render: render,
