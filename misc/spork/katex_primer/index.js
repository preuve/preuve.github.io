...
(function($PS) {
  ...
  var h4 = Spork_Html_Core.elem("h4");
...
(function($PS) {
      ...
      return function (v) {
          ...
          if (v instanceof RenderElement) {
              var effects = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 36, column 17 - line 38, column 30): " + [ v.value1.constructor.name ]);
              })();
              return {
                  model: model,
                  effects: effects
          ...
          throw new Error("Failed pattern match at Main (line 30, column 16 - line 40, column 25): " + [ v.constructor.name ]);
      };
  };
  ...
  var content = (function () {
      var t = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(str) ]));
      };
      var subsubsection = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.h4([  ])([ Spork_Html_Core.text(str) ]));
      };
      var subsection = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.h3([  ])([ Spork_Html_Core.text(str) ]));
      };
      var setTitle = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.h1([  ])([ Spork_Html_Core.text(str) ]));
      };
      var section = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.h2([  ])([ Spork_Html_Core.text(str) ]));
      };
      var nl = SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.br([  ]));
      var m = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(RenderElement.create(str))) ])([  ]));
      };
      var equation = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.label([ Spork_Html_Properties.style("display: block; text-align: center;"), Spork_Html_Core.ref(Spork_Html_Events.always(RenderElement.create(str))) ])([ Spork_Html_Core.text(str) ]));
      };
      var em = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.em([  ])([ Spork_Html_Core.text(str) ]));
      };
      var b = function (str) {
          return SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.b([  ])([ Spork_Html_Core.text(str) ]));
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(setTitle("Essai n\xb01: "))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(section("Formule des sinus: "))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\frac{\\sin(\\bar{A})}{a} = \\frac{\\sin(\\bar{B})}{b} = \\frac{\\sin(\\bar{C})}{c}"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(t(" o\xf9 "))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("A"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(t(" est un "))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(b("angle."))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(nl)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(t("And "))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(em("now, "))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\pi"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(t("."))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(subsection("Interlude"))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(subsection("musical"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(subsubsection("symphonique"))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(equation("(a+b)^2=a^2+2ab+b^2"))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.ul([  ])([ Spork_Html_Elements.li([  ])([ Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(RenderElement.create("\\pm"))) ])([  ]) ]), Spork_Html_Elements.li([  ])([ Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(RenderElement.create("\\int"))) ])([  ]) ]) ])))(function () {
  ...
  var render = function (model) {
      return Spork_Html_Elements.div([  ])(SporKaTeX.fromSeq(content));
  };
  var app = {
      render: render,
      update: update,
  ...
  var main = function __do() {
      var v = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.liftNat(Effect.monadEffect)(SporKaTeX.runRenderEffect))(Spork_Interpreter.never(Effect.monadEffect)))(app)("#app")();
      return v.run();
  };
