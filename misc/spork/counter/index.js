...
(function($PS) {
  ...
  var update = function (i) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 16, column 12 - line 18, column 14): " + [ v.constructor.name ]);
      };
  };
  var render = function (i) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Inc.value)) ])([ Spork_Html_Core.text("+") ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Dec.value)) ])([ Spork_Html_Core.text("-") ]), Spork_Html_Elements.span([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showInt)(i)) ]) ]);
  };
  var app = {
      update: update,
      render: render,
