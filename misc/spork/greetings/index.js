...
(function($PS) {
  ...
  var render = function (state) {
      var hello = (function () {
          var $2 = state.name === "";
          if ($2) {
              return Spork_Html_Elements.p([  ])([  ]);
          };
          return Spork_Html_Elements.p([  ])([ Spork_Html_Core.text("Hello " + state.name) ]);
      })();
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.p([  ])([ Spork_Html_Core.text("What is your name?") ]), Spork_Html_Elements.input([ Spork_Html_Properties.type_(Spork_Html_Core.inputTypeToPropValue)(DOM_HTML_Indexed_InputType.InputText.value), Spork_Html_Events.onValueInput(function ($7) {
          return Data_Maybe.Just.create(UpdateName.create($7));
      }) ]), hello ]);
  };
  var initialState = {
      name: ""
