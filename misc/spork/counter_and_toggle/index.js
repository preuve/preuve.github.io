...
(function($PS) {
  ...
  var text = function ($10) {
      return Html(Halogen_VDom_Types.Text.create($10));
  }; 
  var on = function (ty) {
      var $20 = Halogen_VDom_DOM_Prop.Handler.create(ty);
      return function ($21) {
          return IProp($20($21));
      };
  };
              ...
              return function (el) {
                  return Spork_EventQueue.withAccum(Effect.applicativeEffect)(function (self) {
                      return function __do() {
                          ...
                          var update = function (v1) {
                              return function (v2) {
                                  ...
                                  if (v2 instanceof Render) {
                                      return function __do() {
                                          var vdom = Halogen_VDom_Machine.step(v1.vdom, Data_Newtype.unwrap()(app.render(v1.model)));
                                          return {
                                              vdom: vdom,
                          ...
                          var vdomSpec = {
                              document: document,
                              buildWidget: Halogen_VDom_Thunk.buildThunk(Data_Newtype.unwrap()),
                          ...
                          var vdom = Halogen_VDom_DOM.buildVDom(vdomSpec)(Data_Newtype.unwrap()(app.render(app.init.model)));
