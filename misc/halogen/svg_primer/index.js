...
(function($PS) {
  ...
  var render = function (state) {
      return Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(400.0)(400.0), Halogen_Svg_Attributes.width(400.0), Halogen_Svg_Attributes.height(400.0), Halogen_HTML_Events.onMouseDown(function (mouseev) {
          return UpdateRadius.value;
      }) ])([ Halogen_Svg_Elements.circle([ Halogen_Svg_Attributes.cx(50.0), Halogen_Svg_Attributes.cy(50.0), Halogen_Svg_Attributes.r(state.radius), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(255, 0, 0))), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))) ]), Halogen_Svg_Elements.rect([ Halogen_Svg_Attributes.x(100.0), Halogen_Svg_Attributes.y(10.0), Halogen_Svg_Attributes.width(40.0), Halogen_Svg_Attributes.height(40.0), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 120, 0))), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))) ]), Halogen_Svg_Elements.line([ Halogen_Svg_Attributes.x1(20.0), Halogen_Svg_Attributes.y1(200.0), Halogen_Svg_Attributes.x2(200.0), Halogen_Svg_Attributes.y2(20.0), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 255))), Halogen_Svg_Attributes.strokeWidth(10.0) ]), Halogen_Svg_Elements.path([ Halogen_Svg_Attributes.d([ Halogen_Svg_Attributes.m(Halogen_Svg_Attributes.Abs.value)(200.0)(40.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(240.0)(40.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(240.0)(80.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(280.0)(80.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(280.0)(120.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(320.0)(120.0), Halogen_Svg_Attributes.l(Halogen_Svg_Attributes.Abs.value)(320.0)(160.0) ]), Halogen_Svg_Attributes.fill(Data_Maybe.Nothing.value), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(255, 0, 0))) ]), Halogen_Svg_Elements.text([ Halogen_Svg_Attributes.x(130.0), Halogen_Svg_Attributes.y(130.0), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))), Halogen_Svg_Attributes.text_anchor(Halogen_Svg_Attributes.AnchorMiddle.value), Halogen_Svg_Attributes.dominant_baseline(Halogen_Svg_Attributes.Central.value), Halogen_Svg_Attributes.transform([ new Halogen_Svg_Attributes.Rotate(-45.0, 130.0, 130.0) ]) ])([ Halogen_HTML_Core.text("Welcome to Shapes Club") ]) ]);
  };
  ...
  var handleAction = function (dictMonad) {
      return function (v) {
  ...
  var page = function (dictMonad) {
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              handleAction: handleAction(dictMonad),
