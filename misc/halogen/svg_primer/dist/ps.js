...
(function($PS) {
  ...
  var UpdatePos = (function () {
      function UpdatePos(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdatePos.create = function (value0) {
          return function (value1) {
              return new UpdatePos(value0, value1);
          };
      };
      return UpdatePos;
  })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.element("svg")([ Halogen_HTML_Properties.attr("xmlns")("http://www.w3.org/2000/svg"), Halogen_HTML_Properties.prop(Halogen_HTML_Core.isPropString)("style")("position: absolute; width:100%; height:100%;"), Halogen_HTML_Events.onMouseDown(function (mouseev) {
          return Data_Maybe.Just.create(new UpdatePos(Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(mouseev)), Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(mouseev))));
      }) ])([ Halogen_HTML_Elements.element("path")([ Halogen_HTML_Properties.attr("d")("M " + (Data_Show.show(Data_Show.showNumber)(state.x - radius) + (" " + (Data_Show.show(Data_Show.showNumber)(state.y - radius) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(radius) + (" " + (Data_Show.show(Data_Show.showNumber)(radius) + (" " + ("0 1 0 " + (Data_Show.show(Data_Show.showNumber)(2.0 * radius) + " 0")))))))))))), Halogen_HTML_Properties.attr("style")("stroke: #00F; fill: #F00;") ])([  ]), Halogen_HTML_Elements.element("path")([ Halogen_HTML_Properties.attr("d")("M " + (Data_Show.show(Data_Show.showNumber)(state.x - radius) + (" " + (Data_Show.show(Data_Show.showNumber)(state.y - radius) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(radius) + (" " + (Data_Show.show(Data_Show.showNumber)(radius) + (" " + ("0 1 1 " + (Data_Show.show(Data_Show.showNumber)(2.0 * radius) + " 0")))))))))))), Halogen_HTML_Properties.attr("style")("stroke: #00F; fill: #F00;") ])([  ]) ]);
  };
  var initialState = {
      x: 100.0,
      y: 100.0
