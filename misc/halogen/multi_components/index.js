...
(function($PS) {
  ...
  var render = function (v) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.message), Halogen_HTML_Events.onValueChange(function ($29) {
          return Data_Maybe.Just.create(UpdateMessage.create($29));
  ...
  var handleQuery = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          $18.received = Data_Array.snoc(st.received)(v.value0);
          return $18;
      }))(function () {
