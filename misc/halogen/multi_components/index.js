...
(function($PS) {
  ...
  var render = function (v) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.message), Halogen_HTML_Events.onValueChange(UpdateMessage.create) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](SubmitMessage.value)) ])([ Halogen_HTML_Core.text("Send") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderReceived)(v.received)), Halogen_HTML_Elements.hr_ ]);
  };
  ...
  var handleQuery = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          ...
          $17.received = Data_Array.snoc(st.received)(v.value0);
          return $17;
      }))(function () {
      ...
      if (v instanceof SubmitMessage) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(new UpdateMessage("")))(function () {
                  return Halogen_Query_HalogenM.raise(SendMessage.create(new Post(state.message, state.id)));
              });
          });
      };
      throw new Error("Failed pattern match at Child (line 51, column 1 - line 51, column 78): " + [ v.constructor.name ]);
  };
      ...
      var send = function (id$prime) {
          ...
          if (Data_Boolean.otherwise) {
              return Halogen_Query.tell()(new Data_Symbol.IsSymbol(function () {
                  return "child";
              }))(Data_Ord.ordInt)(_child)(id$prime)(Child.ReceiveMessage.create(v.value0.value0));
          };
          throw new Error("Failed pattern match at Parent (line 37, column 7 - line 41, column 48): " + [ id$prime.constructor.name ]);
      };
