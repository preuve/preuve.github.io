...
(function($PS) {
  ...
  var localStorage = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.bind(Hooks_UseLocalStorage.useLocalStorage(dictMonadEffect)(Data_Eq.eqInt)({
                  defaultValue: 0,
                  fromJson: function (str) {
                      return Data_Either.either(Data_Function["const"](0))(Control_Category.identity(Control_Category.categoryFn))(Simple_JSON.readJSON(Simple_JSON.readInt)(str));
                  },
                  toJson: Simple_JSON.writeJSON(Simple_JSON.writeForeignInt),
                  key: "intStorageExample"
              }))(function (v2) {
                  var increment = v2.value1(function (v3) {
                      return v3 + 1 | 0;
                  });
                  var clearCount = v2.value1(function (v3) {
                      return 0;
                  });
                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Click on the button to clear from local storage"), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v3) {
                      return clearCount;
                  }) ])([ Halogen_HTML_Core.text("Clear") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("You have " + (Data_Show.show(Data_Show.showInt)(v2.value0) + " at the intStorageExample key in local storage.")), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v3) {
                      return increment;
