          ...
          return function (v) {
              var useWriteStorage = function (deps) {
                  return Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "value";
                  }))(Data_Either.eqEither(Data_List_Types.eqNonEmptyList(Foreign.eqForeignError))(dictEq)))()(new Data_Symbol.IsSymbol(function () {
                      return "key";
                      ...
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Either.foldableEither)(deps.value)(function (v1) {
                          return Web_Storage_Storage.setItem(deps.key)(v.toJson(v1))(storage);
                      })();
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                  }));
              };
              return Halogen_Hooks.wrap(newtypeUseLocalStorage)(Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(new Data_Either.Right(v.defaultValue)))(function (v1) {
...
(function($PS) {
  ...
  var localStorage = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Hooks_UseLocalStorage.useLocalStorage(dictMonadEffect)(Data_Eq.eqInt)({
                  defaultValue: 0,
                  fromJson: Simple_JSON.readJSON(Simple_JSON.readInt),
                  toJson: Simple_JSON.writeJSON(Simple_JSON.writeForeignInt),
                  key: "intStorageExample"
              }))(function (v2) {
                  var increment = v2.value1(Data_Lens_Setter.over(Data_Lens_Prism_Either["_Right"](Data_Profunctor_Choice.choiceFn))(function (v3) {
                      return v3 + 1 | 0;
                  }));
                  var clearCount = v2.value1(function (v3) {
                      return new Data_Either.Right(0);
                  });
                  return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Click on the button to clear from local storage"), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v3) {
                      return new Data_Maybe.Just(clearCount);
                  }) ])([ Halogen_HTML_Core.text("Clear") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("You have " + (Data_Either.either(function (v3) {
                      return Data_Show.show(Data_Show.showString)("error");
                  })(Data_Show.show(Data_Show.showInt))(v2.value0) + " at the intStorageExample key in local storage.")), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v3) {
                      return new Data_Maybe.Just(increment);
                  }) ])([ Halogen_HTML_Core.text("Increment") ]) ]));
              });
          };
      });
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(localStorage(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
