...
(function($PS) {
  ...
  var renderNextButton = function (action) {
      return Halogen_HTML_Elements.button((function () {
          ...
          if (action instanceof Data_Maybe.Just) {
              return [ Halogen_HTML_Events.onClick(Data_Function["const"](action.value0)) ];
          };
          throw new Error("Failed pattern match at Main (line 84, column 5 - line 86, column 53): " + [ action.constructor.name ]);
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 60, column 1 - line 60, column 75): " + [ v.constructor.name ]);
  };
  ...
  var render = function (v) {
      if (v.stage instanceof AskName) {
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(UpdateName.create(v.stage.value0)) ]), renderNextButton(Data_Functor.map(Data_Maybe.functorMaybe)(makeNextStage)(v.stage.value0.name)) ]);
      };
      if (v.stage instanceof AskPlanet) {
          ...
          var makeButton = function (planet) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.checked(Data_Eq.eq(Data_Maybe.eqMaybe(eqPlanet))(v.stage.value0.planet)(new Data_Maybe.Just(planet))), Halogen_HTML_Events.onChecked(Data_Function["const"](new SetPlanet(v.stage.value0, planet))) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(Data_Show.show(showPlanet)(planet)) ]) ]);
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("So " + (v.stage.value0.name + ", what planet do you hail from?")) ]), makeButton(Mars.value), makeButton(Neptune.value), makeButton(Uranus.value), renderNextButton(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(makeNextStage)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.stage.value0.name)))(v.stage.value0.planet)) ]);
      };
      if (v.stage instanceof Greet) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Greetings " + (v.stage.value0.name + (" from " + Data_Show.show(showPlanet)(v.stage.value0.planet)))) ]);
      };
      throw new Error("Failed pattern match at Main (line 90, column 1 - line 90, column 57): " + [ v.constructor.name ]);
  };
