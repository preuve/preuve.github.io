...
(function($PS) {
  ...
  var page = function (dictMonadAff) {
      var useTick = function (countId) {
          return function (v) {
              return Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "tick";
              }))(Data_Eq.eqInt)))(v)(Halogen_Hooks.useTickEffect)(Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(new Data_Maybe.Just(Halogen_Hooks_HookM.put(countId)(v.tick))));
          };
      };
          ...
          return function (v1) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(0))(function (v2) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(0))(function (v3) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v4) {
                          return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(v4.emitter))(function (subId) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.notify(v4.listener)(Data_Functor["void"](Halogen_Hooks_HookM.functorHookM)(Halogen_Hooks_HookM.fork(Control_Monad_Rec_Class.forever(Halogen_Hooks_HookM.monadRecHookM)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Data_Functor["void"](Halogen_Hooks_HookM.functorHookM)(Effect_Aff_Class.liftAff(Halogen_Hooks_HookM.monadAffHookM(dictMonadAff))(Effect_Aff.delay(500.0))))(function () {
                                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.get(v3.value1))(function (t) {
                                      return Halogen_Hooks_HookM.put(v3.value1)(t + 1 | 0);
                                  });
                              })))))))(function () {
                          ...
                          return Halogen_Hooks_Hook.discard(useTick(v2.value1)({
                              tick: v3.value0
                          }))(function () {
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("minimal component") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("can have multiple tags") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](Halogen_Hooks_HookM.modify_(v2.value1)(function (v4) {
                                  return v4 + 1 | 0;
                              }))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v2.value0)) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v3.value0)) ]) ]));
                          });
                      });
                  });
              });
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(page(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)));
  exports["page"] = page;
  exports["main"] = main;
})(PS);
PS["Main"].main();