      ...
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(0))(function (v2) {
                  return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(0))(function (v3) {
                      return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(500.0))(function () {
                              return Halogen_Query_EventSource.emit(emitter)(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.get(v3.value1))(function (t) {
                          ...
                          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("minimal component") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("can have multiple tags") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(Halogen_Hooks_HookM.modify_(v2.value1)(function (v4) {
                              return v4 + 1 | 0;
