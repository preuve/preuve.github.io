...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($9) {
          return Data_Maybe.Just.create(UpdateName.create($9));
      }) ]), hello ]);
  };
  var initialState = {
      name: ""
