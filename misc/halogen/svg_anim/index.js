...
(function($PS) {
  ...
  var printTransform = function (v) {
      if (v instanceof Matrix) {
          return "matrix(" + (Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showNumber))([ v.value0, v.value1, v.value2, v.value3, v.value4, v.value5 ])) + ")");
      };
      if (v instanceof Translate) {
          return "translate(" + (Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showNumber))([ v.value0, v.value1 ])) + ")");
      };
      if (v instanceof Scale) {
          return "scale(" + (Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showNumber))([ v.value0, v.value1 ])) + ")");
      };
      if (v instanceof Rotate) {
          return "rotate(" + (Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showNumber))([ v.value0, v.value1, v.value2 ])) + ")");
      };
      ...
      throw new Error("Failed pattern match at Halogen.Svg.Attributes (line 144, column 18 - line 156, column 31): " + [ v.constructor.name ]);
  };
  var printTextAnchor = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.Svg.Attributes (line 119, column 19 - line 122, column 15): " + [ v.constructor.name ]);
  };                                                       
  var printCommand = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.Svg.Attributes (line 180, column 16 - line 201, column 34): " + [ v.constructor.name ]);
  };
  var printD = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.Svg.Attributes (line 161, column 10 - line 167, column 26): " + [ v.constructor.name ]);
  };
  ...
  var printBaseline = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.Svg.Attributes (line 129, column 17 - line 141, column 39): " + [ v.constructor.name ]);
  }; 
  ...
  var dominant_baseline = (function () {
      var $132 = attr("dominant-baseline");
      return function ($133) {
          return $132(printBaseline($133));
      };
  })();
  var fill = (function () {
      var $136 = attr("fill");
...
(function($PS) {
  ...
  var UpdateRadius = (function () {
      ...
      UpdateRadius.value = new UpdateRadius();
      return UpdateRadius;
  })();
  var Tick1 = (function () {
      function Tick1() {
      ...
      return function (act) {
          return function (period) {
              return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(period))(function () {
                      return Halogen_Query_EventSource.emit(emitter)(act);
                  }))))(function (fiber) {
  ...
  var render = function (state) {
      return Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(400.0)(400.0), Halogen_Svg_Attributes.width(400.0), Halogen_Svg_Attributes.height(400.0), Halogen_HTML_Events.onMouseDown(function (mouseev) {
          return new Data_Maybe.Just(UpdateRadius.value);
      }) ])([ Halogen_Svg_Elements.circle([ Halogen_Svg_Attributes.cx(50.0), Halogen_Svg_Attributes.cy(50.0), Halogen_Svg_Attributes.r(state.radius), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(255, 255, 0))), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))) ]), Halogen_Svg_Elements.rect([ Halogen_Svg_Attributes.x(100.0), Halogen_Svg_Attributes.y(10.0), Halogen_Svg_Attributes.width(40.0), Halogen_Svg_Attributes.height(40.0), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 120, 0))), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))), Halogen_Svg_Attributes.transform([ new Halogen_Svg_Attributes.Rotate((state.angle1 * $$Math.pi) / 180.0, 130.0, 130.0), new Halogen_Svg_Attributes.Rotate((state.angle2 * $$Math.pi) / 180.0, 100.0, 10.0) ]) ]), Halogen_Svg_Elements.line([ Halogen_Svg_Attributes.x1(20.0), Halogen_Svg_Attributes.y1(200.0), Halogen_Svg_Attributes.x2(200.0), Halogen_Svg_Attributes.y2(20.0), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 255))), Halogen_Svg_Attributes.strokeWidth(10.0) ]), Halogen_Svg_Elements.path([ Halogen_Svg_Attributes.d([ new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.M(200.0, 40.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(240.0, 40.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(240.0, 80.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(280.0, 80.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(280.0, 120.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(320.0, 120.0)), new Halogen_Svg_Attributes.Abs(new Halogen_Svg_Attributes.L(320.0, 160.0)) ]), Halogen_Svg_Attributes.fill(Data_Maybe.Nothing.value), Halogen_Svg_Attributes.stroke(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(255, 0, 0))) ]), Halogen_Svg_Elements.text([ Halogen_Svg_Attributes.x(130.0), Halogen_Svg_Attributes.y(130.0), Halogen_Svg_Attributes.fill(Data_Maybe.Just.create(new Halogen_Svg_Attributes.RGB(0, 0, 0))), Halogen_Svg_Attributes.text_anchor(Halogen_Svg_Attributes.AnchorMiddle.value), Halogen_Svg_Attributes.dominant_baseline(Halogen_Svg_Attributes.Central.value), Halogen_Svg_Attributes.transform([ new Halogen_Svg_Attributes.Rotate(-45.0, 130.0, 130.0) ]) ])([ Halogen_HTML_Core.text("Welcome to Shapes Club") ]) ]);
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(timer(dictMonadAff)(Tick1.value)(freq1))))(function () {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(timer(dictMonadAff)(Tick2.value)(freq2)));
              });
          };
          if (v instanceof UpdateRadius) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $9.radius = st.radius + 5.0;
                      return $9;
                  });
              });
          };
          if (v instanceof Tick1) {
          ...
          throw new Error("Failed pattern match at Main (line 75, column 1 - line 77, column 54): " + [ v.constructor.name ]);
      };
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(page(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body));
  }));
  exports["timer"] = timer;
  exports["main"] = main;
  exports["page"] = page;
