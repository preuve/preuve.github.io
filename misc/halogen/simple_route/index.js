...
(function($PS) {
  ...
  var router = function (cb) {
      var matchRoute = function __do() {
          ...
          throw new Error("Failed pattern match at Router (line 25, column 15 - line 27, column 37): " + [ route.constructor.name ]);
      };
      return function __do() {
...
(function($PS) {
  ...
  var _salad = Type_Proxy["Proxy"].value;
  var _roast = Type_Proxy["Proxy"].value;
  var _chips = Type_Proxy["Proxy"].value;
  var renderPane = function (state) {
      return Halogen_HTML_Elements.div_([ (function () {
          ...
          throw new Error("Failed pattern match at Parent (line 65, column 30 - line 68, column 89): " + [ state.currentRoute.constructor.name ]);
      })() ]);
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Router.Roast.value))(Router.getRoute)))(function (current) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Parent.page)(current)(body))(function (io) {
              var changeRoute = function (route) {
                  return Effect_Aff.launchAff_(io.query(Halogen_Query.mkTell(Parent.ChangeRoute.create(route))));
              };
