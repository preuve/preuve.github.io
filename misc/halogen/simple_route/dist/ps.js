...
(function($PS) {
  ...
  var router = function (cb) {
      ...
      return function __do() {
          var v = Web_Event_EventTarget.eventListener(Data_Function["const"](matchRoute))();
          var v1 = Web_HTML.window();
          return Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(v)(false)(Web_HTML_Window.toEventTarget(v1))();
      };
  };
  exports["Roast"] = Roast;
  exports["Chips"] = Chips;
