...
(function($PS) {
  ...
  var seq = Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(Data_Functor.map(Data_Functor.functorArray)(function (n) {
      return "\\f00" + (Data_Show.show(Data_Show.showInt)(n) + "\x0a");
  })(Data_Array.range(0)(9)));
  var styleComponent = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_CSS.stylesheet(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".icon"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
              return CSS_Font.fontSize(CSS_Size.em(6.0));
          })))(function () {
              return CSS_Stylesheet.select(CSS_String.fromString(CSS_Selector.isStringSelector)(".myclass::before"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontFamily([ "Font Awesome 5 Free" ])(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Font.sansSerif)))(function () {
                  return CSS_Stylesheet.key(CSS_Property.valString)(CSS_Property.Key(new CSS_Property.Plain("content")))("'" + (seq + "'"));
              }));
          }))));
      };
  });
  var scriptComponent = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
  ...
  var contentComponent = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("icon myclass") ])([  ]) ]));
      };
  });
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(scriptComponent))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(styleComponent))(function () {
              return drivenBy("body")(contentComponent);
          });
      });
  }));
