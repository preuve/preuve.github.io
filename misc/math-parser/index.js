...
(function($PS) {
  ...
  var typeMismatch = function (l) {
      var $7 = TypeMismatch.create(l);
      return function ($8) {
          return $$throw($7($8));
      };
  };
  var unknownValue = function ($9) {
      return $$throw(UnknownValue.create($9));
  }; 
  var parseError = function ($11) {
      return $$throw(ParseError.create($11));
  };
...
(function($PS) {
  ...
  var Float = (function () {
      function Float(value0) {
          this.value0 = value0;
      };
      Float.create = function (value0) {
          return new Float(value0);
      };
      return Float;
  })();
  var Add = (function () {
  ...
  var $$typeof = function (v) {
      ...
      throw new Error("Failed pattern match at Parser.Syntax (line 53, column 1 - line 53, column 24): " + [ v.constructor.name ]);
  };
  var showUnop = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Parser.Syntax (line 39, column 1 - line 42, column 17): " + [ v.constructor.name ]);
  });
  var showLit = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Parser.Syntax (line 18, column 1 - line 21, column 26): " + [ v.constructor.name ]);
  });
  var showBinop = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Parser.Syntax (line 29, column 1 - line 37, column 19): " + [ v.constructor.name ]);
  });
  var showExpr = new Data_Show.Show(function (v) {
      if (v instanceof Lit) {
          return Data_Show.show(showLit)(v.value0);
      };
      if (v instanceof Var) {
          return v.value0;
      };
      ...
      throw new Error("Failed pattern match at Parser.Syntax (line 23, column 1 - line 27, column 41): " + [ v.constructor.name ]);
  });
  var eqLit = new Data_Eq.Eq(function (x) {
      return function (y) {
...
(function($PS) {
  ...
  var raiseInt = (function () {
      var $108 = Control_Applicative.pure(Data_Either.applicativeEither);
      return function ($109) {
          return $108(Parser_Syntax.Lit.create(Parser_Syntax.Int.create($109)));
      };
  })();
  var raiseFloat = (function () {
      var $110 = Control_Applicative.pure(Data_Either.applicativeEither);
      return function ($111) {
          return $110(Parser_Syntax.Lit.create(Parser_Syntax.Float.create($111)));
      };
  })();
  var raiseBool = (function () {
      var $112 = Control_Applicative.pure(Data_Either.applicativeEither);
      return function ($113) {
          return $112(Parser_Syntax.Lit.create(Parser_Syntax.Bool.create($113)));
      };
  })();
  var powerNumber = new Powerable($$Math.pow);
  var powerInt = new Powerable(Data_Int.pow);
  ...
  var evalUnop = function (env) {
      return function (op) {
          return function (e) {
              if (op instanceof Parser_Syntax.Not) {
                  return evalNot(env)(e);
              };
              if (op instanceof Parser_Syntax.Negate) {
                  return evalNegate(env)(e);
              };
              if (op instanceof Parser_Syntax.Sqrt) {
                  return evalSqrt(env)(e);
              };
              throw new Error("Failed pattern match at Parser.Eval (line 104, column 21 - line 107, column 25): " + [ op.constructor.name ]);
          };
      };
  };
  var evalSqrt = function (env) {
      return function (v) {
          if (v instanceof Parser_Syntax.Lit && v.value0 instanceof Parser_Syntax.Float) {
              return raiseFloat($$Math.sqrt(v.value0.value0));
          };
          if (v instanceof Parser_Syntax.Lit) {
              return Parser_Error.typeMismatch(v.value0)("float");
          };
          return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v))(evalSqrt(env));
      };
  };
  var evalOr = function (env) {
      return function (e1) {
          return function (e2) {
              if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Bool && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Bool))) {
                  return raiseBool(e1.value0.value0 || e2.value0.value0);
              };
              if (e1 instanceof Parser_Syntax.Lit && e1.value0 instanceof Parser_Syntax.Int) {
                  return Parser_Error.typeMismatch(e1.value0)("bool");
              };
              if (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Int) {
                  return Parser_Error.typeMismatch(e2.value0)("bool");
              };
              if (e1 instanceof Parser_Syntax.Lit && e1.value0 instanceof Parser_Syntax.Float) {
                  return Parser_Error.typeMismatch(e1.value0)("bool");
              };
              if (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Float) {
                  return Parser_Error.typeMismatch(e2.value0)("bool");
              };
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e1))(function (e) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e2))(function (e$prime) {
                      return evalOr(env)(e)(e$prime);
                  });
              });
          };
      };
  };
  var evalNot = function (env) {
      return function (v) {
          if (v instanceof Parser_Syntax.Lit && v.value0 instanceof Parser_Syntax.Bool) {
              return raiseBool(!v.value0.value0);
          };
          if (v instanceof Parser_Syntax.Lit) {
              return Parser_Error.typeMismatch(v.value0)("bool");
          };
          return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v))(evalNot(env));
      };
  };
  var evalNegate = function (env) {
      return function (v) {
          if (v instanceof Parser_Syntax.Lit && v.value0 instanceof Parser_Syntax.Int) {
              return raiseInt(-v.value0.value0 | 0);
          };
          if (v instanceof Parser_Syntax.Lit && v.value0 instanceof Parser_Syntax.Float) {
              return raiseFloat(-v.value0.value0);
          };
          if (v instanceof Parser_Syntax.Lit) {
              return Parser_Error.typeMismatch(v.value0)("numeric");
          };
          return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v))(evalNegate(env));
      };
  };
  var evalLess = function (env) {
      return function (e1) {
          return function (e2) {
              if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Int && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Int))) {
                  return raiseBool(e1.value0.value0 < e2.value0.value0);
              };
              if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Float && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Float))) {
                  return raiseBool(e1.value0.value0 < e2.value0.value0);
              };
              if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Bool && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Bool))) {
                  return raiseBool(e1.value0.value0 < e2.value0.value0);
              ...
              if (e1 instanceof Parser_Syntax.Lit && e2 instanceof Parser_Syntax.Lit) {
                  return Parser_Error.typeMismatch(e2.value0)(Parser_Syntax["typeof"](e1.value0));
              };
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e1))(function (e) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e2))(function (e$prime) {
                      return evalLess(env)(e)(e$prime);
                  });
              });
          };
      };
  };
  var evalEql = function (env) {
      return function (e1) {
          return function (e2) {
              if (e1 instanceof Parser_Syntax.Lit && e2 instanceof Parser_Syntax.Lit) {
                  return raiseBool(Data_Eq.eq(Parser_Syntax.eqLit)(e1.value0)(e2.value0));
              };
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e1))(function (e) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e2))(function (e$prime) {
                      return evalEql(env)(e)(e$prime);
                  });
              });
          };
      };
                  ...
                  if (op instanceof Parser_Syntax.Pow) {
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return pow(dictPowerable);
                                  };
                              };
                          };
                      })(env)(e1)(e2);
                  };
                  if (op instanceof Parser_Syntax.Or) {
                      return evalOr(env)(e1)(e2);
                  };
                  if (op instanceof Parser_Syntax.Less) {
                      return evalLess(env)(e1)(e2);
                  };
                  if (op instanceof Parser_Syntax.Eql) {
                      return evalEql(env)(e1)(e2);
                  };
                  throw new Error("Failed pattern match at Parser.Eval (line 45, column 26 - line 53, column 27): " + [ op.constructor.name ]);
              };
          };
      };
  };
  var evalArithBinop = function (op) {
      return function (env) {
          return function (e1) {
              return function (e2) {
                  if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Int && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Int))) {
                      return raiseInt(op(Data_Ring.ringInt)(Data_Semiring.semiringInt)(Data_EuclideanRing.euclideanRingInt)(powerInt)(e1.value0.value0)(e2.value0.value0));
                  };
                  if (e1 instanceof Parser_Syntax.Lit && (e1.value0 instanceof Parser_Syntax.Float && (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Float))) {
                      return raiseFloat(op(Data_Ring.ringNumber)(Data_Semiring.semiringNumber)(Data_EuclideanRing.euclideanRingNumber)(powerNumber)(e1.value0.value0)(e2.value0.value0));
                  };
                  if (e1 instanceof Parser_Syntax.Lit && e1.value0 instanceof Parser_Syntax.Bool) {
                      return Parser_Error.typeMismatch(e1.value0)("numeric");
                  };
                  if (e2 instanceof Parser_Syntax.Lit && e2.value0 instanceof Parser_Syntax.Bool) {
                      return Parser_Error.typeMismatch(e2.value0)("numeric");
                  };
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e1))(function (e) {
                      return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e2))(function (e$prime) {
                          return evalArithBinop(function (dictRing) {
                              return function (dictSemiring) {
                                  return function (dictEuclideanRing) {
                                      return function (dictPowerable) {
                                          return op((dictEuclideanRing.CommutativeRing0()).Ring0())(((dictEuclideanRing.CommutativeRing0()).Ring0()).Semiring0())(dictEuclideanRing)(dictPowerable);
                                      };
                                  };
                              };
                          })(env)(e)(e$prime);
  ...
  var $$eval = function (env) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Parser.Eval (line 25, column 12 - line 33, column 33): " + [ v.constructor.name ]);
      };
  };
  exports["eval"] = $$eval;
})(PS);
...
(function($PS) {
  ...
  var table = [ [ new Text_Parsing_Parser_Expr.Prefix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("~"))(Parser_Syntax.Unop.create(Parser_Syntax.Not.value))), new Text_Parsing_Parser_Expr.Prefix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("-"))(Parser_Syntax.Unop.create(Parser_Syntax.Negate.value))), new Text_Parsing_Parser_Expr.Prefix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("sqrt"))(Parser_Syntax.Unop.create(Parser_Syntax.Sqrt.value))) ], [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("^"))(Parser_Syntax.Binop.create(Parser_Syntax.Pow.value)), Text_Parsing_Parser_Expr.AssocRight.value) ], [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("*"))(Parser_Syntax.Binop.create(Parser_Syntax.Mul.value)), Text_Parsing_Parser_Expr.AssocLeft.value), new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("/"))(Parser_Syntax.Binop.create(Parser_Syntax.Div.value)), Text_Parsing_Parser_Expr.AssocLeft.value) ], [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("+"))(Parser_Syntax.Binop.create(Parser_Syntax.Add.value)), Text_Parsing_Parser_Expr.AssocLeft.value), new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("-"))(Parser_Syntax.Binop.create(Parser_Syntax.Sub.value)), Text_Parsing_Parser_Expr.AssocLeft.value) ], [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("<"))(Parser_Syntax.Binop.create(Parser_Syntax.Less.value)), Text_Parsing_Parser_Expr.AssocRight.value), new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("="))(Parser_Syntax.Binop.create(Parser_Syntax.Eql.value)), Text_Parsing_Parser_Expr.AssocRight.value) ], [ new Text_Parsing_Parser_Expr.Infix(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reservedOp("||"))(Parser_Syntax.Binop.create(Parser_Syntax.Or.value)), Text_Parsing_Parser_Expr.AssocRight.value) ] ];
  var reserved = Parser_Token.token.reserved;
  var parens = Parser_Token.token.parens;
  var $$int = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Int.create)(Parser_Token.token.integer);
  ...
  var $$float = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Float.create)(Parser_Token["token"]["float"]);
  var bool = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("true"))(new Parser_Syntax.Bool(true)))(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("false"))(new Parser_Syntax.Bool(false)));
  var lit = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Lit.create)($$float)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Lit.create)($$int)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Lit.create)(bool));
  var term = function (p) {
  ...
  var def = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(identifier)(function (name) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reservedOp(":="))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expr)(function (t) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Parser_Syntax.Assign(name, t));
          });
      });
  });
  ...
  var cmd = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(def))(evalExpr);
  var parse = function (s) {
      var v = Text_Parsing_Parser.runParser(s)(cmd);
      ...
      throw new Error("Failed pattern match at Parser.Parser (line 81, column 11 - line 83, column 20): " + [ v.constructor.name ]);
  };
  exports["parse"] = parse;
})(PS);
(function(exports) {
      ...
      return function (v) {
          ...
          if (v instanceof SaveRef && v.value0 instanceof Data_Maybe.Just) {
              return Spork_Transition.purely({
                  ref: new Data_Maybe.Just(v.value0.value0),
                  renderedExpression: model.renderedExpression
              });
          };
          ...
          if (v instanceof Render) {
              var rExpr = (function () {
                  var v1 = Parser_Parser.parse(v.value0);
                  if (v1 instanceof Data_Either.Right && v1.value0 instanceof Parser_Syntax.Eval) {
                      var v2 = Parser_Eval["eval"](Data_Map_Internal.empty)(v1.value0.value0);
                      if (v2 instanceof Data_Either.Right) {
                          return Data_Show.show(Parser_Syntax.showExpr)(v2.value0);
                      };
                      return "";
                  };
                  return "";
              ...
              var effects = (function () {
                  if (model.ref instanceof Data_Maybe.Just && model.ref.value0 instanceof Halogen_VDom_DOM_Prop.Created) {
                      return Spork_Batch.lift(new SporKaTeX.RenderEffect(rExpr, model.ref.value0.value0, None.value));
                  };
                  if (model.ref instanceof Data_Maybe.Just && model.ref.value0 instanceof Halogen_VDom_DOM_Prop.Removed) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  if (model.ref instanceof Data_Maybe.Nothing) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  throw new Error("Failed pattern match at Main (line 51, column 17 - line 55, column 26): " + [ model.ref.constructor.name ]);
              })();
              return {
                  model: {
                      renderedExpression: rExpr,
                      ref: model.ref
                  },
                  effects: effects
              };
          };
          throw new Error("Failed pattern match at Main (line 38, column 16 - line 57, column 58): " + [ v.constructor.name ]);
      };
  };
  var initialModel = {
      renderedExpression: "",
      ref: Data_Maybe.Nothing.value
  };
  var content = Spork_Html_Elements.div([  ])([ Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(function ($20) {
      return SaveRef.create(Data_Maybe.Just.create($20));
  })) ])([  ]) ]);
  var command = Spork_Html_Elements.input([ Spork_Html_Properties.autofocus(true), Spork_Html_Events.onValueChange(Spork_Html_Events.always(Render.create)) ]);
  var render = function (model) {
      return Spork_Html_Elements.div([  ])([ content, command ]);
  };
  var app = {
      render: render,
      update: update,
