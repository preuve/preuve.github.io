  ...
  var powerDual = new Powerable(function (v) {
      return function (v1) {
          return new Dual({
              ...
              slope: (v1.value0.slope * $$Math.log(v.value0.height) + (v1.value0.height * v.value0.slope) / v.value0.height) * $$Math.pow(v.value0.height)(v1.value0.height)
          });
      };
  });
...
(function($PS) {
      ...
      return function (v) {
          ...
          if (v instanceof RenderCommand) {
              ...
              var effects = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 69, column 11 - line 72, column 30): " + [ model.texSlot.constructor.name ]);
              })();
              return {
                  model: m,
                  effects: effects
          ...
          throw new Error("Failed pattern match at Main (line 58, column 16 - line 74, column 28): " + [ v.constructor.name ]);
      };
  };
  ...
  var execute = function (model) {
      var v = Parser_Parser.parse(model.command);
      if (v instanceof Data_Either.Right && v.value0 instanceof Parser_Syntax.Eval) {
          var v1 = Parser_Eval["eval"](Data_Map_Internal.insert(Data_Ord.ordString)("x")(liftExprDual(Global.readFloat(model.argument)))(Data_Map_Internal.empty))(v.value0.value0);
  ...
  var content = function (model) {
      var e = execute(model);
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(function ($36) {
          return SaveRef.create(Data_Maybe.Just.create($36));
      })) ])([  ]), Spork_Html_Elements.br([  ]), Spork_Html_Elements.input([ Spork_Html_Events.onValueChange(Spork_Html_Events.always(UpdateArgument.create)) ]), Spork_Html_Elements.br([  ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text((function () {
          if (e instanceof Parser_Syntax.Lit) {
              return Data_Show.show(Data_Show.showNumber)(e.value0.value0.height);
          };
          return "";
      })()) ]), Spork_Html_Elements.br([  ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text((function () {
          if (e instanceof Parser_Syntax.Lit) {
              return Data_Show.show(Data_Show.showNumber)(e.value0.value0.slope);
          };
          return "";
      })()) ]) ]);
  };
  var command = Spork_Html_Elements.input([ Spork_Html_Properties.autofocus(true), Spork_Html_Events.onValueChange(Spork_Html_Events.always(RenderCommand.create)) ]);
  var render = function (model) {
      return Spork_Html_Elements.div([  ])([ command, content(model) ]);
  };
  var app = {
      render: render,
      update: update,
