  ...
  var showExpr = function (dictShow) {
      return new Data_Show.Show(function (v) {
          ...
          if (v instanceof Binop && v.value0 instanceof Pow) {
              return Data_Show.show(showExpr(dictShow))(v.value1) + ("^{" + (Data_Show.show(showExpr(dictShow))(v.value2) + "}"));
          };
          if (v instanceof Binop && v.value0 instanceof Div) {
              return "\\dfrac{" + (Data_Show.show(showExpr(dictShow))(v.value1) + ("}{" + (Data_Show.show(showExpr(dictShow))(v.value2) + "}")));
          };
          if (v instanceof Binop) {
              return "(" + (Data_Show.show(showExpr(dictShow))(v.value1) + (Data_Show.show(showBinop)(v.value0) + (Data_Show.show(showExpr(dictShow))(v.value2) + ")")));
          };
          if (v instanceof Unop && v.value0 instanceof Log) {
              return "\\ln(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Sqrt) {
              return "\\sqrt{" + (Data_Show.show(showExpr(dictShow))(v.value1) + "}");
          };
          if (v instanceof Unop && v.value0 instanceof Exp) {
              return "\\mathrm{e}^{" + (Data_Show.show(showExpr(dictShow))(v.value1) + "}");
          };
          if (v instanceof Unop && v.value0 instanceof Sin) {
              return "\\sin(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Cos) {
              return "\\cos(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Tan) {
              return "\\tan(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Sinh) {
              return "\\sinh(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Cosh) {
              return "\\cosh(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Tanh) {
              return "\\tanh(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Asin) {
              return "\\arcsin(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Acos) {
              return "\\arccos(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Atan) {
              return "\\arctan(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Asinh) {
              return "\\mathrm{arcsinh}(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Acosh) {
              return "\\mathrm{arccosh}(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
          if (v instanceof Unop && v.value0 instanceof Atanh) {
              return "\\mathrm{arctanh}(" + (Data_Show.show(showExpr(dictShow))(v.value1) + ")");
          };
...
(function($PS) {
  ...
  var interLineLine = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at SVGpork.Geometry (line 181, column 8 - line 184, column 65): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
