          ...
          return function (fill) {
              return function (fontStyle) {
                  return function (text) {
                      return Spork_Html_Core.elemWithNS(ns)("text")([ Spork_Html_Core.attr("x")(Data_Show.show(Data_Show.showNumber)(x)), Spork_Html_Core.attr("y")(Data_Show.show(Data_Show.showNumber)(y)), Spork_Html_Core.attr("style")("fill:" + (fill + ("; font:" + (fontStyle + ";")))) ])([  ]);
                  };
              };
          };
      };
...
(function($PS) {
  ...
  var SaveRef = (function () {
      function SaveRef(value0) {
          this.value0 = value0;
      };
      SaveRef.create = function (value0) {
          return new SaveRef(value0);
      };
      return SaveRef;
  })();
  ...
  var UpdateDomain = (function () {
      function UpdateDomain(value0) {
          this.value0 = value0;
      };
      UpdateDomain.create = function (value0) {
          return new UpdateDomain(value0);
      };
      return UpdateDomain;
  })();
  var Send = (function () {
  ...
  var showExt = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 103, column 1 - line 106, column 24): " + [ v.constructor.name ]);
  });
  var showIntrvl = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 108, column 1 - line 112, column 64): " + [ v.constructor.name ]);
  });
                              ...
                              if (v2 instanceof Data_Maybe.Just) {
                                  if (v2.value0.head instanceof Data_Maybe.Just) {
                                      ...
                                      $tco_var_acc = (function () {
                                          var $106 = okY(v.value0.y) && okY(v2.value0.head.value0.y);
                                          if ($106) {
                                  ...
                                  if (v2.value0.head instanceof Data_Maybe.Nothing) {
                                      ...
                                      var $110 = Data_Array.length(ys) === 0;
                                      if ($110) {
                                          $tco_done = true;
                                          return acc;
                                      };
                                  ...
                                  throw new Error("Failed pattern match at Main (line 418, column 11 - line 430, column 74): " + [ v2.value0.head.constructor.name ]);
                              };
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  $tco_done = true;
                                  return acc;
                              };
                              throw new Error("Failed pattern match at Main (line 416, column 6 - line 431, column 21): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 407, column 1 - line 410, column 76): " + [ from.constructor.name, acc.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
  ...
  var update = function (model) {
      return function (v) {
          ...
          if (v instanceof SaveRef && v.value0 instanceof Data_Maybe.Just) {
              return Spork_Transition.purely({
                  texSlot: new Data_Maybe.Just(v.value0.value0),
          ...
          if (v instanceof SaveRef) {
              return Spork_Transition.purely(model);
          };
          if (v instanceof StartDragging) {
              return Spork_Transition.purely({
                  previousX: Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(v.value0)),
                  previousY: Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(v.value0)),
                  isDragged: true,
                  argument: model.argument,
                  command: model.command,
                  displayD: model.displayD,
                  ...
                  message: model.message,
                  numbers: model.numbers,
                  texSlot: model.texSlot,
                  toD: model.toD,
                  toF: model.toF
              });
          };
          if (v instanceof EndDragging) {
              return Spork_Transition.purely({
                  isDragged: false,
                  argument: model.argument,
                  command: model.command,
          ...
          if (v instanceof UpdateArgument) {
              return Spork_Transition.purely((function () {
                  if (model.isDragged) {
                      var y = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(v.value0));
                      var x = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(v.value0));
                      var previous = SVGpork_Geometry.point("")(model.previousX)(model.previousY);
                      var $161 = inBox(model.toF)(previous);
                      if ($161) {
                      ...
                      var $162 = inBox(model.toD)(previous);
                      if ($162) {
          ...
          if (v instanceof RenderCommand) {
              ...
              var effects = (function () {
                  if (model.texSlot instanceof Data_Maybe.Just && model.texSlot.value0 instanceof Halogen_VDom_DOM_Prop.Created) {
                      return Spork_Batch.lift(new SporKaTeX.RenderEffect(transmit(m), model.texSlot.value0.value0, None.value));
                  };
                  if (model.texSlot instanceof Data_Maybe.Just && model.texSlot.value0 instanceof Halogen_VDom_DOM_Prop.Removed) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  if (model.texSlot instanceof Data_Maybe.Nothing) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  throw new Error("Failed pattern match at Main (line 228, column 11 - line 231, column 30): " + [ model.texSlot.constructor.name ]);
              })();
              return {
                  model: m,
                  effects: effects
          ...
          if (v instanceof UpdateDomain) {
              return Spork_Transition.purely((function () {
                  if (v.value0 === "R") {
                      return {
                          domain: [ new OpenOpen(MinusInf.value, PlusInf.value) ],
                          argument: model.argument,
                          command: model.command,
                          displayD: model.displayD,
                          displayT: model.displayT,
                  ...
                  return {
                      domain: Data_Functor.map(Data_Functor.functorArray)(parseIntrvl)(Data_String_Common.split("U")(v.value0)),
                      argument: model.argument,
                      command: model.command,
                      displayD: model.displayD,
                      displayT: model.displayT,
          ...
          throw new Error("Failed pattern match at Main (line 178, column 16 - line 256, column 17): " + [ v.constructor.name ]);
      };
  };
  ...
  var segmentInBox = function (v) {
      return function (v1) {
          var candidates = Data_Array.filter(function ($272) {
              return (function (v2) {
                  return v2 === 1;
              })(Data_Array.length($272));
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 389, column 21 - line 389, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 392, column 20 - line 392, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $187 = Data_Array.length(candidates) === 2;
              if ($187) {
                  ...
                  throw new Error("Failed pattern match at Main (line 396, column 28 - line 396, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 386, column 7 - line 398, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  ...
  var drawableFinal = new SVGpork_Render.Render(function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 265, column 1 - line 283, column 41): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
  ...
  var initialModel = {
      ...
      isDragged: false,
      domain: [  ],
      texSlot: Data_Maybe.Nothing.value,
      message: "",
      fromF: local,
      toF: functionDisplay,
      fromD: local,
      ...
      return function (from) {
          return function (to) {
              return function (v) {
                  ...
                  var $242 = Data_Array.length(zs) === 0;
                  if ($242) {
                      return [  ];
                  };
  ...
  var reframe = function (ctx) {
      return function (v) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(grid(ctx)(v.fromF)(v.toF))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(grid(ctx)(v.fromD)(v.toD))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(plot(ctx)(v.fromF)(v.toF)({
              "function": image(v.command),
              domain: v.domain
          }))((function () {
              if (v.displayD) {
                  return plot(ctx)(v.fromD)(v.toD)({
  ...
  var render = function (model) {
      ...
      return Spork_Html_Elements.div([ Spork_Html_Core.attr("style")("display: grid; grid-template-columns: 3fr 2fr;") ])([ Spork_Html_Core.elemWithNS(Data_Maybe.Just.create("http://www.w3.org/2000/svg"))("svg")([ Spork_Html_Core.attr("width")("800px"), Spork_Html_Core.attr("height")("600px"), Spork_Html_Events.onMouseDown(Spork_Html_Events.always(StartDragging.create)), Spork_Html_Events.onMouseUp(Spork_Html_Events.always_(EndDragging.value)), Spork_Html_Events.onMouseMove(Spork_Html_Events.always(UpdateArgument.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ background, functionBkg, diffBkg ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(page(ctx)(model))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(frame(functionDisplay)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(frame(diffDisplay)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSegment)({
          ...
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(cursor(diffDisplay)))))))), Spork_Html_Elements.div([ Spork_Html_Core.attr("style")("display: grid; grid-template-columns: 1fr 1fr;") ])([ mkButtonEvent("zoomOutX"), mkButtonEvent("zoomInX"), mkButtonEvent("F: zoomOutY"), mkButtonEvent("F: zoomInY"), mkButtonEvent("F': zoomOutY"), mkButtonEvent("F': zoomInY"), mkButtonEvent("show Derivative"), mkButtonEvent("hide Derivative"), mkButtonEvent("show Tangent"), mkButtonEvent("hide Tangent"), mkButtonEvent("mark Coefficient"), functionInput, Spork_Html_Elements.input([ Spork_Html_Events.onValueChange(Spork_Html_Events.always(UpdateDomain.create)) ]), Spork_Html_Elements.label([ Spork_Html_Core.ref(Spork_Html_Events.always(function ($273) {
          return SaveRef.create(Data_Maybe.Just.create($273));
      })) ])([  ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showNumber)(model.argument)) ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showNumber)(image(model.command)(model.argument))) ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showNumber)(diff(model.command)(model.argument))) ]) ]) ]);
  };
  var app = {
      render: render,
      update: update,
