...
(function($PS) {
  ...
  var Real = function (acos, acosh, asin, asinh, atan, atanh, cos, cosh, exp, fromNumber, log, sin, sinh, sqrt, tan, tanh) {
      this.acos = acos;
      this.acosh = acosh;
      this.asin = asin;
      this.asinh = asinh;
  ...
  var showUnop = new Data_Show.Show(function (v) {
      if (v instanceof Negate) {
          return "-";
      };
      if (v instanceof Sqrt) {
          return "{- cumbersome symbol for square root -}";
      };
      if (v instanceof Log) {
          return "{- cumbersome symbol for logarithm -}";
      };
      if (v instanceof Exp) {
          return "{- cumbersome symbol for exponential -}";
      };
      if (v instanceof Sin) {
          return "{- cumbersome symbol for sine -}";
      };
      if (v instanceof Cos) {
          return "{- cumbersome symbol for cosine -}";
      };
      if (v instanceof Tan) {
          return "{- cumbersome symbol for tangent -}";
      };
      if (v instanceof Sinh) {
          return "{- cumbersome symbol for hyperbolic sine -}";
      };
      if (v instanceof Cosh) {
          return "{- cumbersome symbol for hyperbolic cosine -}";
      };
      if (v instanceof Tanh) {
          return "{- cumbersome symbol for hyperbolic tangent -}";
      };
      if (v instanceof Asin) {
          return "{- cumbersome symbol for inverse sine -}";
      };
      if (v instanceof Acos) {
          return "{- cumbersome symbol for inverse cosine -}";
      };
      if (v instanceof Atan) {
          return "{- cumbersome symbol for inverse tangent -}";
      };
      if (v instanceof Asinh) {
          return "{- cumbersome symbol for inverse hyperbolic sine -}";
      };
      if (v instanceof Acosh) {
          return "{- cumbersome symbol for inverse hyperbolic cosine -}";
      };
      if (v instanceof Atanh) {
          return "{- cumbersome symbol for inverse hyperbolic tangent -}";
      };
      throw new Error("Failed pattern match at Parser.Syntax (line 153, column 1 - line 169, column 72): " + [ v.constructor.name ]);
  });
  var showBinop = new Data_Show.Show(function (v) {
      if (v instanceof Add) {
          return " + ";
      };
      if (v instanceof Sub) {
      ...
      if (v instanceof Div) {
          return "{- cumbersome symbol for quotient -}";
      };
      if (v instanceof Pow) {
          return "{- cumbersome symbol for exponent -}";
      };
      throw new Error("Failed pattern match at Parser.Syntax (line 146, column 1 - line 151, column 52): " + [ v.constructor.name ]);
  });
  var showExpr = new Data_Show.Show(function (v) {
      if (v instanceof Lit) {
          return Data_Show.show(Data_Show.showNumber)(v.value0.value0.height);
      };
      if (v instanceof Var) {
          return v.value0;
      };
      if (v instanceof Binop && v.value0 instanceof Pow) {
          return Data_Show.show(showExpr)(v.value1) + ("^{" + (Data_Show.show(showExpr)(v.value2) + "}"));
      };
      if (v instanceof Binop && v.value0 instanceof Div) {
          return "\\dfrac{" + (Data_Show.show(showExpr)(v.value1) + ("}{" + (Data_Show.show(showExpr)(v.value2) + "}")));
      };
      if (v instanceof Binop) {
          return "(" + (Data_Show.show(showExpr)(v.value1) + (Data_Show.show(showBinop)(v.value0) + (Data_Show.show(showExpr)(v.value2) + ")")));
      };
      if (v instanceof Unop && v.value0 instanceof Log) {
          return "\\ln(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Sqrt) {
          return "\\sqrt{" + (Data_Show.show(showExpr)(v.value1) + "}");
      };
      if (v instanceof Unop && v.value0 instanceof Exp) {
          return "\\mathrm{e}^{" + (Data_Show.show(showExpr)(v.value1) + "}");
      };
      if (v instanceof Unop && v.value0 instanceof Sin) {
          return "\\sin(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Cos) {
          return "\\cos(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Tan) {
          return "\\tan(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Sinh) {
          return "\\sinh(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Cosh) {
          return "\\cosh(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Tanh) {
          return "\\tanh(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Asin) {
          return "\\arcsin(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Acos) {
          return "\\arccos(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Atan) {
          return "\\arctan(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Asinh) {
          return "\\mathrm{arcsinh}(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Acosh) {
          return "\\mathrm{arccosh}(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop && v.value0 instanceof Atanh) {
          return "\\mathrm{arctanh}(" + (Data_Show.show(showExpr)(v.value1) + ")");
      };
      if (v instanceof Unop) {
          return Data_Show.show(showUnop)(v.value0) + Data_Show.show(showExpr)(v.value1);
      };
      throw new Error("Failed pattern match at Parser.Syntax (line 123, column 1 - line 144, column 41): " + [ v.constructor.name ]);
  });
  ...
  exports["Dual"] = Dual;
  exports["Eval"] = Eval;
  exports["semiringDual"] = semiringDual;
  exports["ringDual"] = ringDual;
...
(function($PS) {
  ...
  var raiseDual = (function () {
      var $54 = Control_Applicative.pure(Data_Either.applicativeEither);
      return function ($55) {
          return $54(Parser_Syntax.Lit.create($55));
      };
  })();
  var evalUnop = function (env) {
      return function (op) {
          return function (e) {
              if (op instanceof Parser_Syntax.Negate) {
                  return evalReal(Data_Ring.negate(Parser_Syntax.ringDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Sqrt) {
                  return evalReal(Parser_Syntax.sqrt(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Exp) {
                  return evalReal(Parser_Syntax.exp(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Sin) {
                  return evalReal(Parser_Syntax.sin(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Cos) {
                  return evalReal(Parser_Syntax.cos(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Tan) {
                  return evalReal(Parser_Syntax.tan(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Sinh) {
                  return evalReal(Parser_Syntax.sinh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Cosh) {
                  return evalReal(Parser_Syntax.cosh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Tanh) {
                  return evalReal(Parser_Syntax.tanh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Asin) {
                  return evalReal(Parser_Syntax.asin(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Acos) {
                  return evalReal(Parser_Syntax.acos(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Atan) {
                  return evalReal(Parser_Syntax.atan(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Asinh) {
                  return evalReal(Parser_Syntax.asinh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Acosh) {
                  return evalReal(Parser_Syntax.acosh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Atanh) {
                  return evalReal(Parser_Syntax.atanh(Parser_Syntax.realDual))(env)(e);
              };
              if (op instanceof Parser_Syntax.Log) {
                  return evalReal(Parser_Syntax.log(Parser_Syntax.realDual))(env)(e);
              };
              throw new Error("Failed pattern match at Parser.Eval (line 52, column 21 - line 68, column 28): " + [ op.constructor.name ]);
          };
      };
  };
  var evalReal = function (op) {
      return function (env) {
          return function (v) {
              if (v instanceof Parser_Syntax.Lit) {
                  return raiseDual(op(v.value0));
              };
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v))(evalReal(op)(env));
          };
      };
  };
  var evalBinop = function (env) {
      return function (op) {
          return function (e1) {
              return function (e2) {
                  if (op instanceof Parser_Syntax.Add) {
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return function (dictReal) {
                                          return Data_Semiring.add(((dictEuclideanRing.CommutativeRing0()).Ring0()).Semiring0());
                                      };
                                  };
                              };
                          };
                      ...
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return function (dictReal) {
                                          return Data_Ring.sub((dictEuclideanRing.CommutativeRing0()).Ring0());
                                      };
                                  };
                              };
                          };
                      ...
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return function (dictReal) {
                                          return Data_Semiring.mul(((dictEuclideanRing.CommutativeRing0()).Ring0()).Semiring0());
                                      };
                                  };
                              };
                          };
                      ...
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return function (dictReal) {
                                          return Data_EuclideanRing.div(dictEuclideanRing);
                                      };
                                  };
                              };
                          };
                      ...
                      return evalArithBinop(function (dictRing) {
                          return function (dictSemiring) {
                              return function (dictEuclideanRing) {
                                  return function (dictPowerable) {
                                      return function (dictReal) {
                                          return Parser_Syntax.pow(dictPowerable);
                                      };
                                  };
                              };
                          };
                  ...
                  throw new Error("Failed pattern match at Parser.Eval (line 29, column 26 - line 34, column 38): " + [ op.constructor.name ]);
              };
          };
      };
  };
  var evalArithBinop = function (op) {
      return function (env) {
          return function (e1) {
              return function (e2) {
                  if (e1 instanceof Parser_Syntax.Lit && e2 instanceof Parser_Syntax.Lit) {
                      return raiseDual(op(Parser_Syntax.ringDual)(Parser_Syntax.semiringDual)(Parser_Syntax.euclideanRingDual)(Parser_Syntax.powerDual)(Parser_Syntax.realDual)(e1.value0)(e2.value0));
                  };
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e1))(function (e) {
                      return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(e2))(function (e$prime) {
                          return evalArithBinop(function (dictRing) {
                              return function (dictSemiring) {
                                  return function (dictEuclideanRing) {
                                      return function (dictPowerable) {
                                          return function (dictReal) {
                                              return op((dictEuclideanRing.CommutativeRing0()).Ring0())(((dictEuclideanRing.CommutativeRing0()).Ring0()).Semiring0())(dictEuclideanRing)(dictPowerable)(dictReal);
                                          };
                                      };
                                  };
                              };
  ...
  var $$eval = function (env) {
      return function (v) {
          ...
          if (v instanceof Parser_Syntax.Binop) {
              return evalBinop(env)(v.value0)(v.value1)(v.value2);
          };
          if (v instanceof Parser_Syntax.Unop) {
              return evalUnop(env)(v.value0)(v.value1);
          };
          throw new Error("Failed pattern match at Parser.Eval (line 17, column 12 - line 23, column 33): " + [ v.constructor.name ]);
      };
  };
  exports["eval"] = $$eval;
})(PS);
...
(function($PS) {
  ...
  var pi = Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("pi"))(Parser_Syntax.fromNumber(Parser_Syntax.realDual)($$Math.pi));
  ...
  var dual = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.fromNumber(Parser_Syntax.realDual))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Parser_Token["token"]["float"]))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Int.toNumber)(Parser_Token.token.integer)));
  var lit = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Lit.create)(dual))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Lit.create)(pi));
  var term = function (p) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(p))(lit))($$var);
  };
  var expr = (function () {
  ...
  var evalExpr = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Parser_Syntax.Eval.create)(expr);
  var parse = function (s) {
      var v = Text_Parsing_Parser.runParser(s)(evalExpr);
      ...
      throw new Error("Failed pattern match at Parser.Parser (line 83, column 11 - line 85, column 20): " + [ v.constructor.name ]);
  };
  exports["parse"] = parse;
})(PS);
(function($PS) {
  ...
  var interLineLine = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at SVGpork.Geometry (line 176, column 8 - line 179, column 65): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var renderSequence = function (dictRender) {
      return new Render(function (ctx) {
          return function (arr) {
              return Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray))(Data_Monoid.mempty(Data_Monoid.monoidArray))(Data_Functor.map(Data_Functor.functorArray)(render$prime(dictRender)(ctx))(arr));
          };
      });
  };
  ...
  var renderHalfLine = new Render(function (v) {
      return function (v1) {
          var far = SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(v1.origin)(SVGpork_Geometry.scale(10.0)(v1.direction));
          return [ svgline(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1.origin))(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1.origin))(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(far))(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(far))(v.stroke)(v.strokeWidth) ];
      };
  });
  var renderLine = new Render(function (ctx) {
      return function (l) {
          var v = SVGpork_Geometry.aVectorOfLine(l);
          var m = SVGpork_Geometry.aPointOnLine(l);
          return render$prime(renderSequence(renderHalfLine))(ctx)([ SVGpork_Geometry.halfline(m)(v), SVGpork_Geometry.halfline(m)(SVGpork_Geometry.scale(-1.0)(v)) ]);
      };
  });
...
(function($PS) {
  ...
  var onMouseUp = (function () {
      var $4 = Spork_Html_Core.on("mouseup");
      return function ($5) {
          return $4($5);
      };
  })();
  var onMouseMove = (function () {
      var $10 = Spork_Html_Core.on("mousemove");
      return function ($11) {
          return $10($11);
      };
  })();
...
(function($PS) {
  ...
  var PlusInf = (function () {
      function PlusInf() {

      };
      PlusInf.value = new PlusInf();
      return PlusInf;
  })();
  var MinusInf = (function () {
      function MinusInf() {

      };
      MinusInf.value = new MinusInf();
      return MinusInf;
  })();
  var OpenOpen = (function () {
      function OpenOpen(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OpenOpen.create = function (value0) {
          return function (value1) {
              return new OpenOpen(value0, value1);
          };
      };
      return OpenOpen;
  })();
  var OpenClose = (function () {
      function OpenClose(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OpenClose.create = function (value0) {
          return function (value1) {
              return new OpenClose(value0, value1);
          };
      };
      return OpenClose;
  })();
  var CloseOpen = (function () {
      function CloseOpen(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CloseOpen.create = function (value0) {
          return function (value1) {
              return new CloseOpen(value0, value1);
          };
      };
      return CloseOpen;
  })();
  var CloseClose = (function () {
      function CloseClose(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CloseClose.create = function (value0) {
          return function (value1) {
              return new CloseClose(value0, value1);
          };
      };
      return CloseClose;
  })();
  ...
  var FunctionSlot = (function () {
      function FunctionSlot(value0) {
          this.value0 = value0;
      };
      FunctionSlot.create = function (value0) {
          return new FunctionSlot(value0);
      };
      return FunctionSlot;
  })();
  var DomainSlot = (function () {
      function DomainSlot(value0) {
          this.value0 = value0;
      };
      DomainSlot.create = function (value0) {
          return new DomainSlot(value0);
      };
      return DomainSlot;
  })();
  var UpdateArgument = (function () {
      function UpdateArgument(value0) {
          this.value0 = value0;
      };
      UpdateArgument.create = function (value0) {
          return new UpdateArgument(value0);
      };
      return UpdateArgument;
  })();
  var RenderCommand = (function () {
      function RenderCommand(value0) {
          this.value0 = value0;
      };
      RenderCommand.create = function (value0) {
          return new RenderCommand(value0);
      };
      return RenderCommand;
  })();
  var RenderDomain = (function () {
      function RenderDomain(value0) {
          this.value0 = value0;
      };
      RenderDomain.create = function (value0) {
          return new RenderDomain(value0);
      };
      return RenderDomain;
  })();
  var Send = (function () {
  ...
  var StartDragging = (function () {
      function StartDragging(value0) {
          this.value0 = value0;
      };
      StartDragging.create = function (value0) {
          return new StartDragging(value0);
      };
  ...
  var EndDragging = (function () {
      ...
      EndDragging.value = new EndDragging();
      return EndDragging;
  })();
  var IncreaseDensity = (function () {
      function IncreaseDensity() {

      };
      IncreaseDensity.value = new IncreaseDensity();
      return IncreaseDensity;
  })();
  var DecreaseDensity = (function () {
      function DecreaseDensity() {

      };
      DecreaseDensity.value = new DecreaseDensity();
      return DecreaseDensity;
  })();
  var zoomOutX = "zoomOutX";
  var zoomInX = "zoomInX";
  var white = "#FFFFFF";
  var unused = 0.0;
  var transmit = function (model) {
      var v = Parser_Parser.parse(model.command);
      if (v instanceof Data_Either.Right && v.value0 instanceof Parser_Syntax.Eval) {
          return Data_Show.show(Parser_Syntax.showExpr)(v.value0.value0);
      };
      return "";
  };
  var svgWidth = 800.0;
  var svgHeight = 600.0;
  var window = {
      center: SVGpork_Geometry.point("")(svgWidth / 2.0)(svgHeight / 2.0),
      halfWidth: svgWidth / 2.0,
      halfHeight: svgHeight / 2.0
  };
  var styleCenter = "display: flex; align-items: center; justify-content: center;";
  var showTangent = "show Tangent";
  var showExt = new Data_Show.Show(function (v) {
      if (v instanceof R) {
          return Data_Show.show(Data_Show.showNumber)(v.value0);
      };
      if (v instanceof PlusInf) {
          return "+\\infty";
      };
  ...
  var showIntrvl = new Data_Show.Show(function (v) {
      ...
      if (v instanceof OpenClose) {
          return "]" + (Data_Show.show(showExt)(v.value0) + (";" + (Data_Show.show(showExt)(v.value1) + "]")));
      };
      if (v instanceof CloseOpen) {
          return "[" + (Data_Show.show(showExt)(v.value0) + (";" + (Data_Show.show(showExt)(v.value1) + "[")));
      };
  ...
  var remap = function (v) {
      return function (p) {
          return function (v1) {
              var v2 = SVGpork_Geometry.vector(v.center)(p);
              var x = (SVGpork_Geometry.abs(SVGpork_Geometry.basedVector)(v2) * v1.halfWidth) / v.halfWidth;
              var y = (SVGpork_Geometry.ord(SVGpork_Geometry.basedVector)(v2) * v1.halfHeight) / v.halfHeight;
              return SVGpork_Geometry.point("")(x + SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1.center))(y + SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1.center));
          };
      };
  };
  var rectangle = function (ctx) {
      return function (x) {
          return function (y) {
              return function (dx) {
                  return function (dy) {
                      var tr = SVGpork_Geometry.point("")(x + dx)(y);
                      var tl = SVGpork_Geometry.point("")(x)(y);
                      var br = SVGpork_Geometry.point("")(x + dx)(y + dy);
                      var bl = SVGpork_Geometry.point("")(x)(y + dy);
                      return SVGpork_Render.svgpath(ctx.stroke)(ctx.strokeWidth)(ctx.fill)("M " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(bl)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(bl)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(br)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(br)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(tr)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(tr)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(tl)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(tl)) + (" " + "z"))))))))))))))))))));
                  };
              };
          };
      };
              ...
              return function ($copy_v) {
                  return function ($copy_v1) {
                      ...
                      function $tco_loop(dictPartial, from, acc, v, v1) {
                          ...
                          if (v instanceof Data_Maybe.Just) {
                              var topY = SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(from.center) + from.halfHeight;
                              var botY = SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(from.center) - from.halfHeight;
                              var okY = function (y) {
                              ...
                              if (v2 instanceof Data_Maybe.Just) {
                                  if (v2.value0.head instanceof Data_Maybe.Just) {
                                      ...
                                      $tco_var_acc = (function () {
                                          var $110 = okY(v.value0.y) && okY(v2.value0.head.value0.y);
                                          if ($110) {
                                  ...
                                  if (v2.value0.head instanceof Data_Maybe.Nothing) {
                                      ...
                                      var $114 = Data_Array.length(ys) === 0;
                                      if ($114) {
                                          $tco_done = true;
                                          return acc;
                                      };
                                  ...
                                  throw new Error("Failed pattern match at Main (line 474, column 11 - line 486, column 74): " + [ v2.value0.head.constructor.name ]);
                              };
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  $tco_done = true;
                                  return acc;
                              };
                              throw new Error("Failed pattern match at Main (line 472, column 6 - line 487, column 21): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 463, column 1 - line 466, column 76): " + [ from.constructor.name, acc.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
  ...
  var parseIntrvl = function (str) {
      var parseExtremities = function (xs) {
          if (xs === "+oo") {
              return PlusInf.value;
          };
          if (xs === "-oo") {
              return MinusInf.value;
          };
          return new R(Global.readFloat(xs));
      };
      var n = Data_String_CodePoints.length(str);
      var s = Data_String_CodePoints.drop(1)(Data_String_CodePoints.take(n - 1 | 0)(str));
      var x01 = Data_Functor.map(Data_Functor.functorArray)(parseExtremities)(Data_String_Common.split(";")(s));
      var x0 = Data_Maybe.fromJust()(Data_Array.head(x01));
      var x1 = Data_Maybe.fromJust()(Data_Array.head(Data_Maybe.fromJust()(Data_Array.tail(x01))));
      var cn = Data_String_CodePoints.drop(n - 1 | 0)(str);
      var c0 = Data_String_CodePoints.take(1)(str);
      if (c0 === "]" && cn === "[") {
          return new OpenOpen(x0, x1);
      };
      if (c0 === "]" && cn === "]") {
          return new OpenClose(x0, x1);
      };
      if (c0 === "[" && cn === "[") {
          return new CloseOpen(x0, x1);
      };
      if (c0 === "[" && cn === "]") {
          return new CloseClose(x0, x1);
      };
      return new OpenOpen(MinusInf.value, PlusInf.value);
  };
  var mkButtonEvent = function (msg) {
      return Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(new Send(msg))) ])([ Spork_Html_Core.text(msg) ]);
  };
  var markCoefficient = "mark Coefficient";
  var local = {
      center: SVGpork_Geometry.point("")(0.0)(0.0),
      halfWidth: 6.0,
      halfHeight: 5.0
  };
  ...
  var inside = function (v) {
      return function (v1) {
          if (v instanceof OpenOpen && (v.value0 instanceof MinusInf && v.value1 instanceof PlusInf)) {
              return true;
          };
          if (v instanceof OpenOpen && (v.value0 instanceof MinusInf && v.value1 instanceof R)) {
              return v1 < v.value1.value0;
          };
          if (v instanceof OpenOpen && (v.value0 instanceof R && v.value1 instanceof R)) {
              return v.value0.value0 < v1 && v1 < v.value1.value0;
          };
          if (v instanceof OpenOpen && (v.value0 instanceof R && v.value1 instanceof PlusInf)) {
              return v.value0.value0 < v1;
          };
          if (v instanceof OpenClose && (v.value0 instanceof MinusInf && v.value1 instanceof R)) {
              return v1 <= v.value1.value0;
          };
          if (v instanceof OpenClose && (v.value0 instanceof R && v.value1 instanceof R)) {
              return v.value0.value0 < v1 && v1 <= v.value1.value0;
          };
          if (v instanceof CloseOpen && (v.value0 instanceof R && v.value1 instanceof PlusInf)) {
              return v.value0.value0 <= v1;
          };
          if (v instanceof CloseOpen && (v.value0 instanceof R && v.value1 instanceof R)) {
              return v.value0.value0 <= v1 && v1 < v.value1.value0;
          };
          if (v instanceof CloseClose && (v.value0 instanceof R && v.value1 instanceof R)) {
              return v.value0.value0 <= v1 && v1 <= v.value1.value0;
          };
          return false;
      };
  ...
  var inDomain = function (domain) {
      return function (x) {
          return Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (intrvl) {
              return inside(intrvl)(x);
          })(domain);
      };
  };
  var inBox = function (v) {
      return function (p) {
          return inInterval(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center) - v.halfWidth)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center) + v.halfWidth)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(p)) && inInterval(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) - v.halfHeight)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) + v.halfHeight)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(p));
      };
  };
  var hideTangent = "hide Tangent";
  var hideDerivative = "hide Derivative";
  var fzoomOutY = "F: zoomOutY";
  var fzoomInY = "F: zoomInY";
  var functionInput = Spork_Html_Elements.input([ Spork_Html_Properties.autofocus(true), Spork_Html_Events.onValueChange(Spork_Html_Events.always(RenderCommand.create)) ]);
  var functionDisplay = {
      center: SVGpork_Geometry.point("")(svgWidth / 2.0)(svgHeight / 4.1),
      halfWidth: svgWidth / 2.0,
  ...
  var frame = function (v) {
      var seg = function (sx) {
          return function (sy) {
              return function (tx) {
                  return function (ty) {
                      return SVGpork_Geometry.segment(SVGpork_Geometry.point("")(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center) + sx * v.halfWidth)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) + sy * v.halfHeight))(SVGpork_Geometry.point("")(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center) + tx * v.halfWidth)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) + ty * v.halfHeight))(Data_Maybe.Nothing.value);
                  };
              };
          };
      };
  ...
  var segmentInBox = function (v) {
      return function (v1) {
          var candidates = Data_Array.filter(function ($305) {
              return (function (v2) {
                  return v2 === 1;
              })(Data_Array.length($305));
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 445, column 21 - line 445, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 448, column 20 - line 448, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $172 = Data_Array.length(candidates) === 2;
              if ($172) {
                  ...
                  throw new Error("Failed pattern match at Main (line 452, column 28 - line 452, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 442, column 7 - line 454, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  var lineInBox = function (b) {
      return function (l) {
          var v = SVGpork_Geometry.aVectorOfLine(l);
          var p = SVGpork_Geometry.aPointOnLine(l);
          return segmentInBox(b)(SVGpork_Geometry.segment(SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(p)(SVGpork_Geometry.scale(-50.0)(v)))(SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(p)(SVGpork_Geometry.scale(50.0)(v)))(Data_Maybe.Nothing.value));
      };
  };
  var f$primezoomOutY = "F': zoomOutY";
  var f$primezoomInY = "F': zoomInY";
  var update = function (model) {
      return function (action) {
          if (action instanceof None) {
              return Spork_Transition.purely(model);
          };
          if (action instanceof IncreaseDensity) {
          ...
          if (action instanceof FunctionSlot) {
              return Spork_Transition.purely(model);
          };
          if (action instanceof DomainSlot && action.value0 instanceof Data_Maybe.Just) {
              return Spork_Transition.purely({
          ...
          if (action instanceof DomainSlot) {
              return Spork_Transition.purely(model);
          };
          if (action instanceof StartDragging) {
              return Spork_Transition.purely({
                  previousX: Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(action.value0)),
          ...
          if (action instanceof EndDragging) {
              return Spork_Transition.purely({
                  isDragged: false,
                  argument: model.argument,
                  command: model.command,
          ...
          if (action instanceof UpdateArgument) {
              return Spork_Transition.purely((function () {
                  if (model.isDragged) {
                      ...
                      var $191 = inBox(model.toF)(previous);
                      if ($191) {
                          ...
                          return {
                              fromF: {
                                  center: SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(model.fromF.center)(SVGpork_Geometry.vector(q)(p)),
                                  halfHeight: model.fromF.halfHeight,
                                  halfWidth: model.fromF.halfWidth
                              },
                              fromD: {
                                  center: SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(model.fromD.center)(SVGpork_Geometry.vector(q0)(p)),
                      ...
                      var $192 = inBox(model.toD)(previous);
                      if ($192) {
                          ...
                          return {
                              fromD: {
                                  center: SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(model.fromD.center)(SVGpork_Geometry.vector(q)(p)),
                                  halfHeight: model.fromD.halfHeight,
                                  halfWidth: model.fromD.halfWidth
                              },
                              fromF: {
                                  center: SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(model.fromF.center)(SVGpork_Geometry.vector(q0)(p)),
                                  halfHeight: model.fromF.halfHeight,
                                  halfWidth: model.fromF.halfWidth
                              },
                              previousX: x,
          ...
          if (action instanceof RenderCommand) {
              ...
              var effects = (function () {
                  if (model.functionSlot instanceof Data_Maybe.Just && model.functionSlot.value0 instanceof Halogen_VDom_DOM_Prop.Created) {
                      return Spork_Batch.lift(new SporKaTeX.RenderEffect(transmit(m), model.functionSlot.value0.value0, None.value));
                  };
                  if (model.functionSlot instanceof Data_Maybe.Just && model.functionSlot.value0 instanceof Halogen_VDom_DOM_Prop.Removed) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  if (model.functionSlot instanceof Data_Maybe.Nothing) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  throw new Error("Failed pattern match at Main (line 256, column 11 - line 260, column 30): " + [ model.functionSlot.constructor.name ]);
              })();
              return {
                  model: m,
                  effects: effects
          ...
          if (action instanceof RenderDomain) {
              var ds = (function () {
                  if (action.value0 === "R+") {
                      return [ new CloseOpen(new R(0.0), PlusInf.value) ];
                  };
                  if (action.value0 === "R*") {
                      return [ new OpenOpen(MinusInf.value, new R(0.0)), new OpenOpen(new R(0.0), PlusInf.value) ];
                  };
                  if (action.value0 === "R") {
                      return [ new OpenOpen(MinusInf.value, PlusInf.value) ];
                  };
                  return Data_Functor.map(Data_Functor.functorArray)(parseIntrvl)(Data_String_Common.split("U")(action.value0));
              })();
              var renderDs = Data_String_Common.joinWith("\\cup")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showIntrvl))(ds));
              var effects = (function () {
                  if (model.domainSlot instanceof Data_Maybe.Just && model.domainSlot.value0 instanceof Halogen_VDom_DOM_Prop.Created) {
                      return Spork_Batch.lift(new SporKaTeX.RenderEffect(renderDs, model.domainSlot.value0.value0, None.value));
                  };
                  if (model.domainSlot instanceof Data_Maybe.Just && model.domainSlot.value0 instanceof Halogen_VDom_DOM_Prop.Removed) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  if (model.domainSlot instanceof Data_Maybe.Nothing) {
                      return Data_Monoid.mempty(Spork_Batch.monoidBatch);
                  };
                  throw new Error("Failed pattern match at Main (line 272, column 11 - line 276, column 30): " + [ model.domainSlot.constructor.name ]);
              })();
              return {
                  model: {
                      functionSlot: model.functionSlot,
          ...
          if (action instanceof Send) {
              return Spork_Transition.purely((function () {
                  var m = Data_Map_Internal.insert(Data_Ord.ordString)(zoomOutX)({
                      fromF: {
                          halfWidth: model.fromF.halfWidth * 1.1,
                          center: model.fromF.center,
                          halfHeight: model.fromF.halfHeight
                      },
                      fromD: {
                          halfWidth: model.fromD.halfWidth * 1.1,
                          center: model.fromD.center,
                          halfHeight: model.fromD.halfHeight
                      },
                      argument: model.argument,
                      command: model.command,
                      ...
                      toD: model.toD,
                      toF: model.toF
                  })(Data_Map_Internal.insert(Data_Ord.ordString)(zoomInX)({
                      fromF: {
                          halfWidth: model.fromF.halfWidth / 1.1,
                          center: model.fromF.center,
                          halfHeight: model.fromF.halfHeight
                      ...
                      toD: model.toD,
                      toF: model.toF
                  })(Data_Map_Internal.insert(Data_Ord.ordString)(fzoomOutY)({
                      fromF: {
                          halfHeight: model.fromF.halfHeight * 1.1,
                          center: model.fromF.center,
                          halfWidth: model.fromF.halfWidth
                      },
                      argument: model.argument,
                      ...
                      toD: model.toD,
                      toF: model.toF
                  })(Data_Map_Internal.insert(Data_Ord.ordString)(fzoomInY)({
                      fromF: {
                          halfHeight: model.fromF.halfHeight / 1.1,
                          center: model.fromF.center,
                          halfWidth: model.fromF.halfWidth
                      ...
                      toD: model.toD,
                      toF: model.toF
                  })(Data_Map_Internal.insert(Data_Ord.ordString)(f$primezoomOutY)({
                      fromD: {
                          halfHeight: model.fromD.halfHeight * 1.1,
                          center: model.fromD.center,
                          halfWidth: model.fromD.halfWidth
                      },
                      argument: model.argument,
                      ...
                      toD: model.toD,
                      toF: model.toF
                  })(Data_Map_Internal.insert(Data_Ord.ordString)(f$primezoomInY)({
                      fromD: {
                          halfHeight: model.fromD.halfHeight / 1.1,
                          center: model.fromD.center,
                          halfWidth: model.fromD.halfWidth
                  ...
                  var v = Data_Map_Internal.lookup(Data_Ord.ordString)(action.value0)(m);
                  if (v instanceof Data_Maybe.Just) {
                      return v.value0;
                  };
                  return model;
          ...
          throw new Error("Failed pattern match at Main (line 196, column 23 - line 309, column 30): " + [ action.constructor.name ]);
      };
  };
  var execute = function (command) {
      return function (x) {
          var v = Parser_Parser.parse(command);
          if (v instanceof Data_Either.Right && v.value0 instanceof Parser_Syntax.Eval) {
              var v1 = Parser_Eval["eval"](Data_Map_Internal.insert(Data_Ord.ordString)("x")(liftExprDual(x))(Data_Map_Internal.empty))(v.value0.value0);
  ...
  var drawableFinal = new SVGpork_Render.Render(function (ctx) {
      return function (v) {
          if (v instanceof FP) {
              return SVGpork_Render["render'"](SVGpork_Render.renderPoint)(ctx)(remap(v.value0)(v.value2)(v.value1));
          };
          if (v instanceof FL) {
              var p = SVGpork_Geometry.aPointOnLine(v.value2);
              var q = SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(p)(SVGpork_Geometry.aVectorOfLine(v.value2));
              return SVGpork_Render["render'"](SVGpork_Render.renderLine)(ctx)(SVGpork_Geometry.line(remap(v.value0)(p)(v.value1))(remap(v.value0)(q)(v.value1)));
          };
          if (v instanceof FC) {
              var q = remap(v.value0)(SVGpork_Geometry.point("")(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.value2.center) + v.value2.radius)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.value2.center)))(v.value1);
              var p = remap(v.value0)(v.value2.center)(v.value1);
              return SVGpork_Render["render'"](SVGpork_Render.renderCircle)(ctx)(SVGpork_Geometry.circle(p)(SVGpork_Geometry.length(SVGpork_Geometry.measurableVector)(SVGpork_Geometry.vector(p)(q))));
          };
          if (v instanceof FH) {
              var q = remap(v.value0)(SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(v.value2.origin)(v.value2.direction))(v.value1);
              var p = remap(v.value0)(v.value2.origin)(v.value1);
              return SVGpork_Render["render'"](SVGpork_Render.renderHalfLine)(ctx)({
                  origin: p,
                  direction: SVGpork_Geometry.vector(p)(q)
              });
          };
          if (v instanceof FS) {
              return SVGpork_Render["render'"](SVGpork_Render.renderSegment)(ctx)({
          ...
          throw new Error("Failed pattern match at Main (line 318, column 1 - line 336, column 41): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
  var grid = function (ctx) {
      return function (from) {
          return function (to) {
              var topY = SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(from.center) + from.halfHeight;
              var topX = SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(from.center) + from.halfWidth;
              var seg = function (x) {
                  return function (y) {
                      return function (x$prime) {
                          return function (y$prime) {
                              return FS.create(from)(to)(SVGpork_Geometry.segment(SVGpork_Geometry.point("")(x)(y))(SVGpork_Geometry.point("")(x$prime)(y$prime))(Data_Maybe.Nothing.value));
                          };
                      };
                  };
              };
              ...
              var botX = SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(from.center) - from.halfWidth;
              var segAtY = function (y) {
                  return seg(botX)(y)(topX)(y);
              };
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Control_Bind.bindFlipped(Control_Bind.bindArray)(function (n) {
                  return SVGpork_Render["render'"](drawableFinal)(ctx$prime(0.5))(segAtX(Data_Int.toNumber(n)));
  ...
  var markDrawing = function (ctx) {
      return function (v) {
          return function (fromD) {
              return function (toD) {
                  return function (x) {
                      var $251 = inDomain(v.domain)(x);
                      if ($251) {
                          var p = SVGpork_Geometry.point("")(x)(-v["function"](x));
                          var $252 = inBox(fromD)(p);
                          if ($252) {
          ...
          return function (to) {
              return function (density) {
                  return function (v) {
                      ...
                      var $261 = Data_Array.length(zs) === 0;
                      if ($261) {
                          return [  ];
                      };
                      return Control_Bind.bindFlipped(Control_Bind.bindArray)(function (s) {
                          return SVGpork_Render["render'"](drawableFinal)(ctx)(new FS(from, to, s));
                      })(pen()(from)([  ])(Data_Maybe.fromJust()(Data_Array.head(zs)))(Data_Maybe.fromJust()(Data_Array.tail(zs))));
                  };
              };
          };
      };
  ...
  var diffDisplay = {
      center: SVGpork_Geometry.point("")(svgWidth / 2.0)((3.1 * svgHeight) / 4.1),
      halfWidth: svgWidth / 2.0,
      halfHeight: svgHeight / 4.1
  };
  var initialModel = {
      ...
      isDragged: false,
      domain: [  ],
      functionSlot: Data_Maybe.Nothing.value,
      domainSlot: Data_Maybe.Nothing.value,
      message: "",
      density: 100,
      fromF: local,
      toF: functionDisplay,
  ...
  var cursor = function (v) {
      return SVGpork_Geometry.segment(SVGpork_Geometry.point("")(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center))(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) - v.halfHeight))(SVGpork_Geometry.point("")(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center))(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) + v.halfHeight))(Data_Maybe.Nothing.value);
  };
  var curryBox = function (f) {
      return function (v) {
          return f(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v.center) - v.halfWidth)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v.center) - v.halfHeight)(2.0 * v.halfWidth)(2.0 * v.halfHeight);
      };
  };
  var blue = "#0602c6";
  ...
  var render = function (model) {
      ...
      var diffBkg = curryBox(rectangle({
          stroke: ctx.stroke,
          fill: beige,
      ...
      var background = rectangle({
          ...
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(0.0)(0.0)(svgWidth)(svgHeight);
      return Spork_Html_Elements.div([ Spork_Html_Core.attr("style")("display: grid; grid-template-columns: 3fr 2fr;") ])([ Spork_Html_Core.elemWithNS(Data_Maybe.Just.create("http://www.w3.org/2000/svg"))("svg")([ Spork_Html_Core.attr("width")("800px"), Spork_Html_Core.attr("height")("600px"), Spork_Html_Events.onMouseDown(Spork_Html_Events.always(StartDragging.create)), Spork_Html_Events.onMouseUp(Spork_Html_Events.always_(EndDragging.value)), Spork_Html_Events.onMouseMove(Spork_Html_Events.always(UpdateArgument.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ background, functionBkg, diffBkg ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(page(ctx)(model))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(frame(functionDisplay)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(frame(diffDisplay)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(SVGpork_Render["render'"](SVGpork_Render.renderSegment)({
          stroke: blue,
          fill: ctx.fill,
          strokeWidth: ctx.strokeWidth,
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(cursor(functionDisplay)))(SVGpork_Render["render'"](SVGpork_Render.renderSegment)({
          stroke: blue,
          fill: ctx.fill,
          strokeWidth: ctx.strokeWidth,
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(cursor(diffDisplay)))))))), Spork_Html_Elements.div([ Spork_Html_Core.attr("style")("display: grid; grid-template-columns: 1fr 1fr;") ])([ mkButtonEvent(zoomOutX), mkButtonEvent(zoomInX), mkButtonEvent(fzoomOutY), mkButtonEvent(fzoomInY), mkButtonEvent(f$primezoomOutY), mkButtonEvent(f$primezoomInY), mkButtonEvent(showDerivative), mkButtonEvent(hideDerivative), mkButtonEvent(showTangent), mkButtonEvent(hideTangent), mkButtonEvent(markCoefficient), Spork_Html_Elements.div([ Spork_Html_Core.attr("style")("display: grid; grid-template-columns: 1fr 2fr 1fr;") ])([ Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(DecreaseDensity.value)) ])([ Spork_Html_Core.text("-") ]), Spork_Html_Elements.label([ Spork_Html_Core.attr("style")(styleCenter) ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showInt)(model.density)) ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(IncreaseDensity.value)) ])([ Spork_Html_Core.text("+") ]) ]), functionInput, Spork_Html_Elements.label([ Spork_Html_Core.attr("style")(styleCenter), Spork_Html_Core.ref(Spork_Html_Events.always(function ($306) {
          return FunctionSlot.create(Data_Maybe.Just.create($306));
      })) ])([  ]), Spork_Html_Elements.input([ Spork_Html_Events.onValueChange(Spork_Html_Events.always(RenderDomain.create)) ]), Spork_Html_Elements.label([ Spork_Html_Core.attr("style")(styleCenter), Spork_Html_Core.ref(Spork_Html_Events.always(function ($307) {
          return DomainSlot.create(Data_Maybe.Just.create($307));
      })) ])([  ]) ]) ]);
  };
  var app = {
      render: render,
  ...
  exports["R"] = R;
  exports["PlusInf"] = PlusInf;
  exports["MinusInf"] = MinusInf;
  exports["OpenOpen"] = OpenOpen;
  exports["OpenClose"] = OpenClose;
  exports["CloseOpen"] = CloseOpen;
  exports["CloseClose"] = CloseClose;
  exports["inside"] = inside;
  exports["parseIntrvl"] = parseIntrvl;
  ...
  exports["fzoomOutY"] = fzoomOutY;
  exports["fzoomInY"] = fzoomInY;
  exports["f'zoomOutY"] = f$primezoomOutY;
  exports["f'zoomInY"] = f$primezoomInY;
  exports["showDerivative"] = showDerivative;
  exports["hideDerivative"] = hideDerivative;
  exports["showTangent"] = showTangent;
  exports["hideTangent"] = hideTangent;
  exports["markCoefficient"] = markCoefficient;
  exports["None"] = None;
  exports["FunctionSlot"] = FunctionSlot;
  exports["DomainSlot"] = DomainSlot;
  ...
  exports["EndDragging"] = EndDragging;
  exports["IncreaseDensity"] = IncreaseDensity;
  exports["DecreaseDensity"] = DecreaseDensity;
  ...
  exports["pen"] = pen;
  exports["plot"] = plot;
  exports["localDrawings"] = localDrawings;
  exports["markDrawing"] = markDrawing;
  exports["page"] = page;
  ...
  exports["app"] = app;
  exports["main"] = main;
  exports["showExt"] = showExt;
  exports["showIntrvl"] = showIntrvl;
