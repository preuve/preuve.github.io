...
(function($PS) {
                              ...
                              if (v2 instanceof Data_Maybe.Just) {
                                  if (v2.value0.head instanceof Data_Maybe.Just) {
                                      ...
                                      $tco_var_acc = (function () {
                                          var $224 = okY(v.value0.y) && okY(v2.value0.head.value0.y);
                                          if ($224) {
                                  ...
                                  if (v2.value0.head instanceof Data_Maybe.Nothing) {
                                      ...
                                      var $228 = Data_Array.length(ys) === 0;
                                      if ($228) {
                                          $tco_done = true;
                                          return acc;
                                      };
                                  ...
                                  throw new Error("Failed pattern match at Main (line 139, column 11 - line 151, column 74): " + [ v2.value0.head.constructor.name ]);
                              };
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  $tco_done = true;
                                  return acc;
                              };
                              throw new Error("Failed pattern match at Main (line 137, column 6 - line 152, column 21): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 128, column 1 - line 131, column 76): " + [ from.constructor.name, acc.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
  ...
  var moveWithButton = Data_Functor.map(Effect.functorEffect)(function (mouse) {
      return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
          return {
              value: (function () {
                  var $234 = Data_Set.isEmpty(v.buttons);
                  if ($234) {
                      return "buttonup";
                  };
                  return "buttondown";
  ...
  var inputCanonical = function (v) {
      return function (div) {
          return function (doc) {
              return function __do() {
                  var v1 = DOM_Editor.createElement("input")(doc)();
                  var v2 = DOM_Editor.setId("CANa")(v1)();
                  var v3 = DOM_Editor.appendChild(v1)(div)();
                  var v4 = DOM_Editor.createElement("input")(doc)();
                  var v5 = DOM_Editor.setId("CANalpha")(v4)();
                  var v6 = DOM_Editor.appendChild(v4)(div)();
                  var v7 = DOM_Editor.createElement("input")(doc)();
                  var v8 = DOM_Editor.setId("CANbeta")(v7)();
                  var v9 = DOM_Editor.appendChild(v7)(div)();
                  return Data_Unit.unit;
              };
          };
      };
  };
  var input3Points = function (v) {
      return function (div) {
          return function (doc) {
              return function __do() {
                  var v1 = DOM_Editor.createElement("input")(doc)();
                  var v2 = DOM_Editor.appendChild(v1)(div)();
                  var v3 = DOM_Editor.createElement("input")(doc)();
                  var v4 = DOM_Editor.appendChild(v3)(div)();
                  var v5 = DOM_Editor.createElement("input")(doc)();
                  var v6 = DOM_Editor.appendChild(v5)(div)();
                  var v7 = DOM_Editor.createElement("input")(doc)();
                  var v8 = DOM_Editor.appendChild(v7)(div)();
                  var v9 = DOM_Editor.createElement("input")(doc)();
                  var v10 = DOM_Editor.appendChild(v9)(div)();
                  var v11 = DOM_Editor.createElement("input")(doc)();
                  var v12 = DOM_Editor.appendChild(v11)(div)();
                  return Data_Unit.unit;
              };
          };
      };
  ...
  var segmentInBox = function (v) {
      return function (v1) {
          var candidates = Data_Array.filter(function ($458) {
              return (function (v2) {
                  return v2 === 1;
              })(Data_Array.length($458));
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 357, column 21 - line 357, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 360, column 20 - line 360, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $278 = Data_Array.length(candidates) === 2;
              if ($278) {
                  ...
                  throw new Error("Failed pattern match at Main (line 364, column 28 - line 364, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 354, column 7 - line 366, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  ...
  var drawableFinal = new Graphics_Canvas_Geometry.DrawableSet(function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 229, column 1 - line 247, column 39): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
      ...
      return function (from) {
          return function (to) {
              return function (v) {
                  ...
                  var $318 = Data_Array.length(zs) === 0;
                  if ($318) {
                      return Data_Monoid.mempty(Graphics_Drawing.monoidDrawing);
                  };
  ...
  var convTripletReduced = new Convertible(function (v) {
      ...
      return {
          a: ((v.c0.x - v.c1.x) * v.c2.y) / den,
          b: ((v.c1.x * v.c1.x - v.c0.x * v.c0.x) * v.c2.y) / den,
          c: (v.c0.x * v.c1.x * (v.c0.x - v.c1.x) * v.c2.y) / den
      };
  });
  ...
  var reframe = function (draw) {
      return function (v) {
          return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(grid(v.fromF)(v.toF))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(plot(draw)(v.fromF)(v.toF)(v.parabola))((function () {
              var v1 = convert(convFunctionReduced)(v.parabola);
              ...
              return FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (v) {
                  return function (st) {
                      if (v.value === "ABCa") {
                          return {
                              parabola: (function () {
                                  var v2 = convert(convFunctionReduced)(st.parabola);
                                  return convert(convReducedFunction)({
                                      a: v.pos.x,
                                      b: v2.b,
                                      c: v2.c
                                  });
  ...
  var cbOption = function (doc) {
      return function (ev) {
          return function __do() {
              var v = DOM_Editor.getElementById("monitor")(doc)();
              var v1 = DOM_Editor.getElementById("memo")(doc)();
              var v2 = DOM_Editor.textContent(v1)();
              var v3 = DOM_Editor.getElementById(v2)(doc)();
              var v4 = DOM_Editor.selectedValueFromEvent(ev)();
              var v5 = (function () {
                  if (v4 === "fromABC") {
                      var v5 = DOM_Editor.setTextContent("ABC")(v1)();
                      return DOM_Editor.getElementById("ABC")(doc)();
                  };
                  if (v4 === "fromCanonical") {
                      var v5 = DOM_Editor.setTextContent("Canonical")(v1)();
                      return DOM_Editor.getElementById("Canonical")(doc)();
                  };
                  if (v4 === "from3Points") {
                      var v5 = DOM_Editor.setTextContent("3Points")(v1)();
                      return DOM_Editor.getElementById("3Points")(doc)();
                  };
                  throw new Error("Failed pattern match at Main (line 474, column 10 - line 483, column 43): " + [ v4.constructor.name ]);
              })();
              var v6 = DOM_Editor.setAttribute("style")("display: none;")(v3)();
              var v7 = DOM_Editor.setAttribute("style")("display: inline;")(v5)();
              return Data_Unit.unit;
          };
      };
  };
          ...
          return function (doc) {
              return function (ev) {
                  return function __do() {
                      ...
                      var v5 = (function () {
                          var v5 = Data_String_CodeUnits.stripPrefix("ABC")(msg);
                          if (v5 instanceof Data_Maybe.Just) {
                              var v6 = DOM_Editor.getElementById("ABCa")(doc)();
                              var v7 = DOM_Editor.getElementById("ABCb")(doc)();
                              var v8 = DOM_Editor.getElementById("ABCc")(doc)();
                              var v9 = DOM_Editor.inputedValue(v6)();
                              var v10 = DOM_Editor.inputedValue(v7)();
                              var v11 = DOM_Editor.inputedValue(v8)();
                              var v12 = DOM_Editor.setTextContent("f(x) = " + (v9 + ("x^2 + (" + (v10 + (")x + (" + (v11 + ")"))))))(v2)();
                              var v13 = convert(convReducedCanonical)({
                                  a: $foreign.fromString(v9),
                                  b: $foreign.fromString(v10),
                                  c: $foreign.fromString(v11)
                              });
                              var v14 = DOM_Editor.setTextContent("f(x) = " + (Data_Show.show(Data_Show.showNumber)(v13.a) + ("(x - (" + (Data_Show.show(Data_Show.showNumber)(v13.alpha) + ("))^2 + (" + (Data_Show.show(Data_Show.showNumber)(v13.beta) + ")"))))))(v3)();
                              var v15 = (function () {
                                  var v15 = convert(convCanonicalFactorized)(v13);
                                  if (v15 instanceof Data_Maybe.Just) {
                                      return DOM_Editor.setTextContent("f(x) = " + (Data_Show.show(Data_Show.showNumber)(v15.value0.a) + ("(x - (" + (Data_Show.show(Data_Show.showNumber)(v15.value0.x1) + (")) (x - (" + (Data_Show.show(Data_Show.showNumber)(v15.value0.x2) + "))"))))))(v4)();
                                  };
                                  return DOM_Editor.setTextContent("")(v4)();
                              })();
                              return Data_Unit.unit;
                          };
                          ...
                          throw new Error("Failed pattern match at Main (line 389, column 8 - line 416, column 30): " + [ v5.constructor.name ]);
                      })();
                      return Data_Unit.unit;
                  };
              };
  ...
  var inputABC = function (bevent) {
      return function (div) {
          return function (doc) {
              return function __do() {
                  var v = DOM_Editor.createElement("input")(doc)();
                  var v1 = DOM_Editor.setId("ABCa")(v)();
                  var v2 = DOM_Editor.setAttribute("value")("1.0")(v)();
                  var v3 = DOM_Editor.addEventListener(cbInput("ABCa")(bevent)(doc))(DOM_Editor.change)(v)();
                  var v4 = DOM_Editor.appendChild(v)(div)();
                  var v5 = DOM_Editor.createElement("input")(doc)();
                  var v6 = DOM_Editor.setId("ABCb")(v5)();
                  var v7 = DOM_Editor.setAttribute("value")("0.0")(v5)();
                  var v8 = DOM_Editor.addEventListener(cbInput("ABCb")(bevent)(doc))(DOM_Editor.change)(v5)();
                  var v9 = DOM_Editor.appendChild(v5)(div)();
                  var v10 = DOM_Editor.createElement("input")(doc)();
                  var v11 = DOM_Editor.setId("ABCc")(v10)();
                  var v12 = DOM_Editor.setAttribute("value")("0.0")(v10)();
                  var v13 = DOM_Editor.addEventListener(cbInput("ABCc")(bevent)(doc))(DOM_Editor.change)(v10)();
                  var v14 = DOM_Editor.appendChild(v10)(div)();
                  return Data_Unit.unit;
              };
          };
      };
  ...
  var main = function __do() {
      ...
      var v6 = DOM_Editor.setId("monitor")(v5)();
      var v7 = mkButtonEvent(v5)("zoomOutX")(v.document)();
      var v8 = mkButtonEvent(v5)("zoomInX")(v.document)();
      var v9 = mkButtonEvent(v5)("zoomOutY")(v.document)();
      var v10 = mkButtonEvent(v5)("zoomInY")(v.document)();
      var v11 = FRP_Event.create();
      var v12 = DOM_Editor.createElement("div")(v.document)();
      var v13 = inputABC(v11)(v12)(v.document)();
      var v14 = DOM_Editor.setId("ABC")(v12)();
      var v15 = DOM_Editor.setAttribute("style")("display: inline;")(v12)();
      var v16 = DOM_Editor.createElement("div")(v.document)();
      var v17 = input3Points(v11)(v16)(v.document)();
      var v18 = DOM_Editor.setId("3Points")(v16)();
      var v19 = DOM_Editor.setAttribute("style")("display: none;")(v16)();
      var v20 = DOM_Editor.createElement("div")(v.document)();
      var v21 = inputCanonical(v11)(v20)(v.document)();
      var v22 = DOM_Editor.setId("Canonical")(v20)();
      var v23 = DOM_Editor.setAttribute("style")("display: none;")(v20)();
      var v24 = DOM_Editor.createElement("select")(v.document)();
      var v25 = mkOptionEvent(v)(v24)("fromABC")();
      var v26 = mkOptionEvent(v)(v24)("fromCanonical")();
      var v27 = mkOptionEvent(v)(v24)("from3Points")();
      var v28 = DOM_Editor.addEventListener(cbOption(v.document))(DOM_Editor.change)(v24)();
      var v29 = DOM_Editor.appendChild(v24)(v5)();
      var v30 = DOM_Editor.createElement("br")(v.document)();
      var v31 = DOM_Editor.appendChild(v30)(v5)();
      var v32 = DOM_Editor.appendChild(v12)(v5)();
      var v33 = DOM_Editor.appendChild(v16)(v5)();
      var v34 = DOM_Editor.appendChild(v20)(v5)();
      var v35 = DOM_Editor.createElement("br")(v.document)();
      var v36 = DOM_Editor.appendChild(v35)(v5)();
      var v37 = DOM_Editor.createElement("label")(v.document)();
      var v38 = DOM_Editor.setId("reduced")(v37)();
      var v39 = DOM_Editor.appendChild(v37)(v5)();
      var v40 = DOM_Editor.createElement("br")(v.document)();
      var v41 = DOM_Editor.appendChild(v40)(v5)();
      var v42 = DOM_Editor.createElement("label")(v.document)();
      var v43 = DOM_Editor.setId("canonical")(v42)();
      var v44 = DOM_Editor.appendChild(v42)(v5)();
      var v45 = DOM_Editor.createElement("br")(v.document)();
      var v46 = DOM_Editor.appendChild(v45)(v5)();
      var v47 = DOM_Editor.createElement("label")(v.document)();
      var v48 = DOM_Editor.setId("factorized")(v47)();
      var v49 = DOM_Editor.appendChild(v47)(v5)();
      var v50 = DOM_Editor.createElement("br")(v.document)();
      var v51 = DOM_Editor.appendChild(v50)(v5)();
      var v52 = DOM_Editor.createElement("label")(v.document)();
      var v53 = DOM_Editor.setId("memo")(v52)();
      var v54 = DOM_Editor.setTextContent("ABC")(v52)();
      var v55 = DOM_Editor.appendChild(v5)(v.body)();
      var v56 = DOM_Editor.setAttribute("style")("display: grid; grid-template-columns: repeat(2, 1fr);")(v.body)();
      var v57 = ePage([ v7, v8, v9, v10, v11 ])((function (dictDrawableSet) {
          return Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
      })(drawableFinal))();
      var v58 = FRP_Behavior.animate(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(background))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(functionBkg))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(v57)(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSequence(Graphics_Canvas_Geometry.drawableSegment))(ctx)(frame(window)))))))(Graphics_Drawing.render(v2))();
      return Data_Unit.unit;
  };
  ...
  exports["input3Points"] = input3Points;
