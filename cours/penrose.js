  ...
  var mesh = function (ctx) {
      return function (m) {
          return Data_Functor.map(Data_Functor.functorArray)(function (edge) {
              var stroke = (function () {
                  if (edge.active && (!edge.selected && !edge.locked)) {
                      return ctx.stroke;
                  };
                  if (!edge.active) {
                      return grey;
  ...
  var inside = function (x) {
      return function (y) {
          return function (m) {
              ...
              return Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q0)(q1)(q2)) + Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q0)(q2)(q3)) >= Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q0)(q1)(q)) + Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q1)(q2)(q)) + Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q2)(q3)(q)) + Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(surf(q3)(q0)(q));
          };
      };
  };
  ...
  var teaser = function (x) {
      return function (y) {
          return function (m) {
              ...
              return Data_Maybe.maybe(m)(Control_Category.identity(Control_Category.categoryFn))(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (i) {
                  return function (r0) {
                      return function (a) {
                          return {
