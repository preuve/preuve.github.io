...
(function($PS) {
  ...
  var vexe = function (q0) {
      return function (a) {
          var v0 = SVGpork_Geometry.rotated(a)(SVGpork_Geometry.vector(SVGpork_Geometry.point("")(0.0)(0.0))(SVGpork_Geometry.point("")(un)(0.0)));
          var q3 = SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(q0)(SVGpork_Geometry.rotated((2.0 * $$Math.pi) / 5.0)(v0));
          var q2 = SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(q0)(SVGpork_Geometry.scale(phi)(v0));
          var q1 = SVGpork_Geometry.plus(SVGpork_Geometry.summublePointVector)(q0)(SVGpork_Geometry.rotated((-2.0 * $$Math.pi) / 5.0)(v0));
  ...
  var probe = function (x) {
      return function (y) {
          return function (m) {
              ...
              var candidates = Data_Array.filter(close)(m.edges);
              var edge = (function () {
                  var $7 = Data_Array.length(candidates) === 0;
                  if ($7) {
                      return Data_Maybe.Nothing.value;
                  };
              ...
              return Data_Maybe.maybe({
                  edges: Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                      return {
                          selected: false,
                          p0: v1.p0,
                          p1: v1.p1
                  ...
                  return {
                      edges: Data_Functor.map(Data_Functor.functorArray)(function (e$prime) {
                          var $8 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                              return "selected";
                          }))(Data_Eq.eqBoolean))()(new Data_Symbol.IsSymbol(function () {
                              return "p1";
                          }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
                              return "p0";
                          }))(Data_Eq.eqInt)))(e)(e$prime);
                          if ($8) {
                              return {
                                  selected: true,
                                  p0: e.p0,
  ...
  var render = function (m) {
      ...
      return Spork_Html_Core.elemWithNS(Data_Maybe.Just.create("http://www.w3.org/2000/svg"))("svg")([ Spork_Html_Core.attr("width")("800px"), Spork_Html_Core.attr("height")("600px"), Spork_Html_Events.onMouseMove(Spork_Html_Events.always(Probe.create)) ])(mesh(ctx)(m));
  };
  var grey = "#050409";
  var blue = "#0602c6";
  var beige = "#FFFFAF";
