...
(function($PS) {
  ...
  exports["svgtext"] = $foreign.svgtext;
...
(function($PS) {
                              ...
                              if (v2 instanceof Data_Maybe.Just) {
                                  if (v2.value0.head instanceof Data_Maybe.Just) {
                                      ...
                                      $tco_var_acc = (function () {
                                          var $126 = okY(v.value0.y) && okY(v2.value0.head.value0.y);
                                          if ($126) {
                                  ...
                                  if (v2.value0.head instanceof Data_Maybe.Nothing) {
                                      ...
                                      var $130 = Data_Array.length(ys) === 0;
                                      if ($130) {
                                          $tco_done = true;
                                          return acc;
                                      };
                                  ...
                                  throw new Error("Failed pattern match at Main (line 68, column 11 - line 80, column 74): " + [ v2.value0.head.constructor.name ]);
                              };
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  $tco_done = true;
                                  return acc;
                              };
                              throw new Error("Failed pattern match at Main (line 66, column 6 - line 81, column 21): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 57, column 1 - line 60, column 76): " + [ from.constructor.name, acc.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
  ...
  var moveWithButton = Data_Functor.map(Effect.functorEffect)(function (mouse) {
      return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
          return {
              value: (function () {
                  var $136 = Data_Set.isEmpty(v.buttons);
                  if ($136) {
                      return "buttonup";
                  };
                  return "buttondown";
  ...
  var functionDisplay = {
      center: SVG_Geometry.point("")(width / 2.0)(height / 4.1),
      halfWidth: width / 2.0,
  ...
  var segmentInBox = function (v) {
      return function (v1) {
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 374, column 21 - line 374, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 377, column 20 - line 377, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $161 = Data_Array.length(candidates) === 2;
              if ($161) {
                  ...
                  throw new Error("Failed pattern match at Main (line 381, column 28 - line 381, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 371, column 7 - line 383, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  ...
  var drawableFinal = new SVG_Render.Render(function (ctx) {
      return function (v) {
          if (v instanceof FP) {
          ...
          if (v instanceof FA) {
              return SVG_Render["render'"](SVG_Render.renderSequence(drawableFinal))(ctx)(v.value0);
          };
          throw new Error("Failed pattern match at Main (line 167, column 1 - line 185, column 41): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
          ...
          return function (to) {
              ...
              return function __do() {
                  Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (a) {
                      return function (n) {
                          return Data_Semigroup.append(Effect.semigroupEffect(Data_Semigroup.semigroupUnit))(Control_Applicative.pure(Effect.applicativeEffect)(a))(SVG_Render["render'"](drawableFinal)(ctx$prime(0.5))(segAtX(Data_Int.toNumber(n))));
                      };
                  })(Data_Unit.unit)(Data_Array.range(Data_Int.ceil(botX))(Data_Int.floor(topX)))();
                  Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (a) {
                      return function (n) {
                          return Data_Semigroup.append(Effect.semigroupEffect(Data_Semigroup.semigroupUnit))(Control_Applicative.pure(Effect.applicativeEffect)(a))(SVG_Render["render'"](drawableFinal)(ctx$prime(0.5))(segAtY(Data_Int.toNumber(n))));
                      };
                  })(Data_Unit.unit)(Data_Array.range(Data_Int.ceil(botY))(Data_Int.floor(topY)))();
                  SVG_Render["render'"](drawableFinal)(ctx$prime(1.5))(segAtX(0.0))();
                  var $195 = botY <= 0.0 && 0.0 <= topY;
                  if ($195) {
                      return SVG_Render["render'"](drawableFinal)(ctx$prime(1.5))(segAtY(0.0))();
                  };
                  return Data_Unit.unit;
              };
          };
  ...
  var diffDisplay = {
      center: SVG_Geometry.point("")(width / 2.0)((3.1 * height) / 4.1),
      halfWidth: width / 2.0,
      halfHeight: height / 4.1
  };
  var initialState = {
      ...
      return function (from) {
          return function (to) {
              return function (v) {
                  ...
                  var $201 = Data_Array.length(zs) === 0;
                  if ($201) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                  };
                  return Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (acc) {
                      return function (s) {
                          return Data_Semigroup.append(Effect.semigroupEffect(Data_Semigroup.semigroupUnit))(Control_Applicative.pure(Effect.applicativeEffect)(acc))(SVG_Render["render'"](drawableFinal)(ctx)(new FS(from, to, s)));
                      };
  ...
  var cursor = function (v) {
      return SVG_Geometry.segment(SVG_Geometry.point("")(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v.center))(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v.center) - v.halfHeight))(SVG_Geometry.point("")(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v.center))(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v.center) + v.halfHeight))(Data_Maybe.Nothing.value);
  };
  ...
  var reframe = function (ctx) {
      return function (v) {
          return function __do() {
              ...
              grid(ctx)(v.fromD)(v.toD)();
              plot(ctx)(v.fromF)(v.toF)(v["fAndDf"]["function"])();
              (function () {
                  if (v.displayD) {
                      return plot(ctx)(v.fromD)(v.toD)(v.fAndDf.diff)();
                  };
                  return Data_Unit.unit;
              })();
              var x = SVG_Geometry.abs(SVG_Geometry.basedPoint)(remap(v.toF)(v.toF.center)(v.fromF));
              (function () {
                  var $227 = v["fAndDf"]["function"].domain(x);
                  if ($227) {
                      var p = SVG_Geometry.point("")(x)(-v["fAndDf"]["function"].expression(x));
                      var a = -v.fAndDf.diff.expression(x);
                      var b = -1.0;
                      var c = x * v.fAndDf.diff.expression(x) - v["fAndDf"]["function"].expression(x);
                      var a2 = digit2(-a);
                      var c2 = digit2(-c);
                      SVG_Render.svgtext(ctx.svg)(width * 0.7)(height * 5.0e-2)(blue)("italic bold 15px arial, serif")("a = " + Data_Show.show(Data_Show.showNumber)(digit2(x)))();
                      (function () {
                          var $228 = inBox(v.fromF)(p);
                          if ($228) {
                              return SVG_Render["render'"](drawableFinal)(ctx)(new FP(v.fromF, v.toF, p))();
                          };
                          return Data_Unit.unit;
                      })();
                      if (v.displayT) {
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              SVG_Render["render'"](drawableFinal)(tanStyle(ctx))(new FS(v.fromF, v.toF, v1.value0))();
                              return SVG_Render.svgtext(ctx.svg)(width * 0.7)(height * 0.1)(purple)("italic bold 15px arial, serif")("y = " + (Data_Show.show(Data_Show.showNumber)(a2) + ("x" + (function () {
                                  var $231 = c2 < 0.0;
                                  if ($231) {
              ...
              return Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (a) {
                  return function (n) {
                      return Data_Semigroup.append(Effect.semigroupEffect(Data_Semigroup.semigroupUnit))(Control_Applicative.pure(Effect.applicativeEffect)(a))((function () {
                          var $234 = v.fAndDf.diff.domain(n);
                          if ($234) {
                              var p = SVG_Geometry.point("")(n)(-v.fAndDf.diff.expression(n));
                              var $235 = inBox(v.fromD)(p);
                              if ($235) {
                                  return SVG_Render["render'"](drawableFinal)(tanStyle(ctx))(new FP(v.fromD, v.toD, p));
                              };
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              ...
              return FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (v) {
                  return function (st) {
                      ...
                      if (v.value === "mark Coefficient") {
                          return {
                              numbers: Data_Semigroup.append(Data_Semigroup.semigroupArray)(st.numbers)([ SVG_Geometry.abs(SVG_Geometry.basedPoint)(st.fromD.center) ]),
                              displayD: st.displayD,
                              displayT: st.displayT,
                              fAndDf: st.fAndDf,
                              fromD: st.fromD,
                      ...
                      if (v.value === "buttondown") {
                          ...
                          if ($248) {
                              ...
                              return {
                                  ...
                                  fromD: {
                                      center: SVG_Geometry.plus(SVG_Geometry.summublePointVector)(st.fromD.center)(SVG_Geometry.vector(q0)(p)),
                                      halfHeight: st.fromD.halfHeight,
                                      halfWidth: st.fromD.halfWidth
                                  },
                                  previousX: v.pos.x,
                          ...
                          var $249 = inBox(st.toD)(previous);
                          if ($249) {
                              var q0 = remap(st.toD)(SVG_Geometry.point("")(v.pos.x)(st.previousY))(st.fromD);
                              var q = remap(st.toD)(SVG_Geometry.point("")(v.pos.x)(v.pos.y))(st.fromD);
                              var p = remap(st.toD)(previous)(st.fromD);
                              return {
                                  fromD: {
                                      center: SVG_Geometry.plus(SVG_Geometry.summublePointVector)(st.fromD.center)(SVG_Geometry.vector(q)(p)),
                                      halfHeight: st.fromD.halfHeight,
                                      halfWidth: st.fromD.halfWidth
                                  },
                                  fromF: {
                                      center: SVG_Geometry.plus(SVG_Geometry.summublePointVector)(st.fromF.center)(SVG_Geometry.vector(q0)(p)),
                                      halfHeight: st.fromF.halfHeight,
                                      halfWidth: st.fromF.halfWidth
                                  },
                                  previousX: v.pos.x,
  ...
  var main = function __do() {
      ...
      var v1 = DOM_Editor.createElement("div")(v.document)();
      var v2 = DOM_Editor.setAttribute("style")("display: grid; grid-template-columns: 3fr 2fr;")(v1)();
      var v3 = DOM_Editor.newSVG("position: relative; width:800px; height:600px;")(v1)();
      var v4 = DOM_Editor.createElement("div")(v.document)();
      var v5 = DOM_Editor.appendChild(v4)(v1)();
      var ctx = (function () {
          var v6 = SVG_Render.defaultContext(v3);
          return {
              stroke: "#050409",
              fill: v6.fill,
              fontStyle: v6.fontStyle,
              strokeWidth: v6.strokeWidth,
              svg: v6.svg,
      ...
      var v6 = mkButtonEvent(v)(v4)("zoomOutX")();
      var v7 = mkButtonEvent(v)(v4)("zoomInX")();
      var v8 = mkButtonEvent(v)(v4)("F: zoomOutY")();
      var v9 = mkButtonEvent(v)(v4)("F: zoomInY")();
      var v10 = mkButtonEvent(v)(v4)("F': zoomOutY")();
      var v11 = mkButtonEvent(v)(v4)("F': zoomInY")();
      var v12 = mkButtonEvent(v)(v4)("show Derivative")();
      var v13 = mkButtonEvent(v)(v4)("hide Derivative")();
      var v14 = mkButtonEvent(v)(v4)("show Tangent")();
      var v15 = mkButtonEvent(v)(v4)("hide Tangent")();
      var v16 = mkButtonEvent(v)(v4)("mark Coefficient")();
      var v17 = DOM_Editor.createElement("select")(v.document)();
      var v18 = mkOptionEvent(v)(v17)("inverse")();
      var v19 = mkOptionEvent(v)(v17)("square")();
      var v20 = mkOptionEvent(v)(v17)("arbitrary")();
      var v21 = FRP_Event.create();
      var v22 = DOM_Editor.addEventListener(cbOption(v21))(DOM_Editor.change)(v17)();
      var v23 = DOM_Editor.appendChild(v17)(v4)();
      var v24 = DOM_Editor.appendChild(v1)(v.body)();
      var v25 = ePage([ v12, v13, v14, v15, v16, v6, v7, v10, v11, v8, v9, v21 ])(ctx)();
      var v26 = FRP_Behavior.animate(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(SVG_Render.svgclear(v3)))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(background))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(functionBkg))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(diffBkg))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(v25)(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(SVG_Render["render'"](SVG_Render.renderSequence(SVG_Render.renderSegment))(ctx)(frame(functionDisplay))))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(SVG_Render["render'"](SVG_Render.renderSequence(SVG_Render.renderSegment))(ctx)(frame(diffDisplay))))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Effect.semigroupEffect(Data_Semigroup.semigroupUnit)))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(SVG_Render["render'"](SVG_Render.renderSegment)({
          svg: ctx.svg,
          stroke: blue,
          fill: ctx.fill,
          strokeWidth: ctx.strokeWidth,
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(cursor(functionDisplay))))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(SVG_Render["render'"](SVG_Render.renderSegment)({
          svg: ctx.svg,
          stroke: blue,
          fill: ctx.fill,
          strokeWidth: ctx.strokeWidth,
          fontStyle: ctx.fontStyle,
          textFill: ctx.textFill
      })(cursor(diffDisplay))))))))))))(Control_Category.identity(Control_Category.categoryFn))();
      return Data_Unit.unit;
  };
  exports["width"] = width;
