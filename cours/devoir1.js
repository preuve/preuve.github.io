...
(function($PS) {
  ...
  var symx = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 54, column 3 - line 67, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var symy = function (a) {
      if (a === m5pi_6) {
          return mpi_6;
      ...
      throw new Error("Failed pattern match at Main (line 72, column 3 - line 85, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  ...
  var positive = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 97, column 3 - line 104, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var sixths = [ {
      exact: "\\frac{-13\\pi}{6}",
  ...
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              var v6 = DOM_Editor.setAttribute("width")("200")(v5)();
              var v7 = DOM_Editor.setAttribute("height")("200")(v5)();
              var v8 = DOM_Editor.appendChild(v5)(v1)();
              var v9 = DOM_Editor.appendChild(v4)(v1)();
              var v10 = DOM_Editor.appendChild(v1)(v3)();
              ...
              var draw = function (dictDrawableSet) {
                  var $39 = Graphics_Drawing.render(v11);
                  var $40 = Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
                  return function ($41) {
                      return $39($40($41));
                  };
              };
              var pO = Graphics_Canvas_Geometry.point("O")(100.0)(100.0);
              var pI = Graphics_Canvas_Geometry.point("I")(100.0 + 75.0)(100.0);
              var pJ = Graphics_Canvas_Geometry.point("J")(100.0)(100.0 - 75.0);
              draw(Graphics_Canvas_Geometry.drawableSequence(Graphics_Canvas_Geometry.drawablePoint))([ pO, pI, pJ ])();
              draw(Graphics_Canvas_Geometry.drawableCircle)(Graphics_Canvas_Geometry.circle(pO)(Graphics_Canvas_Geometry.length(Graphics_Canvas_Geometry.measurableVector)(Graphics_Canvas_Geometry.vector(pO)(pI))))();
              draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(pO)(pI)(Data_Maybe.Nothing.value))();
              draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(pO)(pJ)(Data_Maybe.Nothing.value))();
              var angle0 = Data_Maybe.fromJust()(Data_Array.index(points)(r0.val));
              var pM = Graphics_Canvas_Geometry.point("M")(100.0 + 75.0 * $$Math.cos(angle0.approx))(100.0 - 75.0 * $$Math.sin(angle0.approx));
              draw(Graphics_Canvas_Geometry.drawablePoint)(pM)();
              draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(pO)(pM)(Data_Maybe.Nothing.value))();
              KaTeX.rawIn(v4)("Soit ")();
              KaTeX.renderIn(v4)("M")();
              ...
              var r1 = rand(r0);
              var arr = (function () {
                  var v12 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(3);
                  if (v12 === 0) {
                      return thirds;
                  };
                  if (v12 === 1) {
              ...
              var rep = [ "r\xe9ponses: 1)", angle0.princ, "\\;2)", (function () {
                  var $34 = angle1.cos === angle2.cos;
                  if ($34) {
                      return "\xe9gaux,";
                  };
                  return "oppos\xe9s,";
              })() + (function () {
                  var $35 = angle1.sin === angle2.sin;
                  if ($35) {
                      return "\xe9gaux";
                  };
                  return "oppos\xe9s";
