...
(function($PS) {
  ...
  var svgLines = function (model) {
      return Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("500"), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
          return Data_Maybe.maybe(model)(function (mouse) {
              ...
              return {
                  ...
                  lastDependantPosition: new Data_Tuple.Tuple(x, y),
                  tick: model.tick,
                  baton: model.baton
              };
          ...
          shapes: model.shapes,
          tick: model.tick
      })(Concur_VDom_Props.onMouseUp) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ makeLine(model.lastReferencePosition)(model.lastDependantPosition) ])(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function ($40) {
          return makeLines(closed(Shape.toDrawable($40)));
      })(model.shapes))));
  };
  var modelWidget = function (model) {
      return Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(model)(function (m$prime) {
          return Control_Alt.alt(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(ticker(m$prime))(svgLines(m$prime));
      }))(function (m) {
          return Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(m.tick)));
      }));
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(modelWidget({
      pressed: false,
