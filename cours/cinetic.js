...
(function($PS) {
  ...
  var onMouseDown = handle("mousedown");
  var onMouseMove = handle("mousemove");
  var onMouseUp = handle("mouseup");
...
(function($PS) {
  "use strict";
  $PS["Shape"] = $PS["Shape"] || {};
  var exports = $PS["Shape"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Int = $PS["Data.Int"];
  var Data_Tuple = $PS["Data.Tuple"];
  var $$Math = $PS["Math"];                
  var toDynamicCoord = function (c) {
      return {
          previous: new Data_Tuple.Tuple(0, 0),
          current: c,
          next: new Data_Tuple.Tuple(0, 0)
      };
  };
  var toDynamicState = function (v) {
      return {
          center: toDynamicCoord(v.center),
          orientation: v.orientation,
          tops: Data_Functor.map(Data_Functor.functorArray)(toDynamicCoord)(v.tops)
      };
  };
  var toDrawable = function (v) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v1) {
          return new Data_Tuple.Tuple(v.fugitive.center.current.value0 + Data_Int.round(v.size * (Data_Int.toNumber(v1.current.value0) * $$Math.cos(v.fugitive.orientation) - Data_Int.toNumber(v1.current.value1) * $$Math.sin(v.fugitive.orientation))) | 0, v.fugitive.center.current.value1 + Data_Int.round(v.size * (Data_Int.toNumber(v1.current.value0) * $$Math.sin(v.fugitive.orientation) + Data_Int.toNumber(v1.current.value1) * $$Math.cos(v.fugitive.orientation))) | 0);
      })(v.fugitive.tops);
  };
  var evolve = function (xs) {
      return Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return {
              fugitive: {
                  orientation: x.fugitive.orientation + 0.1,
                  center: x.fugitive.center,
                  tops: x.fugitive.tops
              },
              size: x.size - 1.0,
              stable: x.stable
          };
  ...
  exports["toDynamicState"] = toDynamicState;
  exports["toDrawable"] = toDrawable;
 ...
 */  
  var shapeSide = 20.0;
  var shapesInit = [ (function () {
      var state = {
          center: new Data_Tuple.Tuple(200, 200),
          orientation: 0.0,
          tops: [ new Data_Tuple.Tuple(-3 | 0, -1 | 0), new Data_Tuple.Tuple(3, -1 | 0), new Data_Tuple.Tuple(4, 0), new Data_Tuple.Tuple(3, 1), new Data_Tuple.Tuple(-3 | 0, 1), new Data_Tuple.Tuple(-2 | 0, 0) ]
      };
      return {
          stable: state,
          fugitive: Shape.toDynamicState(state),
          size: shapeSide
      };
  })() ];
  ...
  var incrementTicker$prime = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (m) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(50.0)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)({
                  "tick'": m["tick'"] + 12 | 0,
                  lastDependantPosition: m.lastDependantPosition,
                  lastReferencePosition: m.lastReferencePosition,
                  pressed: m.pressed,
                  shapes: m.shapes,
                  tick: m.tick
              });
  ...
  var incrementTicker = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (m) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(100.0)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)({
                  tick: m.tick + 10 | 0,
                  lastDependantPosition: m.lastDependantPosition,
                  lastReferencePosition: m.lastReferencePosition,
  ...
  var modelWidget = function (m) {
      return Concur_Core_FRP.loopS(Concur_Core_Types.widgetMonad)(m)(function (model$prime) {
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(incrementTicker(model$prime))(function (m$prime) {
              return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(incrementTicker$prime(m$prime))(function (m$prime$prime) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(m$prime$prime.tick) + "   ")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Show.showInt)(m$prime$prime["tick'"]))))(function () {
                          return Control_Applicative.pure(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))({
                              tick: m$prime$prime.tick,
                              lastDependantPosition: m$prime$prime.lastDependantPosition,
                              lastReferencePosition: m$prime$prime.lastReferencePosition,
                              pressed: m$prime$prime.pressed,
                              shapes: m$prime$prime.shapes,
                              "tick'": m$prime$prime["tick'"]
                          });
                      });
                  });
  ...
  var main = Concur_VDom_Run.runWidgetInDom("main")(Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(modelWidget({
      pressed: false,
      lastReferencePosition: new Data_Tuple.Tuple(200, 200),
      lastDependantPosition: new Data_Tuple.Tuple(250, 200),
      tick: 0,
      "tick'": 0,
      shapes: shapesInit
  })));
  var evolveTicker = function (init) {
      return Concur_Core_FRP.loopW(Concur_Core_Types.widgetMonad)(init)(function (m) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Effect_Aff.delay(50.0)))(function () {
              return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)({
                  shapes: Shape.evolve(m.shapes),
                  lastDependantPosition: m.lastDependantPosition,
                  lastReferencePosition: m.lastReferencePosition,
                  pressed: m.pressed,
                  tick: m.tick,
  ...
  var svgLines = function (model) {
      return Concur_Core_FRP.step(model)(Control_Bind.bind(Concur_Core_Types.widgetBind)(Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("500"), Concur_VDom_SVG.height("500"), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
          return Data_Maybe.maybe(model)(function (mouse) {
              var v = new Data_Tuple.Tuple(Web_UIEvent_MouseEvent.pageX(mouse), Web_UIEvent_MouseEvent.pageY(mouse));
              var v1 = new Data_Tuple.Tuple(v.value0 - model.lastReferencePosition.value0 | 0, v.value1 - model.lastReferencePosition.value1 | 0);
              var v2 = new Data_Tuple.Tuple(model.lastDependantPosition.value0 - model.lastReferencePosition.value0 | 0, model.lastDependantPosition.value1 - model.lastReferencePosition.value1 | 0);
              var den2 = Data_Int.toNumber(((v1.value0 - v2.value0 | 0) * (v1.value0 - v2.value0 | 0) | 0) + ((v1.value1 - v2.value1 | 0) * (v1.value1 - v2.value1 | 0) | 0) | 0);
              var x = (model.lastReferencePosition.value0 + v1.value0 | 0) - Data_Int.round((shapeSide * Data_Int.toNumber(v1.value0 - v2.value0 | 0)) / $$Math.sqrt(den2)) | 0;
              var y = (model.lastReferencePosition.value1 + v1.value1 | 0) - Data_Int.round((shapeSide * Data_Int.toNumber(v1.value1 - v2.value1 | 0)) / $$Math.sqrt(den2)) | 0;
              return {
                  pressed: model.pressed,
                  shapes: model.shapes,
                  lastReferencePosition: new Data_Tuple.Tuple(v.value0, v.value1),
                  lastDependantPosition: new Data_Tuple.Tuple(x + model.tick | 0, y),
                  tick: model.tick,
                  "tick'": model["tick'"]
              };
          })(Web_UIEvent_MouseEvent.fromEvent(ev));
      })(Concur_VDom_Props.onMouseMove), Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          pressed: true,
          lastDependantPosition: model.lastDependantPosition,
          lastReferencePosition: model.lastReferencePosition,
          shapes: model.shapes,
          tick: model.tick,
          "tick'": model["tick'"]
      })(Concur_VDom_Props.onMouseDown), Data_Functor.voidRight(Concur_Core_Props.functorProps)({
          pressed: false,
          lastDependantPosition: model.lastDependantPosition,
          lastReferencePosition: model.lastReferencePosition,
          shapes: model.shapes,
          tick: model.tick,
          "tick'": model["tick'"]
      })(Concur_VDom_Props.onMouseUp) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ makeLine(model.lastReferencePosition)(model.lastDependantPosition) ])(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function ($41) {
          return makeLines(closed(Shape.toDrawable($41)));
      })(model.shapes)))))(function ($$new) {
          return Control_Applicative.pure(Concur_Core_Types.widgetApplicative)(Control_Applicative.pure(Control_Cofree.applicativeCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))($$new));
      }));
  };
  exports["incrementTicker"] = incrementTicker;
  exports["incrementTicker'"] = incrementTicker$prime;
  exports["evolveTicker"] = evolveTicker;
  exports["makeLine"] = makeLine;
  exports["closed"] = closed;
  exports["makeLines"] = makeLines;
  exports["svgLines"] = svgLines;
  exports["modelWidget"] = modelWidget;
  exports["shapeSide"] = shapeSide;
  exports["shapesInit"] = shapesInit;
  exports["main"] = main;
})(PS);
PS["Main"].main();