...
(function($PS) {
  ...
  var update = function (model) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 62, column 16 - line 64, column 40): " + [ v.constructor.name ]);
      };
  };
  var randomNumberLessThan = function (mag) {
      return function (r) {
          ...
          var rx = Rand.rand(rs);
          var s = (function () {
              var $21 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rs.val)(2) === 0;
              if ($21) {
                  return 1.0;
              };
              return -1.0;
  ...
  var withSolution = function (v) {
      return function (time) {
          return Data_Map_Internal.insert(Data_Ord.ordString)("x")(liftExprDual(v.x))(Data_Map_Internal.insert(Data_Ord.ordString)("y")(liftExprDual(v.y))(Data_Map_Internal.insert(Data_Ord.ordString)("t")(liftExprDual(time))(Data_Map_Internal.empty)));
      };
  };
  var initialModel = {
      command0: "",
      ...
      return function (sol) {
          return function (time) {
              var evalCommand = function (str) {
                  var v = Parser_Parser.parse(Parser_Syntax.realDual)(str);
                  if (v instanceof Data_Either.Right) {
                      var v1 = Parser_Eval["eval"](Parser_Syntax.euclideanRingDual)(Parser_Syntax.powerDual)(Parser_Syntax.realDual)(withSolution(sol)(time))(v.value0);
                      if (v1 instanceof Data_Either.Right && v1.value0 instanceof Parser_Syntax.Lit) {
                          return new Data_Maybe.Just(v1.value0.value0.value0.height);
                      };
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Maybe.Nothing.value;
                  ...
                  return function (v2) {
                      return function (v3) {
                          return function (v4) {
                              return function (v5) {
                                  return {
                                      x: v1.x + (h * (v2.x + 2.0 * v3.x + 2.0 * v4.x + v5.x)) / 6.0,
                                      y: v1.y + (h * (v2.y + 2.0 * v3.y + 2.0 * v4.y + v5.y)) / 6.0
                                  };
                              };
                          };
                      };
      ...
      return function (model) {
          return function (v) {
              return function (t) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ SVGpork_Geometry.segment(SVGpork_Geometry.point("")(v.x + xoffset)(v.y + yoffset))(SVGpork_Geometry.point("")(v1.value0.x + xoffset)(v1.value0.y + yoffset))(Data_Maybe.Nothing.value) ])(segmentSolution(iter - 1 | 0)(model)(v1.value0)(t + h));
                  };
                  return [  ];
              };
          };
      ...
      return function (ctx) {
          return function (r) {
              return function (model) {
                  ...
                  var rx = Rand.rand(r);
                  var ry = Rand.rand(rx);
                  var y = randomNumberLessThan(magnitude)(ry);
                  var x = randomNumberLessThan(magnitude)(rx);
                  var rt = Rand.rand(ry);
                  var t = randomNumberLessThan(1.0e-3)(rt);
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ SVGpork_Render["render'"](SVGpork_Render.renderSequence(SVGpork_Render.renderSegment))(ctx)(segmentSolution(pathLength)(model)({
                      x: x,
                      y: y
  ...
  var render = function (model) {
      ...
      return Spork_Html_Elements.div([  ])([ Spork_Html_Core.elemWithNS(Data_Maybe.Just.create("http://www.w3.org/2000/svg"))("svg")([ Spork_Html_Core.attr("width")("800px"), Spork_Html_Core.attr("height")("600px") ])(Data_Array.concat(renderSolutions(pathNumber)(ctx)({
          gen: 345,
          seed: 543562263,
          val: 75
      })(model))), command0, command1 ]);
  };
  var app = {
      render: render,
      update: update,
