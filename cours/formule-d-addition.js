...
(function($PS) {
  ...
  var Data_Semigroup = $PS["Data.Semigroup"];
  var $$Math = $PS["Math"];                
  var main = Concur_VDom_Run.runWidgetInDom("main")(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.setTitle("Formules d'addition du sinus et du cosinus"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 2fr 3fr;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("600"), Concur_VDom_SVG.height("100%") ])((function () {
          var pi = Data_Geometry_Plane.point("I")(95.0 + 260.0)(350.0);
          var pj = Data_Geometry_Plane.point("J")(95.0)(350.0 - 260.0);
          var po = Data_Geometry_Plane.point("O")(95.0)(350.0);
          var vi = Data_Geometry_Plane.vector(po)(pi);
          var trigo = Data_Geometry_Plane.circle(po)(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(vi));
          var vj = Data_Geometry_Plane.vector(po)(pj);
          var ctx = {
              strokeWidth: 1.0,
              stroke: "#c3c2c7",
              textFill: "#c3c2c7",
          ...
          var angleB = -0.5;
          var vob = Data_Geometry_Plane.rotated(angleB)(vi);
          var pb = Data_Geometry_Plane.rename("B")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(po)(vob));
          var angleA = -0.35;
          var angleA$prime = angleA - $$Math.pi / 2.0;
          var voa$prime = Data_Geometry_Plane.rotated(angleA$prime)(vi);
          var pa$prime = Data_Geometry_Plane.rename("A'")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(po)(voa$prime));
          var voa = Data_Geometry_Plane.rotated(angleA)(vi);
          var pa = Data_Geometry_Plane.rename("A")(Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(po)(voa));
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderPoint)(po))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(po)(pi)(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(po)(pj)(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderCircle)(trigo))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderPoint)(pa))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(po)(pa)(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderArc)(Data_Geometry_Plane.arc(vi)(po)(voa)(260.0 * 0.4)(false)(true)(false)(new Data_Maybe.Just("   a"))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderPoint)(pb))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(po)(pb)(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderArc)(Data_Geometry_Plane.arc(vi)(po)(vob)(260.0 * 0.75)(false)(true)(false)(new Data_Maybe.Just("     a+b"))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderPoint)(pa$prime))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(po)(pa$prime)(new Data_Maybe.Just(""))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(draw(Concur_VDom_GeometryRender.renderRightAngle)(Data_Geometry_Plane.rightangle(vi)(po)(vj)(260.0 / 15.0)))(draw(Concur_VDom_GeometryRender.renderRightAngle)(Data_Geometry_Plane.rightangle(voa)(po)(voa$prime)(260.0 / 6.0)))))))))))))));
      })()), Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Sur le cercle trigonom\xe9trique du rep\xe8re "))(function () {
          var par = function (x) {
              return function (y) {
                  return "(" + (x + ("," + (y + ")")));
              };
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(O," + ("\\overrightarrow{\\imath}" + ("," + ("\\overrightarrow{\\jmath}" + ")")))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", on place "))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.ul(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("A"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", tel que "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(par("\\overrightarrow{\\imath}")("\\overrightarrow{OA}") + "=a"))(function () {
                              return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                          });
                      });
                  }))), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("B"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", tel que "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + "=a+b"))(function () {
                              return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                          });
                      });
                  }))), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("A'"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", tel que "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(par("\\overrightarrow{OA}")("\\overrightarrow{OA'}") + "= \\frac{\\pi}{2}"))(function () {
                              return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                          });
                      });
                  }))) ])))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Par la relation de Chasles, "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("=" + (par("\\overrightarrow{OA}")("\\overrightarrow{\\imath}") + ("+" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + "."))))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Donc par construction, "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("= -" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OA}") + ("+" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + "=-a+b-a=b."))))))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Par d\xe9finition, "))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\overrightarrow{OB}" + ("=\\cos(a+b)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a+b)" + ("\\overrightarrow{\\jmath}" + "."))))))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Mais comme "))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(O," + ("\\overrightarrow{OA}" + ("," + ("\\overrightarrow{OA'}" + ")")))))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est aussi un rep\xe8re orthonorm\xe9, on a aussi"))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation("\\overrightarrow{OB}" + ("=\\cos" + (par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("\\overrightarrow{OA}" + ("+" + ("\\sin" + (par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("\\overrightarrow{OA'}" + ".")))))))))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Or "))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\overrightarrow{OA}" + ("=" + ("\\cos(a)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a)" + "\\overrightarrow{\\jmath}"))))))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\overrightarrow{OA'}" + ("=" + ("\\cos(a+\\frac{\\pi}{2})" + ("\\overrightarrow{\\imath}" + ("+\\sin(a+\\frac{\\pi}{2})" + ("\\overrightarrow{\\jmath}" + ".")))))))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Donc"))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation("\\overrightarrow{OB}" + ("=\\cos(b)\\left(\\cos(a)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a)" + ("\\overrightarrow{\\jmath}" + ("\\right)" + ("+\\sin(b)\\left(-\\sin(a)" + ("\\overrightarrow{\\imath}" + ("+\\cos(a)" + ("\\overrightarrow{\\jmath}" + ("\\right)" + "."))))))))))))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Puis par unicit\xe9 de la d\xe9composition dans une base orthonorm\xe9e"))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation("\\bigg\\{\\begin{array}{l}\\cos(a+b)=\\cos(a)\\cos(b)-\\sin(a)\\sin(b)\\\\ \\sin(a+b)=\\sin(a)\\cos(b)+\\sin(b)\\cos(a) \\end{array}"))(function () {
                                                                                                                                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                                                                              });
                                                                                                                          });
                                                                                                                      });
