...
(function($PS) {
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      var v3 = DOM_Editor.setAttribute("style")("display: grid; grid-template-columns: 2fr 3fr;")(v2)();
      var v4 = DOM_Editor.appendChild(v2)(v.body)();
      var v5 = DOM_Editor.newSVG("position: relative; width: 600px; height: 100%;")(v2)();
      var v6 = DOM_Editor.createElement("div")(v.document)();
      var v7 = DOM_Editor.setId("description")(v6)();
      var v8 = DOM_Editor.appendChild(v6)(v2)();
      var ctx = SVG_Render.defaultContext(v5);
      ...
      var po = SVG_Geometry.point("O")(95.0)(350.0);
      var pi = SVG_Geometry.point("I")(95.0 + 260.0)(350.0);
      var pj = SVG_Geometry.point("J")(95.0)(350.0 - 260.0);
      var vi = SVG_Geometry.vector(po)(pi);
      var vj = SVG_Geometry.vector(po)(pj);
      var trigo = SVG_Geometry.circle(po)(SVG_Geometry.length(SVG_Geometry.measurableVector)(vi));
      draw(SVG_Render.renderPoint)(po)();
      draw(SVG_Render.renderSegment)(SVG_Geometry.segment(po)(pi)(new Data_Maybe.Just("")))();
      draw(SVG_Render.renderSegment)(SVG_Geometry.segment(po)(pj)(new Data_Maybe.Just("")))();
      draw(SVG_Render.renderCircle)(trigo)();
      ...
      var angleA = -0.35;
      var voa = SVG_Geometry.rotated(angleA)(vi);
      var pa = SVG_Geometry.rename("A")(SVG_Geometry.plus(SVG_Geometry.summublePointVector)(po)(voa));
      draw(SVG_Render.renderPoint)(pa)();
      draw(SVG_Render.renderSegment)(SVG_Geometry.segment(po)(pa)(new Data_Maybe.Just("")))();
      draw(SVG_Render.renderArc)(SVG_Geometry.arc(vi)(po)(voa)(260.0 * 0.4)(false)(true)(false)(new Data_Maybe.Just("   a")))();
      var angleB = -0.5;
      var vob = SVG_Geometry.rotated(angleB)(vi);
      var pb = SVG_Geometry.rename("B")(SVG_Geometry.plus(SVG_Geometry.summublePointVector)(po)(vob));
      draw(SVG_Render.renderPoint)(pb)();
      draw(SVG_Render.renderSegment)(SVG_Geometry.segment(po)(pb)(new Data_Maybe.Just("")))();
      draw(SVG_Render.renderArc)(SVG_Geometry.arc(vi)(po)(vob)(260.0 * 0.75)(false)(true)(false)(new Data_Maybe.Just("     a+b")))();
      var angleA$prime = angleA - $$Math.pi / 2.0;
      var voa$prime = SVG_Geometry.rotated(angleA$prime)(vi);
      var pa$prime = SVG_Geometry.rename("A'")(SVG_Geometry.plus(SVG_Geometry.summublePointVector)(po)(voa$prime));
      draw(SVG_Render.renderPoint)(pa$prime)();
      draw(SVG_Render.renderSegment)(SVG_Geometry.segment(po)(pa$prime)(new Data_Maybe.Just("")))();
      draw(SVG_Render.renderRightAngle)(SVG_Geometry.rightangle(vi)(po)(vj)(260.0 / 15.0))();
      draw(SVG_Render.renderRightAngle)(SVG_Geometry.rightangle(voa)(po)(voa$prime)(260.0 / 6.0))();
