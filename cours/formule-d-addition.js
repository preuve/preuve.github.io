...
(function($PS) {
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      var v1 = DOM_Editor.setAttribute("style")("background: #ffffff")(v.body)();
      var v2 = DOM_Editor.getElementById("canvas")(v.document)();
      var v3 = DOM_Editor.setAttribute("width")("400")(v2)();
      var v4 = DOM_Editor.setAttribute("height")("600")(v2)();
      var v5 = DOM_Editor.getContext2D(v2)();
      var ctx = {
          color: Color.rgb(0)(0)(0),
          lineWidth: 1.5
      };
      var draw = function (dictDrawableSet) {
          var $11 = Graphics_Drawing.render(v5);
          var $12 = Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
          return function ($13) {
              return $11($12($13));
          };
      };
      ...
      KaTeX.render("(O," + ("\\overrightarrow{\\imath}" + ("," + ("\\overrightarrow{\\jmath}" + ")"))))();
      KaTeX.raw(", on place ")();
      KaTeX.list([ KaTeX.cat([ KaTeX.subrender("A"), KaTeX.subraw(", tel que "), KaTeX.subrender(par("\\overrightarrow{\\imath}")("\\overrightarrow{OA}") + "=a") ]), KaTeX.cat([ KaTeX.subrender("B"), KaTeX.subraw(", tel que "), KaTeX.subrender(par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + "=a+b") ]), KaTeX.cat([ KaTeX.subrender("A'"), KaTeX.subraw(", tel que "), KaTeX.subrender(par("\\overrightarrow{OA}")("\\overrightarrow{OA'}") + "=\\frac{\\pi}{2}") ]) ])();
      var po = Graphics_Canvas_Geometry.point("O")(95.0)(350.0);
      var pi = Graphics_Canvas_Geometry.point("I")(95.0 + 260.0)(350.0);
      var pj = Graphics_Canvas_Geometry.point("J")(95.0)(350.0 - 260.0);
      var vi = Graphics_Canvas_Geometry.vector(po)(pi);
      var vj = Graphics_Canvas_Geometry.vector(po)(pj);
      var trigo = Graphics_Canvas_Geometry.circle(po)(Graphics_Canvas_Geometry.length(Graphics_Canvas_Geometry.measurableVector)(vi));
      draw(Graphics_Canvas_Geometry.drawablePoint)(po)();
      draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(po)(pi)(new Data_Maybe.Just("")))();
      draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(po)(pj)(new Data_Maybe.Just("")))();
      draw(Graphics_Canvas_Geometry.drawableCircle)(trigo)();
      var angleA = -0.35;
      var voa = Graphics_Canvas_Geometry.rotated(angleA)(vi);
      var pa = Graphics_Canvas_Geometry.rename("A")(Graphics_Canvas_Geometry.plus(Graphics_Canvas_Geometry.summublePointVector)(po)(voa));
      draw(Graphics_Canvas_Geometry.drawablePoint)(pa)();
      draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(po)(pa)(new Data_Maybe.Just("")))();
      draw(Graphics_Canvas_Geometry.drawableArc)(Graphics_Canvas_Geometry.arc(vi)(po)(voa)(260.0 * 0.4)(false)(true)(new Data_Maybe.Just("   a")))();
      var angleB = -0.5;
      var vob = Graphics_Canvas_Geometry.rotated(angleB)(vi);
      var pb = Graphics_Canvas_Geometry.rename("B")(Graphics_Canvas_Geometry.plus(Graphics_Canvas_Geometry.summublePointVector)(po)(vob));
      draw(Graphics_Canvas_Geometry.drawablePoint)(pb)();
      draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(po)(pb)(new Data_Maybe.Just("")))();
      draw(Graphics_Canvas_Geometry.drawableArc)(Graphics_Canvas_Geometry.arc(vi)(po)(vob)(260.0 * 0.75)(false)(true)(new Data_Maybe.Just("     a+b")))();
      var angleA$prime = angleA - $$Math.pi / 2.0;
      var voa$prime = Graphics_Canvas_Geometry.rotated(angleA$prime)(vi);
      var pa$prime = Graphics_Canvas_Geometry.rename("A'")(Graphics_Canvas_Geometry.plus(Graphics_Canvas_Geometry.summublePointVector)(po)(voa$prime));
      draw(Graphics_Canvas_Geometry.drawablePoint)(pa$prime)();
      draw(Graphics_Canvas_Geometry.drawableSegment)(Graphics_Canvas_Geometry.segment(po)(pa$prime)(new Data_Maybe.Just("")))();
      draw(Graphics_Canvas_Geometry.drawRightAngle)(Graphics_Canvas_Geometry.rightangle(vi)(po)(vj)(260.0 / 15.0))();
      draw(Graphics_Canvas_Geometry.drawRightAngle)(Graphics_Canvas_Geometry.rightangle(voa)(po)(voa$prime)(260.0 / 6.0))();
      KaTeX.raw("Par la relation de Chasles, ")();
      KaTeX.render(par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("=" + (par("\\overrightarrow{OA}")("\\overrightarrow{\\imath}") + ("+" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + ".")))))();
      KaTeX.newline();
      KaTeX.raw("Donc par construction, ")();
      KaTeX.render(par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("= -" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OA}") + ("+" + (par("\\overrightarrow{\\imath}")("\\overrightarrow{OB}") + "=-a+b-a=b.")))))();
      KaTeX.newline();
      KaTeX.newline();
      KaTeX.raw("Par d\xe9finition, ")();
      KaTeX.render("\\overrightarrow{OB}" + ("=\\cos(a+b)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a+b)" + ("\\overrightarrow{\\jmath}" + ".")))))();
      KaTeX.newline();
      KaTeX.raw("Mais comme ")();
      KaTeX.render("(O," + ("\\overrightarrow{OA}" + ("," + ("\\overrightarrow{OA'}" + ")"))))();
      KaTeX.raw(" est aussi un rep\xe8re orthonorm\xe9, on a aussi")();
      KaTeX.newline();
      KaTeX.newline();
      KaTeX.equation("\\overrightarrow{OB}" + ("=\\cos" + (par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("\\overrightarrow{OA}" + ("+" + ("\\sin" + (par("\\overrightarrow{OA}")("\\overrightarrow{OB}") + ("\\overrightarrow{OA'}" + "."))))))))();
      KaTeX.raw("Or ")();
      KaTeX.render("\\overrightarrow{OA}" + ("=" + ("\\cos(a)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a)" + "\\overrightarrow{\\jmath}")))))();
      KaTeX.raw(" et ")();
      KaTeX.render("\\overrightarrow{OA'}" + ("=" + ("\\cos(a+\\frac{\\pi}{2})" + ("\\overrightarrow{\\imath}" + ("+\\sin(a+\\frac{\\pi}{2})" + ("\\overrightarrow{\\jmath}" + "."))))))();
      KaTeX.newline();
      KaTeX.raw("Donc")();
      KaTeX.equation("\\overrightarrow{OB}" + ("=\\cos(b)\\left(\\cos(a)" + ("\\overrightarrow{\\imath}" + ("+\\sin(a)" + ("\\overrightarrow{\\jmath}" + ("\\right)" + ("+\\sin(b)\\left(-\\sin(a)" + ("\\overrightarrow{\\imath}" + ("+\\cos(a)" + ("\\overrightarrow{\\jmath}" + ("\\right)" + ".")))))))))))();
      KaTeX.raw("Puis par unicit\xe9 de la d\xe9composition dans une base orthonorm\xe9e")();
      KaTeX.newline();
      KaTeX.newline();
