...
(function($PS) {
  ...
  var ringFraction = new Data_Ring.Ring(function () {
      ...
      return function (f2) {
          return Data_Semiring.add(semiRingFraction)(f1)(Data_Semiring.mul(semiRingFraction)({
              num: -1 | 0,
              den: 1
          })(f2));
      };
  ...
  var eqFraction = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v.num === v1.num && v.den === v1.den;
      };
  });
  ...
  var rand = function (max) {
      return function (v) {
          ...
          return {
              val: Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(y)(max),
              gen: y
          };
      };
  };
  var randFraction = function (r) {
      var r0 = rand(avgNbFactors)(r);
      var r1 = rand(avgNbFactors)(r0);
      var nbNumFactors = 1 + r0.val | 0;
      var nrands = Data_Functor.map(Data_Functor.functorArray)(function (f) {
          return f(r1);
      })(Data_Traversable.scanl(Data_Traversable.traversableArray)(Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn))(Control_Category.identity(Control_Category.categoryFn))(Data_Array.replicate(nbNumFactors)(rand(Data_Array.length(primes)))));
      var nbDenFactors = 1 + r1.val | 0;
      var v = Data_Array.last(nrands);
      if (v instanceof Data_Maybe.Just) {
          var drands = Data_Functor.map(Data_Functor.functorArray)(function (f) {
              return f(v.value0);
          })(Data_Traversable.scanl(Data_Traversable.traversableArray)(Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn))(Control_Category.identity(Control_Category.categoryFn))(Data_Array.replicate(nbDenFactors)(rand(Data_Array.length(primes)))));
          ...
          if (v1 instanceof Data_Maybe.Just) {
              ...
              var nextRand = rand(2)(v1.value0);
              var sign = (2 * nextRand.val | 0) - 1 | 0;
          ...
          throw new Error("Failed pattern match at Main (line 76, column 7 - line 76, column 28): " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main (line 72, column 7 - line 72, column 28): " + [ v.constructor.name ]);
  };
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              KaTeX.newline();
              KaTeX.list([ KaTeX.cat([ KaTeX.subraw("10 questions") ]), KaTeX.cat([ KaTeX.subrender("\\frac{1}{2}"), KaTeX.subraw(" point par bonne r\xe9ponse") ]) ])();
              KaTeX.newline();
              ...
              var rep = [ "r\xe9ponses: 1)", "\\mathcal{S}=" + (function () {
                  var $48 = Data_Eq.eq(eqFraction)(f1.fraction)(f2.fraction);
                  if ($48) {
