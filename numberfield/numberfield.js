(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply1(map9($$const(identity2))(a2))(b2);
      };
    };
  };
      ...
      return {
        event: function(a2) {
          return function(v, k2) {
            $$void3(modify2(alter2(function(v1) {
              if (v1 instanceof Nothing) {
                return new Just([k2]);
              }
              ;
            ...
            return $$void3(modify2(alter2(function(v1) {
              if (v1 instanceof Nothing) {
                return Nothing.value;
              }
              ;
      ...
      return function(interpreter) {
        ...
        return function(v1) {
          if (v1 instanceof FixedChildren$prime) {
            return merge2(map12(flatten(v)(psr)(interpreter))(v1.value0));
          }
          ;
          ...
          if (v1 instanceof DynamicChildren$prime) {
            return makeLemmingEventO(function(v2, v3) {
              ...
              var cancelOuter = v2(v1.value0, function(inner) {
                ...
                var c0 = v2(inner, function(kid$prime) {
                  ...
                  if (kid$prime instanceof Insert && stage instanceof Begin) {
                    ...
                    var c1 = v2(flatten(v)(function() {
                      var $122 = {};
                      for (var $123 in psr) {
                        if ({}.hasOwnProperty.call(psr, $123)) {
                          $122[$123] = psr[$123];
                        }
                        ;
                      }
                      ;
                      $122.scope = myScope;
                      $122.raiseId = function(id) {
                        return $$void4(modify3(append3([id]))(myIds));
                      };
                      return $122;
                    }())(interpreter)(kid$prime.value0), v3);
                    $$void4(modify3(insert4(eltsUnsubId)(c1))(cancelInner))();
                ...
                $$void4(modify3(insert4(myUnsubId)(c0))(cancelInner))();
    ...
    var go2 = function(v) {
      return function(v1) {
        return makeLemmingEventO(function(v2, k) {
          var me = v1.ids();
          v.raiseId(me)();
          var unsub = v2(merge3([pure3(v1.makeText({
            id: me,
            parent: v.parent,
            pos: v.pos,
            scope: v.scope,
    ...
    return function(children) {
      return function(v) {
        return makeLemmingEventO(function(v1, k) {
          return v1(alt2(pure3(v.makeRoot({
            id: "deku-root",
            root
        ...
        var go2 = function(v) {
          return function(v1) {
            return makeLemmingEventO(function(v2, k) {
              var me = v1.ids();
              v.raiseId(me)();
              var unsub = v2(alt2(merge3(append4([pure3(v1.makeElement({
                id: me,
                parent: v.parent,
                scope: v.scope,
                tag,
  ...
  var a = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("a")(attributes)(coerce3(fixed(coerce3(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var br = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("br")(attributes)(coerce4(fixed(coerce4(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var div2 = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("div")(attributes)(coerce5(fixed(coerce5(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var h1 = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("h1")(attributes)(coerce6(fixed(coerce6(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var h2 = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("h2")(attributes)(coerce7(fixed(coerce7(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  var h2_ = /* @__PURE__ */ h2(/* @__PURE__ */ empty(plusEvent));

  // output/Deku.DOM.Elt.H3/index.js
  var coerce8 = /* @__PURE__ */ coerce();
  var h3 = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("h3")(attributes)(coerce8(fixed(coerce8(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var h5 = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("h5")(attributes)(coerce9(fixed(coerce9(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  var h5_ = /* @__PURE__ */ h5(/* @__PURE__ */ empty(plusEvent));

  // output/Deku.DOM.Elt.Label/index.js
  var coerce10 = /* @__PURE__ */ coerce();
  var label = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("label")(attributes)(coerce10(fixed(coerce10(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var li = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("li")(attributes)(coerce11(fixed(coerce11(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var pre = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("pre")(attributes)(coerce12(fixed(coerce12(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var ul = function(attributes) {
    return function(kids) {
      return new Element$prime(elementify("ul")(attributes)(coerce13(fixed(coerce13(mapWithIndex2(unsafeSetPos)(kids))))));
    };
  };
  ...
  var attr5 = /* @__PURE__ */ attr(attrA_HrefString);
  ...
  var section_2 = function(str) {
    return function(dictFunctor) {
      ...
      return function(dictMonadState) {
        return put1(dictMonadState)(h2_([text_(str)]));
      };
    };
  };
  ...
  var subsubsubsection_ = function(str) {
    return function(dictFunctor) {
      var put1 = put2(dictFunctor);
      return function(dictMonadState) {
        return put1(dictMonadState)(h5_([text_(str)]));
      };
    };
  };
  var t = function(dictFunctor) {
    ...
    return function(dictMonadState) {
      ...
      return function(str) {
        return put22(label(map13(t$prime)(str))([]));
      };
    };
  };
  ...
  var pre_2 = function(str) {
    return function(dictFunctor) {
      var put1 = put2(dictFunctor);
      return function(dictMonadState) {
        return put1(dictMonadState)(pre_([text_(str)]));
      };
    };
  };
  ...
  var m = function(dictFunctor) {
    ...
    return function(dictMonadState) {
      var put22 = put1(dictMonadState);
      return function(str) {
        return put22(label(map13(m$prime)(str))([]));
      };
    };
  };
  ...
  var equation2 = function(dictFunctor) {
    ...
    return function(dictMonadState) {
      var put22 = put1(dictMonadState);
      return function(str) {
        return put22(label(map13(function(txt) {
          return attr2(Self.value)(display(txt));
        })(str))([]));
      };
    };
  };
  var equation_ = function(dictFunctor) {
    var equation1 = equation2(dictFunctor);
    return function(dictMonadState) {
      var equation22 = equation1(dictMonadState);
      return function(str) {
        return equation22(pure4(str));
      };
    };
  };
  var a_2 = function(str) {
    return function(dictFunctor) {
      var put1 = put2(dictFunctor);
      return function(dictMonadState) {
        return put1(dictMonadState)(a(pure4(attr5(Href.value)(str)))([text_(str)]));
      };
    };
  };
  ...
  var nl2 = /* @__PURE__ */ nl(functorStateT3)(monadStateStateT3);
  var t_2 = /* @__PURE__ */ t_(functorStateT3)(monadStateStateT3);
  var put3 = /* @__PURE__ */ put2(functorStateT3)(monadStateStateT3);
    ...
    return discard3(nl2)(function() {
      return discard3(subsubsubsection_("Technical documentation at")(functorStateT3)(monadStateStateT3))(function() {
        return discard3(a_2("https://pursuit.purescript.org/packages/purescript-numberfield")(functorStateT3)(monadStateStateT3))(function() {
          return discard3(section_2("Computation with extension fields of the field of rational numbers ")(functorStateT3)(monadStateStateT3))(function() {
            return discard3(t_2("Thanks to the introduction of arbitrary precision integers in Javascript, it is now possible to perform ambitious theoretic computations in the browser without drowning in low-level details."))(function() {
              return discard3(nl2)(function() {
                return discard3(nl2)(function() {
                  return discard3(t_2("The main purpose of this page is to show interactively"))(function() {
                    return discard3(put3(ul_([li_(fromIncremental(discard3(t_2("how to do computations in "))(function() {
                      return discard3(m_2("\\mathbb{Q}(\\alpha)"))(function() {
                        return discard3(t_2(" where "))(function() {
                          return discard3(m_2("\\alpha"))(function() {
                            return discard3(t_2(" is an algebraic number "))(function() {
                              return get3;
                            });
                          });
                        });
                      ...
                      return discard3(t_2("A minimal understanding of how to work with "))(function() {
                        return discard3(a_2("https://pursuit.purescript.org/packages/purescript-sparse-polynomials")(functorStateT3)(monadStateStateT3))(function() {
                          return discard3(t_2(" is assumed."))(function() {
                            return discard3(pre_2("import Prelude\n\n> import Data.Algebraic.NumberField\n> import Data.Ratio (Ratio, (%))\n> import Data.Reflectable (reifyType)\n> import Data.Sparse.Polynomial ((^), display, factor)\n> import JS.BigInt (BigInt, fromInt)")(functorStateT3)(monadStateStateT3))(function() {
                              return discard3(put3(h3_(fromIncremental(discard3(t_2("Computations in "))(function() {
                                return discard3(m_2("\\mathbb{Q}(\\alpha)"))(function() {
                                  return get3;
                                });
                              })))))(function() {
                                return discard3(t_2("First, let's choose "))(function() {
                                  return discard3(m_2("\\mathbb{Q}"))(function() {
                                    return discard3(t_2(" as the undelying field by defining its unity"))(function() {
                                      return discard3(pre_2("> bigOne = fromInt 1 % fromInt 1")(functorStateT3)(monadStateStateT3))(function() {
                                        return discard3(t_2("As an initial example, suppose that "))(function() {
                                          return discard3(m_2("\\alpha"))(function() {
                                            return discard3(t_2(" is an algebraic number we know the minimal polynomial of."))(function() {
                                              return discard3(nl2)(function() {
                                                return discard3(t_2("For instance, "))(function() {
                                                  return discard3(m_2("\\alpha = \\phi"))(function() {
                                                    return discard3(t_2(", the golden ratio satisfying"))(function() {
                                                      return discard3(equation_2("\\phi ^ 2 = \\phi + 1"))(function() {
                                                        return discard3(t_2("or rather"))(function() {
                                                          return discard3(equation_2("\\phi ^ 2 - \\phi - 1 = 0."))(function() {
                                                            return discard3(t_2("So, the minimal polynomial of "))(function() {
                                                              return discard3(m_2("\\alpha"))(function() {
                                                                return discard3(t_2(" is"))(function() {
                                                                  return discard3(equation_2("P_1(X) = X^2-X-1"))(function() {
                                                                    return discard3(t_2("since this expression is irreductible in "))(function() {
                                                                      return discard3(m_2("\\mathbb{Q}"))(function() {
                                                                        return discard3(t_2(" (see below.)"))(function() {
                                                                          return discard3(nl2)(function() {
                                                                            return discard3(nl2)(function() {
                                                                                ...
                                                                                return discard3(m_2("\\mathbb{Q}(\\alpha)"))(function() {
                                                                                  return discard3(t_2(" can be performed in "))(function() {
                                                                                    return discard3(m_2("\\mathbb{Q}[X]/ P_1(X)"))(function() {
                                                                                      return discard3(t_2(" which is, significant fact, a field "))(function() {
                                                                                        return discard3(m_2("-"))(function() {
                                                                                          return discard3(t_2(" like "))(function() {
                                                                                            return discard3(m_2("\\mathbb{Q} \\, -"))(function() {
                                                                                              return discard3(t_2(" whereas "))(function() {
                                                                                                return discard3(m_2("\\mathbb{Q}[X]"))(function() {
                                                                                                  return discard3(t_2(" is only a ring."))(function() {
                                                                                                    return discard3(nl2)(function() {
                                                                                                      return discard3(t_2("With the property that "))(function() {
                                                                                                        return discard3(m_2("\\mathbb{Q}(\\alpha)"))(function() {
                                                                                                          return discard3(t_2(" is also a vector space of the same dimension as the degree of "))(function() {
                                                                                                            return discard3(m_2("P_1"))(function() {
                                                                                                              return discard3(t_2(", we can conclude that every addition, multiplication, subtraction and inversion involving elements of "))(function() {
                                                                                                                return discard3(m_2("\\mathbb{Q}(\\alpha)"))(function() {
                                                                                                                  return discard3(t_2(" can eventually be simplified to an expression of the form"))(function() {
                                                                                                                    return discard3(equation_2("a\\alpha + b"))(function() {
                                                                                                                      return discard3(t_2("where "))(function() {
                                                                                                                        return discard3(m_2("a"))(function() {
                                                                                                                          return discard3(t_2(" and "))(function() {
                                                                                                                            return discard3(m_2("b"))(function() {
                                                                                                                              return discard3(t_2(" are elements of "))(function() {
                                                                                                                                return discard3(m_2("\\mathbb{Q}."))(function() {
                                                                                                                                  return discard3(nl2)(function() {
                                                                                                                                    return discard3(nl2)(function() {
                                                                                                                                      return discard3(t_2("To illustrate, let's simplify"))(function() {
                                                                                                                                        return discard3(equation_2("\\frac{\\phi + 2}{(\\phi-2)^2}."))(function() {
                                                                                                                                          return discard3(t_2("This is a 3-step process."))(function() {
                                                                                                                                            return discard3(nl2)(function() {
                                                                                                                                              return discard3(t_2("The first thing to do is to define a framework in which computations will take place."))(function() {
                                                                                                                                                return discard3(pre_2("> fw1 = framework (bigOne ^ 0) [one ^ 2 - one ^ 1 - one ^ 0]")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                  return discard3(t_2("The first argument is the polynomic representation of unity as a polynomial of arity equal to the number of univariate polynomials that define "))(function() {
                                                                                                                                                    return discard3(m_2("\\alpha"))(function() {
                                                                                                                                                      return discard3(t_2(", one here."))(function() {
                                                                                                                                                        return discard3(nl2)(function() {
                                                                                                                                                          return discard3(t_2("The second argument is an array listing the polynomial(s) it(them)self(ves)."))(function() {
                                                                                                                                                            return discard3(nl2)(function() {
                                                                                                                                                              return discard3(nl2)(function() {
                                                                                                                                                                return discard3(t_2("The second step is to define the expression,"))(function() {
                                                                                                                                                                  return discard3(pre_2("> :paste\n\u2026 test1 :: forall f. Expression f _\n\u2026 test1 = const $\n\u2026    let phi = element (bigOne ^ 1)\n\u2026        toFrac n = element ((fromInt n % fromInt 1) ^ 0)\n\u2026     in (phi + toFrac 2) * recip ((phi - toFrac 2) * (phi - toFrac 2))\n\u2026")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                    return discard3(t_2("then hit "))(function() {
                                                                                                                                                                      return discard3(m_2("<"))(function() {
                                                                                                                                                                        return discard3(t_2("CTRL"))(function() {
                                                                                                                                                                          return discard3(m_2(">"))(function() {
                                                                                                                                                                            return discard3(t_2("+D."))(function() {
                                                                                                                                                                              return discard3(pre_2(">")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                return discard3(t_2("The compiler will refuse the expression if the type signature is not provided. "))(function() {
                                                                                                                                                                                  return discard3(nl2)(function() {
                                                                                                                                                                                    return discard3(t_2("The first binding is the selection of our variable, "))(function() {
                                                                                                                                                                                      return discard3(m_2("\\phi"))(function() {
                                                                                                                                                                                        return discard3(t_2(". This makes the correspondance between the (unique) variable of a univariate polynomial and the minimal polynomial provided."))(function() {
                                                                                                                                                                                          return discard3(nl2)(function() {
                                                                                                                                                                                            return discard3(t_2("The second binding defines a helper function introducing numerical constants in the expression."))(function() {
                                                                                                                                                                                              return discard3(nl2)(function() {
                                                                                                                                                                                                return discard3(t_2("Then, the expression is naturally defined with the division replaced by a product with the reciprocal."))(function() {
                                                                                                                                                                                                  return discard3(nl2)(function() {
                                                                                                                                                                                                    return discard3(nl2)(function() {
                                                                                                                                                                                                      return discard3(t_2("From the last step"))(function() {
                                                                                                                                                                                                        return discard3(pre_2('> display ["phi"] $ run $ reifyType fw1 (build test1)\n"(11 % 1)\xD7phi+7 % 1"')(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                          return discard3(t_2("we conclude that the simplification gives"))(function() {
                                                                                                                                                                                                            return discard3(equation_2("11\\phi+7"))(function() {
                                                                                                                                                                                                              return discard3(put3(h3_(fromIncremental(discard3(t_2("Computations in "))(function() {
                                                                                                                                                                                                                return discard3(m_2("\\mathbb{Q}(\\alpha_0,\\alpha_1,\\cdots)"))(function() {
                                                                                                                                                                                                                  return get3;
                                                                                                                                                                                                                });
                                                                                                                                                                                                              })))))(function() {
                                                                                                                                                                                                                return discard3(t_2("This second paragraph is nothing but the general case from which the first paragraph is extracted."))(function() {
                                                                                                                                                                                                                  return discard3(nl2)(function() {
                                                                                                                                                                                                                    return discard3(t_2("Nevertheless, it will show two new interesting tools which would have seemed trivial if presented earlier."))(function() {
                                                                                                                                                                                                                      return discard3(nl2)(function() {
                                                                                                                                                                                                                        return discard3(nl2)(function() {
                                                                                                                                                                                                                          return discard3(t_2("Now, we want to work with several algebraic numbers, "))(function() {
                                                                                                                                                                                                                            return discard3(m_2("\\alpha_i"))(function() {
                                                                                                                                                                                                                              return discard3(t_2(", each of which have a known minimal polynomial."))(function() {
                                                                                                                                                                                                                                return discard3(nl2)(function() {
                                                                                                                                                                                                                                  return discard3(t_2("Behind the scene, the same process happens, as before, "))(function() {
                                                                                                                                                                                                                                    return discard3(t_2(" with an algebraic number, "))(function() {
                                                                                                                                                                                                                                      return discard3(m_2("\\alpha"))(function() {
                                                                                                                                                                                                                                        return discard3(t_2(", along with its minimal polynomial. The difference now is that "))(function() {
                                                                                                                                                                                                                                          return discard3(m_2("\\alpha"))(function() {
                                                                                                                                                                                                                                            return discard3(t_2(" is not provided anymore, it is computed as the sum of the "))(function() {
                                                                                                                                                                                                                                              return discard3(m_2("\\alpha_i"))(function() {
                                                                                                                                                                                                                                                return discard3(t_2(" along with its minimal polynomial."))(function() {
                                                                                                                                                                                                                                                  return discard3(nl2)(function() {
                                                                                                                                                                                                                                                    return discard3(nl2)(function() {
                                                                                                                                                                                                                                                      return discard3(t_2("As before, let's illustrate from an example, by expressing"))(function() {
                                                                                                                                                                                                                                                        return discard3(equation_2("\\frac{1}{\\sqrt[3]{4}+\\sqrt[3]{2}-\\sqrt{3}}"))(function() {
                                                                                                                                                                                                                                                          return discard3(t_2("as a sum rather than a quotient."))(function() {
                                                                                                                                                                                                                                                            return discard3(nl2)(function() {
                                                                                                                                                                                                                                                              return discard3(nl2)(function() {
                                                                                                                                                                                                                                                                return discard3(t_2("With "))(function() {
                                                                                                                                                                                                                                                                  return discard3(m_2("\\alpha_0 = \\sqrt[3]{2}"))(function() {
                                                                                                                                                                                                                                                                    return discard3(t_2(" and "))(function() {
                                                                                                                                                                                                                                                                      return discard3(m_2("\\alpha_1 = \\sqrt{3}"))(function() {
                                                                                                                                                                                                                                                                        return discard3(t_2(" and, since "))(function() {
                                                                                                                                                                                                                                                                          return discard3(m_2("\\alpha_0^2 = \\sqrt[3]{4}"))(function() {
                                                                                                                                                                                                                                                                            return discard3(t_2(", we have only two algebraic numbers to deal with."))(function() {
                                                                                                                                                                                                                                                                              return discard3(pre_2("> fw2 = let f = fromInt in framework (bigOne^0^0) [one^3 - (f 2 % f 1)^0, one^2 - (f 3 % f 1)^0]")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                return discard3(t_2("From the following request, the minimal polynomial of "))(function() {
                                                                                                                                                                                                                                                                                  return discard3(m_2("\\sqrt[3]{2}+\\sqrt{3}"))(function() {
                                                                                                                                                                                                                                                                                    return discard3(t_2(" is"))(function() {
                                                                                                                                                                                                                                                                                      return discard3(equation_2("P_2(X)=X^6-9X^4-4X^3+27X^2-36X-23"))(function() {
                                                                                                                                                                                                                                                                                        return discard3(pre_2("> minimalPolynomial fw2\n(1 % 1)\xD7z^6+(-9 % 1)\xD7z^4+(-4 % 1)\xD7z^3+(27 % 1)\xD7z^2+(-36 % 1)\xD7z+(-23 % 1)")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                          return discard3(t_2("From the following request, if we define "))(function() {
                                                                                                                                                                                                                                                                                            return discard3(equation_2("Q_0(X)=-\\frac{2 }{51}X^5-\\frac{1 }{102}X^4+\\frac{20}{51}X^3+\\frac{13}{51}X^2-\\frac{38}{51}X+\\frac{91}{102}"))(function() {
                                                                                                                                                                                                                                                                                              return discard3(t_2("and"))(function() {
                                                                                                                                                                                                                                                                                                return discard3(equation_2("Q_1(X)=\\frac{2 }{51}X^5+\\frac{1 }{102}X^4-\\frac{20}{51}X^3-\\frac{13}{51}X^2+\\frac{89}{51}X-\\frac{91}{102}"))(function() {
                                                                                                                                                                                                                                                                                                  return discard3(t_2("then"))(function() {
                                                                                                                                                                                                                                                                                                    return discard3(equation_2("Q_0(\\sqrt[3]{2}+\\sqrt{3})=\\sqrt[3]{2}"))(function() {
                                                                                                                                                                                                                                                                                                      return discard3(t_2("and"))(function() {
                                                                                                                                                                                                                                                                                                        return discard3(equation_2("Q_1(\\sqrt[3]{2}+\\sqrt{3})=\\sqrt{3}"))(function() {
                                                                                                                                                                                                                                                                                                          return discard3(pre_2("> toPrimitive fw2\n[(-2 % 51)\xD7z^5+(-1 % 102)\xD7z^4+(20 % 51)\xD7z^3+(13 % 51)\xD7z^2+(-38 % 51)\xD7z+91 % 102,(2 % 51)\xD7z^5+(1 % 102)\xD7z^4+(-20 % 51)\xD7z^3+(-13 % 51)\xD7z^2+(89 % 51)\xD7z+(-91 % 102)]")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                            return discard3(nl2)(function() {
                                                                                                                                                                                                                                                                                                              return discard3(t_2("Going back to our initial problem"))(function() {
                                                                                                                                                                                                                                                                                                                return discard3(pre_2("> :paste\n\u2026 test2 :: forall f. Expression f _\n\u2026 test2 = const $\n\u2026    let cbrt2 = element (bigOne ^ 0 ^ 1)\n\u2026        sqrt3 = element (bigOne ^ 1 ^ 0)\n\u2026     in (recip $ cbrt2 * cbrt2 + cbrt2 - sqrt3)\n\u2026")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                                  return discard3(pre_2('> display ["cr2", "sr3"] $ run $ reifyType fw2 (build test2)\n"((1 % 3)\xD7sr3+(-1 % 3))\xD7cr2^2+(1 % 3)\xD7cr2+(-1 % 3)\xD7sr3+2 % 3"')(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                                    return discard3(t_2("the expression we're looking for is"))(function() {
                                                                                                                                                                                                                                                                                                                      return discard3(equation_2("\\frac{1}{3}\\sqrt{3}\\sqrt[3]{4}-\\frac{1}{3}\\sqrt[3]{4}+\\frac{1}{3}\\sqrt[3]{2}-\\frac{1}{ 3}\\sqrt{3}+\\frac{2}{3}."))(function() {
                                                                                                                                                                                                                                                                                                                        return discard3(put3(h3_(fromIncremental(discard3(t_2("Troubleshooting (is "))(function() {
                                                                                                                                                                                                                                                                                                                          return discard3(m_2("P"))(function() {
                                                                                                                                                                                                                                                                                                                            return discard3(t_2(" minimal ?)"))(function() {
                                                                                                                                                                                                                                                                                                                              return get3;
                                                                                                                                                                                                                                                                                                                            });
                                                                                                                                                                                                                                                                                                                          });
                                                                                                                                                                                                                                                                                                                        })))))(function() {
                                                                                                                                                                                                                                                                                                                          return discard3(t_2("Given an algebraic expression, it is sometimes harder than it seems to choose the minimal polynomial for it."))(function() {
                                                                                                                                                                                                                                                                                                                            return discard3(nl2)(function() {
                                                                                                                                                                                                                                                                                                                              return discard3(t_2("For instance, with"))(function() {
                                                                                                                                                                                                                                                                                                                                return discard3(equation_2("\\alpha=\\sqrt{7+\\sqrt{24}}"))(function() {
                                                                                                                                                                                                                                                                                                                                  return discard3(t_2("we can derive"))(function() {
                                                                                                                                                                                                                                                                                                                                    return discard3(equation_2("(\\alpha^2-7)^2=24"))(function() {
                                                                                                                                                                                                                                                                                                                                      return discard3(t_2("and"))(function() {
                                                                                                                                                                                                                                                                                                                                        return discard3(equation_2("\\alpha^4-14\\alpha^2+49=24"))(function() {
                                                                                                                                                                                                                                                                                                                                          return discard3(t_2("However, if we choose"))(function() {
                                                                                                                                                                                                                                                                                                                                            return discard3(equation_2("\\tilde{P}(X)=X^4-14X^2+25"))(function() {
                                                                                                                                                                                                                                                                                                                                              return discard3(t_2("as the minimal polynomial, we can't get the right answer for "))(function() {
                                                                                                                                                                                                                                                                                                                                                return discard3(m_2("\\alpha^3-9\\alpha"))(function() {
                                                                                                                                                                                                                                                                                                                                                  return discard3(t_2(" (which is "))(function() {
                                                                                                                                                                                                                                                                                                                                                    return discard3(m_2("10"))(function() {
                                                                                                                                                                                                                                                                                                                                                      return discard3(t_2(", but we don't know it yet.)"))(function() {
                                                                                                                                                                                                                                                                                                                                                        return discard3(nl2)(function() {
                                                                                                                                                                                                                                                                                                                                                          return discard3(t_2("The reason of this issue is due to required irreductibility of the minimal polynomial, but that's not the case for "))(function() {
                                                                                                                                                                                                                                                                                                                                                            return discard3(m_2("\\tilde{P}"))(function() {
                                                                                                                                                                                                                                                                                                                                                              return discard3(t_2(" by looking at the result of the `factor` function which displays some non-trivial  factors of "))(function() {
                                                                                                                                                                                                                                                                                                                                                                return discard3(m_2("\\tilde{P}"))(function() {
                                                                                                                                                                                                                                                                                                                                                                  return discard3(t_2(":"))(function() {
                                                                                                                                                                                                                                                                                                                                                                    return discard3(pre_2("> frac n = fromInt n % fromInt 1\n> ptilde = frac 1^4 - frac 14^2 + frac 25^0\n>\n> factor ptilde\n[(-1 % 1)\xD7x^2+(-2 % 1)\xD7x+5 % 1,(-1 % 1)\xD7x^2+(2 % 1)\xD7x+5 % 1,(1 % 1)\xD7x^2+(2 % 1)\xD7x+(-5 % 1),(1 % 1)\xD7x^2+(-2 % 1)\xD7x+(-5 % 1)]")(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                                                                                      return discard3(t_2("Incidentally, each of these factors can be chosen as a minimal polynomial for "))(function() {
                                                                                                                                                                                                                                                                                                                                                                        return discard3(m_2("\\alpha"))(function() {
                                                                                                                                                                                                                                                                                                                                                                          return discard3(t_2(". Let's choose the last one, and check that it satisfies "))(function() {
                                                                                                                                                                                                                                                                                                                                                                            return discard3(m_2("\\alpha"))(function() {
                                                                                                                                                                                                                                                                                                                                                                              return discard3(t_2("'s definition:"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                return discard3(pre_2('> display ["a"] $ run $ reifyType (framework (frac 1 ^ 0) [one ^ 2 - frac 2 ^ 1 - frac 5 ^ 0]) (build ((const $ let a = element (frac 1 ^ 1) in let kst n = element (frac n ^ 0) in (a*a-kst 7)*(a*a-kst 7)) :: forall f. Expression f _))\n"24 % 1"')(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                                                                                                  return discard3(t_2("Now, the framework is coherent:"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                    return discard3(pre_2('> display ["a"] $ run $ reifyType (framework (frac 1 ^ 0) [one ^ 2 - frac 2 ^ 1 - frac 5 ^ 0]) (build ((const $ let a = element (frac 1 ^ 1) in let kst n = element (frac n ^ 0) in a*a*a -kst 9 *a) :: forall f. Expression f _))\n"10 % 1"')(functorStateT3)(monadStateStateT3))(function() {
                                                                                                                                                                                                                                                                                                                                                                                      return get3;
                                                                                                                                                                                                                                                                                                                                                                                    });
                                                                                                                                                                                                                                                                                                                                                                                  });
                                                                                                                                                                                                                                                                                                                                                                                });
  ...
  var main2 = /* @__PURE__ */ runInBody(/* @__PURE__ */ div_(documentation));
