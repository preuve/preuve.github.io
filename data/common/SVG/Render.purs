...
foreign import svgline :: DOM.Node 
                       -> Position -> Position 
                       -> Position -> Position 
                       -> Color -> Size -> Effect Unit
foreign import svgtext :: DOM.Node 
                       -> Position -> Position 
                       -> Color -> FontStyle 
                       -> String -> Effect Unit
foreign import svgpath :: DOM.Node
                       -> Color -> Size
                       -> Color 
                       -> Path -> Effect Unit
                       
foreign import svgclear :: DOM.Node -> Effect Unit
...
defaultContext :: DOM.Node -> Context
defaultContext svg = 
  { svg
  , stroke: "#000"
  , fill: "#00000000"
