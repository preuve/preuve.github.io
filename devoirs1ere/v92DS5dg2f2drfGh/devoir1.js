...
(function($PS) {
  ...
  var renderCircle = new Render(function (v) {
      return function (v1) {
          return [ path(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.center) - v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.center)) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 1 0 " + (Data_Show.show(Data_Show.showNumber)(2.0 * v1.radius) + " 0")))))))))))), path(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.center) - v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.center)) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 1 1 " + (Data_Show.show(Data_Show.showNumber)(2.0 * v1.radius) + " 0")))))))))))) ];
      };
  });
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le cercle trigonom\xe9trique suivant :"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("180"), Concur_VDom_SVG.height("180"), Concur_VDom_SVG.viewBox("-10 -10 200 200") ])((function () {
                                              var pI = Data_Geometry_Plane.point("I")(80.0 + 70.0)(80.0);
                                              var pJ = Data_Geometry_Plane.point("J")(80.0)(80.0 - 70.0);
                                              var pM = Data_Geometry_Plane.point("M")(80.0 + 70.0 * $$Math.cos(angle0.approx))(80.0 - 70.0 * $$Math.sin(angle0.approx));
                                              var pO = Data_Geometry_Plane.point("O")(80.0)(80.0);
                                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSequence(Concur_VDom_GeometryRender.renderPoint))([ pO, pI, pJ ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderCircle)(Data_Geometry_Plane.circle(pO)(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(Data_Geometry_Plane.vector(pO)(pI)))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(pO)(pI)(Data_Maybe.Nothing.value)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(pO)(pJ)(Data_Maybe.Nothing.value)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderRightAngle)(Data_Geometry_Plane.rightangle(Data_Geometry_Plane.vector(pO)(pI))(pO)(Data_Geometry_Plane.vector(pO)(pJ))(10.0)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_GeometryRender.renderPoint)(pM))(render(Concur_VDom_GeometryRender.renderSegment)(Data_Geometry_Plane.segment(pO)(pM)(Data_Maybe.Nothing.value))))))));
