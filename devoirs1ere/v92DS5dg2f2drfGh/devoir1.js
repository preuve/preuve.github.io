(() => {
  ...
  var viewBox = /* @__PURE__ */ attr2("viewBox");
  ...
  var scale = function(k) {
    return function(v) {
      return mul(semiringPoly(eqNumber)(semiringNumber))(monoPol(k)(0))(v);
    };
  };
  ...
  var renderCircle = {
    "render'": function(v) {
      return function(v1) {
        return [path2(v.stroke)(v.strokeWidth)(v.fill)("M " + (show(showNumber)(abs3(basedPoint)(v1.center) - v1.radius) + (" " + (show(showNumber)(ord(basedPoint)(v1.center)) + (" " + ("a " + (show(showNumber)(v1.radius) + (" " + (show(showNumber)(v1.radius) + (" " + ("0 1 0 " + (show(showNumber)(2 * v1.radius) + " 0")))))))))))), path2(v.stroke)(v.strokeWidth)(v.fill)("M " + (show(showNumber)(abs3(basedPoint)(v1.center) - v1.radius) + (" " + (show(showNumber)(ord(basedPoint)(v1.center)) + (" " + ("a " + (show(showNumber)(v1.radius) + (" " + (show(showNumber)(v1.radius) + (" " + ("0 1 1 " + (show(showNumber)(2 * v1.radius) + " 0"))))))))))))];
      };
    }
  };
  var renderRightAngle = {
    "render'": function(v) {
      return function(v1) {
        var w = scale(v1.radius / length5(measurableVector)(v1.origin))(v1.origin);
        var v2 = scale(v1.radius / length5(measurableVector)(v1.extremity))(v1.extremity);
        ...
        var m2 = plus(summublePointVector)(v1.center)(u);
  ...
  var renderPoint = {
    "render'": function(v) {
      return function(v1) {
        return [line2(abs3(basedPoint)(v1) - 5)(ord(basedPoint)(v1) - 5)(abs3(basedPoint)(v1) + 5)(ord(basedPoint)(v1) + 5)(v.stroke)(v.strokeWidth), line2(abs3(basedPoint)(v1) - 5)(ord(basedPoint)(v1) + 5)(abs3(basedPoint)(v1) + 5)(ord(basedPoint)(v1) - 5)(v.stroke)(v.strokeWidth), text3(abs3(basedPoint)(v1) + 10)(ord(basedPoint)(v1) - 10)(v.textFill)(v.fontStyle)(v1.name)];
      };
    }
  };
  var defaultContext = {
  ...
  var spacex = function(n) {
    return foldr(foldableArray)(append(semigroupString))("")(replicate(n)("\\;"));
  };
  ...
  var readWrap = function(a) {
    return function(xs) {
      return function(i) {
        var v = index(xs)(mod(euclideanRingInt)(i)(length3(xs)));
        if (v instanceof Just) {
          return v.value0;
        }
        ;
  ...
  var header = /* @__PURE__ */ div$prime(/* @__PURE__ */ widgetMultiAlternative(monoidArray))(widgetShiftMap)(/* @__PURE__ */ fromIncremental(/* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindStateT(monadIdentity))(/* @__PURE__ */ setTitle("Devoir 1 : Trigonom\xE9trie"))(function() {
    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Pr\xE9nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Classe:")])])))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("10 questions : pour chacune d'elle, indiquer la bonne r\xE9ponse")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("\\frac{1}{2}"))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(t(" point par bonne r\xE9ponse"))(function() {
            return get2(monadStateStateT(monadIdentity));
          });
        }))), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("sans calculatrice")])])))(function() {
          return get2(monadStateStateT(monadIdentity));
        });
      });
    });
  ...
  var symx = function(a) {
    var next = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 280, column 5 - line 292, column 26): " + []);
    }();
    return next;
  };
  var symy = function(a) {
    var next = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 298, column 5 - line 310, column 26): " + []);
    }();
    return next;
  };
  ...
  var positive = function(a) {
    var next = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 323, column 5 - line 329, column 26): " + []);
    }();
    return next;
  };
  ...
  var points = /* @__PURE__ */ append(semigroupArray)(thirds)(/* @__PURE__ */ append(semigroupArray)(fourths)(sixths));
  var dfltPoint = {
    exact: "",
    approx: 0,
    cos: "",
        ...
        return display2(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(function() {
          ...
          return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(b2("1."))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t(" On consid\xE8re "))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(m("\\mathcal{C}"))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" le cercle trigonom\xE9trique suivant :"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 5fr ;")])([svg(widgetMultiAlternative(monoidArray))(widgetShiftMap)([width2("180"), height2("180"), viewBox("-10 -10 200 200")])(function() {
                        ...
                        return append(semigroupArray)(render(renderSequence(renderPoint))([pO, pI, pJ]))(append(semigroupArray)(render(renderCircle)(circle(pO)(length5(measurableVector)(vector(pO)(pI)))))(append(semigroupArray)(render(renderSegment)(segment(pO)(pI)(Nothing.value)))(append(semigroupArray)(render(renderSegment)(segment(pO)(pJ)(Nothing.value)))(append(semigroupArray)(render(renderRightAngle)(rightangle(vector(pO)(pI))(pO)(vector(pO)(pJ))(10)))(append(semigroupArray)(render(renderPoint)(pM))(render(renderSegment)(segment(pO)(pM)(Nothing.value))))))));
                      }()), div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(m("M"))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point de coordonn\xE9es "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(m("(" + (angle0.cos + ("," + (angle0.sin + ").")))))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(t("Donner la valeur (en radians) du r\xE9el compris dans l'intervalle "))(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("]-\\pi, \\pi]"))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" correspondant au point "))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("M:"))(function() {
                                          return get2(monadStateStateT(monadIdentity));
                                        });
                                      });
                        ...
                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("2."))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" Compl\xE9ter la phrase en rempla\xE7ant chaque mot manquant par "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\underline{\xE9gaux}"))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" ou "))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("\\underline{oppos\xE9s}:"))(function() {
                                    var r1 = rand(r0);
                                    var arr = function() {
                                      var v = mod(euclideanRingInt)(r1.val)(3);
                                      if (v === 0) {
                                        return thirds;
                                      }
                                      ;
                                    ...
                                    var n = length3(arr);
                                    var r2 = rand(r1);
                                    var i1 = mod(euclideanRingInt)(r2.val)(n);
                                    var r3 = rand(r2);
                                    var i2 = mod(euclideanRingInt)((i1 + 1 | 0) + mod(euclideanRingInt)(r3.val)(n - 1 | 0) | 0)(n);
                                    var angle1 = readWrap(dfltPoint)(arr)(i1);
                                    var angle2 = readWrap(dfltPoint)(arr)(i2);
                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("Les r\xE9els "))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(m(angle1.exact))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(m(angle2.exact))(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" ont leurs cosinus "))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("\\underline{" + (spacex(16) + "}")))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" et leurs sinus "))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\underline{" + (spacex(16) + "}.")))(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("3."))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" Donner la valeur du r\xE9el "))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("a"))(function() {
                                                                var r4 = rand(r3);
                                                                var angle3 = readWrap(dfltPoint)(points)(r4.val);
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" de l'intervalle "))(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("[0, 2\\pi["))(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" v\xE9rifiant "))(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos(a)=" + angle3.cos))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\sin(a)=" + (angle3.sin + ":")))(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(b2("4."))(function() {
                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" Etant donn\xE9 que "))(function() {
                                                                                        var r5 = rand(r4);
                                                                                        var cosa = readWrap(dfltDecimal)(decimals)(r5.val);
                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(equation2(cosa.origin))(function() {
                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" et sachant que "))(function() {
                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("a\\in]-\\pi,0["))(function() {
                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(", et que "))(function() {
                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos(a)=" + cosa.decimal))(function() {
                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(", d\xE9terminer la valeur exacte de "))(function() {
                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\sin(a):"))(function() {
                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("5."))(function() {
                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Convertir "))(function() {
                                                                                                                var r6 = rand(r5);
                                                                                                                var deg = readWrap(dfltDegree)(degrees)(r6.val);
                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m(deg.degree + "^\\circ"))(function() {
                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" en radians. On donnera une r\xE9ponse dans "))(function() {
                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("[0, 2\\pi["))(function() {
                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" sous la forme exacte la plus simple possible:"))(function() {
                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("6."))(function() {
                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Convertir "))(function() {
                                                                                                                                var r7 = rand(r6);
                                                                                                                                var fifth = readWrap(dfltDegree)(fifths)(r7.val);
                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m(fifth.radian))(function() {
                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" en degr\xE9s. On donnera un entier positif inf\xE9rieur \xE0 "))(function() {
                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("359^\\circ"))(function() {
                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(":"))(function() {
                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("7."))(function() {
                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("M"))(function() {
                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point du cercle trigonom\xE9trique v\xE9rifiant "))(function() {
                                                                                                                                                    var r8 = rand(r7);
                                                                                                                                                    var angle4 = readWrap(dfltPoint)(points)(r8.val);
                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{IOM} =" + angle4.exact))(function() {
                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" (remarque: on \xE9crit aussi "))(function() {
                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("(\\overrightarrow{OI},\\overrightarrow{OM})=" + angle4.exact))(function() {
                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("). Donner la valeur de "))(function() {
                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{IOM'} "))(function() {
                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" comprise entre "))(function() {
                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("-\\pi"))(function() {
                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\pi"))(function() {
                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" si "))(function() {
                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("M'"))(function() {
                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" est le sym\xE9trique de "))(function() {
                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("M"))(function() {
                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" par la sym\xE9trie d'axe "))(function() {
                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("(OI):"))(function() {
                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("8."))(function() {
                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("M"))(function() {
                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point du cercle trigonom\xE9trique v\xE9rifiant "))(function() {
                                                                                                                                                                                              var r9 = rand(r8);
                                                                                                                                                                                              var angle5 = readWrap(dfltPoint)(points)(r9.val);
                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{IOM} =" + angle5.exact))(function() {
                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(". Donner la valeur de "))(function() {
                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{IOM'}"))(function() {
                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" comprise entre "))(function() {
                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("-\\pi"))(function() {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" si "))(function() {
                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("M'"))(function() {
                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" est le sym\xE9trique de "))(function() {
                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("M"))(function() {
                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" par la sym\xE9trie d'axe "))(function() {
                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("(OJ):"))(function() {
                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("9."))(function() {
                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Donner la valeur de "))(function() {
                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos(" + (angle4.exact + "):")))(function() {
                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("10."))(function() {
                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Donner la valeur de "))(function() {
                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\sin(" + (angle5.exact + "):")))(function() {
                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                              var rep = ["r\xE9ponses: 1)", angle0.princ, "\\;2)", function() {
                                                                                                                                                                                                                                                var $9 = angle1.cos === angle2.cos;
                                                                                                                                                                                                                                                if ($9) {
                                                                                                                                                                                                                                                  return "\xE9gaux,";
                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                ;
                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m(function() {
                                                                                                                                                                                                                                                var $11 = fromMaybe(0)(validateInput(newState.seed)) < 0;
                                                                                                                                                                                                                                                if ($11) {
