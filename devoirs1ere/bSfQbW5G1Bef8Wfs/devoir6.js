(() => {
  ...
  var rands = function(v) {
    return function(r) {
      ...
      ;
      return append(semigroupArray)([r.val])(rands(v - 1 | 0)(rand(r)));
    };
  };
  ...
  var scalarT = function(v) {
    return div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0))(fromInt(2));
  };
  ...
  var randomTriangle = function($copy_r) {
    ...
    function $tco_loop(r) {
      ...
      var ok = function(v) {
        return smaller(v.ab)(v.ac)(v.bc) && (smaller(v.ac)(v.bc)(v.ab) && (smaller(v.bc)(v.ab)(v.ac) && (mod(euclideanRingInt)((v.ab + v.ac | 0) + v.bc | 0)(2) === 0 && (((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) !== (v.bc * v.bc | 0) && (((v.ab * v.ab | 0) + (v.bc * v.bc | 0) | 0) !== (v.ac * v.ac | 0) && ((v.ac * v.ac | 0) + (v.bc * v.bc | 0) | 0) !== (v.ab * v.ab | 0))))));
      };
      var nth = function(arr) {
        return function(n) {
          return fromJust()(index(arr)(n));
        };
      };
      var lp = length3(possibleSides);
      var indices = map(functorArray)(function(x) {
        return mod(euclideanRingInt)(x)(lp);
      })(rands(3)(r));
      var sides = map(functorArray)(nth(possibleSides))(indices);
      var triangle = {
        ab: nth(sides)(0),
        ac: nth(sides)(1),
        bc: nth(sides)(2)
  ...
  var exo1 = function(mode) {
    return function(r0) {
      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 1"))(function() {
        var h = discard(discardUnit)(bindStateT(monadIdentity))(m("H"))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(t(" le projet\xE9 orthogonal de "))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(m("C"))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t(" sur "))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(m("(AB)."))(function() {
        ...
        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("ABC"))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(" un triangle du plan tel que "))(function() {
              var r1 = rand(r0);
              ...
              return discard(discardUnit)(bindStateT(monadIdentity))(function() {
                var v = lessThan(ordRatio(ordInt)(euclideanRingInt))(s2)(fromInt(0));
                var v1 = lessThan(ordRatio(ordInt)(euclideanRingInt))(s1)(fromInt(0));
                if (v1) {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m(" H, A"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("B"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" align\xE9s dans cet ordre avec "))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(h)(function() {
                            var ah = div(euclideanRingRatio(ordInt)(euclideanRingInt))(negate(ringRatio(ordInt)(euclideanRingInt))(s1))(fromInt(t1.ab));
                            return discard(discardUnit)(bindStateT(monadIdentity))(m("AH=" + rshow(ah)))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                return m("AB=" + show(showInt)(t1.ab));
                              });
                            });
                          });
                        });
                ...
                ;
                if (!v1 && v) {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m("A, B"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("H"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" align\xE9s dans cet ordre avec "))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(h)(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(m("AB=" + show(showInt)(t1.ab)))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                var ah = div(euclideanRingRatio(ordInt)(euclideanRingInt))(s1)(fromInt(t1.ab));
                                return m("BH=" + rshow(sub(ringRatio(ordInt)(euclideanRingInt))(ah)(fromInt(t1.ab))));
                              });
                            });
                          });
                        });
                ...
                ;
                return discard(discardUnit)(bindStateT(monadIdentity))(m("A, H"))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(m("B"))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" align\xE9s dans cet ordre avec "))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(h)(function() {
                          ...
                          return discard(discardUnit)(bindStateT(monadIdentity))(m("AH=" + rshow(ah)))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                              return m("HB=" + rshow(sub(ringRatio(ordInt)(euclideanRingInt))(fromInt(t1.ab))(ah)));
                            });
                          });
                        });
                      });
                ...
                return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t("Calculer "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                        if (mode) {
                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
  ...
  var randomTriangle2 = function(r) {
    ...
    var lp = length3(possibleValues);
    var indices = map(functorArray)(function(x) {
      return mod(euclideanRingInt)(x)(lp);
    })(rands(6)(r));
    var vals = map(functorArray)(nth(possibleValues))(indices);
    return {
      a: {
        x: nth(vals)(0),
        y: nth(vals)(1)
    ...
    return function(r0) {
      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 2"))(function() {
        ...
        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soient "))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("A(" + (show(showInt)(t1.a.x) + (";" + (show(showInt)(t1.a.y) + ")")))))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(m("B(" + (show(showInt)(t1.b.x) + (";" + (show(showInt)(t1.b.y) + ")")))))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m("C(" + (show(showInt)(t1.c.x) + (";" + (show(showInt)(t1.c.y) + ")")))))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" trois points du plan dans un rep\xE8re orthonorm\xE9."))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t("Calculer "))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                            if (mode) {
  ...
  var scalarT3 = function(c) {
    return div(euclideanRingInt)(c * c | 0)(2);
  };
  var possibleValues2 = /* @__PURE__ */ range2(2)(13);
  var randomTriangle3 = function(r) {
    var lp = length3(possibleValues2);
    var index4 = mod(euclideanRingInt)(rand(r).val)(lp);
    return 2 * fromJust()(index(possibleValues2)(index4)) | 0;
  };
  var exo3 = function(mode) {
    return function(r0) {
      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 3"))(function() {
        ...
        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("ABC"))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(" un triangle \xE9quilat\xE9ral de c\xF4t\xE9 "))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(m(show(showInt)(t1)))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(t(". "))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t("Calculer "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
  ...
  var scalarT4 = function(v) {
    return div(euclideanRingInt)(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0)(2);
  };
  ...
  var randomTriangle4 = function($copy_r) {
    ...
    function $tco_loop(r) {
      ...
      var lp = length3(possibleSides2);
      var indices = map(functorArray)(function(x) {
        return mod(euclideanRingInt)(x)(lp);
      })(unsort(lp)(r));
      var sides = map(functorArray)(nth(possibleSides2))(indices);
      var bc = nth(sides)(2);
      var ac = nth(sides)(1);
      var ab = nth(sides)(0);
      var triangle = {
  ...
  var exo4 = function(mode) {
    return function(r0) {
      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 4"))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("ABC"))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(" tel que "))(function() {
              var r1 = rand(r0);
              var t1 = randomTriangle4(r1);
              var s1 = scalarT4(t1);
              return discard(discardUnit)(bindStateT(monadIdentity))(m("AB = " + show(showInt)(t1.ab)))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m("AC = " + show(showInt)(t1.ac)))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("BC = " + show(showInt)(t1.bc)))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t("Calculer "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
  ...
  var randomTriangle5 = function(r) {
    ...
    var lp = length3(possibleValues3);
    return {
      ab: nth(possibleValues3)(mod(euclideanRingInt)(r1.val)(lp)),
      ac: nth(possibleValues3)(mod(euclideanRingInt)(r2.val)(lp)),
      t: mod(euclideanRingInt)(r.val)(2) === 0
    };
  };
  var exo5 = function(mode) {
    return function(r0) {
      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 5"))(function() {
        ...
        return discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("ABC"))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(" un triangle tel que "))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(m("AB = " + show(showInt)(t1.ab)))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m("AC = " + show(showInt)(2 * t1.ac | 0)))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{BAC}=" + function() {
                        if (t1.t) {
                          return "\\frac{\\pi}{3}";
                        }
                        ;
  ...
  var header = /* @__PURE__ */ div$prime(/* @__PURE__ */ widgetMultiAlternative(monoidArray))(widgetShiftMap)(/* @__PURE__ */ fromIncremental(/* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindStateT(monadIdentity))(/* @__PURE__ */ setTitle("Devoir 6 : Produit scalaire"))(function() {
    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Pr\xE9nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Classe:")])])))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("5 produits scalaires \xE0 calculer")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("1 point par bonne r\xE9ponse")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("calculatrice autoris\xE9e")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("documents autoris\xE9s")])])))(function() {
