...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b) {
        return apply1(map24($$const(identity2))(a2))(b);
      };
    };
  };
  ...
  var semigroupWriterT = function(dictApply) {
    return function(dictSemigroup) {
      var lift24 = lift2(applyWriterT(dictSemigroup)(dictApply));
      return function(dictSemigroup1) {
        return {
          append: lift24(append(dictSemigroup1))
        };
      };
    };
  };
  var applicativeWriterT = function(dictMonoid) {
    ...
    return function(dictApplicative) {
      ...
      return {
        pure: function(a2) {
          return pure21(new Tuple(a2, mempty10));
        },
        Apply0: function() {
          return applyWriterT2;
        }
    ...
    return function(dictFunctor) {
      ...
      return function(dictFunctor1) {
        ...
        return function(f) {
          return function(b) {
            return function(e) {
              return sample22(map24(f)(b))(map32(applyFlipped)(e));
            };
          };
        };
      };
  ...
  var traverse1Impl = function() {
    ...
    return function(apply5, map24, f) {
      var buildFrom = function(x, ys) {
        return apply5(map24(consList)(f(x)))(ys);
      };
  ...
  var ordRatio = function(dictOrd) {
    ...
    return function(dictEuclideanRing) {
      var sub2 = sub(ringRatio1(dictEuclideanRing));
      var zero2 = zero(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0());
      return {
        compare: function(x) {
          return function(y) {
  ...
  var seeds = function(v) {
    return function(v1) {
      if (v === 0) {
        return [unSeed(v1)];
      }
      ;
      return append7([unSeed(v1)])(seeds(v - 1 | 0)(lcgNext(v1)));
    };
  };
  ...
  var mempty4 = /* @__PURE__ */ mempty(/* @__PURE__ */ monoidWriterT(applicativeIdentity)(monoidNut)(monoidUnit));
  var scalarT = function(v) {
    return div3(fromInt2(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0))(fromInt2(2));
  };
  var rshow = function(r) {
    var n = numerator2(r);
    var d = denominator2(r);
    var $34 = eq4(d)(fromInt(1));
    if ($34) {
      return show5(n);
    }
    ;
    return "\\frac{" + (show5(n) + ("}{" + (show5(d) + "}")));
  };
  var possibleSides = /* @__PURE__ */ range2(2)(23);
  var randomTriangle = function($copy_r) {
    var $tco_done = false;
    var $tco_result;
    function $tco_loop(r) {
      var smaller = function(a2) {
        return function(b) {
          return function(c) {
            return a2 <= (b + c | 0);
          };
      ...
      var ok = function(v) {
        return smaller(v.ab)(v.ac)(v.bc) && (smaller(v.ac)(v.bc)(v.ab) && (smaller(v.bc)(v.ab)(v.ac) && (mod4((v.ab + v.ac | 0) + v.bc | 0)(2) === 0 && (((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) !== (v.bc * v.bc | 0) && (((v.ab * v.ab | 0) + (v.bc * v.bc | 0) | 0) !== (v.ac * v.ac | 0) && ((v.ac * v.ac | 0) + (v.bc * v.bc | 0) | 0) !== (v.ab * v.ab | 0))))));
      };
      ...
      var lp = length(possibleSides);
      var indices = map19(function(x) {
        return mod4(x)(lp);
      })(seeds(3)(r));
      var sides = map19(nth(possibleSides))(indices);
      var bc = nth(sides)(2);
      var ac = nth(sides)(1);
      var ab = nth(sides)(0);
      var triangle = {
  ...
  var exo1 = function(mode) {
    return function(r0) {
      return discard3(section_("Exercice 1"))(function() {
        var h = discard3(m_("H"))(function() {
          return discard3(t_(" le projet\xE9 orthogonal de "))(function() {
            return discard3(m_("C"))(function() {
              return discard3(t_(" sur "))(function() {
                return discard3(m_("(AB)."))(function() {
        ...
        return discard3(t_("Soit "))(function() {
          return discard3(m_("ABC"))(function() {
            return discard3(t_(" un triangle du plan tel que "))(function() {
              var r1 = lcgNext(r0);
              ...
              return discard3(function() {
                var v = lessThan2(s2)(fromInt2(0));
                var v1 = lessThan2(s1)(fromInt2(0));
                if (v1) {
                  return discard3(m_(" H, A"))(function() {
                    return discard3(t_(" et "))(function() {
                      return discard3(m_("B"))(function() {
                        return discard3(t_(" align\xE9s dans cet ordre avec "))(function() {
                          return discard3(h)(function() {
                            var ah = div3(negate2(s1))(fromInt2(t1.ab));
                            return discard3(m_("AH=" + rshow(ah)))(function() {
                              return discard3(t_(" et "))(function() {
                                return m_("AB=" + show1(t1.ab));
                              });
                            });
                          });
                        });
                ...
                ;
                if (!v1 && v) {
                  return discard3(m_("A, B"))(function() {
                    return discard3(t_(" et "))(function() {
                      return discard3(m_("H"))(function() {
                        return discard3(t_(" align\xE9s dans cet ordre avec "))(function() {
                          return discard3(h)(function() {
                            return discard3(m_("AB=" + show1(t1.ab)))(function() {
                              return discard3(t_(" et "))(function() {
                                var ah = div3(s1)(fromInt2(t1.ab));
                                return m_("BH=" + rshow(sub1(ah)(fromInt2(t1.ab))));
                              });
                            });
                          });
                        });
                ...
                ;
                return discard3(m_("A, H"))(function() {
                  return discard3(t_(" et "))(function() {
                    return discard3(m_("B"))(function() {
                      return discard3(t_(" align\xE9s dans cet ordre avec "))(function() {
                        return discard3(h)(function() {
                          ...
                          return discard3(m_("AH=" + rshow(ah)))(function() {
                            return discard3(t_(" et "))(function() {
                              return m_("HB=" + rshow(sub1(fromInt2(t1.ab))(ah)));
                            });
                          });
                        });
                      });
                ...
                return discard3(t_("."))(function() {
                  return discard3(nl)(function() {
                    return discard3(t_("Calculer "))(function() {
                      return discard3(m_("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                        if (mode) {
                          return discard3(nl)(function() {
  ...
  // output/Devoir6.Exercise2/index.js
  ...
  var possibleValues = /* @__PURE__ */ function() {
    return range2(-13 | 0)(13);
  }();
  var randomTriangle2 = function(r) {
    var nth = function(arr) {
      return function(n) {
        return fromJust6(index(arr)(n));
      };
    };
    var lp = length(possibleValues);
    var indices = map20(function(x) {
      return mod5(x)(lp);
    })(seeds(6)(r));
    var vals = map20(nth(possibleValues))(indices);
    return {
      a: {
        x: nth(vals)(0),
        y: nth(vals)(1)
  ...
  var exo2 = function(mode) {
    return function(r0) {
      return discard4(section_("Exercice 2"))(function() {
        var r1 = lcgNext(r0);
        var t1 = randomTriangle2(r1);
        var s1 = scalarT2(t1);
        return discard4(t_("Soient "))(function() {
          return discard4(m_("A(" + (show6(t1.a.x) + (";" + (show6(t1.a.y) + ")")))))(function() {
            return discard4(t_(", "))(function() {
              return discard4(m_("B(" + (show6(t1.b.x) + (";" + (show6(t1.b.y) + ")")))))(function() {
                return discard4(t_(" et "))(function() {
                  return discard4(m_("C(" + (show6(t1.c.x) + (";" + (show6(t1.c.y) + ")")))))(function() {
                    return discard4(t_(" trois points du plan dans un rep\xE8re orthonorm\xE9."))(function() {
                      return discard4(nl)(function() {
                        return discard4(t_("Calculer "))(function() {
                          return discard4(m_("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                            if (mode) {
                              return discard4(nl)(function() {
  ...
  // output/Devoir6.Exercise3/index.js
  ...
  var scalarT3 = function(c) {
    return div4(c * c | 0)(2);
  };
  var possibleValues2 = /* @__PURE__ */ range2(2)(13);
  var randomTriangle3 = function(r) {
    var lp = length(possibleValues2);
    var index4 = mod6(unSeed(lcgNext(r)))(lp);
    return 2 * fromJust7(index(possibleValues2)(index4)) | 0;
  };
  var exo3 = function(mode) {
    return function(r0) {
      return discard5(section_("Exercice 3"))(function() {
        var r1 = lcgNext(r0);
        var t1 = randomTriangle3(r1);
        var s1 = scalarT3(t1);
        return discard5(t_("Soit "))(function() {
          return discard5(m_("ABC"))(function() {
            return discard5(t_(" un triangle \xE9quilat\xE9ral de c\xF4t\xE9 "))(function() {
              return discard5(m_(show7(t1)))(function() {
                return discard5(t_(". "))(function() {
                  return discard5(nl)(function() {
                    return discard5(t_("Calculer "))(function() {
                      return discard5(m_("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                        if (mode) {
                          return discard5(nl)(function() {
  ...
  // output/Devoir6.Exercise4/index.js
  ...
  var scalarT4 = function(v) {
    return div5(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0)(2);
  };
  var possibleSides2 = /* @__PURE__ */ range2(2)(23);
  var randomTriangle4 = function($copy_r) {
    var $tco_done = false;
    var $tco_result;
    function $tco_loop(r) {
      var smaller = function(a2) {
      ...
      var ok = function(v) {
        return smaller(v.ab)(v.ac)(v.bc) && (smaller(v.ac)(v.bc)(v.ab) && (smaller(v.bc)(v.ab)(v.ac) && (mod7((v.ab + v.ac | 0) + v.bc | 0)(2) === 0 && (((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) !== (v.bc * v.bc | 0) && (((v.ab * v.ab | 0) + (v.bc * v.bc | 0) | 0) !== (v.ac * v.ac | 0) && ((v.ac * v.ac | 0) + (v.bc * v.bc | 0) | 0) !== (v.ab * v.ab | 0))))));
      };
      var nth = function(arr) {
        return function(n) {
          return fromJust8(index(arr)(n));
        };
      };
      var lp = length(possibleSides2);
      var indices = map21(function(x) {
        return mod7(x)(lp);
      })(unsort(lp)(r));
      var sides = map21(nth(possibleSides2))(indices);
      var bc = nth(sides)(2);
      var ac = nth(sides)(1);
      var ab = nth(sides)(0);
      var triangle = {
    ...
    return function(r0) {
      return discard6(section_("Exercice 4"))(function() {
        return discard6(t_("Soit "))(function() {
          return discard6(m_("ABC"))(function() {
            return discard6(t_(" tel que "))(function() {
              var r1 = lcgNext(r0);
              var t1 = randomTriangle4(r1);
              var s1 = scalarT4(t1);
              return discard6(m_("AB = " + show8(t1.ab)))(function() {
                return discard6(t_(", "))(function() {
                  return discard6(m_("AC = " + show8(t1.ac)))(function() {
                    return discard6(t_(" et "))(function() {
                      return discard6(m_("BC = " + show8(t1.bc)))(function() {
                        return discard6(t_("."))(function() {
                          return discard6(nl)(function() {
                            return discard6(t_("Calculer "))(function() {
                              return discard6(m_("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                                if (mode) {
                                  return discard6(nl)(function() {
  ...
  // output/Devoir6.Exercise5/index.js
  ...
  var possibleValues3 = /* @__PURE__ */ range2(2)(13);
  var randomTriangle5 = function(r) {
    var r1 = lcgNext(r);
    var r2 = lcgNext(r1);
    var nth = function(arr) {
      return function(n) {
        return fromJust9(index(arr)(n));
      };
    };
    var lp = length(possibleValues3);
    return {
      ab: nth(possibleValues3)(mod8(unSeed(r1))(lp)),
      ac: nth(possibleValues3)(mod8(unSeed(r2))(lp)),
      t: mod8(unSeed(r))(2) === 0
    };
  };
  var exo5 = function(mode) {
    return function(r0) {
      return discard7(section_("Exercice 5"))(function() {
        var r1 = lcgNext(r0);
        var t1 = randomTriangle5(r1);
        var s1 = scalarT5(t1);
        return discard7(t_("Soit "))(function() {
          return discard7(m_("ABC"))(function() {
            return discard7(t_(" un triangle tel que "))(function() {
              return discard7(m_("AB = " + show9(t1.ab)))(function() {
                return discard7(t_(", "))(function() {
                  return discard7(m_("AC = " + show9(2 * t1.ac | 0)))(function() {
                    return discard7(t_(" et "))(function() {
                      return discard7(m_("\\widehat{BAC}=" + function() {
                        if (t1.t) {
                          return "\\frac{\\pi}{3}";
                        }
                        ;
                        ...
                        return discard7(t_("."))(function() {
                          return discard7(nl)(function() {
                            return discard7(t_("Calculer "))(function() {
                              return discard7(m_("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function() {
                                if (mode) {
                                  return discard7(nl)(function() {
  ...
  var header = /* @__PURE__ */ discard1(/* @__PURE__ */ setTitle_("Devoir 6 : Produit scalaire"))(function() {
    return discard1(nl)(function() {
      return discard1(tell3(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label_([text_("Nom:")]), label_([text_("Pr\xE9nom:")]), label_([text_("Classe:")])])))(function() {
        return tell3(ul_([li_([text_("5 produits scalaires \xE0 calculer")]), li_([text_("1 point par bonne r\xE9ponse")]), li_([text_("calculatrice autoris\xE9e")]), li_([text_("documents autoris\xE9s")])]));
      });
    });
  });
    ...
    return runInBody(bind4(useState(""))(function(v) {
      return bind4(useState(false))(function(v1) {
        ...
        return div_([div_([label_([text_("Enonc\xE9 n\xB0 ")]), input([valueOn_(input2)(v.value0), keydown_(function(k) {
          ...
          return maybe(pure20(unit))(function($42) {
            return focus(toHTMLElement($42));
          })(fromElement(e));
