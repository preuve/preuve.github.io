...
(function($PS) {
  ...
  var validExperience = function (e) {
      ...
      var valid = function (x) {
          return Data_Ord.lessThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(0))(x) && Data_Ord.lessThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(x)(Data_Rational.fromInt(1));
      };
  ...
  var exercice = function (p1) {
      return function (p2) {
          return function (p3) {
              return function (ref) {
                  return Data_Map_Internal.insert(Data_Ord.ordString)(p1)(Data_Maybe.fromMaybe(Data_Semiring.zero(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt)))(Data_Map_Internal.lookup(Data_Ord.ordString)(p1)(ref)))(Data_Map_Internal.insert(Data_Ord.ordString)(p2)(Data_Maybe.fromMaybe(Data_Semiring.zero(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt)))(Data_Map_Internal.lookup(Data_Ord.ordString)(p2)(ref)))(Data_Map_Internal.insert(Data_Ord.ordString)(p3)(Data_Maybe.fromMaybe(Data_Semiring.zero(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt)))(Data_Map_Internal.lookup(Data_Ord.ordString)(p3)(ref)))(Data_Map_Internal.empty)));
              };
          };
      };
  };
  ...
  var randProba = function ($copy_r) {
      ...
      function $tco_loop(r) {
          ...
          if (num < den) {
              $tco_done = true;
              return {
                  probability: Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(num))(Data_Rational.fromInt(den)),
                  nextRand: nextRand
              };
          };
          if (num > den) {
              $tco_done = true;
              return {
                  probability: Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(den))(Data_Rational.fromInt(num)),
                  nextRand: nextRand
              };
          };
          if (Data_Boolean.otherwise) {
          ...
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(prob(v.experience))(prob(v1.experience)))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(prob(v2.experience))(prob(v3.experience)))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(prob(v4.experience))))(function () {
                                          return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                      });
                                  });
                              });
