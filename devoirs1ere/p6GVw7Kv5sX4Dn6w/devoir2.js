...
(function($PS) {
  ...
  var header = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.setTitle("Devoir 2 : Second degr\xe9"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pr\xe9nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Classe:") ]) ])))(function () {
              ...
              }))), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("toute valeur num\xe9rique \xe0 donner sous forme enti\xe8re ou rationnelle irr\xe9ductible") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("calculatrice autoris\xe9e") ]) ])))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
          });
      });
  ...
  var ordFraction = new Data_Ord.Ord(function () {
      ...
      return function (f2) {
          ...
          throw new Error("Failed pattern match at Main (line 85, column 9 - line 88, column 36): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
  ...
  var randFraction = function (r) {
      ...
      var prime = function (ix) {
          return Data_Maybe.fromMaybe(1)(Data_Array.index(primes)(ix));
      };
  ...
  var inline = function (c) {
      ...
      throw new Error("Failed pattern match at Main (line 60, column 3 - line 63, column 41): " + [ Data_Unit.unit.constructor.name ]);
  };
      ...
      return function (b) {
          return function (c) {
              var m2 = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 45, column 9 - line 48, column 49): " + [ Data_Unit.unit.constructor.name ]);
              })();
              var m1 = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 50, column 9 - line 55, column 54): " + [ Data_Unit.unit.constructor.name ]);
              })();
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("1."))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Deux nombres "))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x_1"))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x_2"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" v\xe9rifient "))(function () {
                                              var f1 = randFraction(r0);
                                              var f2 = randFraction(f1.nextRand);
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\left\\{\\begin{array}{l}x_1+x_2=" + (Data_Show.show(showFraction)(Data_Semiring.add(semiRingFraction)(f1.fraction)(f2.fraction)) + ("\\\\ x_1x_2 = " + (Data_Show.show(showFraction)(Data_Semiring.mul(semiRingFraction)(f1.fraction)(f2.fraction)) + "\\end{array}\\right.")))))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Donner l'ensemble des couples "))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(x_1, x_2)"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" possibles:"))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("2."))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Soit "))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f"))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" la fonction polyn\xf4me du second degr\xe9 d\xe9finie par "))(function () {
                                                                                              var f3 = randFraction(f2.nextRand);
                                                                                              var f4 = randFraction(f3.nextRand);
                                                                                              var f5 = randFraction(f4.nextRand);
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f(x)=" + showTrinom(f3.fraction)(f4.fraction)(f5.fraction)))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" pour tout "))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x\\in\\mathbb{R}"))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(". "))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Donner la forme canonique de "))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f"))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" :"))(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("3."))(function () {
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Calculer le discriminant de "))(function () {
                                                                                                                                                      ...
                                                                                                                                                      var v = Data_Semiring.mul(semiRingFraction)(lift(l3))(f6.fraction);
                                                                                                                                                      var v1 = Data_Semiring.mul(semiRingFraction)(lift(l3))(f7.fraction);
                                                                                                                                                      var v2 = Data_Semiring.mul(semiRingFraction)(lift(l3))(f8.fraction);
                                                                                                                                                      var g3 = Data_EuclideanRing.gcd(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v.num))(Data_EuclideanRing.gcd(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v1.num))(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v2.num)));
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(showTrinom(Data_EuclideanRing.div(euclideanRingFraction)(v)(lift(g3)))(Data_EuclideanRing.div(euclideanRingFraction)(v1)(lift(g3)))(Data_EuclideanRing.div(euclideanRingFraction)(v2)(lift(g3)))))(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("."))(function () {
                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("En d\xe9duire le nombre de solutions r\xe9elles de l'\xe9quation "))(function () {
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation((function () {
                                                                                                                                                                          var $48 = Data_Eq.eq(eqFraction)(f6.fraction)(Data_EuclideanRing.div(euclideanRingFraction)(v)(lift(g3)));
                                                                                                                                                                          if ($48) {
                                                                                                                                                                          ...
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("On donnera la valeur du discriminant "))(function () {
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("ainsi que le nombre de solutions."))(function () {
                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("M\xeame s'il y a des solutions, on ne demande pas de calculer leur valeur:"))(function () {
                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("4."))(function () {
                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" R\xe9soudre dans "))(function () {
                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\mathbb{R}:"))(function () {
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      var v3 = Data_Semiring.mul(semiRingFraction)(Data_Ring.negate(ringFraction)(f9.fraction))(Data_Semiring.add(semiRingFraction)(f10.fraction)(f11.fraction));
                                                                                                                                                                                                                      var v4 = Data_Semiring.mul(semiRingFraction)(Data_Semiring.mul(semiRingFraction)(f9.fraction)(f10.fraction))(f11.fraction);
                                                                                                                                                                                                                      var l4 = Data_EuclideanRing.lcm(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(f9.fraction.den)(Data_EuclideanRing.lcm(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(v3.den)(v4.den));
                                                                                                                                                                                                                      var v5 = Data_Semiring.mul(semiRingFraction)(lift(l4))(f9.fraction);
                                                                                                                                                                                                                      var v6 = Data_Semiring.mul(semiRingFraction)(lift(l4))(v3);
                                                                                                                                                                                                                      var v7 = Data_Semiring.mul(semiRingFraction)(lift(l4))(v4);
                                                                                                                                                                                                                      var g4 = Data_EuclideanRing.gcd(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v5.num))(Data_EuclideanRing.gcd(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v6.num))(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v7.num)));
                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation(showTrinom(Data_EuclideanRing.div(euclideanRingFraction)(v5)(lift(g4)))(Data_EuclideanRing.div(euclideanRingFraction)(v6)(lift(g4)))(Data_EuclideanRing.div(euclideanRingFraction)(v7)(lift(g4))) + "=0"))(function () {
                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5."))(function () {
                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Soit "))(function () {
                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f"))(function () {
                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\mathbb{R}"))(function () {
                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" par "))(function () {
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f(x)=" + (showTrinom(f12.fraction)(f13.fraction)(Data_Semiring.zero(semiRingFraction)) + "+c")))(function () {
                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" o\xf9 "))(function () {
                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("c"))(function () {
                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est un nombre r\xe9el."))(function () {
                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("D\xe9terminer la valeur de "))(function () {
                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("c"))(function () {
                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" pour laquelle "))(function () {
                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("f"))(function () {
                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" admet une unique racine (on dit aussi racine \"double\") "))(function () {
                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x_0"))(function () {
                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", puis calculer "))(function () {
                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("x_0"))(function () {
                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(":"))(function () {
                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                          var sol4 = (function () {
                                                                                                                                                                                                                                                                                                                                              var $55 = Data_Eq.eq(eqFraction)(f10.fraction)(f11.fraction);
                                                                                                                                                                                                                                                                                                                                              if ($55) {
                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                          var delta3 = delta(Data_EuclideanRing.div(euclideanRingFraction)(v)(lift(g3)))(Data_EuclideanRing.div(euclideanRingFraction)(v1)(lift(g3)))(Data_EuclideanRing.div(euclideanRingFraction)(v2)(lift(g3)));
                                                                                                                                                                                                                                                                                                                                          var nbsol3 = (function () {
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              throw new Error("Failed pattern match at Main (line 300, column 22 - line 303, column 81): " + [ Data_Unit.unit.constructor.name ]);
                                                                                                                                                                                                                                                                                                                                          })();
                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                          var rep = [ "r\xe9ponses: 1)", "\\mathcal{S}=" + (function () {
                                                                                                                                                                                                                                                                                                                                              var $57 = Data_Eq.eq(eqFraction)(f1.fraction)(f2.fraction);
                                                                                                                                                                                                                                                                                                                                              if ($57) {
