(() => {
  ...
  var lcm = function(dictEq) {
    return function(dictEuclideanRing) {
      return function(a) {
        return function(b3) {
          var $10 = eq(dictEq)(a)(zero(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0())) || eq(dictEq)(b3)(zero(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0()));
          if ($10) {
            return zero(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0());
          }
          ;
          return div(dictEuclideanRing)(mul(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0())(a)(b3))(gcd(dictEq)(dictEuclideanRing)(a)(b3));
        };
      };
    };
  };
  ...
  var showFraction = {
    show: function(v) {
      var $23 = v.den === 1;
      if ($23) {
        return show(showInt)(v.num);
      }
      ;
      return "\\frac{" + (show(showInt)(v.num) + ("}{" + (show(showInt)(v.den) + "}")));
    }
  };
  var semiRingFraction = {
    add: function(v) {
      return function(v1) {
        ...
        var g = gcd(eqInt)(euclideanRingInt)(abs(ordInt)(ringInt)(n))(d);
        return {
          num: div(euclideanRingInt)(n)(g),
          den: div(euclideanRingInt)(d)(g)
        };
      };
    },
    zero: {
  ...
  var ringFraction = {
    sub: function(f1) {
      return function(f2) {
        return add(semiRingFraction)(f1)(mul(semiRingFraction)(lift3(-1 | 0))(f2));
      };
    },
    Semiring0: function() {
  ...
  var header = /* @__PURE__ */ div$prime(/* @__PURE__ */ widgetMultiAlternative(monoidArray))(widgetShiftMap)(/* @__PURE__ */ fromIncremental(/* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindStateT(monadIdentity))(/* @__PURE__ */ setTitle("Devoir 2 : Second degr\xE9"))(function() {
    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Pr\xE9nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Classe:")])])))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("5 questions : pour chacune d'elle, indiquer la bonne r\xE9ponse")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("1"))(function() {
        ...
        }))), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("toute valeur num\xE9rique \xE0 donner sous forme enti\xE8re ou rationnelle irr\xE9ductible")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("calculatrice autoris\xE9e")])])))(function() {
          return get2(monadStateStateT(monadIdentity));
        });
      });
    });
  ...
  var ordFraction = {
    compare: function(f1) {
      return function(f2) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 85, column 9 - line 88, column 36): " + [unit.constructor.name]);
      };
    },
    Eq0: function() {
      return eqFraction;
  ...
  var delta = function(a) {
    return function(b3) {
      return function(c) {
        return sub(ringFraction)(mul(semiRingFraction)(b3)(b3))(mul(semiRingFraction)(mul(semiRingFraction)(lift3(4))(a))(c));
      };
    };
  };
  ...
  var euclideanRingFraction = {
    ...
    div: function(f1) {
      return function(f2) {
        return mul(semiRingFraction)(f1)(recip(divisionRingFraction)(f2));
      };
    },
    mod: function(v) {
      return function(v1) {
        return zero(semiRingFraction);
      };
    },
    CommutativeRing0: function() {
  ...
  var alpha = function(a) {
    return function(b3) {
      return function(c) {
        return div(euclideanRingFraction)(div(euclideanRingFraction)(negate(ringFraction)(b3))(a))(lift3(2));
      };
    };
  };
  var beta = function(a) {
    return function(b3) {
      return function(c) {
        var f = function(x) {
          return add(semiRingFraction)(add(semiRingFraction)(mul(semiRingFraction)(mul(semiRingFraction)(a)(x))(x))(mul(semiRingFraction)(b3)(x)))(c);
        };
        var al = alpha(a)(b3)(c);
        return f(al);
      };
  ...
  var abs4 = function(v) {
    return {
      num: abs(ordInt)(ringInt)(v.num),
      den: v.den
    };
  };
  var inline2 = function(c) {
    if (lessThan(ordFraction)(c)(zero(semiRingFraction))) {
      return "-" + show(showFraction)(abs4(c));
    }
    ;
    if (eq(eqFraction)(c)(zero(semiRingFraction))) {
      return "";
    }
    ;
    if (otherwise) {
      return "+" + show(showFraction)(c);
    }
    ;
    throw new Error("Failed pattern match at Main (line 60, column 3 - line 63, column 41): " + [unit.constructor.name]);
  };
  var showTrinom = function(a) {
    return function(b3) {
      return function(c) {
        var m2 = function() {
          if (eq(eqFraction)(a)(negate(ringFraction)(one(semiRingFraction)))) {
            return "-x^2";
          }
          ;
          if (eq(eqFraction)(a)(one(semiRingFraction))) {
            return "x^2";
          }
          ;
          if (otherwise) {
            return show(showFraction)(a) + "x^2";
          }
          ;
          throw new Error("Failed pattern match at Main (line 45, column 9 - line 48, column 49): " + [unit.constructor.name]);
        }();
        var m1 = function() {
          if (eq(eqFraction)(b3)(negate(ringFraction)(one(semiRingFraction)))) {
            return "-x";
          }
          ;
          if (lessThan(ordFraction)(b3)(zero(semiRingFraction))) {
            return "-" + (show(showFraction)(abs4(b3)) + "x");
          }
          ;
          if (eq(eqFraction)(b3)(zero(semiRingFraction))) {
            return "";
          }
          ;
          if (eq(eqFraction)(b3)(one(semiRingFraction))) {
            return "+x";
          }
          ;
          if (otherwise) {
            return "+" + (show(showFraction)(b3) + "x");
          }
          ;
          throw new Error("Failed pattern match at Main (line 50, column 9 - line 55, column 54): " + [unit.constructor.name]);
        }();
        return m2 + (m1 + inline2(c));
      };
    };
  };
        ...
        return display2(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(function() {
          ...
          return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(b2("1."))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Deux nombres "))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(m("x_1"))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(m("x_2"))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" v\xE9rifient "))(function() {
                        var f1 = randFraction(r0);
                        var f2 = randFraction(f1.nextRand);
                        return discard(discardUnit)(bindStateT(monadIdentity))(m("\\left\\{\\begin{array}{l}x_1+x_2=" + (show(showFraction)(add(semiRingFraction)(f1.fraction)(f2.fraction)) + ("\\\\ x_1x_2 = " + (show(showFraction)(mul(semiRingFraction)(f1.fraction)(f2.fraction)) + "\\end{array}\\right.")))))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t("Donner l'ensemble des couples "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(m("(x_1, x_2)"))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" possibles:"))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("2."))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" la fonction polyn\xF4me du second degr\xE9 d\xE9finie par "))(function() {
                                                var f3 = randFraction(f2.nextRand);
                                                var f4 = randFraction(f3.nextRand);
                                                var f5 = randFraction(f4.nextRand);
                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("f(x)=" + showTrinom(f3.fraction)(f4.fraction)(f5.fraction)))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" pour tout "))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("x\\in\\mathbb{R}"))(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(". "))(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("Donner la forme canonique de "))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" :"))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("3."))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" Calculer le discriminant de "))(function() {
                                                                            var f6 = randFraction(f5.nextRand);
                                                                            var f7 = randFraction(f6.nextRand);
                                                                            var f8 = randFraction(f7.nextRand);
                                                                            var l3 = lcm(eqInt)(euclideanRingInt)(f6.fraction.den)(lcm(eqInt)(euclideanRingInt)(f7.fraction.den)(f8.fraction.den));
                                                                            var v = mul(semiRingFraction)(lift3(l3))(f6.fraction);
                                                                            var v1 = mul(semiRingFraction)(lift3(l3))(f7.fraction);
                                                                            var v2 = mul(semiRingFraction)(lift3(l3))(f8.fraction);
                                                                            var g3 = gcd(eqInt)(euclideanRingInt)(abs(ordInt)(ringInt)(v.num))(gcd(eqInt)(euclideanRingInt)(abs(ordInt)(ringInt)(v1.num))(abs(ordInt)(ringInt)(v2.num)));
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m(showTrinom(div(euclideanRingFraction)(v)(lift3(g3)))(div(euclideanRingFraction)(v1)(lift3(g3)))(div(euclideanRingFraction)(v2)(lift3(g3)))))(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t("En d\xE9duire le nombre de solutions r\xE9elles de l'\xE9quation "))(function() {
                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(equation2(function() {
                                                                                      var $48 = eq(eqFraction)(f6.fraction)(div(euclideanRingFraction)(v)(lift3(g3)));
                                                                                      if ($48) {
                                                                                        return showTrinom(div(euclideanRingFraction)(f6.fraction)(lift3(-2 | 0)))(div(euclideanRingFraction)(f7.fraction)(lift3(-2 | 0)))(div(euclideanRingFraction)(f8.fraction)(lift3(-2 | 0)));
                                                                                      }
                                                                                      ;
                                                                                      return showTrinom(f6.fraction)(f7.fraction)(f8.fraction);
                                                                                    }() + "=0"))(function() {
                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("On donnera la valeur du discriminant "))(function() {
                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("ainsi que le nombre de solutions."))(function() {
                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("M\xEAme s'il y a des solutions, on ne demande pas de calculer leur valeur:"))(function() {
                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("4."))(function() {
                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" R\xE9soudre dans "))(function() {
                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\mathbb{R}:"))(function() {
                                                                                                            ...
                                                                                                            var v3 = mul(semiRingFraction)(negate(ringFraction)(f9.fraction))(add(semiRingFraction)(f10.fraction)(f11.fraction));
                                                                                                            var v4 = mul(semiRingFraction)(mul(semiRingFraction)(f9.fraction)(f10.fraction))(f11.fraction);
                                                                                                            var l4 = lcm(eqInt)(euclideanRingInt)(f9.fraction.den)(lcm(eqInt)(euclideanRingInt)(v3.den)(v4.den));
                                                                                                            var v5 = mul(semiRingFraction)(lift3(l4))(f9.fraction);
                                                                                                            var v6 = mul(semiRingFraction)(lift3(l4))(v3);
                                                                                                            var v7 = mul(semiRingFraction)(lift3(l4))(v4);
                                                                                                            var g4 = gcd(eqInt)(euclideanRingInt)(abs(ordInt)(ringInt)(v5.num))(gcd(eqInt)(euclideanRingInt)(abs(ordInt)(ringInt)(v6.num))(abs(ordInt)(ringInt)(v7.num)));
                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(equation2(showTrinom(div(euclideanRingFraction)(v5)(lift3(g4)))(div(euclideanRingFraction)(v6)(lift3(g4)))(div(euclideanRingFraction)(v7)(lift3(g4))) + "=0"))(function() {
                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("5."))(function() {
                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" la fonction d\xE9finie sur "))(function() {
                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\mathbb{R}"))(function() {
                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" par "))(function() {
                                                                                                                                  ...
                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("f(x)=" + (showTrinom(f12.fraction)(f13.fraction)(zero(semiRingFraction)) + "+c")))(function() {
                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" o\xF9 "))(function() {
                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("c"))(function() {
                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" est un nombre r\xE9el."))(function() {
                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("D\xE9terminer la valeur de "))(function() {
                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("c"))(function() {
                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" pour laquelle "))(function() {
                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(' admet une unique racine (on dit aussi racine "double") '))(function() {
                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("x_0"))(function() {
                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(", puis calculer "))(function() {
                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("x_0"))(function() {
                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(":"))(function() {
                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                      var sol4 = function() {
                                                                                                                                                                        var $55 = eq(eqFraction)(f10.fraction)(f11.fraction);
                                                                                                                                                                        if ($55) {
                                                                                                                                                                          return "\\{" + (show(showFraction)(f10.fraction) + "\\}");
                                                                                                                                                                        }
                                                                                                                                                                        ;
                                                                                                                                                                        return "\\{" + (show(showFraction)(f10.fraction) + ("," + (show(showFraction)(f11.fraction) + "\\}")));
                                                                                                                                                                      }();
                                                                                                                                                                      var delta3 = delta(div(euclideanRingFraction)(v)(lift3(g3)))(div(euclideanRingFraction)(v1)(lift3(g3)))(div(euclideanRingFraction)(v2)(lift3(g3)));
                                                                                                                                                                      var nbsol3 = function() {
                                                                                                                                                                        if (lessThan(ordFraction)(delta3)(zero(semiRingFraction))) {
                                                                                                                                                                          return "pas\\;de\\; solution";
                                                                                                                                                                        }
                                                                                                                                                                        ;
                                                                                                                                                                        if (eq(eqFraction)(delta3)(zero(semiRingFraction))) {
                                                                                                                                                                        ...
                                                                                                                                                                        ;
                                                                                                                                                                        throw new Error("Failed pattern match at Main (line 300, column 22 - line 303, column 81): " + [unit.constructor.name]);
                                                                                                                                                                      }();
                                                                                                                                                                      ...
                                                                                                                                                                      var rep = ["r\xE9ponses: 1)", "\\mathcal{S}=" + function() {
                                                                                                                                                                        var $57 = eq(eqFraction)(f1.fraction)(f2.fraction);
                                                                                                                                                                        if ($57) {
                                                                                                                                                                          return "\\{(" + (show(showFraction)(f1.fraction) + ("," + (show(showFraction)(f2.fraction) + ")\\}")));
                                                                                                                                                                        }
                                                                                                                                                                        ;
                                                                                                                                                                        return "\\{(" + (show(showFraction)(f1.fraction) + ("," + (show(showFraction)(f2.fraction) + ("),(" + (show(showFraction)(f2.fraction) + ("," + (show(showFraction)(f1.fraction) + ")\\}")))))));
                                                                                                                                                                      }(), "\\; 2) ", "f(x)=" + (show(showFraction)(f3.fraction) + ("(x" + (inline2(negate(ringFraction)(alpha2)) + (")^2" + inline2(beta2))))), "\\; 3)\\Delta =" + (show(showFraction)(delta3) + (",\\; " + nbsol3)), "\\; 4)\\mathcal{S}=" + sol4, "\\; 5)", "c=", show(showFraction)(div(euclideanRingFraction)(div(euclideanRingFraction)(mul(semiRingFraction)(f13.fraction)(f13.fraction))(f12.fraction))(lift3(4))), "\\; x_0=", show(showFraction)(div(euclideanRingFraction)(div(euclideanRingFraction)(negate(ringFraction)(f13.fraction))(f12.fraction))(lift3(2)))];
                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m(function() {
                                                                                                                                                                        var $58 = fromMaybe(0)(validateInput(newState.seed)) < 0;
                                                                                                                                                                        if ($58) {
