...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b) {
        return apply1(map20($$const(identity2))(a2))(b);
      };
    };
  };
  ...
  var applicativeWriterT = function(dictMonoid) {
    ...
    return function(dictApplicative) {
      ...
      return {
        pure: function(a2) {
          return pure23(new Tuple(a2, mempty10));
        },
        Apply0: function() {
          return applyWriterT2;
        }
  ...
  var monoidEffectFn1 = function(dictMonoid) {
    var mempty10 = mempty(monoidEffect(dictMonoid));
      ...
      return function(b) {
        return function(e) {
          return fix1(function(i) {
            return sampleOnRight1(alt6(i)(voidLeft4(once12(e))(b)))(map110(flip(f))(e));
          });
        };
      };
    };
      ...
      return function(acc) {
        return function(xs) {
          return filterMap4(snd)(fold12(function(v) {
            return function(b) {
              return map4(pure3)(f(v.value0)(b));
            };
  ...
  var consume = function(v) {
    return function(v1) {
      ...
      ;
      return lcgNext(consume(v - 1 | 0)(v1));
    };
  };

  // output/Devoir7.Exercise1/index.js
  ...
  var show1 = /* @__PURE__ */ show(/* @__PURE__ */ showArray(showInt));
  var pure16 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeWriterT(monoidNut)(applicativeIdentity));
  ...
  var randomInteger = function(r) {
    var rsign = lcgNext(r);
    var sign2 = (2 * mod3(unSeed(rsign))(2) | 0) - 1 | 0;
    var ri = lcgNext(rsign);
    var i = mod3(unSeed(ri))(majorant);
    return sign2 * i | 0;
  };
  var randomParam = function($copy_r) {
    ...
    function $tco_loop(r) {
      ...
      var a2 = randomInteger(ra);
      var ok = a2 !== 1 && (a2 !== 0 && b !== 0);
      if (ok) {
        $tco_done = true;
        return {
          a: a2,
  ...
  var exo1 = function(mode) {
    return function(r0) {
      return discard3(section_("Exercice 1"))(function() {
        return discard3(t_("Soit "))(function() {
          return discard3(m_("(u_n)"))(function() {
            return discard3(t_(" la suite d\xE9finie sur "))(function() {
              return discard3(m_("\\mathbb{N}"))(function() {
                return discard3(t_(" par "))(function() {
                  var v = randomParam(r0);
                  return discard3(m_("u_n = " + showSeq({
                    a: v.a,
                    b: v.b
                  })))(function() {
                    return discard3(t_("."))(function() {
                      return discard3(nl)(function() {
                        return discard3(nl)(function() {
                          return discard3(tell3(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;")])([label_([execWriter(m_("u_0="))]), label_([execWriter(m_("u_1="))]), label_([execWriter(m_("u_2="))]), label_([execWriter(m_("u_3="))])])))(function() {
                            if (mode) {
                              return discard3(nl)(function() {
                                return discard3(t_("r\xE9ponse: "))(function() {
                                  return t_(show1([v.b, v.a + v.b | 0, (2 * v.a | 0) + v.b | 0, (3 * v.a | 0) + v.b | 0]));
                                });
                              });
                            }
                            ;
                            return pure16(mempty4);
                          });
                        });
                      });
                    });
  ...
  // output/Devoir7.Exercise2/index.js
  ...
  var show12 = /* @__PURE__ */ show(/* @__PURE__ */ showArray(showInt));
  ...
  var randomInteger2 = function(r) {
    var rsign = lcgNext(r);
    var sign2 = (2 * mod4(unSeed(rsign))(2) | 0) - 1 | 0;
    var ri = lcgNext(rsign);
    var i = mod4(unSeed(ri))(majorant2);
    return sign2 * i | 0;
  };
  var randomParam2 = function($copy_r) {
    ...
    function $tco_loop(r) {
      ...
      var b = randomInteger2(rb);
      var a2 = randomInteger2(ra);
      var ok = c !== 0 && (a2 !== 1 && (a2 !== 0 && b !== 0));
      if (ok) {
        $tco_done = true;
        return {
          a: a2,
  ...
  var exo2 = function(mode) {
    return function(r0) {
      return discard4(section_("Exercice 2"))(function() {
        return discard4(t_("Soit "))(function() {
          return discard4(m_("(v_n)"))(function() {
            return discard4(t_(" la suite d\xE9finie sur "))(function() {
              return discard4(m_("\\mathbb{N}"))(function() {
                return discard4(t_(" par "))(function() {
                  var v = randomParam2(r0);
                  return discard4(m_("\\left\\{\\begin{array}{l}v_0=" + (show6(v.c) + ("\\\\" + ("v_{n+1}=" + (showSeq2({
                    a: v.a,
                    b: v.b,
                    c: v.c
                    ...
                    return discard4(t_("."))(function() {
                      return discard4(nl)(function() {
                        return discard4(nl)(function() {
                          return discard4(tell4(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;")])([label_([execWriter(m_("v_0="))]), label_([execWriter(m_("v_1="))]), label_([execWriter(m_("v_2="))]), label_([execWriter(m_("v_3="))])])))(function() {
                            if (mode) {
                              return discard4(nl)(function() {
                                return discard4(t_("r\xE9ponse: "))(function() {
                                  return t_(show12([v.c, (v.a * v.c | 0) + v.b | 0, (v.a * ((v.a * v.c | 0) + v.b | 0) | 0) + v.b | 0, (v.a * ((v.a * ((v.a * v.c | 0) + v.b | 0) | 0) + v.b | 0) | 0) + v.b | 0]));
                                });
                              });
                            }
                            ;
                            return pure17(mempty5);
                          });
                        });
                      });
                    });
  ...
  // output/Devoir7.Exercise3/index.js
  var show7 = /* @__PURE__ */ show(showInt);
  var eq4 = /* @__PURE__ */ eq(eqBigInt);
  var show13 = /* @__PURE__ */ show(showBigInt);
  ...
  var mempty6 = /* @__PURE__ */ mempty(monoidUnit);
  var showSeq3 = function(v) {
    return function() {
      ...
      var $29 = v.b < 0;
      if ($29) {
        return "-" + ("\\dfrac{" + (show7(-v.b | 0) + ("}{n+" + (show7(v.c) + "}"))));
      }
      ;
      return "+" + ("\\dfrac{" + (show7(v.b) + ("}{n+" + (show7(v.c) + "}"))));
    }();
  };
  var rshow = function(r) {
    var n = numerator2(r);
    var d = denominator2(r);
    var $33 = eq4(d)(fromInt(1));
    if ($33) {
      return show13(n);
    }
    ;
    return "\\frac{" + (show13(n) + ("}{" + (show13(d) + "}")));
  };
  var majorant3 = 10;
  var randomInteger3 = function(r) {
    var rsign = lcgNext(r);
    var sign2 = (2 * mod5(unSeed(rsign))(2) | 0) - 1 | 0;
    var ri = lcgNext(rsign);
    var i = mod5(unSeed(ri))(majorant3);
    return sign2 * i | 0;
  };
  ...
  var randomParam3 = function($copy_r) {
    ...
    function $tco_loop(r) {
      ...
      var b = randomInteger3(rb);
      var a2 = randomInteger3(ra);
      var ok = a2 !== 0 && (b !== 0 && c !== 0);
      if (ok) {
        $tco_done = true;
        return {
  ...
  var exo3 = function(mode) {
    return function(r0) {
      return discard5(section_("Exercice 3"))(function() {
        return discard5(t_("Soit "))(function() {
          return discard5(m_("(w_n)"))(function() {
            return discard5(t_(" la suite d\xE9finie sur "))(function() {
              return discard5(m_("\\mathbb{N}"))(function() {
                return discard5(t_(" par "))(function() {
                  var v = randomParam3(r0);
                  return discard5(m_("w_n = " + showSeq3({
                    a: v.a,
                    b: v.b,
                    c: v.c
                  })))(function() {
                    return discard5(t_("."))(function() {
                      return discard5(nl)(function() {
                        return discard5(nl)(function() {
                          return discard5(tell5(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;")])([label_([execWriter(m_("w_0="))]), label_([execWriter(m_("w_1="))]), label_([execWriter(m_("w_2="))]), label_([execWriter(m_("w_3="))])])))(function() {
                            if (mode) {
                              return discard5(nl)(function() {
                                return discard5(t_("r\xE9ponse: "))(function() {
                                  return discard5(m_("[" + (rshow(div3(fromInt2(v.b))(fromInt2(v.c))) + ("," + (rshow(add3(fromInt2(v.a))(div3(fromInt2(v.b))(fromInt2(1 + v.c | 0)))) + ("," + (rshow(add3(fromInt2(2 * v.a | 0))(div3(fromInt2(v.b))(fromInt2(2 + v.c | 0)))) + ("," + (rshow(add3(fromInt2(3 * v.a | 0))(div3(fromInt2(v.b))(fromInt2(3 + v.c | 0)))) + "]")))))))))(function() {
                                    return t_("");
                                  });
                                });
                              });
  ...
  // output/Devoir7.Exercise4/index.js
  var eq5 = /* @__PURE__ */ eq(eqBigInt);
  var show8 = /* @__PURE__ */ show(showBigInt);
  ...
  var rshow2 = function(r) {
    var n = numerator2(r);
    var d = denominator2(r);
    var $25 = eq5(d)(fromInt(1));
    if ($25) {
      return show8(n);
    }
    ;
    return "\\frac{" + (show8(n) + ("}{" + (show8(d) + "}")));
  };
  var majorant4 = 10;
  var randomInteger4 = function(r) {
    var rsign = lcgNext(r);
    var sign2 = (2 * mod6(unSeed(rsign))(2) | 0) - 1 | 0;
    var ri = lcgNext(rsign);
    var i = mod6(unSeed(ri))(majorant4);
    return sign2 * i | 0;
  };
  ...
  var exo4 = function(mode) {
    return function(r0) {
      return discard6(section_("Exercice 4"))(function() {
        return discard6(t_("Soit "))(function() {
          return discard6(m_("(s_n)"))(function() {
            return discard6(t_(" la suite d\xE9finie sur "))(function() {
              return discard6(m_("\\mathbb{N}"))(function() {
                return discard6(t_(" par "))(function() {
                  var v = randomParam4(r0);
                  return discard6(m_("\\left\\{\\begin{array}{l}s_0=" + (show14(v.a) + ("\\\\" + ("s_{n+1}=" + (showSeq4({
                    a: v.a
                  }) + "\\end{array}\\right."))))))(function() {
                    return discard6(t_("."))(function() {
                      return discard6(nl)(function() {
                        return discard6(nl)(function() {
                          return discard6(tell6(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;")])([label_([execWriter(m_("s_0="))]), label_([execWriter(m_("s_1="))]), label_([execWriter(m_("s_2="))]), label_([execWriter(m_("s_3="))])])))(function() {
                            if (mode) {
                              return discard6(nl)(function() {
                                return discard6(t_("r\xE9ponse: "))(function() {
                                  return discard6(m_("[" + (rshow2(fromInt2(v.a)) + ("," + (rshow2(div4(fromInt2(1))(fromInt2(1 - v.a | 0))) + ("," + (rshow2(div4(fromInt2(v.a - 1 | 0))(fromInt2(v.a))) + ("," + (rshow2(fromInt2(v.a)) + "]")))))))))(function() {
                                    return t_("");
                                  });
                                });
                              });
  ...
  // output/Devoir7.Exercise5/index.js
  var show9 = /* @__PURE__ */ show(showInt);
  var mod7 = /* @__PURE__ */ mod(euclideanRingInt);
  var discard7 = /* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindWriterT(semigroupNut)(bindIdentity));
  var tell7 = /* @__PURE__ */ tell(/* @__PURE__ */ monadTellWriterT(monoidNut)(monadIdentity));
  var show15 = /* @__PURE__ */ show(/* @__PURE__ */ showArray(showInt));
  var pure20 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeWriterT(monoidNut)(applicativeIdentity));
  var mempty8 = /* @__PURE__ */ mempty(monoidUnit);
  var showSeq5 = function(v) {
    ...
    ;
    return show9(v.a) + "n^2-t_n";
  };
  var majorant5 = 10;
  var randomInteger5 = function(r) {
    var rsign = lcgNext(r);
    var sign2 = (2 * mod7(unSeed(rsign))(2) | 0) - 1 | 0;
    var ri = lcgNext(rsign);
    var i = mod7(unSeed(ri))(majorant5);
    return sign2 * i | 0;
  };
  var randomParam5 = function($copy_r) {
    ...
    function $tco_loop(r) {
      var ra = lcgNext(r);
      var rb = lcgNext(ra);
      var b = randomInteger5(rb);
      var a2 = randomInteger5(ra);
      var ok = a2 !== 1 && (a2 !== 0 && b !== 0);
      if (ok) {
        $tco_done = true;
        return {
  ...
  var exo5 = function(mode) {
    return function(r0) {
      return discard7(section_("Exercice 5"))(function() {
        return discard7(t_("Soit "))(function() {
          return discard7(m_("(t_n)"))(function() {
            return discard7(t_(" la suite d\xE9finie sur "))(function() {
              return discard7(m_("\\mathbb{N}"))(function() {
                return discard7(t_(" par "))(function() {
                  var v = randomParam5(r0);
                  return discard7(m_("\\left\\{\\begin{array}{l}t_0=" + (show9(v.b) + ("\\\\" + ("t_{n+1}=" + (showSeq5({
                    a: v.a,
                    b: v.b
                  }) + "\\end{array}\\right."))))))(function() {
                    return discard7(t_("."))(function() {
                      return discard7(nl)(function() {
                        return discard7(nl)(function() {
                          return discard7(tell7(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;")])([label_([execWriter(m_("t_0="))]), label_([execWriter(m_("t_1="))]), label_([execWriter(m_("t_2="))]), label_([execWriter(m_("t_3="))])])))(function() {
                            if (mode) {
                              return discard7(nl)(function() {
                                return discard7(t_("r\xE9ponse: "))(function() {
                                  return t_(show15([v.b, -v.b | 0, v.a + v.b | 0, (3 * v.a | 0) - v.b | 0]));
                                });
                              });
                            }
                            ;
                            return pure20(mempty8);
                          });
                        });
                      });
                    });
  ...
  // output/Devoir7.Main/index.js
  var discard8 = /* @__PURE__ */ discard(discardUnit);
  var discard1 = /* @__PURE__ */ discard8(/* @__PURE__ */ bindWriterT(semigroupNut)(bindIdentity));
  var tell8 = /* @__PURE__ */ tell(/* @__PURE__ */ monadTellWriterT(monoidNut)(monadIdentity));
  var abs4 = /* @__PURE__ */ abs(ordInt)(ringInt);
  var map19 = /* @__PURE__ */ map(/* @__PURE__ */ functorAPoll(functorEvent));
  var pure21 = /* @__PURE__ */ pure(applicativeEffect);
  var apply4 = /* @__PURE__ */ apply(/* @__PURE__ */ applyAPoll(applyEvent));
  var mempty9 = /* @__PURE__ */ mempty(monoidNut);
  var header = /* @__PURE__ */ discard1(/* @__PURE__ */ setTitle_("Devoir 7 : Suites num\xE9riques"))(function() {
    return discard1(nl)(function() {
      return discard1(tell8(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label_([text_("Nom:")]), label_([text_("Pr\xE9nom:")]), label_([text_("Classe:")])])))(function() {
        return tell8(ul_([li_([text_("5 exercices")]), li_([text_("4 termes \xE0 d\xE9terminer par exercice")]), li_([execWriter(discard1(m_("\\frac{1}{4}"))(function() {
          return t_(" point par terme");
        }))]), li_([text_("calculatrice autoris\xE9e")]), li_([text_("documents autoris\xE9s")])]));
      });
    });
  });
  ...
  var main = function __do5() {
    ...
    return runInBody(bind4(useState(""))(function(v) {
      return bind4(useState(false))(function(v1) {
        var absoluteSeed = map19(toSeed)(v.value1);
        var seed = map19(fromRelative)(absoluteSeed);
        var solved = map19(function(v2) {
          return v2 < 0;
        })(absoluteSeed);
        return div_([div_([label_([text_("Enonc\xE9 n\xB0 ")]), input([valueOn_(input2)(v.value0), keydown_(function(k) {
        ...
        })])([])]), div_([switcherFlipped(apply4(apply4(map19(function(a2) {
          return function(b) {
            return function(c) {
          ...
          if (v2.value0) {
            return execWriter(discard1(nl)(function() {
              var r1 = consume(30)(v2.value1.value1);
              var r2 = consume(30)(r1);
              var r3 = consume(30)(r2);
              var r4 = consume(30)(r3);
              var r5 = consume(30)(r4);
              return discard1(exo1(v2.value1.value0)(r1))(function() {
                return discard1(exo2(v2.value1.value0)(r2))(function() {
                  return discard1(exo3(v2.value1.value0)(r3))(function() {
                    return discard1(exo4(v2.value1.value0)(r4))(function() {
                      return exo5(v2.value1.value0)(r5);
                    });
                  });
                });
              });
