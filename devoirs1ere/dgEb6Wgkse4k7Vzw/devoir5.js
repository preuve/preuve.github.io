(() => {
  ...
  var hr = function(dictMultiAlternative) {
    return function(dictShiftMap) {
      return function(ps) {
        return node("hr")(dictMultiAlternative)(dictShiftMap)(ps)([]);
      };
    };
  };
  var hr$prime = function(dictMultiAlternative) {
    return function(dictShiftMap) {
      return hr(dictMultiAlternative)(dictShiftMap)([]);
    };
  };
    ...
    "render'": function(v) {
      return function(v1) {
        ...
        return append(semigroupArray)([line2(abs3(basedPoint)(v1.origin))(ord(basedPoint)(v1.origin))(abs3(basedPoint)(v1.extremity))(ord(basedPoint)(v1.extremity))(v.stroke)(v.strokeWidth)])(append(semigroupArray)(maybe([])(function(v2) {
          ...
          return [text7(abs3(basedPoint)(m2) + 10)(ord(basedPoint)(m2) - 10)(v.textFill)(v.fontStyle)(str), text7(abs3(basedPoint)(m2) + 10)(ord(basedPoint)(m2) - 23)(v.textFill)(v.fontStyle)(function() {
            var $82 = str === "";
            if ($82) {
              return "";
            }
  ...
  // output/First/index.js
  var tree = function(mode) {
    return div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(function() {
      var pF = function() {
        if (mode) {
          return "0.52";
        }
      ...
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(svg(widgetMultiAlternative(monoidArray))(widgetShiftMap)([width2("500"), height2("400"), attr2("style")("position: absolute; ")])(function() {
        var startA$prime = point("")(134)(264);
        var startA = point("")(134)(80);
        var root = point("")(12)(175);
        var nodeA$prime = point("")(100)(244);
        var nodeA = point("")(100)(92);
        var endAB$prime = point("")(202)(136);
        var endAB = point("")(202)(24);
        var endA$primeB$prime = point("")(202)(320);
        var endA$primeB = point("")(202)(208);
        var context = {
          stroke: "#000",
          strokeWidth: 1.5,
          fill: "#00000000",
        ...
        return render$prime(renderSequence(renderSegment))(context)([segment(root)(nodeA)(Nothing.value), segment(root)(nodeA$prime)(Nothing.value), segment(startA)(endAB)(Nothing.value), segment(startA)(endAB$prime)(Nothing.value), segment(startA$prime)(endA$primeB)(Nothing.value), segment(startA$prime)(endA$primeB$prime)(Nothing.value)]);
      }())))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(m("\\begin{array}{ccccccccc} & & & & & & & & S \\\\ " + ("& & & & & " + (" \\\\ \\\\ " + ("& & & & F \\\\ " + ("& " + (pF + (" \\\\ " + ("& & & & & " + (" \\\\ " + ("& & & & & & & &" + ("\\overline{S} \\\\ " + ("\\cdot \\\\ " + ("& & & & &\xA0& & &" + ("S \\\\ " + ("& & & & &" + (pgnFS + (" \\\\ " + ("&" + (pnF + (" \\\\ " + ("& & & & \\overline{F} \\\\ \\\\" + ("& & & & & " + (pgnFnS + " \\\\ & & & & & & & & \\overline{S} \\end{array}"))))))))))))))))))))))))(function() {
  ...
  var exo2 = function(v) {
    return function(mode) {
      return div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(em2("Dans cet exercice, on arrondira les r\xE9sultats au milli\xE8me."))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(t("Une entreprise sp\xE9cialis\xE9e dans la fabrication de confitures fait appel \xE0 des producteurs locaux."))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t("\xC0 la livraison, l\u2019entreprise effectue un contr\xF4le qualit\xE9 \xE0 l\u2019issue duquel les fruits sont s\xE9lectionn\xE9s ou non pour la pr\xE9paration des confitures."))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t("Une \xE9tude statistique a \xE9tabli que :"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("22% des fruits livr\xE9s sont issus de l\u2019agriculture biologique ;"))(function() {
                      return get2(monadStateStateT(monadIdentity));
                    })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("parmi les fruits issus de l\u2019agriculture biologique, 95% sont s\xE9lectionn\xE9s pour la pr\xE9paration des confitures ;"))(function() {
                      return get2(monadStateStateT(monadIdentity));
                    })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("parmi les fruits non issus de l\u2019agriculture biologique, 90% sont s\xE9lectionn\xE9s pour la pr\xE9paration des confitures."))(function() {
                      return get2(monadStateStateT(monadIdentity));
                    })))])])))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(t("On pr\xE9l\xE8ve au hasard un fruit et on note :"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("B"))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(t(` l'\xE9v\xE9nement "le fruit est issu de l\u2019agriculture biologique" ;`))(function() {
                            return get2(monadStateStateT(monadIdentity));
                          });
                        })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("S"))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(t(` l'\xE9v\xE9nement "le fruit est s\xE9lectionn\xE9 pour la pr\xE9paration des confitures".`))(function() {
                            return get2(monadStateStateT(monadIdentity));
                          });
                        })))])])))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u2022"))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" Repr\xE9senter la situation par un arbre pond\xE9r\xE9."))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u2022\u25E6"))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("a)"))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Calculer "))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("p(B\\cap S)."))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(b2("b)"))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" Interpr\xE9ter ce r\xE9sultat dans le cadre de l'\xE9nonc\xE9."))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022\u25E6"))(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Montrer que la probabilit\xE9 que le fruit est selectionn\xE9 pour la pr\xE9paration des confitures vaut 0,911."))(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("4\u2022"))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Sachant que le fruit a \xE9t\xE9 selectionn\xE9 pour la pr\xE9paration des confitures, d\xE9terminer la probabilit\xE9 qu'il ne soit pas issu de l'agriculture biologique."))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(function() {
                                                                  if (mode) {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                      return t("r\xE9ponses: 1)2)a)p(B/\\S)=0.209 b)3)pS(nB)~0.771");
                                                                    });
                                                                  }
                                                                  ;
                                                                  return pure(applicativeStateT(monadIdentity))(unit);
                                                                }())(function() {
                                                                  return get2(monadStateStateT(monadIdentity));
                                                                });
                                                              });
  ...
  var exo1 = function(v) {
    return function(mode) {
      return div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(em2("Dans cet exercice, on arrondira les r\xE9sultats au milli\xE8me."))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(t("Une agence P\xF4le Emploi \xE9tudie l'ensemble des demandeurs d'emploi selon deux crit\xE8res, le sexe et l'exp\xE9rience professionnelle."))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t("Cette \xE9tude montre que :"))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("52% des demandeurs d'emploi sont des femmes et 48% sont des hommes ;"))(function() {
                    return get2(monadStateStateT(monadIdentity));
                  })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("18% des demandeurs d'emploi sont sans exp\xE9rience et les autres sont avec exp\xE9rience ;"))(function() {
                    return get2(monadStateStateT(monadIdentity));
                  })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("parmi les hommes qui sont demandeurs d'emploi, on sait que 17,5% sont sans exp\xE9rience."))(function() {
                    return get2(monadStateStateT(monadIdentity));
                  })))])])))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(t("On pr\xE9l\xE8ve au hasard la fiche d'un demandeur d'emploi de cette agence. On note:"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("S"))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(` : l'\xE9v\xE9nement "le demandeur d'emploi est sans exp\xE9rience" ;`))(function() {
                              return get2(monadStateStateT(monadIdentity));
                            });
                          })))]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(m("F"))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t(` : l'\xE9v\xE9nement "le demandeur d'emploi est une femme".`))(function() {
                              return get2(monadStateStateT(monadIdentity));
                            });
                          })))])])))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u2022"))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" Pr\xE9ciser "))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("p(S)"))(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("p_{\\overline{F}}(S)"))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u2022"))(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" Recopier l'arbre ci-dessous et compl\xE9ter les pointill\xE9s par les probabilit\xE9s associ\xE9es."))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(tree(mode)))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022"))(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" D\xE9montrer que "))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("p(\\overline{F}\\cap S)=0,084"))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(". Interpr\xE9ter le r\xE9sultat."))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("4\u2022"))(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" La fiche pr\xE9lev\xE9e est celle d'un demandeur d'emploi sans exp\xE9rience. Calculer la probabilit\xE9 pour que ce soit un homme."))(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("5\u2022"))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(b2(" a)"))(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" Justifier que "))(function() {
                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("p(S\\cap F)=0,096."))(function() {
                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2(" b)"))(function() {
                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" Sachant que la fiche pr\xE9lev\xE9e est celle d'une femme, calculer la probabilit\xE9 que ce soit la fiche d'un demandeur d'emploi sans exp\xE9rience."))(function() {
                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(function() {
                                                                                              if (mode) {
                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                  return t("r\xE9ponses: 1) p(S)=0.18 pnF(S)=0.175 2)3)4) pS(nF)~0.467 5)a)b) pF(S)~0.185");
                                                                                                });
                                                                                              }
                                                                                              ;
                                                                                              return pure(applicativeStateT(monadIdentity))(unit);
  ...
  var first = function(r) {
    return function(mode) {
      var arr = [exo1(r)(mode), exo2(r)(mode)];
      return fromJust()(index(arr)(mod(euclideanRingInt)(r.val)(length3(arr))));
    };
  };
        ...
        return function($copy_v1) {
          return function($copy_ys) {
            ...
            function $tco_loop(v, v1, ys) {
              ...
              var x = fromJust()(index(v)(mod(euclideanRingInt)(r$prime$prime.val)(length3(v))));
              $tco_var_v = difference(eqInt)(v)([x]);
  ...
  var exo12 = function(r) {
    return function(mode) {
      return div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(em2("Cet exercice est un questionnaire \xE0 choix multiple. Pour chaque question, une seule des r\xE9ponses propos\xE9es est correcte. Une bonne r\xE9ponse rapporte 1 point, une mauvaise r\xE9ponse enl\xE8ve 1 point tant que la note globale reste positive. Une absence de r\xE9ponse n'apporte et n'enl\xE8ve aucun point. Aucune justification n'est exig\xE9e."))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(t("Un lecteur d'une biblioth\xE8que est passionn\xE9 de romans policiers et de biographies. Cette biblioth\xE8que lui propose 150 romans policiers et 50 biographies."))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t("40% des \xE9crivains de romans policiers sont fran\xE7ais et 70% des \xE9crivains de biographies sont fran\xE7ais."))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t("Le lecteur choisit un livre au hasard parmi les 200 ouvrages."))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                        var chosen_indices = unsort(length3(problems))(r);
                        var chosen_problems = take(5)(map(functorArray)(function(i) {
                          return fromJust()(index(problems)(i));
                        })(chosen_indices));
                        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(foldMapWithIndex(foldableWithIndexArray)(monoidArray)(function(i) {
                          return function(p) {
                            return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(b2(show(showInt)(i + 1 | 0) + ". "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(t(p.q + " :"))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(t("(a) "))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(m(p.a))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad\\quad"))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("(b) "))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(m(p.b))(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad\\quad"))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("(c) "))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m(p.c))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                        return get2(monadStateStateT(monadIdentity));
                                                      });
                        ...
                        })(chosen_problems))))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(function() {
                            if (mode) {
                              return t("r\xE9ponses: " + foldMapWithIndex(foldableWithIndexArray)(monoidString)(function(i) {
                                return function(a) {
                                  return " " + (show(showInt)(i + 1 | 0) + (") (" + (a.r + ")")));
                                };
                              })(chosen_problems));
                            }
                            ;
  ...
  var third = function(r) {
    return function(mode) {
      return div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(function() {
        var chosen_indices = unsort(length3(problems2))(r);
        var chosen_problems = take(2)(map(functorArray)(function(i) {
          return fromJust()(index(problems2)(i));
        })(chosen_indices));
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(foldMapWithIndex(foldableWithIndexArray)(monoidArray)(function(i) {
          return function(p) {
            return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(b2(show(showInt)(i + 1 | 0) + "\u2022\u2022\u25E6"))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(t(" R\xE9soudre dans "))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(m(p.domain))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" :"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(equation2(p.inequation))(function() {
                        return get2(monadStateStateT(monadIdentity));
                      });
                    });
                  });
          ...
          return discard(discardUnit)(bindStateT(monadIdentity))(function() {
            if (mode) {
              return m("r\xE9ponses: " + foldMapWithIndex(foldableWithIndexArray)(monoidString)(function(i) {
                return function(p) {
                  return " " + (show(showInt)(i + 1 | 0) + (") " + (p.answer + "\\quad")));
                };
              })(chosen_problems));
            }
            ;
  ...
  var opener = function(title3) {
    return function(points) {
      return put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)([div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("margin: 0; display: flex; justify-content: space-between")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("font-size: 24px; font-weight: 700;")])([text(widgetLiftWidget)(title3)]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("font-size: 16px; font-weight: 700;")])([text(widgetLiftWidget)(points)])]), hr$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)]));
    };
  };
  ...
  var header = /* @__PURE__ */ div$prime(/* @__PURE__ */ widgetMultiAlternative(monoidArray))(widgetShiftMap)(/* @__PURE__ */ fromIncremental(/* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindStateT(monadIdentity))(/* @__PURE__ */ setTitle("Devoir 5 : Probabilit\xE9s conditionnelles / Fonctions de degr\xE9 2"))(function() {
    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Pr\xE9nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Classe:")])])))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("4 exercices")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("5 points par exercice "))(function() {
    ...
    return dyn(widgetMonad)(discard(discardUnit)(bindCofree(widgetAlternative(monoidArray)))(display2(text(widgetLiftWidget)("Enonc\xE9 n\xB0 ")))(function() {
      return bind(bindCofree(widgetAlternative(monoidArray)))(debounce(widgetMonad)(widgetAlt(monoidArray))(widgetMonadAff(monoidArray))(50)(st)(function(s) {
        ...
        return display2(div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(function() {
          var $1 = !newState.enabled;
          if ($1) {
            return [];
          }
          ;
          return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(opener("Exercice 1")("5 points"))(function() {
              var r1 = rand(r0);
              return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(first(r1)(mode)))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(opener("Exercice 2")("5 points"))(function() {
                      var r2 = rand(r1);
                      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(second(r2)(mode)))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(opener("Exercice 3")("5 points"))(function() {
                              var r3 = rand(r2);
                              return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(third(r3)(mode)))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(opener("Exercice 4")("5 points"))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u2022\u2022\u25E6"))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" R\xE9soudre l'in\xE9quation"))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(equation2("x+\\dfrac{1}{x}-2\\geq 0."))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u25E6"))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" En d\xE9duire que, pour tout r\xE9el "))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("a>0, \\quad a+\\dfrac{1}{a}\\geq 2."))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022\u2022"))(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" Montrer alors que, pour tous r\xE9els strictement positifs "))(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\alpha"))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\beta"))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(", on a"))(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(b2("a) "))(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad \\dfrac{\\alpha}{\\beta}+\\dfrac{\\beta}{\\alpha}\\geq 2"))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad"))(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(b2("b)"))(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("\\quad (\\alpha+\\beta)(\\dfrac{1}{\\alpha}+\\dfrac{1}{\\beta})\\geq 4."))(function() {
                                                                                  return get2(monadStateStateT(monadIdentity));
                                                                                });
                                                                              });
                                                                            });
