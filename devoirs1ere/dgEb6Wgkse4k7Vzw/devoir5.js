...
(function($PS) {
  ...
  var newSVG = function (str) {
      return function (node) {
          return function __do() {
              ...
              var el = Web_DOM_Document.createElementNS(new Data_Maybe.Just("http://www.w3.org/2000/svg"))("svg")(document)();
              var svg = Web_DOM_Element.toNode(el);
              setAttribute("style")(str)(svg)();
              Web_DOM_Node.appendChild(svg)(node)();
              return svg;
          };
      };
  };
  ...
  var setup = function __do() {
      ...
      var bodyRaw = Data_Maybe.fromJust()(maybeBody);
      var body = Web_HTML_HTMLElement.toNode(bodyRaw);
      var pom = createElement("a")(document)();
      appendChild(pom)(body)();
      setAttribute("style")("display=\"none\"")(pom)();
      var saveText = function (textNode) {
          return function (nameOfFile) {
              return function (v) {
                  return function __do() {
                      var text = value(textNode)();
                      setAttribute("href")("data:text/plain;charset=utf-8," + Global_Unsafe.unsafeEncodeURIComponent(text))(pom)();
                      setAttribute("download")(nameOfFile)(pom)();
                      doClick(pom)();
      ...
      return function (ev) {
          return function (node) {
              return function __do() {
                  ...
                  Web_Event_EventTarget.addEventListener(ev)(listener)(false)(Web_DOM_Element.toEventTarget(Data_Maybe.fromJust()(Web_DOM_Element.fromNode(node))))();
                  return Data_Unit.unit;
              };
          };
      };
...
(function($PS) {
  ...
  var tree = function (doc) {
      return function (mode) {
          return function __do() {
              var thisPosition = DOM_Editor.getElementById("description")(doc)();
              var svg = DOM_Editor.newSVG("position: absolute; width: 500px; height: 400px;")(thisPosition)();
...
(function($PS) {
  ...
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              var val = DOM_Editor.inputedValueFromEvent(ev)();
              var mode = $foreign.fromString(val) < 0;
              var odd = (2 * Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)($foreign.fromString(val)) | 0) + 1 | 0;
              var r0 = Rand.rand({
                  val: odd,
                  gen: 0,
                  seed: odd * odd | 0
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      var setup = DOM_Editor.setup();
      var seed = DOM_Editor.createElement("input")(setup.document)();
      DOM_Editor.addEventListener(cb(setup.document))(DOM_Editor.change)(seed)();
      DOM_Editor.appendChild(seed)(setup.body)();
