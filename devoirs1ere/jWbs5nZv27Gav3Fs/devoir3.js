...
(() => {
  ...
  var signum = function(dictOrd) {
    ...
    return function(dictRing) {
      ...
      return function(x3) {
        var $89 = lessThan1(x3)(zero2);
        if ($89) {
          return negate1(one2);
        }
        ;
        var $90 = greaterThan1(x3)(zero2);
        if ($90) {
          return one2;
        }
        ;
  ...
  var reduce = function(dictOrd) {
    ...
    return function(dictEuclideanRing) {
      ...
      var abs14 = abs5(Ring0);
      return function(n) {
        return function(d2) {
          var g2 = gcd1(n)(d2);
          var d$prime = div4(d2)(g2);
          return new Ratio(mul3(div4(n)(g2))(signum1(d$prime)), abs14(d$prime));
        };
      };
    };
  };
  ...
  var ringRatio = function(dictOrd) {
    ...
    return function(dictEuclideanRing) {
      ...
      return {
        sub: function(v) {
          return function(v1) {
            return reduce22(sub4(mul3(v.value0)(v1.value1))(mul3(v.value1)(v1.value0)))(mul3(v.value1)(v1.value1));
          };
        },
        Semiring0: function() {
  ...
  var biAdd = (x3) => (y3) => x3 + y3;
  var biMul = (x3) => (y3) => x3 * y3;
  var biSub = (x3) => (y3) => x3 - y3;
  var biMod = (x3) => (y3) => {
    if (y3 === 0n)
      return 0n;
    const yy = y3 < 0n ? -y3 : y3;
    return (x3 % yy + yy) % yy;
  };
  var biDiv = (x3) => (y3) => {
    if (y3 === 0n)
      return 0n;
    return (x3 - biMod(x3)(y3)) / y3;
  };
  var biDegree = (x3) => {
    return x3 < 0n ? -x3 : x3;
  };
      ...
      return {
        ...
        mul: function(v) {
          return function(v1) {
            return filter3(function(v2) {
              return notEq1(v2)(zero2);
            })(foldr4(unionWith2(add1))(empty2)(map4(function(v2) {
              return foldrWithIndex2(function(j) {
                return function(w) {
                  return function(acc) {
                    return insert2(v2.value0 + j | 0)(mul23(v2.value1)(w))(acc);
                  };
                };
              })(empty2)(v1);
            })(toUnfoldable2(v))));
  ...
  var snoc = function(xs) {
    return function(x3) {
      return foldr5(Cons.create)(new Cons(x3, Nil.value))(xs);
    };
  };
  ...
  var compactableEvent = {
    compact: /* @__PURE__ */ filter5(identity6),
  ...
  var abs12 = /* @__PURE__ */ abs3(basedVector);
  ...
  var renderPoint = {
    "render'": function(v) {
      return function(v1) {
        return g_([line3(abs4(v1) - 5)(ord3(v1) - 5)(abs4(v1) + 5)(ord3(v1) + 5)(v.stroke)(v.strokeWidth), line3(abs4(v1) - 5)(ord3(v1) + 5)(abs4(v1) + 5)(ord3(v1) - 5)(v.stroke)(v.strokeWidth), text7(abs4(v1) + 10)(ord3(v1) - 10)(v.textFill)(v.fontStyle)(v1.name)]);
      };
    }
  };
  var defaultContext = {
  ...
  var arrowTip = function(v) {
    ...
    var ang = atan2(ord12(v1))(abs12(v1));
  ...
  var abs13 = /* @__PURE__ */ abs(ordInt)(ringInt);
  var sub3 = /* @__PURE__ */ sub(ringRational);
  ...
  var header = /* @__PURE__ */ discard1(/* @__PURE__ */ setTitle_("Devoir 3 : Cercle trigonom\xE9trique / Equations de degr\xE9 2"))(function() {
    return discard1(nl)(function() {
      return discard1(tell3(div2([style_("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label_([text_("Nom:")]), label_([text_("Pr\xE9nom:")]), label_([text_("Classe:")])])))(function() {
        return tell3(ul_([li_([text_("4 exercices")]), li_([execWriter(discard1(t_("5 points par exercice ("))(function() {
  ...
  var nth2 = /* @__PURE__ */ nth(dfltTriple);
  var nth3 = /* @__PURE__ */ nth(dfltPoint);
  var avgNbFactors = 2;
