(() => {
  ...
  var applySecond = function(dictApply) {
    return function(a) {
      return function(b3) {
        return apply(dictApply)(map(dictApply.Functor0())($$const(identity(categoryFn)))(a))(b3);
      };
    };
  };
    ...
    return function($copy_dictEuclideanRing) {
      return function($copy_a) {
        return function($copy_b) {
          ...
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(dictEq, dictEuclideanRing, a, b3) {
            var $8 = eq(dictEq)(b3)(zero(dictEuclideanRing.CommutativeRing0().Ring0().Semiring0()));
            if ($8) {
              $tco_done = true;
              return a;
            }
            ...
            $tco_var_a = b3;
            $copy_b = mod(dictEuclideanRing)(a)(b3);
            return;
          }
          ;
          while (!$tco_done) {
  ...
  var scanl = function(dictTraversable) {
    return function(f) {
      return function(b0) {
        return function(xs) {
          return mapAccumL(dictTraversable)(function(b3) {
            return function(a) {
              var b$prime = f(b3)(a);
              return {
                accum: b$prime,
  ...
  function insertChildIx(i, a, b3) {
    var n = b3.childNodes.item(i) || null;
    if (n !== a) {
      b3.insertBefore(a, n);
    }
  }
  function removeChild(a, b3) {
    if (b3 && a.parentNode === b3) {
      b3.removeChild(a);
    }
  }
  ...
  var em = function(dictMultiAlternative) {
    return function(dictShiftMap) {
      return node("em")(dictMultiAlternative)(dictShiftMap);
    };
  };
  ...
  var foldableList2 = {
    ...
    foldMap: function(dictMonoid) {
      return function(f) {
        return foldl(foldableList2)(function(b3) {
          return function(a) {
            return append(dictMonoid.Semigroup0())(b3)(f(a));
          };
        })(mempty(dictMonoid));
      };
    }
  ...
  var mapMaybeWithKey = function(dictOrd) {
    return function(f) {
      return foldrWithIndex(foldableWithIndexMap)(function(k) {
        return function(a) {
          return function(acc) {
            return maybe(acc)(function(b3) {
              return insert2(dictOrd)(k)(b3)(acc);
            })(f(k)(a));
          };
        };
      })(empty6);
  ...
  var line2 = function(m2) {
    return function(n) {
      return {
        a: ord(basedPoint)(m2) - ord(basedPoint)(n),
        b: abs3(basedPoint)(n) - abs3(basedPoint)(m2),
        c: abs3(basedPoint)(m2) * ord(basedPoint)(n) - ord(basedPoint)(m2) * abs3(basedPoint)(n)
      };
    };
  };
  ...
  var equation = function(content3) {
    return function() {
      return katex.renderToString(content3, { displayMode: true, throwOnError: false });
    };
  };
  ...
  var equationImpl = function(str) {
    return bind(widgetBind)(liftEffect(widgetMonadEff(monoidArray))(equation(str)))(function(ktx) {
      return label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([dangerouslySetInnerHTML(ktx)])([]);
    });
  };
  var equation2 = function(str) {
    return put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(equationImpl(str));
  };
  var em2 = function(str) {
    return put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(em(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)(str)]));
  };
  var b2 = function(str) {
    return put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(b(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)(str)]));
  };
  ...
  var renderPoint = {
    "render'": function(v) {
      return function(v1) {
        return [line3(abs3(basedPoint)(v1) - 5)(ord(basedPoint)(v1) - 5)(abs3(basedPoint)(v1) + 5)(ord(basedPoint)(v1) + 5)(v.stroke)(v.strokeWidth), line3(abs3(basedPoint)(v1) - 5)(ord(basedPoint)(v1) + 5)(abs3(basedPoint)(v1) + 5)(ord(basedPoint)(v1) - 5)(v.stroke)(v.strokeWidth), text3(abs3(basedPoint)(v1) + 10)(ord(basedPoint)(v1) - 10)(v.textFill)(v.fontStyle)(v1.name)];
      };
    }
  };
  var defaultContext = {
  ...
  var renderSegment = {
    "render'": function(v) {
      return function(v1) {
        var m2 = middle("")(v1);
        return append(semigroupArray)([line3(abs3(basedPoint)(v1.origin))(ord(basedPoint)(v1.origin))(abs3(basedPoint)(v1.extremity))(ord(basedPoint)(v1.extremity))(v.stroke)(v.strokeWidth)])(append(semigroupArray)(maybe([])(function(v2) {
          var v3 = arrowTip(v1);
  ...
  var pythagoreanTriples = /* @__PURE__ */ map(functorArray)(Triple)([{
    a: 3,
    b: 4,
    c: 5
  }, {
  ...
  var header = /* @__PURE__ */ div$prime(/* @__PURE__ */ widgetMultiAlternative(monoidArray))(widgetShiftMap)(/* @__PURE__ */ fromIncremental(/* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindStateT(monadIdentity))(/* @__PURE__ */ setTitle("Devoir 3 : Cercle trigonom\xE9trique / Equations de degr\xE9 2"))(function() {
    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
      return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;")])([label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Pr\xE9nom:")]), label(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("Classe:")])])))(function() {
        return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(ul(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("4 exercices")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("5 points par exercice"))(function() {
          return discard(discardUnit)(bindStateT(monadIdentity))(m("(\\bullet"))(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(t(" : 1 point, "))(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\circ : \\frac{1}{2}"))(function() {
                return discard(discardUnit)(bindStateT(monadIdentity))(t(" point)"))(function() {
                  return get2(monadStateStateT(monadIdentity));
                });
              });
            });
          });
        }))), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("qualit\xE9 de la r\xE9daction prise en compte")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("sans document")]), li(widgetMultiAlternative(monoidArray))(widgetShiftMap)([])([text(widgetLiftWidget)("calculatrice autoris\xE9e")])])))(function() {
          return get2(monadStateStateT(monadIdentity));
        });
      });
    });
  ...
  var randFraction = function(r) {
    ...
    var sign2 = (2 * mod(euclideanRingInt)(nextRand.val)(2) | 0) - 1 | 0;
    ...
    if ($18) {
      return {
        fraction: div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt(sign2 * num | 0))(fromInt(den)),
        nextRand
      };
    }
    ;
    return {
      fraction: div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt(sign2 * den | 0))(fromInt(num)),
      nextRand
    };
  };
          ...
          return fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
              return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 1"))(function() {
                var r1 = rand(r0);
                var v = nth(dfltTriple)(pythagoreanTriples)(mod(euclideanRingInt)(r1.val)(length3(pythagoreanTriples)));
                return discard(discardUnit)(bindStateT(monadIdentity))(put3(functorStateT(functorIdentity))(monadStateStateT(monadIdentity))(div2(widgetMultiAlternative(monoidArray))(widgetShiftMap)([attr("style")("display: grid; grid-template-columns : 2fr 4fr;")])([svg(widgetMultiAlternative(monoidArray))(widgetShiftMap)([width2("400"), height2("310")])(function() {
                  ...
                  var pK = function(v1) {
                    return nth(dfltPoint)(v1)(0);
                  }(meets(interLineLine)(line2(pO)(pI))(line2(pE)(pH)));
                  var pL = function(v1) {
                    return nth(dfltPoint)(v1)(0);
                  }(meets(interLineLine)(line2(pO)(pJ))(line2(pF)(pG)));
                  var pN = function(v1) {
                    return nth(dfltPoint)(v1)(0);
                  }(meets(interLineLine)(line2(pO)(pM))(line2(pE)(pF)));
                  var pQ = function(v1) {
                    return nth(dfltPoint)(v1)(0);
                  }(meets(interLineLine)(line2(pO)(pP))(line2(pG)(pH)));
                  var ctx = {
                    strokeWidth: 1,
                  ...
                  return append(semigroupArray)(dt1(renderSequence(renderPoint))([pO, pA, pB, pC, pD]))(append(semigroupArray)(dt1(renderSequence(renderSegment))([segment(pA)(pB)(Nothing.value), segment(pB)(pC)(Nothing.value), segment(pC)(pD)(Nothing.value), segment(pD)(pA)(Nothing.value)]))(append(semigroupArray)(dt1(renderSequence(renderSegment))([segment(pE)(pF)(Nothing.value), segment(pF)(pG)(Nothing.value), segment(pG)(pH)(Nothing.value), segment(pH)(pE)(Nothing.value)]))(append(semigroupArray)(dt1(renderSequence(renderPoint))([rename("\u{1D465}")(pI), pK]))(append(semigroupArray)(dt1(renderSegment)(segment(pI)(pK)(Nothing.value)))(append(semigroupArray)(dt1(renderSequence(renderPoint))([rename("\u{1D465}")(pL), pJ]))(append(semigroupArray)(dt1(renderSegment)(segment(pJ)(pL)(Nothing.value)))(append(semigroupArray)(dt1(renderSequence(renderPoint))([rename("\u{1D465}")(pM), pN]))(append(semigroupArray)(dt1(renderSegment)(segment(pM)(pN)(Nothing.value)))(append(semigroupArray)(dt1(renderSequence(renderPoint))([rename("\u{1D465}")(pQ), pP]))(dt1(renderSegment)(segment(pQ)(pP)(Nothing.value))))))))))));
                }()), div$prime(widgetMultiAlternative(monoidArray))(widgetShiftMap)(fromIncremental(discard(discardUnit)(bindStateT(monadIdentity))(t("Soit "))(function() {
                  return discard(discardUnit)(bindStateT(monadIdentity))(m("ABCD"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" un rectangle de centre "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m("O"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t("On construit un autre rectangle de centre "))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(m("O"))(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" \xE0 l'int\xE9rieur de "))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("ABCD"))(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" de mani\xE8re \xE0 laisser entre les deux rectangles "))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("une bande de largeur constante "))(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("Le but de l'exercice est de trouver la valeur de "))(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" pour laquelle "))(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" l'aire du rectangle int\xE9rieur est \xE9gale \xE0 la "))(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(em2("moiti\xE9"))(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" de l'aire de "))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("ABCD"))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t("On donne "))(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m(" AB=" + show(showInt)(v.b)))(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("AD=" + show(showInt)(v.a)))(function() {
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" (la figure n'est pas \xE0 l'\xE9chelle)."))(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                  return get2(monadStateStateT(monadIdentity));
                                                                                });
                  ...
                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u25E6"))(function() {
                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" Expliquer bri\xE8vement pourquoi le rectangle int\xE9rieur a pour longeur "))(function() {
                      return discard(discardUnit)(bindStateT(monadIdentity))(m(show(showInt)(v.b) + "-2x"))(function() {
                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" et pour hauteur "))(function() {
                          return discard(discardUnit)(bindStateT(monadIdentity))(m(show(showInt)(v.a) + "-2x"))(function() {
                            return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                return discard(discardUnit)(bindStateT(monadIdentity))(t("Ceci implique que "))(function() {
                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" ne peut d\xE9passer une valeur maximale. Laquelle ? Expliquer bri\xE8vement."))(function() {
                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u2022\u25E6"))(function() {
                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" Donner l'aire de "))(function() {
                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("ABCD."))(function() {
                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t("Montrer que l'aire du rectangle int\xE9rieur est "))(function() {
                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("4x^2 -" + (show(showInt)(2 * (v.b + v.a | 0) | 0) + ("x+" + show(showInt)(v.b * v.a | 0)))))(function() {
                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("En d\xE9duire que l'\xE9quation que doit v\xE9rifier "))(function() {
                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" est"))(function() {
                                                                return discard(discardUnit)(bindStateT(monadIdentity))(equation2("4x^2 -" + (show(showInt)(2 * (v.b + v.a | 0) | 0) + ("x+" + (show(showInt)(div(euclideanRingInt)(v.b * v.a | 0)(2)) + "=0")))))(function() {
                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022\u2022\u25E6"))(function() {
                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" R\xE9soudre cette \xE9quation dans "))(function() {
                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\mathbb{R}"))(function() {
                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(b2("4\u25E6"))(function() {
                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" En prenant en compte les contraintes sur "))(function() {
                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" \xE9tablies \xE0 la question 1, donner "))(function() {
                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(em2("la"))(function() {
                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" valeur de "))(function() {
                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" r\xE9pondant au probl\xE8me."))(function() {
                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 2"))(function() {
                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t("Dans un rep\xE8re orthonorm\xE9, soient "))(function() {
                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("J"))(function() {
                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point de coordonn\xE9es "))(function() {
                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("(0;1)"))(function() {
                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("K"))(function() {
                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point de coordonn\xE9es "))(function() {
                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\left(\\cos(\\frac{ -5\\pi}{6}); \\sin(\\frac{ -5\\pi}{6})\\right)"))(function() {
                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("L"))(function() {
                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" le point de coordonn\xE9es "))(function() {
                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("\\left(\\cos(\\frac{ -\\pi}{6}); \\sin(\\frac{ -\\pi}{6})\\right)"))(function() {
                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u2022\u2022\u2022\u25E6"))(function() {
                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" Calculer les distances "))(function() {
                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("JK"))(function() {
                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("KL"))(function() {
                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("LJ"))(function() {
                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t("Pour rappel, la distance entre "))(function() {
                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("A"))(function() {
                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("B"))(function() {
                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(" est "))(function() {
                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(m("\\sqrt{(x_B-x_A)^2+(y_B-y_A)^2}"))(function() {
                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" dans un rep\xE8re orthonorm\xE9."))(function() {
                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u2022\u25E6"))(function() {
                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" En d\xE9duire la nature du triangle "))(function() {
                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("JKL"))(function() {
                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(","))(function() {
                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t(" puis une mesure "))(function() {
                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(em2("en radians"))(function() {
                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" de l'angle "))(function() {
                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("\\widehat{JKL}"))(function() {
                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 3"))(function() {
                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(t("Le but de cet exercice est de r\xE9soudre le syst\xE8me en "))(function() {
                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("y"))(function() {
                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" suivant "))(function() {
                                                                                                                                                                                                                var f1 = randFraction(r1);
                                                                                                                                                                                                                var f2 = randFraction(f1.nextRand);
                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(equation2("\\left\\{\\begin{array}{l}x-y=" + (showFraction(sub(ringRatio(ordInt)(euclideanRingInt))(f1.fraction)(f2.fraction)) + ("\\\\ xy = " + (showFraction(mul(semiringRatio(ordInt)(euclideanRingInt))(f1.fraction)(f2.fraction)) + "\\end{array}\\right.")))))(function() {
                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u25E6"))(function() {
                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(t(" En effectuant les changements de variables "))(function() {
                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(m("X=x"))(function() {
                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(m("Y=-y"))(function() {
                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(t(", montrer que le syst\xE8me initial devient"))(function() {
                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(equation2("\\left\\{\\begin{array}{l}X+Y=" + (showFraction(sub(ringRatio(ordInt)(euclideanRingInt))(f1.fraction)(f2.fraction)) + ("\\\\ XY = " + (showFraction(mul(semiringRatio(ordInt)(euclideanRingInt))(negate(ringRatio(ordInt)(euclideanRingInt))(f1.fraction))(f2.fraction)) + "\\end{array}\\right.")))))(function() {
                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u2022\u2022\u2022\u25E6"))(function() {
                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" R\xE9soudre le syst\xE8me de la question 1, c'est-\xE0-dire "))(function() {
                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("trouver tous les couples "))(function() {
                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("(X;Y)"))(function() {
                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" solutions du syst\xE8me avec la m\xE9thode du cours."))(function() {
                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022"))(function() {
                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" En d\xE9duire l'ensemble des couples "))(function() {
                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("(x;y)"))(function() {
                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" solutions du syst\xE8me initial en utilisant \xE0 nouveau les changements de variables."))(function() {
                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(section("Exercice 4"))(function() {
                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("Dire si chacune des affirmations suivantes est vraie ou fausse."))(function() {
                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("Si elle est vraie, justifier bri\xE8vement pourquoi par une propri\xE9t\xE9 du cours, ou un argument g\xE9om\xE9trique."))(function() {
                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("Sinon, donner un contre-exemple."))(function() {
                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t("Toutes les questions sont ind\xE9pendantes les unes des autres."))(function() {
                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(b2("1\u2022\u25E6"))(function() {
                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soient "))(function() {
                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("S"))(function() {
                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("P"))(function() {
                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" deux nombres r\xE9els. Il est toujours possible de trouver "))(function() {
                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("deux nombres r\xE9els "))(function() {
                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("x_1"))(function() {
                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("x_2"))(function() {
                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" tels que "))(function() {
                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x_1+x_2=S"))(function() {
                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("x_1x_2=P"))(function() {
                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(b2("2\u25E6"))(function() {
                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" Quelque soient "))(function() {
                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("y"))(function() {
                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos(x)+\\sin(y)=\\cos(y)+\\sin(x)"))(function() {
                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("3\u2022\u25E6"))(function() {
                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" la fonction d\xE9finie par "))(function() {
                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("f(x)=a(x-\\alpha)^2+\\beta"))(function() {
                                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("Si "))(function() {
                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("a"))(function() {
                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("\\beta"))(function() {
                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" sont de signes contraires, alors "))(function() {
                                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t(" admet deux racines r\xE9elles distinctes."))(function() {
                                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("4\u25E6"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" Quelque soit "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(", "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos^2(x)-\\sin^2(x)=1"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("5\u25E6"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" Soit "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" une fonction polyn\xF4me du second degr\xE9. "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("Si "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("f"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t(" poss\xE8de la racine "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(m("x_1"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(", alors elle poss\xE8de aussi la racine "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("x_2"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("x_2\\not = x_1"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                            return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(b2("6\u25E6"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(t(" Quelque soient "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(m("x"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(t(" et "))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                          return discard(discardUnit)(bindStateT(monadIdentity))(m("y"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                              return discard(discardUnit)(bindStateT(monadIdentity))(m("\\cos(x)\\sin(y)=\\cos(y)\\sin(x)"))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                return discard(discardUnit)(bindStateT(monadIdentity))(t("."))(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                  return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                    return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      return discard(discardUnit)(bindStateT(monadIdentity))(nl)(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                        var rep = ["r\xE9ponses: ", "\\; 1)1\u25E6 \\; 0<x<" + showFraction(div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt(v.a))(fromInt(2))), "\\; 1)2\u2022\u25E6 \\;", "AB AD = " + show(showInt)(v.b * v.a | 0), "\\; 1)3\u2022\u2022\u25E6 \\;", "\\mathcal{S}=\\{" + (showFraction(div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt((v.b + v.a | 0) - v.c | 0))(fromInt(4))) + ("," + (showFraction(div(euclideanRingRatio(ordInt)(euclideanRingInt))(fromInt((v.b + v.a | 0) + v.c | 0))(fromInt(4))) + "\\} "))), "\\; 1)4\u25E6", "\\; 2)1\u2022\u2022\u2022\u25E6 \\;JK=KL=LJ=\\sqrt{3}", "\\; 2)2\u2022\u25E6 \\;\\widehat{JKL}=\\frac{\\pi}{3}", "\\; 3)1\u25E6", "\\; 3)2\u2022\u2022\u2022\u25E6 \\;\\mathcal{S}=\\{(" + (showFraction(f1.fraction) + ("," + (showFraction(negate(ringRatio(ordInt)(euclideanRingInt))(f2.fraction)) + ("),(" + (showFraction(negate(ringRatio(ordInt)(euclideanRingInt))(f2.fraction)) + ("," + (showFraction(f1.fraction) + ")\\}"))))))), "\\; 3)3\u2022\\; \\mathcal{S}=\\{(" + (showFraction(f1.fraction) + ("," + (showFraction(f2.fraction) + ("),(" + (showFraction(negate(ringRatio(ordInt)(euclideanRingInt))(f2.fraction)) + ("," + (showFraction(negate(ringRatio(ordInt)(euclideanRingInt))(f1.fraction)) + ")\\}"))))))), "\\; 4)1\u2022\u25E6", "\\; 4)2\u25E6", "\\; 4)3\u2022\u25E6", "\\; 4)4\u25E6", "\\; 4)5\u25E6", "\\; 4)6\u25E6"];
                                                                                                                                                                                                                                                                                                                                                                                                                                                        return discard(discardUnit)(bindStateT(monadIdentity))(m(function() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                          var $21 = fromMaybe(0)(validateInput(newState.seed)) < 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                          if ($21) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                            return foldr(foldableArray)(append(semigroupString))("")(rep);
                                                                                                                                                                                                                                                                                                                                                                                                                                                          }
                                                                                                                                                                                                                                                                                                                                                                                                                                                          ;
                                                                                                                                                                                                                                                                                                                                                                                                                                                          return "";
                                                                                                                                                                                                                                                                                                                                                                                                                                                        }()))(function() {
