...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Concur.VDom.SVG.Geometry"] = $PS["Concur.VDom.SVG.Geometry"] || {};
  var exports = $PS["Concur.VDom.SVG.Geometry"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Ring = $PS["Data.Ring"];
  var Data_Semiring = $PS["Data.Semiring"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Concur.VDom.SVG.Render"] = $PS["Concur.VDom.SVG.Render"] || {};
  var exports = $PS["Concur.VDom.SVG.Render"];
  var Concur_Core_LiftWidget = $PS["Concur.Core.LiftWidget"];
  var Concur_Core_Types = $PS["Concur.Core.Types"];
  var Concur_VDom_DOM = $PS["Concur.VDom.DOM"];
  var Concur_VDom_SVG = $PS["Concur.VDom.SVG"];
  var Concur_VDom_SVG_Geometry = $PS["Concur.VDom.SVG.Geometry"];
  var Data_Array = $PS["Data.Array"];
  var Data_Enum = $PS["Data.Enum"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Int = $PS["Data.Int"];
  ...
  var pathCoord = function (p) {
      return " " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(p)) + (" " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(p)) + " ")));
  };
  ...
  var renderCircle = new Render(function (v) {
      return function (v1) {
          return [ path(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1.center) - v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1.center)) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 1 0 " + (Data_Show.show(Data_Show.showNumber)(2.0 * v1.radius) + " 0")))))))))))), path(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1.center) - v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1.center)) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 1 1 " + (Data_Show.show(Data_Show.showNumber)(2.0 * v1.radius) + " 0")))))))))))) ];
      };
  });
  var renderRightAngle = new Render(function (v) {
      return function (v1) {
          var w = Concur_VDom_SVG_Geometry.scale(v1.radius / Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(v1.origin))(v1.origin);
          var v2 = Concur_VDom_SVG_Geometry.scale(v1.radius / Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(v1.extremity))(v1.extremity);
          var u = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summableVectorVector)(v2)(w);
          var o = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(w);
          var n = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(v2);
          var m = Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v1.center)(u);
  ...
  var renderPoint = new Render(function (v) {
      return function (v1) {
          return [ line(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1) - 5.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1) - 5.0)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1) + 5.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1) + 5.0)(v.stroke)(v.strokeWidth), line(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1) - 5.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1) + 5.0)(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1) + 5.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1) - 5.0)(v.stroke)(v.strokeWidth), text(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1) + 10.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1) - 10.0)(v.textFill)(v.fontStyle)(v1.name) ];
      };
  });
  var defaultContext = {
      stroke: "#000",
  ...
  var arrowTip = function (v) {
      var v1 = Concur_VDom_SVG_Geometry.vector(v.origin)(v.extremity);
      var v0 = Concur_VDom_SVG_Geometry.Vector(Data_Sparse_Polynomial.monoPol(Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(v1))(0));
      var ang = $$Math.atan2(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedVector)(v1))(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedVector)(v1));
      var f = function (theta) {
          var v11 = Concur_VDom_SVG_Geometry.rotated(theta)(Concur_VDom_SVG_Geometry.Vector(Data_Sparse_Polynomial.monoPol(arrowLength)(0)));
          return Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summublePointVector)(v.origin)(Concur_VDom_SVG_Geometry.rotated(ang)(Concur_VDom_SVG_Geometry.plus(Concur_VDom_SVG_Geometry.summableVectorVector)(v11)(v0)));
      };
      return {
  ...
  var renderSegment = new Render(function (v) {
      return function (v1) {
          var m = Concur_VDom_SVG_Geometry.middle("")(v1);
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ line(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1.origin))(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1.origin))(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(v1.extremity))(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(v1.extremity))(v.stroke)(v.strokeWidth) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              var v2 = arrowTip(v1);
              ...
              return [ text(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(m) + 10.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(m) - 10.0)(v.textFill)(v.fontStyle)(str), text(Concur_VDom_SVG_Geometry.abs(Concur_VDom_SVG_Geometry.basedPoint)(m) + 10.0)(Concur_VDom_SVG_Geometry.ord(Concur_VDom_SVG_Geometry.basedPoint)(m) - 23.0)(v.textFill)(v.fontStyle)((function () {
                  var $80 = str === "";
                  if ($80) {
                      return "";
                  };
...
(function($PS) {
  ...
  var Concur_VDom_SVG = $PS["Concur.VDom.SVG"];
  var Concur_VDom_SVG_Geometry = $PS["Concur.VDom.SVG.Geometry"];
  var Concur_VDom_SVG_Render = $PS["Concur.VDom.SVG.Render"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Cofree = $PS["Control.Cofree"];
  var Control_Monad_State_Trans = $PS["Control.Monad.State.Trans"];
  var Data_Array = $PS["Data.Array"];
  ...
  var readWrap = function (a) {
      return function (xs) {
          return function (i) {
              var v = Data_Array.index(xs)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i)(Data_Array.length(xs)));
              if (v instanceof Data_Maybe.Just) {
                  return v.value0;
              };
              return a;
  ...
  var header = Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.setTitle("Devoir 1 : Trigonom\xe9trie"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 1fr 1fr;") ])([ Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Pr\xe9nom:") ]), Concur_VDom_DOM.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Classe:") ]) ])))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.ul(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("10 questions : pour chacune d'elle, indiquer la bonne r\xe9ponse") ]), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])(Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\frac{1}{2}"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" point par bonne r\xe9ponse"))(function () {
                      return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                  });
              }))), Concur_VDom_DOM.li(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("sans calculatrice") ]) ])))(function () {
                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
              });
          });
      });
  ...
  var body = function (st) {
      return Concur_Core_FRP.dyn(Concur_Core_Types.widgetMonad)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.display(Concur_VDom_DOM.text(Concur_Core_LiftWidget.widgetLiftWidget)("Enonc\xe9 n\xb0 ")))(function () {
          return Control_Bind.bind(Control_Cofree.bindCofree(Concur_Core_Types.widgetAlternative(Data_Monoid.monoidArray)))(Concur_Core_FRP.debounce(Concur_Core_Types.widgetMonad)(Concur_Core_Types.widgetAlt(Data_Monoid.monoidArray))(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(50.0)(st)(function (s) {
              ...
              var ctx = {
                  strokeWidth: 1.0,
                  fill: Concur_VDom_SVG_Render.defaultContext.fill,
                  fontStyle: Concur_VDom_SVG_Render.defaultContext.fontStyle,
                  stroke: Concur_VDom_SVG_Render.defaultContext.stroke,
                  textFill: Concur_VDom_SVG_Render.defaultContext.textFill
              };
              var render = function (dictRender) {
                  return Concur_VDom_SVG_Render["render'"](dictRender)(ctx);
              };
              ...
              return Concur_Core_FRP.display(Concur_VDom_DOM["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)((function () {
                  ...
                  return Article.fromIncremental(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("1."))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" On consid\xe8re "))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\mathcal{C}"))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le cercle trigonom\xe9trique suivant :"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Concur_VDom_DOM.div(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_Props.attr("style")("display: grid; grid-template-columns: 1fr 5fr ;") ])([ Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("180"), Concur_VDom_SVG.height("180"), Concur_VDom_SVG.viewBox("-10 -10 200 200") ])((function () {
                                              var pI = Concur_VDom_SVG_Geometry.point("I")(80.0 + 70.0)(80.0);
                                              var pJ = Concur_VDom_SVG_Geometry.point("J")(80.0)(80.0 - 70.0);
                                              var pM = Concur_VDom_SVG_Geometry.point("M")(80.0 + 70.0 * $$Math.cos(angle0.approx))(80.0 - 70.0 * $$Math.sin(angle0.approx));
                                              var pO = Concur_VDom_SVG_Geometry.point("O")(80.0)(80.0);
                                              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderSequence(Concur_VDom_SVG_Render.renderPoint))([ pO, pI, pJ ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderCircle)(Concur_VDom_SVG_Geometry.circle(pO)(Concur_VDom_SVG_Geometry.length(Concur_VDom_SVG_Geometry.measurableVector)(Concur_VDom_SVG_Geometry.vector(pO)(pI)))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderSegment)(Concur_VDom_SVG_Geometry.segment(pO)(pI)(Data_Maybe.Nothing.value)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderSegment)(Concur_VDom_SVG_Geometry.segment(pO)(pJ)(Data_Maybe.Nothing.value)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderRightAngle)(Concur_VDom_SVG_Geometry.rightangle(Concur_VDom_SVG_Geometry.vector(pO)(pI))(pO)(Concur_VDom_SVG_Geometry.vector(pO)(pJ))(10.0)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(render(Concur_VDom_SVG_Render.renderPoint)(pM))(render(Concur_VDom_SVG_Render.renderSegment)(Concur_VDom_SVG_Geometry.segment(pO)(pM)(Data_Maybe.Nothing.value))))))));
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Soit "))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le point de coordonn\xe9es "))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(" + (angle0.cos + ("," + (angle0.sin + ").")))))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Donner la valeur (en radians) du r\xe9el compris dans l'intervalle "))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("]-\\pi, \\pi]"))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" correspondant au point "))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M:"))(function () {
                                                                                  return Article.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                                                              });
                                                                          });
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("2."))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Compl\xe9ter la phrase en rempla\xe7ant chaque mot manquant par "))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\underline{\xe9gaux}"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" ou "))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\underline{oppos\xe9s}:"))(function () {
                                                                      var r1 = Rand.rand(r0);
                                                                      var arr = (function () {
                                                                          var v = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(3);
                                                                          if (v === 0) {
                                                                              return thirds;
                                                                          };
                                                                          if (v === 1) {
                                                                      ...
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("Les r\xe9els "))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(angle1.exact))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(angle2.exact))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" ont leurs cosinus "))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\underline{" + (spacex(16) + "}")))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et leurs sinus "))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\underline{" + (spacex(16) + "}.")))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("3."))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Donner la valeur du r\xe9el "))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("a"))(function () {
                                                                                                                              ...
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" de l'intervalle "))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("[0, 2\\pi["))(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" v\xe9rifiant "))(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\cos(a)=" + angle3.cos))(function () {
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\sin(a)=" + (angle3.sin + ":")))(function () {
                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("4."))(function () {
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Etant donn\xe9 que "))(function () {
                                                                                                                                                                              var r5 = Rand.rand(r4);
                                                                                                                                                                              var cosa = readWrap(dfltDecimal)(decimals)(r5.val);
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.equation(cosa.origin))(function () {
                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et sachant que "))(function () {
                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("a\\in]-\\pi,0["))(function () {
                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", et que "))(function () {
                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\cos(a)=" + cosa.decimal))(function () {
                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(", d\xe9terminer la valeur exacte de "))(function () {
                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\sin(a):"))(function () {
                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("5."))(function () {
                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Convertir "))(function () {
                                                                                                                                                                                                                              var r6 = Rand.rand(r5);
                                                                                                                                                                                                                              var deg = readWrap(dfltDegree)(degrees)(r6.val);
                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(deg.degree + "^\\circ"))(function () {
                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" en radians. On donnera une r\xe9ponse dans "))(function () {
                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("[0, 2\\pi["))(function () {
                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" sous la forme exacte la plus simple possible:"))(function () {
                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("6."))(function () {
                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Convertir "))(function () {
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m(fifth.radian))(function () {
                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" en degr\xe9s. On donnera un entier positif inf\xe9rieur \xe0 "))(function () {
                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("359^\\circ"))(function () {
                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(":"))(function () {
                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("7."))(function () {
                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Soit "))(function () {
                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le point du cercle trigonom\xe9trique v\xe9rifiant "))(function () {
                                                                                                                                                                                                                                                                                                      var r8 = Rand.rand(r7);
                                                                                                                                                                                                                                                                                                      var angle4 = readWrap(dfltPoint)(points)(r8.val);
                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{IOM} =" + angle4.exact))(function () {
                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" (remarque: on \xe9crit aussi "))(function () {
                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(\\overrightarrow{OI},\\overrightarrow{OM})=" + angle4.exact))(function () {
                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t("). Donner la valeur de "))(function () {
                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{IOM'} "))(function () {
                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" comprise entre "))(function () {
                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("-\\pi"))(function () {
                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" et "))(function () {
                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\pi"))(function () {
                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" si "))(function () {
                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M'"))(function () {
                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est le sym\xe9trique de "))(function () {
                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" par la sym\xe9trie d'axe "))(function () {
                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(OI):"))(function () {
                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("8."))(function () {
                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Soit "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" le point du cercle trigonom\xe9trique v\xe9rifiant "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                          var r9 = Rand.rand(r8);
                                                                                                                                                                                                                                                                                                                                                                                          var angle5 = readWrap(dfltPoint)(points)(r9.val);
                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{IOM} =" + angle5.exact))(function () {
                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(". Donner la valeur de "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\widehat{IOM'}"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" comprise entre "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("-\\pi"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" si "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M'"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" est le sym\xe9trique de "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("M"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" par la sym\xe9trie d'axe "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("(OJ):"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("9."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Donner la valeur de "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\cos(" + (angle4.exact + "):")))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.b("10."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.t(" Donner la valeur de "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m("\\sin(" + (angle5.exact + "):")))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          var rep = [ "r\xe9ponses: 1)", angle0.princ, "\\;2)", (function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var $12 = angle1.cos === angle2.cos;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              if ($12) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return "\xe9gaux,";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              };
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return "oppos\xe9s,";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          })() + (function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var $13 = angle1.sin === angle2.sin;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              if ($13) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return "\xe9gaux";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              };
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return "oppos\xe9s";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Article.m((function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              var $14 = Data_Maybe.fromMaybe(0)(Article.validateInput(newState.seed)) < 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              if ($14) {
  ...
  exports["dfltDecimal"] = dfltDecimal;
  exports["degrees"] = degrees;
  exports["dfltDegree"] = dfltDegree;
  exports["fifths"] = fifths;
  exports["readWrap"] = readWrap;
