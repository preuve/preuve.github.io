...
(function($PS) {
  ...
  var randExperience = function (dictPartial) {
      return function (r) {
          var r1 = Rand.rand(r);
          var r2 = Rand.rand(r1);
          var r3 = Rand.rand(r2);
          var f3 = Data_Maybe.fromJust(dictPartial)(Data_Array.index(fractions)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r3.val)(Data_Array.length(fractions))));
          var f2 = Data_Maybe.fromJust()(Data_Array.index(fractions)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r2.val)(Data_Array.length(fractions))));
          var f1 = Data_Maybe.fromJust()(Data_Array.index(fractions)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(Data_Array.length(fractions))));
          var fs = Data_Array.sort(Fraction.ordFraction)([ f1, f2, f3 ]);
          return fs;
      };
  };
  var empty = {
  ...
  var complete8 = function (v) {
      ...
      var $74 = Data_Ord.lessThan(Fraction.ordFraction)(mn)(v.pB) && Data_Ord.lessThan(Fraction.ordFraction)(v.pB)(mx);
      if ($74) {
          var pnB = Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))(v.pB);
  ...
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              KaTeX.subsection("1)")();
              tree(empty)();
              KaTeX.raw(Data_Show.show(Data_Show.showArray(Fraction.showFraction))(randExperience()(r0)))();
              KaTeX.subsection("2)")();
              tree(empty)();
              KaTeX.newline();
              var rep = [ "r\xe9ponses: " ];
              return KaTeX.render((function () {
                  var $80 = $foreign.fromString(v) < 0;
                  if ($80) {
